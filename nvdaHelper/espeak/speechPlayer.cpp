...
speechPlayer_handle_t speechPlayerHandle=nullptr;
const unsigned int minFadeLength=110;

inline bool needsMixWaveFile() {
	return static_cast<bool>(wdata.n_mix_wavefile);
}
...
void mixWaveFile(unsigned int maxNumSamples, sample* sampleBuf) {
	unsigned int i=0;
...
int Wavegen_Klatt2(int length, int resume, frame_t *fr1, frame_t *fr2){
	...
	mixWaveFile(outLength,(sample*)out_ptr);
