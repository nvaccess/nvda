...
В этом поле редактирования устанавливается число строк на странице, на которое вы будете перемещаться при нажатии клавиш PageUp или PageDown в режиме обзора.
