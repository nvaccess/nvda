...
##### Режимы, доступные по команде переключения режима речи {#SpeechModesDisabling}
...
##### Время удерживания аудиоустройство активным после окончания речи {#AudioAwakeTime}

В этом поле редактирования указывается, как долго NVDA будет поддерживать аудиоустройство в активном состоянии после окончания произнесённого.
Это позволяет NVDA избегать некоторых речевых сбоев, таких как пропущенные части слов.
Это может произойти из-за того, что аудиоустройства (особенно Bluetooth и беспроводные устройства) переходят в ждущий режим.
Это также может быть полезно в других случаях использования, например, при запуске NVDA внутри виртуальной машины (например, Citrix Virtual Desktop) или на некоторых ноутбуках.

Более низкие значения могут привести к более частому отключению звука, поскольку устройство может слишком рано перейти в ждущий режим, что приведёт к обрезанию начала следующего произносимого фрагмента.
Установка слишком высокого значения может привести к более быстрой разрядке аккумулятора устройства вывода звука, поскольку оно остается активным дольше, пока звук не передается.

Вы можете установить время в ноль, чтобы отключить эту возможность.
