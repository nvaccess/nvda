...
+ Bewegen Sie den Cursor zum Text, der die Notiz enthält.
+ Rufen Sie die Markierungsoptionen wie oben beschrieben auf.
+ Wählen Sie Notiz bearbeiten.
+
...
%kc:setting
==== Einstellungen für Sprachausgaben öffnen ====
...
%kc:setting
==== Dialogfeld zum Auswählen der Sprachausgabe öffnen ====
...
%kc:setting
==== Dialogfeld zum Auswählen der Braillezeile öffnen ====
...
%kc:setting
==== Einstellungen zur Objekt-Darstellung öffnen ====
...
%kc:setting
==== Einstellungen zum Lesemodus öffnen ====
...
%kc:setting
==== Einstellungen zur Dokument-formatierung öffnen ====
...
+++ Tastenzuweisungen für Brailliant BI 32/40 und B 80 +++
%kc:beginInclude
|| Name | Taste |
...
+ Bitte stellen Sie sicher, dass Sie den [neuesten Treiber https://www.papenmeier-rehatechnik.de/service/downloadcenter/software/artikel/software-braille-geräte.html] installiert haben.
+ Öffnen Sie den Windows-Geräte-Manager.
+ Scrollen Sie in der Liste nach unten zu „USB-Controller“ oder „USB-Geräte“.
+ Wählen Sie „Papenmeier Braillex USB-Gerät“ o. ä..
+ Öffnen Sie die Eigenschaften und wechseln Sie zur Registerkarte Erweitert.
...
+ Deaktivieren Sie die Option VCP laden.
+
