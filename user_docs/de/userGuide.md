...
* Betriebssysteme: Alle 32-Bit- und 64-Bit-Versionen von Windows 7, Windows 8, Windows 8.1, Windows 10, Windows 11 und alle Server-Versionen ab Windows Server 2008 R2.
  * Für NVDA unter Windows 7 wird Service Pack 1 oder höher benötigt.
  * Für NVDA unter Windows Server 2008 R2 wird Service Pack 1 oder höher benötigt.
...
|Aktuelle Zeile vorlesen |`NVDA+Pfeiltaste nach oben` |`NVDA+L` |Liest die Zeile vor. Zweimaliges Drücken buchstabiert die Zeile. Dreimaliges Drücken buchstabiert die Zeile unter Verwendung von Zeichenbeschreibungen (Alpha, Bravo, Charlie, usw.).|
|Auswahl vorlesen |`NVDA+Umschalt+Pfeiltaste nach oben` |`NVDA+Umschalt+S` |Liest jeden markierten Text vor.|
|Text aus der Zwischenablage vorlesen |`NVDA+C` |`NVDA+C` |Liest beliebigen Text aus der Zwischenablage vor.|
...
|Focus mitteilen |`NVDA+Tab` |`NVDA+Tab` |Teilt das aktuelle Steuerelement mit, welches den Fokus hat. Zweimaliges Drücken buchstabiert die Informationen.|
...
|Link-Zieladresse mitteilen |`NVDA+K` |`NVDA+K` |Bei einmaligem drücken wird die Zieladresse des Links an der aktuellen Cursor- oder Fokus-Position angezeigt. Bei zweimaligem Drücken wird sie in einem Fenster zur genaueren Überprüfung angezeigt.|
...
|Überschriftebene 1, 2, or 3 |`1`, `2`, `3` |Zur nächsten Überschrift auf der angegebenen Ebene wechseln.|
...
Es gibt auch ein Programm [NVDA Certified Expert](https://certification.nvaccess.org/).
Dies ist eine Online-Prüfung, die Sie absolvieren können, um Ihre Kenntnisse in NVDA nachzuweisen.
[NVDA Certified Experts](https://certification.nvaccess.org/) können ihre Kontaktdaten und relevanten Geschäftsinformationen auflisten.
...
NV Access bietet telefonisch auch kostenpflichtigen [Support](https://www.nvaccess.org/product/nvda-telephone-support/) an, entweder in Blöcken oder als Teil des [NVDA-Produktivitätspaket](https://www.nvaccess.org/product/nvda-productivity-bundle/).
...
* Windows 8 und neuer: Die Unfähigkeit, Eingaben über einen Touchscreen zu unterstützen.
* Windows 8 und neuer: Die Unfähigkeit, Funktionen wie den Lesemodus und das Vorlesen von Zeichen während der Eingabe in Apps aus dem Windows-Store anzubieten.
* Windows 8 und neuer: Die Lautstärke anderer Audio-Quellen zu steuern wird nicht unterstützt.
...
Wenn Sie NVDA auf einem Gerät mit Touchscreen und Windows 8 oder neuer benutzen, können Sie NVDA auch direkt über Touch-Eingaben bedienen.
...
|Schnelltasten mitteilen |`Umschalt+Nummernblock 2` |`NVDA+Strg+Umschalt+Punkt` |Teilt die Tastenkombination (Accelerator) des aktuell fokussierten Objekts mit.|
...
### Die Objekt-Navigation {#ObjectNavigation}
...
* F: Formularfeld
* U: Noch nicht besuchter Link
* V: Bereits besuchter Link
* E: Eingabefeld
* B: Schalter
* X: Kontrollfeld
* C: Kombinationsfeld
...
* G: Grafik
* D: Sprungmarke
* O: Eingebettetes Objekt (Anwendung, Dialog, Audio- und Videoplayer)
...
Sie können MathPlayer 4 von Design Science verwenden, um mit NVDA in mathematischen Inhalten zu navigieren.
Hierfür ist die Installation von MathPlayer 4 notwendig.
Der MathPlayer ist als kostenloser Download auf der englischsprachigen Seite unter https://www.dessci.com/en/products/mathtype/ verfügbar.
Nach der Installation von MathPlayer muss NVDA einmal neugestartet werden.

NVDA unterstützt die folgenden mathematischen Inhalte:
...
Sie können die aktuelle Version von der englischsprachigen Seite unter https://www.dessci.com/en/products/mathtype/ herunterladen.
* Adobe Reader:
...
Jetzt können Sie die Tastenkombinationen von Mathplayer (z. B. Pfeiltasten) verwenden, um innerhalb des Ausdrucks zu navigieren.
...
Weitere Informationen hierzu finden Sie in der [MathPlayer-Dokumentation zu Navigationsbefehlen](https://www.dessci.com/en/products/mathplayer/navigation_commands.htm).
...
Drücken Sie dann den Buchstaben, welches Teil des gewünschten Tastaturkürzels ist.
Um z. B. Strg+F zu erzeugen, verwenden Sie den Befehl "Strg-Taste umschalten" und geben dann ein F ein, und um Strg+Alt+T einzugeben, verwenden Sie entweder die Befehle "Strg-Taste umschalten" und "Alt-Taste umschalten" in beliebiger Reihenfolge oder den Befehl "Strg- und Alt-Tasten umschalten" und geben dann ein T ein.
...
## Erkennung von Inhalten {#ContentRecognition}
...
NVDA muss die Reihen und Spalten mit den Überschriften kennen.
...
Für manche Einstellungen können Sie auch auf den Schalter "Übernehmen" klicken, um weiterhin in den NVDA-Einstellungen zu bleiben.
...
##### Allgemeine Einstellungen öffnen {#toc104}
...
* Nur Debug-Meldungen: Zusätzlich zu den Informationen, Warn- und Ein-/Ausgabemeldungen werden weitere Debug-Meldungen protokolliert.
 * Genau wie bei der Ein-/Ausgabe, wenn Sie sich um den Datenschutz sorgen, sollten Sie diese Option nicht benutzen.
...
#### Einstellungen für die Sprachausgabe {#SpeechSettings}

<!-- KC:setting -->

##### Einstellungen für die Sprachausgaben öffnen {#toc117}
...
##### Dialogfeld zum Auswählen der Sprachausgabe öffnen {#toc137}
...
##### Dialogfeld zum Auswählen der Braillezeile öffnen {#toc160}
...
Bitte beachten Sie: Wenn Sie mehrere Braille-Displays gleichzeitig an Ihr Gerät anschließen, die denselben Treiber verwenden (z. B. zwei Seika-Braillezeilen anschließen), ist es derzeit nicht möglich, NVDA mitzuteilen, welche Braillezeile verwendet werden soll.
...
##### Audio-Einstellungen öffnen {#toc165}
...
Unter Windows 8 und neuer können Sie mit dieser Option festlegen, wie NVDA bei Verwendung der Sprachausgabe die Lautstärke anderer Anwendungen verringern soll oder die ganze Zeit, während NVDA läuft.
...
Um den Bildschirmvorhang überall umzuschalten, weisen Sie eine Tastenkombination über das Dialogfeld für die [Tastenbefehle](#InputGestures) zu.
...
##### Tastatur-Einstellungen öffnen {#toc175}
...
Legen Sie daher immer mindestens eine Taste als NVDA-Taste fest, nachdem Sie die Fehlermeldung mit "OK" geschlossen haben.
...
##### Maus-einstellungen öffnen {#toc188}
...
##### Objekttyp unter dem Mauszeiger ansagen {#MouseSettingsRole}
...
Diese Kategorie ist nur auf Computern mit Windows 8 oder neuer verfügbar, sofern dieser ein Touchscreen besitzt. Hier können Sie einstellen, wie NVDA damit interagiert.
Folgende Optionen sind enthalten:
...
##### Einstellungen zur Objekt-Darstellung öffnen {#toc205}
...
##### Einstellungen zum Lesemodus öffnen {#toc223}
...
##### Einstellungen zur Dokument-formatierung öffnen {#toc237}
...
Die Optionen in dieser Kategorie ermöglichen die Konfiguration der [Optischen Zeichenerkennung für Windows 10 und neuer](#Win10Ocr).
Folgende Optionen sind enthalten:
...
Diese Schaltfläche ist nur aktiviert, wenn NVDA so konfiguriert ist, dass benutzerdefinierter Code aus dem Developer Scratchpad-Verzeichnis geladen werden kann.
...
Während die Fokusverfolgung in mehr Situationen zuverlässiger ist, wird die Leistung erheblich beeinträchtigt, insbesondere in Anwendungen wie Microsoft Visual Studio.

##### UIA verwenden, um auf die Steuerelemente in Dokumenten in Microsoft Word zuzugreifen {#MSWordUIA}

Legt fest, ob NVDA für den Zugriff bei Dokumenten in Microsoft Word die UIA-API für Barrierefreiheit und nicht das ältere Objektmodell in Microsoft Word verwenden soll oder nicht.
...
Die Implementierung der UIA von Microsoft Excel ändert sich ständig, und Versionen von Microsoft Office, die älter als 16.0.13522.10000 sind, geben möglicherweise nicht genügend Informationen darüber Auskunft, um diese Option zu nutzen.
...
Ermöglicht das Festlegen, wann UIA verwendet wird, wenn es in Chromium-basierten Browsern wie Microsoft Edge verfügbar ist.
...
* "Aria-Beschreibung immer mitteilen":
  ...
  Dies ist nützlich für Anmerkungen im Web.
  Hinweis:
...
Diese Einstellung steuert, wie NVDA neuen Text in Terminals vorgelesen werden sollen.
...
Diese Option teilt mit, wenn Farben transparent sind. Dies ist nützlich für Entwickler von NVDA-Erweiterungen und App-Modulen, die Informationen sammeln, um die Benutzererfahrung mit einer Drittanbieteranwendung zu verbessern.
Einige GDI-Anwendungen heben Text mit einer Hintergrundfarbe hervor, NVDA (über das Anzeigemodell) versucht, diese Farbe mitzuteilen.
...
##### Fehlern im Protokoll mit einem Sound kennzeichnen {#PlayErrorSound}
...
Ein Tutorial zur Einführung finden Sie unter [https://docs.python.org/3.7/howto/regex.html].
 ...
 * Ein Tastenbefehl mit NVDA-Tasten kann möglicherweise nicht auf eine emulierten Tastenbefehl ohne NVDA-Tasten abgebildet werden. Zum Beispiel kann das definieren der emulierten Eingabe "a" und das Konfigurieren des Tastenbefehls von "Strg+M" dazu führen, dass die Anwendung "Strg+A" interpretiert werden könnte.
...
Sie können die verfügbaren inkompatiblen NVDA-Erweiterungen mit Hilfe der Registerkarte [verfügbaren und zu aktualisierende NVDA-Erweiterungen](#AddonStoreFilterStatus) durchsuchen.
...
Mit NVDA+F1 wird der Protokoll-Betrachter geöffnet und Entwickler-Informationen über das aktuelle Navigator-Objekt angezeigt.

Den Protokollinhalt können Sie auch abspeichern oder den Betrachter aktualisieren, sodass lediglich die Einträge angezeigt werden, die seit dem Aufruf des Protokoll-Betrachters aufgelistet sind.
Diese Optionen sind entsprechend im Menü des Protokoll-Betrachters verfügbar.
...
Wenn Sie in das Fenster des Betrachters klicken, unterbricht NVDA augenblicklich die weitere Aktualisierung des vorgelesenen Textes, sodass Sie nun die entsprechenden Einträge markieren und in die Zwischenablage kopieren können.
...
### Store für NVDA-Erweiterungen {#toc296}
...
Die Sprachausgabe eSpeak wird unter Windows 7, 8 und 8.1 von NVDA standardmäßig verwendet, während unter Windows 10 und neuer [Windows OneCore](#OneCore) standardmäßig verwendet wird.
...
* Microsoft Speech Platform - Runtime (Version 11), x86: https://www.microsoft.com/download/de/details.aspx?id=27225
* Microsoft Speech Platform - Runtime Languages (Version 11): https://www.microsoft.com/download/de/details.aspx?id=27224
 * Diese Webseite enthält viele Dateien für Sprachein- und -ausgabe.
...
In diesem [Microsoft-Artikel](https://support.microsoft.com/de-de/windows/appendix-a-supported-languages-and-voices-4486e345-7730-53da-fcfe-55cc64300f01) finden Sie eine Liste aller verfügbaren Stimmen.
...
Falls diese noch nicht installiert wurden, können Sie die Treiber von der Website [hier](https://www2.freedomscientific.com/downloads/focus-40-blue/focus-40-14-blue-downloads.asp) herunterladen.
...
#### Tasten für alle Braillezeilenmodelle {#toc316}
...
#### Tastenzuweisungen für Brailliant BI 32/40 und B 80 {#toc317}
...
#### Tastenzuweisungen für Brailliant BI 14 {#toc318}
...
Wenn Sie die Braillezeile per USB anschließen, müssen Sie noch den USB-Treiber von HIMS auf Ihrem System installieren.
Sie können diese unter http://www.himsintl.com/upload/HIMS_USB_Driver_v25.zip herunterladen.
...
Weitere Informationen zu den Braillezeilen finden Sie unter https://de.seika-braille.com/down/index.html.
...
Nachfolgend finden Sie die Tastenzuweisungen für diese Braillezeilen mit NVDA. 
...
|Zwischen den Sprachmodi Aus, Signaltöne und Sprechen umschalten |`attribute2+attribute4`|
...
|Auf der Braillezeile zur vorherigen Zeile navigieren |Leertaste+Punkt1|
...
Um NVDA zu zwingen, immer im sicheren Modus zu starten, setzen Sie den `forceSecureMode` [systemweiter Parameter](#SystemWideParameters).
NVDA kann auch im sicheren Modus mit der [Kommandozeilenoption](#CommandLineOptions) `-s` gestartet werden.
...
|`-f <Protokolldateiname>` |`--log-file=<Protokolldateiname>` |Legt die Datei fest, in der die Protokollierung stattfinden soll.|
|`-l <Protokollierungsstufe>` |`--log-level=<Protokollierungsstufe>` |Die niedrigste Stufe der protokollierten Meldung (Debug 10, Eingabe/Ausgabe 12, Debug-Warnungen 15, Info 20, Ausgeschaltet 100).|
|`-c <Konfigurationspfad>` |`--config-path=<KonfigurationsPfad>` |Gibt den Ordner an, in dem alle NVDA-Einstellungen gespeichert werden sollen.|
