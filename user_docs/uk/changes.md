...
* Виправлення, що стосуються брайля:
  ...
  * Маршрутизація курсору тепер значно надійніша, коли рядок містить один або кілька селекторів варіацій Unicode або декомпонованих символів. (#10960, @mltony, @LeonarddeR)
