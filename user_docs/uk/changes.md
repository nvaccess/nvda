...
Це дозволяє розділити звуки NVDA на один канал (наприклад, на лівий), в той час як звуки усіх інших застосунків відтворюються в іншому каналі (наприклад, у правому).
...
Оновлено LibLouis, додано нові докладні (з великими літерами) білоруські та українські брайлівські таблиці, а також іспанську таблицю для читання грецьких текстів.
...
* Нові клавіатурні команди:
  ...
  * Нові непризначені команди швидкої навігації, які можна використовувати для переходу до наступного/попереднього:
    ...
    * Збільшення та зменшення поточного налаштування в кільці налаштувань синтезатора з більшим кроком (#13768):
      * Desktop-розкладка: `NVDA+control+сторінка вгору` чи `NVDA+control+сторінка вниз`.
      * Laptop-розкладка: `NVDA+control+shift+сторінка вгору` чи `NVDA+control+shift+сторінка вниз`.
...
* Розділення звуку: (#12985, @mltony)
  ...
  * Гучність інших застосунків можна відрегулювати командою `NVDA+alt+сторінка вгору` та `NVDA+alt+сторінка вниз`. (#16052, @mltony)
  * Звук інших застосунків можна вимкнути командою `NVDA+alt+деліт`. (#16052, @mltony)
...
* Магазин додатків:
  ...
  * Дія «Відгуки спільноти» буде доступна, а вебсторінка з відгуками буде показана на панелі подробиць, на всіх вкладках магазину. (#16179, @nvdaes)
* Оновлення компонентів:
  * Бібліотеку брайлівського введення/виведення LibLouis оновлено до [3.29.0](https://github.com/liblouis/liblouis/releases/tag/v3.29.0). (#16259, @codeofdusk)
    * Додано нові докладні (з показом великих літер) білоруську й українську брайлівські таблиці, разом з іспанською таблицею для читання грецьких текстів.
...
* Під час завантаження сторінки в Google chrome 100 NVDA більше не виводитиме заголовок сторінки й автоматично розпочинати читання. (#13571)
...
* З деяких мов у діалоговому вікні «Список елементів» клавішу прискорювача на кнопці «Активувати» було видалено, щоб уникнути колізій з мітками радіокнопок для вибору типу елементів. Коли кнопка доступна, вона як і раніше використовується в діалоговому вікні і її все ще можна викликати простим натисканням клавіші Enter у списку елементів. (#6167) 
