...
* Магазин додатків:
  ...
  * Списки додатків можна відсортувати за стовпцями, зокрема, за датою публікації, зростанням чи спаданням. (#15277, #16681, @nvdaes)
* Мовлення:
...
* Тепер NVDA перекладено боснійською мовою. (#17953)
...
Тепер можна налаштувати, як NVDA показуватиме форматування тексту шрифтом Брайля, і налаштувати NVDA на показ початку абзаців шрифтом Брайля.
...
Інструмент виправлення реєстрації COM тепер виправляє більше проблем під час роботи NVDA.
...
* Інструмент виправлення реєстрації COM тепер виправляє більше проблем, особливо у 64-розрядних версіях Windows. (#12560)
...
* NVDA більше не повідомляє про новий фокус вмісту на вебсторінці, якщо старий фокус зникає і замінюється новим у тій самій позиції. (#12147)
