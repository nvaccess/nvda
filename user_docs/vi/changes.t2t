...
- Từ Windows 8 trở lên, nếu thiết lập để khởi động cùng với Windows, NVDA sẽ khởi động nhanh hơn. (308)
 - Nếu cập nhật NVDA từ các phiên bản cũ hơn, người dùng cần thực hiện các bước sau đây để tắt rồi bật lại để tính năng này phát huy tác dụng:
  + Vào hộp thoại Thiết lập chung
  + Bỏ chọn Tự khởi động NVDA sau khi đăng nhập vào Windows
  + Bấm nút Đồng ý
  + Vào lại hộp thoại Thiết lập chung
  + Đánh dấu chọn vào Tự khởi động NVDA sau khi đăng nhập vào Windows
  + Bấm nút OK
+
...
- Giờ đây đã có thể dùng chế độ duyệt cho các trang trong Internet Explorer 10 ở chế độ chuẩn; ví dụ: trang đăng nhập www.gmail.com. (#3151)
