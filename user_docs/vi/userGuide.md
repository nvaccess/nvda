...
Bấm hai lần để hiển thị thông tin dưới dạng thông điệp có thể duyệt.
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
Bấm `NVDA+alt+c` để đọc phần chú thích của ô hiện tại`.
Bấm hai lần để hiển thị thông tin dưới dạng thông điệp có thể duyệt.
...
NVDA cung cấp hỗ trợ nâng cao cho Poedit 3.5 hoặc mới hơn.
...
##### Dấu bắt đầu đoạn {#BrailleParagraphStartMarkers}
...
Để bật / tắt tùy chọn này ở bất cứ đâu, hãy gán thao tác / phím tắt cho nó bằng cách sử dụng [Hộp thoại quản lý thao tác](#InputGestures).
...
##### Tránh Tách Từ nếu có thể {#BrailleSettingsWordWrap}

Nếu được bật, một từ quá dài ở cuối màn hình chữ nổi sẽ không bị tách ra.
Thay vào đó, sẽ có vài ô trắng ở cuối màn hình.
...
Nếu tùy chọn này bị tắt, phần lớn của một từ sẽ được hiển thị, trong khi phần còn lại sẽ bị cắt.
Khi cuộn màn hình, bạn có thể đọc phần còn lại của từ.
...
Khi bật tùy chọn này, việc chuẩn hóa unicode được thực hiện trên văn bản hiển thị trên màn hình chữ nổi.
