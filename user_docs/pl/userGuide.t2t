...
+ Przesuń kursor do tekstu zawierającego notatkę.
+ Otwórz opcje zaznaczenia w sposób opisany powyżej.
+ Wybierz edycję notatki.
+
...
%kc:setting
==== Otwiera okno dialogowe wybór syntezatora ====
...
%kc:setting
==== Otwiera okno dialogowe wybor monitora brajlowskiego ====
...
%kc:setting
==== Otwiera opcje prezentacji obiektów ====
...
%kc:setting
==== Otwiera ustawienia trybu czytania ====
...
%kc:setting
==== Otwiera ustawienia formatowania dokumentów ====
...
+ Upewnij się, że masz zainstalowany [ostatni sterownik https://www.papenmeier-rehatechnik.de/en/service/downloadcenter/software/articles/software-braille-devices.html].
+ Otwórz menedżer urządzeń systemu Windows.
+ Na liście kategorii znajdź  "Kontrolery USB" lub "Urządzenia USB".
+ Wybierz "Papenmeier Braillex USB Device".
+ Otwórz właściwości, i znajdź kartę "zaawansowane".
