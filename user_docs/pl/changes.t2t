...
= 2018.3.2 =
Pomniejsze wydanie wprowadzające obejście zawieszania się Google Chrome przy nawigacji tweetów na stronie www.twitter.com. (#8777)
...
- W Windows 8 i nowszych, jeśli włączone jest uruchamianie NVDA po zalogowaniu do Windows, NVDA uruchamia się dużo szybciej. (#308)
 - Jeśli Automatyczne uruchamianie po zalogowaniu było włączone w starszej wersji NVDA, trzeba to wyłączyć i włączyć ponownie w ustawieniach ogólnych, aby zmiana stała się zauważalna. Wykonaj następujące czynności:
  + Otwórz Ustawienia ogólne NVDA.
  + Odznacz pole wyboru "Uruchom NVDA po zalogowaniu do Windows".
  + Naciśnij przycisk OK.
  + Ponownie otwórz Ustawienia ogólne NVDA.
  + Zaznacz pole wyboru "Uruchom NVDA po zalogowaniu do Windows".
  + Naciśnij przycisk OK.
...
- Możliwe jest teraz używanie trybu czytania na stronach w Internet Explorer 10 w trybie zgodności; np. strona logowania www.gmail.com. (#3151)
