...
Dit is een patch-release om een bug op te lossen bij het opslaan van woordenboeken voor symbooluitspraak.

### Opgeloste problemen

* Probleem opgelost waarbij woordenboeken voor symbooluitspraak niet werden opgeslagen en het dialoogvenster niet werd gesloten. (#17344)
