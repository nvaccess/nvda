# NVDA NVDA_VERSIE Gebruikershandleiding

[TOC]

<!-- KC:title: NVDA NVDA_VERSIE overzicht commando's -->
...
#### De synth settings ring {#TheSynthSettingsRing}
...
|De huidige synthesizerinstelling in grotere stappen oplopend bijstellen |`NVDA+control+pageUp` |`NVDA+shift+control+pageUp` |Verhoogt de waarde van de momenteel geldende spraakinstelling met een groter bereik. Als je bijv wilt veranderen van stem, spring je steeds 20 stemmen vooruit; voor aanpassingen met een schuifbalk (snelheid, toonhoogte, etc) wordt de waarde met tot 20% verhoogd|
...
U kunt NVDA zo instellen dat het programma ook meldt welk type [object](#Objects) zich onder de muisaanwijzer bevindt, zoals een lijst, een knop, etc.
...
|---|---|
|app |aplicatie / toepassing|
|art |artikel|
|bct |blokcitaat|
|knp |knop|
|uschfknp |uitschuifknop|
|drkzknp |draaikeuzeknop|
|splknp |splitsknop|
|schknp |(om)schakelknop|
|bijst |bijschrift (caption)|
|vklst |vervolgkeuzelijst|
|slv |selectievakje|
|dlg |dialoog|
|enoot |eindnoot|
|tiv |tekstinvoerveld|
|wwinv |wachtwoordinvoervak|
|ingebed |ingebed object|
|enoot |eindnoot|
|fig |figuur|
|vnoot |voetnoot|
|gra |grafische voorstelling|
|grp |groepering|
|hN |koptekst op niveau n, bijv. h1, h2.|
|hlp |helpballon|
|oripnt |oriëntatiepunt|
...
|mnuitem |menu-item|
|pnl |paneel|
|vrtgblk |voortgangsbalk|
|bezindic |'bezig' indicator|
|kr |keuzerondje|
|schfbalk |schuifbalk|
|sect |sectie|
|statblkbalk |statusbalk|
|sect |sectie|
|tbl |tabel|
|kN |tabelkolomnummer n, bijv k1, k2.|
|rN |tabelrijnummer N, bijv. r1, r2.|
|tbl |tabel|
|wrkblk |werkbalk|
|tltip |tooltip|
|bmstr |boomstructuur|
|bmstrknop |boomstrutuurknop|
|bmstritem |boomstructuuritem|
|nv N |eenboomstructuuritem heeft een hierarchisch niveau N|
|vnst |venster|
|⠤⠤⠤⠤⠤ |scheiding|
...
* Egaal blauw markeert de plaats waar navigatorobject en systeemfocus samenkomen, (bijv. omdat [het navigatorobject de systeemfocus volgt](#ReviewCursorFollowFocus)).
...
Wanneer Visuele Uitlichting ingeschakeld is in de [categorie zicht](#VisionSettings)  in het dialoogvenster [NVDA-instellingen](#NVDASettings) , kunt u daar [aanpassen of u al dan niet de focus, het navigatorobject of de bladermodusaanwijzer](#VisionSettingsFocusHighlight) uitlicht.
...
<!-- KC:beginInclude -->
Om opmerkingen bij de huidige  position van de cursor te melden, druk je op `NVDA+alt+c`.
Door tweemaal te drukken wordt de informatie als leesbare tekst weergegeven.
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
Om eventuele opmerkingen te laten melden mbt de cel die momenteel de focus heeft, druk je op `NVDA+alt+c`.
Door tweemaal te drukken wordt de informatie als tekst in bladermodus weergegeven.
...
NVDA biedt uitgebreide ondersteuning voor Poedit 3.5 of nieuwer.

<!-- KC:beginInclude -->

| Naam |Toets |Omschrijving|
|---|---|---|
|Aantekeningen voor vertalers melden |`control+shift+a` |Meldt eventuele aantekeningen voor vertalers. Bij tweemaal drukken worden deze in bladermodus getoond|
...
<!-- KC:beginInclude -->
Nadat u tekst hebt geselecteerd, drukt u op de toepassingstoets of op shift+f10 om te zien welke opties er zijn om de selectie te bewerken.
<!-- KC:endInclude -->
...
U kunt een aantekening toevoegen aan een woord of een tekstgedeelte.
...
1. Verplaats de cursor naar de tekst waar de aantekening zich bevindt.
1. Krijg toegang tot de opties voor de selectie zoals hierboven beschreven.
1. Kies Aantekening Bewerken.
...
##### Algemene instellingen openen {#OpenGeneralSettings}
...
##### Spraakinstellingen openen {#OpenSpeechSettings}
...
De latijnse letter "h" kan bijvoorbeeld ook worden weergegeven als "𝐡" (vet), "ℎ" (cursief), etc. maar zal altijd uitgesproken worden als "h" wanneer normalizering ingeschakeld is.
...
Om Unicode Consortium data van elke willekeurige plaats al dan niet op te nemen kunt u zelf een invoerhandeling aanmaken met behulp van het [dialoogvenster Invoerhandelingen](#InputGestures).
...
##### Dialoogvenster synthesizer selecteren openen {#OpenSelectSynthesizer}
...
|De huidige synthesizer-instelling in grotere stappen aflopend bijstellen |`NVDA+control+pageDown` |`NVDA+shift+control+pageDown` |Verlaagt de waarde van de momenteel geldende spraakinstelling met een groter bereik. Als je bijv wilt veranderen van stem, spring je steeds 20 stemmen terug; voor aanpassingen met een schuifbalk wordt de waarde met tot 20% verlaagd|
...
| . {.hideHeaderRow} |.|
|---|---|
|Opties |Standaard (Nooit), Nooit, Alleen in geval van automatische tethering, Altijd|
|Standaard |Nooit|
...
##### Alineastartteken {#BrailleParagraphStartMarkers}

Als "Lezen per alinea" aangevinkt is, zal het geselecteerde startteken getoond worden om aan te geven dat er een alinea begint.
Dit kan vooral handig zijn bij toepassingen die gebruikt worden om grote stukken tekst te lezen, zoals gelaagde documenten of boeken.
In dergelijke documenten kan het helpen bij het begrijpen van de structuur van de inhoud, of om bladwijzers in te stellen dan wel aantekeningen te maken die gebaseerd zijn op de plaats van de alinea, als je weet waar een alinea begint , or to set bookmarks or annotations based on paragraph position.

Er is keuze uit het gebruiken van twee spaties als een  subtiele alineascheiding, en het alineasymbool, pilcrow (¶), wat een duidelijkere aanduiding is.

| . {.hideHeaderRow} |.|
|---|---|
|Opties |Geen alinea startteken, Dubbele spatie (  ), Pilcrow (¶)|
|Standaard |Geen alinea startteken|
...
##### Opmaakweergave {#BrailleFormattingDisplay}

Met deze instelling kan bepaald worden hoe NVDA tekstopmaak  in braille weergeeft.
Deze optie heeft alleen effect als NVDA is ingesteld op [fontattributen in braille tonen](#DocumentFormattingFontAttributes).

| . {.hideHeaderRow} |.|
|---|---|
| Opties | Standaard (Liblouis), Liblouis, Tags |
| Standaard | Liblouis |

| Optie | Gedrag |
|---|---|
| Liblouis | Gebruik native Brailleopmaak. Merk op dat deze optie alleen vette, cursieve en onderstreepte tekst toont, en dat alleen als de geselecteerde brailletabel aangeeft deze opmaakkenmerken te ondersteunen. |
| [Tags](#BrailleFormattingDisplayTags) | Gebruik tags die beschrijven hoe en waar tekstopmaak verandert. |

###### Tags {#BrailleFormattingDisplayTags}

Als "Opmaakweergave" ingesteld staat op "Tags", wordt er een opmaak-tag getoond in braille wanneer er een verandering in de opmaakt wordt gedetecteerd.
Deze tags beginnen met ⣋ en eindigen met ⣙.
Een opmaak-tag bestaat uit een of meer symbolen waarmee de tekstopmaak wordt beschreven.
De volgende symbolen worden onderscheiden:

| Symbool | Betekenis |
|---|---|
| ⠃ ("b") | Start vet |
| ⡃ ("b" met punt 7) | Einde vet |
| ⠊ ("i") | Start cursief |
| ⡊ ("i" met punt 7) | Einde cursief |
| ⠥ ("u") | Start onderstrepen |
| ⡥ ("u" met punt 7) | Einde onderstrepen |
| ⠎ ("s")| Start doorstrepen |
| ⡎ ("s" met punt 7) | Einde doorstrepen |

##### Spreek teken uit bij routing van cursor in tekst {#BrailleSpeakOnRouting}

Als dit ingeschakeld is, zal NVDA automatisch het teken bij de cursor uitspreken wanneer je daar heen gaat met de routingtoetsen van de braillecursor.

Om deze optie vanuit elke willekeurige plaats in of uit te schakelen, kun je een daartoe aangepaste handeling aanmaken met behulp van het [dialoogvenster Invoerhandelingen](#InputGestures).
...
##### Vermijd zo mogelijk het afbreken van woorden {#BrailleSettingsWordWrap}

Als dit ingeschakeld is, zal een woord dat te lang is om op de brailleleesregel te passen, niet worden afgebroken.
In plaats daarvan, komt er wat witruimte aan het eind van de leesregel.
Door de leesregel te scrollen kun je het gehele woord lezen.
Dit wordt wel "word wrap" genoemd.
Merk op  dat als het woord op zichzelf sowieso te lang is om op de leesregel te passen, moet het woord toch nog worden afgebroken.

Als dit uitgeschakeld is, wordt zoveel als mogelijk is van het woord getoond, maar de rest wordt afgebroken.
Door de regel te scrollen kun je de rest van het woord lezen.

Door dit in te schakelen verloopt het lezen wel vloeiender, maar in het algemeen betekent dit dat je meer moet scrollen met de leesregel.

##### Unicodenormalisering {#BrailleUnicodeNormalization}

Wanneer deze optie ingeschakeld is, wordt unicodenormalisering uitgevoerd op de in braille weergegeven tekstvia de braillleesregel.
Dit heeft zijn voordeel wanneer je tekens tegenkomt in braille die onbekend zijn in een bepaalde brailletabel en die een compatibel alternatief hebben, zoals de vette en cursieve tekens die gebruikelijk zijn op social media.
Andere vordelen van unicode normalisering worden meer gedetailleerd uitgelegd in het [gedeelte met betrekking tot de overeenkomende spraakinstelling](#SpeechUnicodeNormalization).
...
##### Onderbreek spraak tijdens scrollen {#BrailleSettingsInterruptSpeech}

Deze instelling bepaalt of sppraak onderbroken moet worden wanneer de Brailleleesregel vooruit/achteruit wordt gescrolld.
De commando's vorige/volgende regel onderbreken altijd de spraak.

Spraak die doorgaat terwijl je braille aan het lezen bent, kan afleiden.
Om deze reden staat de ptie standaard ingeschakeld, spraak onderbreken wanneer  braille wordt gescrold.

Deze optie uitschakelen houdt in dat de spraakuitvoer doorgaat terwijl je tegelijkertijd Braille aan het lezen bent.
...
Het is niet mogelijk audio ducking te ondersteunen bij gebruik van de draagbare en de tijdelijke kopieën van NVDA.
...
Met sound split krijgen gebruikers de mogelijkheid te werken met gescheiden kanalen van hun stereo geluidsapparatuur zoals koptelefoons en speakers.
...
* Sound split uitgeschakeld: NVDA past geen stereosplitsing toe.
* NVDA links en andere toepassingen rechts: NVDA is op het linker kanaal te horen, terwijl andere toepassingen te horen zijn via het rechter kanaal.
...
Er zijn meer geavanceerde modi voor stereosplitsing beschikbaar in het vervolgkeuzemenu NVDA setting.
...
Deze modus kan afwijken van de modus "Sound split uitgeschakeld" in het geval dat andere audiobewerking interfereert met kanaalvolumes.

Merk op dat sound split niet als mixer werkt.
Als een bepaalde toepassing bijv een stereo sound track afspeelt terwijl stereosplitsing is ingesteld op  "NVDA via het linker  en toepassingen via het rechter kanaal", zul je alleen het rechter kanaal van de sound track horen terwijl het linker kanaal van de sound track onderdrukt wordt.
...
##### Meermaals toets indrukken voor timeout {#MultiPressTimeout}

Enkele NVDA toetsenbordinvoerhandelingen voeren verschillende acties uit op basis van het aantal keren dat dezelfde toets snel achterelkaar  wordt ingedrukt.
Een voorbeeld hiervan is het commando "Huidig teken van navigatorobject melden".
Dit commando meldt het teken bij eenmaal indrukken, een fonetische beschrijving van het teken bij tweemaal indrukken, en de numerieke waarde van het teken bij driemaal indrukken.
Met deze optie wordt de timeout ingesteld waarna een volgende aanslag van dezelfde toets zal leiden tot een nieuwe invoerhandeling, eerder dan dat deze moet worden gezien als een opeenvolgende toetsaanslag.
In geval van het voorbeeldcommando betekent dit dat een te korte timeout zal leiden tot een dubbele toetsaanslag waarmee het huidige teken tweemaal wordt gemeld, in plaats van de fonetische beschrijving.
De standaard timeout is 500 ms, dwz een halve seconde.
Het verlengen van  deze timeout kan vooral nuttig zijn voor mensen die plaktoetsen gebruiken, of mensen met een lichamelijke beperking.
...
Als de leescursor ingeschakeld is, volgt deze (review cursor) automatisch de Systeemcursor telkens wanneer deze wordt verplaatst.
...
##### Notificaties melden {#ObjectPresentationReportNotifications}
...
* Uitspreken: U hoort het percentage dat aangeeft hoe ver het proces is gevorderd. Elke nieuwe waarde wordt door NVDA gemeld.
...
* Lettertype
  * Naam
  * Lettergrootte
  * Lettertype attribute [(Uit, Spraak, Braille, Spraak en braille)](#DocumentFormattingFontAttributes)
...
##### Lettertype attributen {#DocumentFormattingFontAttributes}

Met deze optie kun je selecteren hoe bepaalde lettertype attributen, zoals vet, cursief, onderstrepen en doorstrepen worden gemeld.
Het vervolgkeuzemenu lettertype  attributen heeft vier opties:

* Uit: NVDA meldt deze lettertypeattributen niet.
* Spraak: NVDA zal wijzigingen in deze lettertypeattributen aankondigen.
* Braille: NVDA zal deze attributen in braille tonen.
Hoe ze precies worden getoond kan worden ingesteld in [braille-instellingen van NVDA](#BrailleFormattingDisplay).
* Spraak en braille: NVDA zal lettertypeattributen melden waarbij allebei de hierboven vermelde methodes worden gebruikt.
...
Hetmenu voor acties  mbt een add-on in de lijst met add-ons kan worden bereikt  door op de toets met het `Toepassingsmenu` te drukken, `enter` in te drukken, rechts te klikken of dubbel te klikken op de add-on.
...
### Uitvoeren COM registration fixing tool... {#RunCOMRegistrationFixingTool}
...
Zodra deze optie wordt geactiveerd, zullen alle app modules en globale plugins opnieuw worden geladen zonder dat NVDA wordt herstart, wat handig is voor ontwikkelaars.
App-modules regelen hoe NVDA omgaat met  bepaalde applicaties.
Globale plugins regelen hoe  NVDA omgaat  met alle applicaties.
...
|Geladen ep module en executabel melden |`NVDA+control+f1` |Meldt de naam van de app-module, indien aanwezig, en de naam van het executabel dat verbonden is met de  applicatie die de toetsenbord-focus heeft.|
...
In Windows 8.1 start NVDA standaard op met de eSpeak NG spraaksynthesizer, in Windows 10 en later is het gebruik van ([Windows OneCore](#OneCore)standaard).
...
Er is ook een groot aantal varianten waarmee  je kunt aanpassen hoe de stemmen klinken.
...
* [Microsoft Speech Platform - Runtime (Versie 11), x86](https://www.microsoft.com/download/en/details.aspx?id=27225)
* [Microsoft Speech Platform - Runtime Talen (Versie 11)](https://www.microsoft.com/download/en/details.aspx?id=27224)
...
De volgende leesregels ondersteunen deze automatische herkenningsfunctionaliteit.
...
### Freedom Scientific Focus/PAC Mate Serie {#FreedomScientificFocus}
...
|shift+tab toetsen |braille Spatiebalk+punt1+punt2|
|tab toets |brailleSpatiebalk+punt4+punt5|
|omhoogPijltoets |brailleSpatiebalk+punt1|
|omlaagPijltoets |brailleSpatiebalk+punt4|
|control+Pijllinks toets |brailleSpatiebalk+punt2|
|control+Pijlrechts toets |brailleSpatiebalk+punt5|
|linkerPijl |brailleSpatiebalk+punt3|
|rechterPijltoets |brailleSpatiebalk+punt6|
|home toets |braillSspatiebalk+punt1+punt3|
|end toets |brailleSpatiebalk+punt4+punt6|
|control+home toets |brailleSpatiebalk+punt1+punt2+punt3|
|control+end toets |brailleSpatiebalk+punt4+punt5+punt6|
|alt toets |brailleSpatiebalk+punt1+punt3+punt4|
|alt+tab toets |brailleSpatiebalk+punt2+punt3+punt4+punt5|
|alt+shift+tab-toets |brailleSpatieBalk+punt1+punt2+punt5+punt6|
|windows+tab-toets |brailleSpatieBalk+punt2+punt3+punt4|
|escape toets |brailleSpatiebalk+punt1+punt5|
...
|windows+d (alle toepassingen minimaliseren) |brailleSpatiebalk+punt1+punt2+punt3+punt4+punt5+punt6|
...
|escape toets |sp3|
|tab toets |sp4|
|omhoogPijltoets |spOmhoog|
|omlaagPijltoets |spOmlaag|
|linkerPijltoets |spLinks|
|rechterPijltoets |spRechts|
|enter toets |spEnter, enter|
|Datum/tijd weergeven |sp2+sp3|
|NVDA-Menü |Sp1+Sp3|
|windows+d (alle toepassingenn minimaliseren) |sp1+sp4|
|windows toets+b(focus op systeemvak) |sp3+sp4|
|windows toets |sp1+sp2, windows|
|alt+tab toets |sp2+sp4|
...
* Braillino
* Bookworm
* Modulaire leesregels met firmware-versie 1.13 of lager. Merk op dat de firmware van deze leesregel bijgewerkt kan worden.
...
|shift+tab toets |esc, links triple actie toets omhoog+omlaag|
|alt toets |b2+b4+b5|
|escape toets |b4+b6|
|tab toets |enter, rechter triple actie toets omhoog+omlaag|
|enter toets |esc+enter, linker+rechter triple actie toets omhoog+omlaag, joystickActie|
|omhoogPijltoets |joystickOmhoog|
|omlaagPijltoets |joystickOmlaag|
|linkerPijltoets |joystickLinks|
|rechterPijltoets |joystickRechts|
|NVDA-Menü |B2+B4+B5+B6|
|Braille koppelen wisselen |b2|
|Braille cursor in of uitschakelen |b1|
...
| Naam |Toets|
|---|---|
|omhoogPijltoets |omhoog|
|omlaagPijltoets |omlaag|
|linkerPijltoets |links|
|rechterPijltoets |rechts|
|enter toets |selecteren|

<!-- KC:endInclude -->

### gedo ProfiLine USB {#HedoProfiLine}
...
|omhoogPijltoets |spatie+punt1|
|omlaagPijltoets |spatie+punt4|
|linkerPijltoets |spatie+punt3|
|rechterPijltoets |spatie+punt6|
|shift+tab toets |spatie+punt1+punt3|
|tab toets |spatie+punt4+punt6|
|alt toets |spatie+punt1+punt3+punt4 (spatie+m)|
|sscape toets |spatie+punt1+punt5 (spatie+e)|
|enter toets |punt8|
|windows toets |spatie+punt3+punt4|
|alt+tab toets |spatie+punt2+punt3+punt4+punt5 (spatie+t)|
|NVDA Menu |spatie+punt1+punt3+punt4+punt5 (spatie+n)|
...
| Naam |Toets|
|---|---|
|pijl Omhoog toets |joystick omhoog|
|pijl omlaag toets |joystick omlaag|
|pijl links toets |joystick links|
|pijl rechts toets |joystick rechts|
...
|contextmenu toets |punt1+punt2+punt3+punt4+spatie, f8|
...
|rechterPijltoets |punt6+spatie, linkerZijdeRechterPijl|
...
|omhoogPijltoets |punt1+spatie, linkerZijdePijlOmhoog|
...
|omlaagPijltoets |punt4+spatie, linkerZijdePijlOmlaag|
...
Bij gebruik van de Seika Braille Leesregel met NVDA zijn de volgende toetscombinaties van toepassing.
...
|tab |LJ rechts|
|shift+tab |LJ links|
|omhoogPijltoets |RJ omhoog|
|omlaagPijltoets |RJ omlaag|
...
De navigatiebalk kan in vier richtingen bewogen worden waarbij er als regel twee schakelpunten per richting zijn.
Door indrukken en vasthouden van de toetsen omhoog, omlaag, rechts en links (of EAB) wordt bewerkstelligd dat de ermee samenhangende actie wordt herhaald.
...
|---|---|
|NVDA-menu |Lezen+n|
|Omhoog pijltoets |omhoogPijl|
|Omlaag pijltoets |omlaagPijl|
...
Bij gebruik van EcoBraille leesregels met NVDA zijn de volgende toetscombinaties van toepassing.
...
### Nattiq nBraille Leesregels {#NattiqTechnologies}
...
* De [NVDA Python console](#PythonConsole)
* De [Log Viewer](#LogViewer) en loggen
