...
= 2018.3.2 =
Deze versie lost een probleem op dat een crash in Google Chrome veroorzaakte bij het navigeren tussen tweets op www.twitter.com. (#8777)
...
- In Windows 8 en hoger start NVDA nu een stuk vroeger als het is geconfigureerd om te starten na het aanmelden bij Windows. (#308)
 - Als u dit heeft ingeschakeld in een vorige versie van NVDA, dan moet u het uitschakelen en het opnieuw inschakelen om deze verandering van kracht te laten worden. Volg deze procedure:
  + Open het dialoogvenster met Algemene instellingen.
  + Schakel dit selectievakje uit: NVDA &automatisch starten nadat ik me bij windows heb aangemeld.
  + Druk op de OK knop.
  + Open opnieuw het dialoogvenster met Algemene instellingen.
  + Schakel het selectievakje in: NVDA &automatisch starten nadat ik me bij windows heb aangemeld".
  + Druk op de OK knop.
...
- Het is nu mogelijk bladermodus te gebruiken voor pagina's in Internet Explorer 10 als u in standaardmodus bent; b.v. www.gmail.com login-pagina. (#3151)
