# NVDA NVDA_VERSION korisnički priručnik

[TOC]

<!-- KC:title: NVDA NVDA_VERSION tipkovničke prečice -->
...
NonVisual Desktop Access (NVDA) je besplatni čitač zaslona otvorenog koda za operativni sistem Microsoft Windows.
Pružajući povratne informacije putem sintetičkog govora i Brailleovog pisma, omogućuje slijepim ili slabovidnim osobama pristup računarima s operativnim sistemom Windows po nižoj cijeni nego osobama koje vide.
NVDA je razvijen od strane [NV Accessa](https://www.nvaccess.org/), uz doprinose zajednice.

### Opće funkcije {#GeneralFeatures}

NVDA omogućava slijepim i slabovidnim osobama pristup i interakciju s Windows operativnim sistemom i mnogim aplikacijama trećih strana.

Kratka video demonstracija, ["Šta je NVDA?"](https://www.youtube.com/watch?v=tCFyyqy9mqo) dostupna je na NV Access YouTube kanalu.

Neke od glavnih funkcija su:
...
### Sistemski zahtjevi {#SystemRequirements}

#### Minimalni sistemski zahtjevi {#MinimumSystemRequirements}

* Operativni sistemi: sva 32-bitna i 64-bitna izdanja Windows 8.1, Windows 10, Windows 11 i svi serverski operativni sistemi počevši od Windows Server 2012 R2.
  * podržane su i AMD64 i ARM64 varijante Windowsa.
  * Imajte na umu da 32-bitni operativni sistemi više nisu pod aktivnom podrškom.
  * Imajte na umu da Windows 8.1 i Windows Server verzije starije od 2022 više nisu pod aktivnom podrškom.
* najmanje 500 MB prostora za pohranu.

#### Preporučeni sistemski zahtjevi {#RecommendedSystemRequirements}

* Operativni sistemi: 64-bitna izdanja Windowsa 10, Windowsa 11 i Windows Server 2022.
  * podržane su i AMD64 i ARM64 varijante Windowsa.
* najmanje 500 MB prostora za pohranu.
* najmanje 4 GB RAM-a.
...
Važno je da ljudi bilo gdje u svijetu, bez obzira koji jezik govore, imaju jednak pristup tehnologiji.
...
### Podrška za govorne sinteze {#SpeechSynthesizerSupport}

Osim što pruža svoje poruke i sučelje na nekoliko jezika, NVDA takođe može omogućiti korisniku čitanje sadržaja na bilo kojem drugom jeziku, sve dok ima govornu sintezu koja može da govori tim jezikom.

NVDA dolazi u paketu sa [eSpeak-om](https://github.com/espeak-ng/espeak-ng), besplatnom, višejezičnom sintisajzerom govora govornom sintezom otvorenog koda.

Informacije o drugim govornim sintezama koje NVDA podržava mogu se naći u odjeljku [Podržane govorne sinteze](#SupportedSpeechSynths).

### Braille support {#BrailleSupport}

Za korisnike koji posjeduju Brajev redak koji se može osvježiti, NVDA može ispisati svoje informacije na Brajevom pismu.
NVDA koristi brajev prevod otvorenog koda [LibLouis](https://liblouis.io/) za generiranje brajevih sekvenci iz teksta.
Both uncontracted and contracted braille input via a braille keyboard is also supported.
Štaviše, NVDA će automatski detektovati mnoge brajeve redove prema zadanim postavkama.
Molimo pogledajte odjeljak [Podržani Brajevi retci](#SupportedBrailleDisplays) za informacije o podržanim Brajevim retcima.

NVDA podržava Brajeve kodove za mnoge jezike, uključujući ugovorene, neugovorene i kompjuterske Brajeve kodove.

### Licenca i autorska prava {#LicenseAndCopyright}

NVDA je autorska prava NVDA COPYRIGHT GODINE NVDA suradnici.

NVDA je dostupan pod GNU General Public License verzija 2, sa dva posebna izuzetka.
Izuzeci su navedeni u licencnom dokumentu u odjeljcima "Non-GPL Components in Plugins and Drivers" i "Microsoft Distributable Code".
NVDA također uključuje i koristi komponente koje su dostupne pod različitim besplatnim i otvorenim licencama.
Možete slobodno dijeliti ili mijenjati ovaj softver na bilo koji način pod uslovom da ga prati licenca i da sav izvorni kod učinite dostupnim svima koji to žele.
...
Za detalje o izuzecima, pristupite licencnom dokumentu u NVDA izborniku, podizborniku "pomoć".

## Vodič za brzi početak {#NVDAQuickStartGuide}

Ovaj vodič za brzi početak sadrži tri glavna odjeljka: preuzimanje, početno podešavanje i pokretanje NVDA čitača zaslona.
Nakon njih slijede informacije o prilagođavanju postavki, korištenju dodataka, učešću u zajednici i dobivanju pomoći.
Informacije u ovom vodiču sažete su iz drugih dijelova NVDA korisničkog vodiča.
Molimo pogledajte kompletan korisnički priručnik za detaljnije informacije o svakoj temi.

### Preuzimanje NVDA {#GettingAndSettingUpNVDA}

NVDA je potpuno besplatan za svakoga.
Ne postoji licencni ključ ili skupa pretplata.
NVDA is updated, on average, four times per year.
Najnovija NVDA verzija uvijek je dostupna na stranici "Download" na web stranici [NV Access] (NVDA URL).

NVDA radi na svim nedavnim verzijama Windowsa.
Provjerite [System Requirements] (#SystemRequirements) za potpune detalje.

#### Koraci za preuzimanje NVDA {#StepsForDownloadingNVDA}

Ovi koraci podrazumijevaju poznavanje kretanja po web stranici.

* Otvorite svoj web pretraživač (pritisnite `Windows` tipku, upišite riječ "Internet" bez navodnika i pritisnite` Enter`)
* Load the NV Access download page (Press `alt+d`, type the following address and press `enter`):
https://www.nvaccess.org/download
* Kliknite na dugme "Download"
...
### Podešavanje NVDA {#SettingUpNVDA}
...
#### Koraci za pokretanje preuzete datoteke {#StepsForRunningTheDownloadLauncher}
...
#### Koraci za instaliranje NVDA iz datoteke {#StepsForInstallingNVDAFromTheLauncher}
...
| Naziv |Tipka na fiksnom računaru|Tipka na prijenosnom računaru|Opis|
|---|---|---|---|
...
#### Podešavanje informacija koje će NVDA čitati {#ToggleWhichInformationNVDAReads}
...
#### Prsten postavki govorne sinteze {#TheSynthSettingsRing}
...
#### Navigacija kroz web {#WebNavigation}
...
Iz ovog izbornika možete pristupiti korisničkom priručniku, tipkovničkim prečicama, popisu promjena i još mnogo toga.
...
## Više opcija instalacije {#MoreSetupOptions}
### Opcije instaliranja {#InstallingNVDA}
...
#### Koristi NVDA tokom prijave {#StartAtWindowsLogon}
...
#### Stvori prečicu na radnoj površini (Control+Alt+N) {#CreateDesktopShortcut}
...
#### Kopiraj korisničku konfiguraciju u trenutni korisnički račun {#CopyPortableConfigurationToCurrentUserAccount}
...
### Stvaranje prijenosne kopije {#CreatingAPortableCopy}
...
### Ograničenja prijenosne i privremene kopije {#PortableAndTemporaryCopyRestrictions}
...
#### Dijalog statistike upotrebe {#UsageStatsDialog}
...
### O NVDA tipkovničkim prečicama {#AboutNVDAKeyboardCommands}
...
#### Raspored tipkovnice {#KeyboardLayouts}
...
### NVDA komande na zaslonu osjetljivom na dodir {#NVDATouchGestures}
...
#### Istraživanje zaslona {#ExploringTheScreen}
...
#### Komande na zaslonu osjetljivom na dodir {#TouchGestures}
...
#### Tipkovnica na zaslonu osjetljivom na dodir {#TouchKeyboard}
...
### Način pomoći za unos {#InputHelpMode}
...
* Alternativno, pristupite sistemskoj paleti pritiskom na `Windows+B`, `strelicom dolje` dođite do NVDA ikone i otvorite kontekstni izbornik pritiskom na `aplikacijsku` tipku, koja se nalazi pored desne Control tipke na većini tipkovnica.
Na tipkovnici bez `aplikacijske` tipke, umjesto toga pritisnite `Shift+F10`.
...
## Kretanje s NVDA {#NavigatingWithNVDA}
...
### Kretanje sistemskim fokusom {#SystemFocus}
...
### Kretanje sistemskim kursorom {#SystemCaret}
...
### Objektna navigacija {#ObjectNavigation}
...
#### Pregled dokumenata {#DocumentReview}
...
### Kretanje s mišem {#NavigatingWithTheMouse}
...
## Način pretraživanja {#BrowseMode}
...
### Kretanje jednim slovom {#SingleLetterNavigation}
...
#### Komande za kretanje po odlomcima teksta {#TextNavigationCommand}
...
#### Druge komande za kretanje {#OtherNavigationCommands}
...
### Pretraživanje teksta {#SearchingForText}
...
### Način izvornog odabira {#NativeSelectionMode}
...
### Vrsta kontrole, stanje i skraćenice za orijentire {#BrailleAbbreviations}
...
#### Unošenje tipkovničkih prečica {#BrailleKeyboardShortcuts}
...
### Vizuelno isticanje {#VisionFocusHighlight}
...
### Zaslonska zavjesa {#VisionScreenCurtain}
...
## Funkcije specifične za aplikacije {#ApplicationSpecificFeatures}
...
#### Način pretraživanja u Microsoft Wordu {#BrowseModeInMicrosoftWord}
...
#### Automatsko čitanje zaglavlja  kolona i redova {#ExcelAutomaticColumnAndRowHeaderReading}
...
#### Odabir teksta {#KindleTextSelection}
...
## Konfigurisanje NVDA {#ConfiguringNVDA}
...
#### Postavke trgovine dodataka {#AddonStoreSettings}
...
Regularni izrazi nisu pokriveni u ovom priručniku.
...
Udaljeni pristup je po zadanim postavkama isključen zbog vaše sigurnosti.
You can enable Remote Access [in Remote Access settings](#RemoteSettings).

### Početak {#RemoteAccessGettingStarted}
...
### Postavljanje sesije udaljenog pristupa {#RemoteAccessSetup}
...
### Korištenje udaljenog pristupa {#RemoteAccessUsage}
...
## Dodaci i trgovina dodataka {#AddonsManager}
...
#### Obuhvati nekompatibilne dodatke {#AddonStoreFilterIncompatible}
...
#### Pretraživanje dodataka {#AddonStoreFilterSearch}
...
### Radnje nad dodacima {#AddonStoreActions}
...
#### Onemogućavanje i omogućavanje dodataka {#AddonStoreDisablingEnabling}
...
#### Recenzije dodataka {#AddonStoreReviews}
...
### Trgovina dodataka {#AddonStoreMenuItem}
...
### Pokreni  alat za popravljanje COM registracija... {#RunCOMRegistrationFixingTool}
...
### Ponovno učitaj dodatke {#ReloadPlugins}
...
## Podržane govorne sinteze {#SupportedSpeechSynths}
...
## Podržani brajevi zasloni {#SupportedBrailleDisplays}
...
## Daljnje informacije {#FurtherInformation}
