...
* NVDA spustíte v 32 aj 64 bitových verziách systémov Windows 7, 8, 8.1, 10, Windows 11 a tiež v serverových edíciách Windows od verzie 2008 R2.
  * Vo Windows 7 musí byť nainštalovaný Service Pack 2 alebo novší.
  * V systémoch Windows Server 2008 R2 musí byť nainštalovaný Service Pack 1 alebo novší.
...
* Nefunguje používanie dotykovej obrazovky v systéme Windows 8 a novších.
* Nie je možné využívať režim prehliadania a čítanie napísaných znakov vo Windows Store v systéme Windows od verzie 8.
* V systémoch windows 8 a novších nie je možné využívať automatické stíšenie.
...
Podrobnosti sú vysvetlené v kapitole [Povoliť zasielanie údajov](#GeneralSettingsGatherUsageStats).
...
Ak používate NVDA na zariadení vybavenom dotykovou obrazovkou a máte nainštalovaný operačný systém Windows 8 alebo novší, môžete NVDA ovládať tiež priamo cez dotykové gestá.
...
NVDA môže čítať matematický obsah sprostredkovaný cez aplikáciu MathPlayer 4 od spoločnosti Design Science.
Musíte však mať vo vašom počítači nainštalovanú aplikáciu  MathPlayer 4.
MathPlayer si môžete zdarma stiahnuť z tejto adresy (anglicky): https://www.dessci.com/en/products/mathplayer/.
Po nainštalovaní Mathplayeru reštartujte NVDA.
...
Môžete ju stiahnuť tu: https://www.dessci.com/en/products/mathtype/
* Adobe Reader:
...
od tohto momentu môžete používať skratky programu MathPlayer, ako napríklad šípky na prezeranie obsahu.
...
Zoznam klávesových skratiek nájdete v [návode k programu MathPlayer](https://www.dessci.com/en/products/mathplayer/navigation_commands.htm).
...
Najprv Musíte mať začiarknuté "Oznamovať hlavičky riadkov / stĺpcov tabuľky" v kategórii  čítanie textu v [Nastaveniach](#NVDASettings).
...
##### Otvoriť všeobecné nastavenia {#toc105}
...
##### Zhromažďovanie údajov o používaní NVDA {#GeneralSettingsGatherUsageStats}
...
##### Otvoriť nastavenia reči {#toc117}
...
##### Otvoriť nastavenia hlasového výstupu {#toc137}
...
##### Otvoriť nastavenia brailového riadka {#toc160}
...
##### Otvoriť nastavenia zvuku {#toc165}
...
Ak chcete zapínať a vypínať tienenie obrazovky pomocou klávesovej skratky, môžete ju nastaviť v dialógu [Klávesové skratky](#InputGestures).
...
##### Otvoriť nastavenia klávesnice {#toc175}
...
Ak nevyberiete žiadny kláves ako kláves NVDA, je ťažké vykonávať väčšinu príkazov NVDA.
preto ak zatvoríte dialóg tlačidlom OK a nevybrali ste žiadny kláves NVDA, zobrazí sa chybové hlásenie.
Potom sa vrátite naspäť do dialógu s nastaveniami, kde musíte vybrať aspoň jeden kláves NVDA, aby ste mohli dialóg zatvoriť a uložiť nastavenia.
...
##### Otvoriť nastavenia myšy {#toc188}

Klávesová skratka: `NVDA+ctrl+m`

Tu môžete nastaviť sledovane kurzora myši, oznamovanie polohy myši a ďalšie užitočné funkcie.
...
##### Oznamovať typ prvku pri zameraní kurzorom myši {#MouseSettingsRole}
...
Táto kategória je dostupná len v počítačoch s operačným systémom Windows od verzie 8. Môžete tu nastaviť, ako sa NVDA bude správať pri používaní dotykovej obrazovky.
Nájdete tu nasledujúce možnosti.
...
##### Otvorí nastavenia prezentácie objektov {#toc205}
...
##### Otvorí nastavenia režimu prehliadania {#toc223}
...
##### Otvorí nastavenia čítania textu {#toc237}
...
Odporúčame vám preštudovať si návod (anglicky) na adrese [https://docs.python.org/3.7/howto/regex.html].
...
Skratkou NVDA+F1 otvoríte zobrazovač logu a do logu sa zapíšu informácie o aktuálnom navigačnom objekte.

Okrem čítania obsahu, je možné obsah logu uložiť do súboru, či obnoviť obsah, aby obsahoval aj záznamy zapísané po otvorení okna zobrazovač logu.
Tieto možnosti sú dostupné z aplikačnej ponuky okna zobrazovač logu.
...
Pozastaviť zobrazovanie aktuálneho textu (napr. užitočné pre kopírovanie) je možné kliknutím alebo prepnutím fokusu do okna zobrazovač reči.
...
V systémoch  Windows 7, 8 a 8.1, NVDA používa  eSpeak NG ako predvolený hlasový výstup. ([Hlasy Windows OneCore](#OneCore) sa používajú predvolene v systéme Windows od verzie 10).
...
* Microsoft Speech Platform - Runtime Languages (Verzia 11): https://www.microsoft.com/download/en/details.aspx?id=27224
 * Na tejto stránke nájdete množstvo hlasov určených na rozpoznávanie hlasu aj na prevod textu na reč.
...
Ak ich ešte nemáte, môžete ich stiahnuť zo stránky https://www2.freedomscientific.com/downloads/focus-40-blue/focus-40-14-blue-downloads.asp.
...
#### Klávesové skratky spoločné pre všetky modely {#toc317}
...
#### Klávesové skratky pre riadky Brailliant BI 32, BI 40 a B 80 {#toc318}
...
#### Klávesové skratky pre Brailliant BI 14 {#toc319}
...
Ak máte riadok pripojený cez USB, je potrebné nainštalovať ovládač dodávaný spoločnosťou HIMS.
Ovládače si môžete stiahnuť zo stránky: http://www.himsintl.com/upload/HIMS_USB_Driver_v25.zip
...
Systémoví administrátori môžu chcieť nastaviť NVDA tak, aby nemalo oprávnenia pristupovať k celému systému.
...
Ak hľadáte ďalšie informácie o NVDA, o jeho vývoji, alebo hľadáte pomoc, navštívte stránku projektu na adrese NVDA_URL.
