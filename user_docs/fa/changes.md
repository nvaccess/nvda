...
* متن گفتار هنگامی که موس به نمایشگر گفتار می‌رود، دیگر بروز نمی‌شود. (#15952 @hwf1324)
...
* امکانات جدید بریل:
  ...
  * پشتیبانی از ویژگی aria-brailleroledescription در ARIA 1.3 که به نویسندگان وب اجازه می‌دهد نوع سازه‌ای که روی نمایشگر بریل نشان داده می‌شود را نادیده بگیرند. (#14748)
...
* اگر ویندوز تنظیم شده باشد که ثانیه‌ها را در ساعت سیستم نشان بدهد، استفاده از NVDA+F12 برای اعلام ساعت، حالا به آن تنظیم توجه می‌کند. (#14742)
...
* بریل:
  ...
  * وقتی نمایشگر بریلی متصل نباشد و نمایشگر مجازی بریل با alt+f4 یا کلیک روی دکمه‌ی Close بسته شود، اندازه‌ی نمایشگر زیرسیستم بریل دوباره به بدون خانه تنظیم خواهد شد. (#15214)
* مرورگرهای وب:
...
* مشکلی که هنگام قفل کردن ویندوز، متن نمایشگر گفتار ذخیره می‌شد، برطرف شد.
...
* فرمانی برای فعال یا غیرفعال کردن نمایشگر مجازی بریل افزوده شد. کلیدی به این فرمان بطور پیشفرض اختصاص نیافته است. (#13258)
...
* بریلِ HID: حرکات آکوردی، مثلا، فشردن همزمان کلید فاصله و نقطه‌ی ۴ را می‌توان با موفقیت از نمایشگر بریل اجرا کرد. (#13326)
...
* Espeak-ng به نسخه‌ی 1.51-dev ویرایش ab11439b18... بروز شد. (#12449, #12202, #12280, #12568)
...
* نمایشگر گفتار را حالا می‌توانید با Alt+F4 ببندید. این نمایشگر همچنین یک دکمه‌ی استاندارد «بستن» دارد برای تعامل آسانتر کاربرانی که از  دستگاه‌های اشاره‌گر (مثل موس) استفاده می‌کنند. (#12330)
* نمایشگر مجازی بریل حالا یک دکمه‌ی استاندارد «بستن» برای تعامل آسانتر کاربرانی که از دستگاه‌های اشاره‌گر (مثل موس) استفاده می‌کنند دارد. (#12328)
...
* نصب‌کننده‌ی NVDA حالا پارامتر خط فرمان «--minimal» را هم به حساب آورده، با پیروی از همان رفتار بیان‌شده در راهنما برای پارامتر یادشده، مانند یک نسخه‌ی نصب‌شده یا قابل حمل، صدای آغاز اجرای نصب‌کننده را پخش نمی‌کند.  (#12289)
...
* جابجایی به خانه‌ی بریل در نمایشگر مجازی بریل، هم‌اکنون برای کاربرانی که از موس استفاده می‌کنند پشتیبانی می‌شود. موس را روی خانه‌ی مورد نظر نگهدارید تا مکان‌نما به آن خانه برود. (#11804)
...
* eSpeak-NG به نسخه‌ی ۱.۵۱-dev، ویرایش 1fb68ffffea4 بروز شد.
...
از دیگر نکات برجسته، می‌توان به پشتیبانی از ماشین‌های مجازی ۶۴-بیتی جاوا، قابلیت‌های پرده و برجسته‌ساز فکوس، پشتیبانی از نمایشگرهای بریلِ بیشتر و یک نمایشگر مجازیِ بریل، و رفع اشکال‌های بسیارِ دیگر اشاره نمود.
...
* ابزار نمایشگر بریل افزوده شد؛ که امکان مشاهده‌ی خروجی بریل از طریق پنجره‌ای روی صفحه‌نمایش را فراهم می‌کند. (#7788)
...
* eSpeak-NG به نسخه‌ی ۱.۵۱-dev، ویرایش ca65812ac6019926f2fbd7f12c92d7edd3701e0c بروز شد. (#10581)
...
* گزینه‌ای برای باز کردن نمایشگر گفتار هنگام شروع کار NVDA افزوده شده است. این گزینه را می‌توانید با استفاده از کادر علامت‌زدنی‌ای که در پنجره‌ی نمایشگر گفتار هست فعال کنید. (#5050)
* هنگامی که پنجره‌ی نمایشگر گفتار را دوباره باز می‌کنید، موقعیت و ابعاد پنجره به آخرین وضعیت اجرا باز‌می‌گردد. (#5050)
...
* مشکل نادری که باعث می‌شد هنگام خروج از NVDA، اگر نمایشگر گفتار باز باشد NVDA دچار خطا شود، برطرف شد. (#5050)
...
* بعد از بسته شدن نمایشگر گفتار از طریق نوار وظیفه یا Alt+F4، وضعیت کادر علامت‌زدنی نمایشگر گفتار در منوی NVDA، نمایانی واقعی پنجره‌ی نمایشگر را منعکس خواهد کرد. (#6340)
...
* وقتی حالت سخن‌گویی خاموش باشد، اعلام اشیاء (مانند فشردن NVDA+Tab برای اعلام محل فرمان‌پذیری) هم‌اکنون -آن‌گونه که انتظار می‌رود- در نمایشگر گفتار ظاهر می‌شود. (#6049)
...
* اما برای جدول‌هایی که سطرهایشان با هم ادغام شده اند، این مورد بطور خودکار کار نخواهد کرد. در این موقع، می‌توانید بطور دستی با استفاده از NVDA+Shift+C سر‌ستون‌های جدول را معین کنید.
