...
+ Mueve o cursor t'o texto que contién a nota.
+ Accede t'as opcions pa la selección como ye descrito alto.
+ Triga editar una Nota.
+
...
+ paquet, lo nombre d'o complemento
+ versión, la versión d'o complemento
+ razón d'incompatibilidad, una explicación de por qué lo complemento se considera incompatible
+
...
Por favor mira-te la documentación d'a linia pa descripcions de do puede trobar-sen istas teclas.
+++ Asignacions de teclas pa totz los modelos +++
%kc:beginInclude
|| Nombre | Tecla |
...
+++ Asignacions de teclas pa Brailliant BI 32, BI 40 y B 80 +++ 
%kc:beginInclude
|| Nombre | Tecla |
...
+++ Asignacions de teclas pa Brailliant BI 14 +++ 
%kc:beginInclude
|| Nombre | Tecla |
