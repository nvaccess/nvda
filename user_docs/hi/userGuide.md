...
#### सामान्य सेटिंग्स (एनव्हिडिए + + नियंत्रण छ) {#toc34}
...
#### सिंथेसाइज़र चयन (एनव्हिडिए + नियंत्रण + s) {#toc42}
...
##### रिपोर्ट भूमिका जब माउस वस्तु प्रवेश करती है {#toc74}
...
##### रिपोर्ट पृष्ठभूमि प्रगति सलाखों {#toc89}
...
#### आभासी बफर सेटिंग्स (NVDA + + नियंत्रण ख) {#toc90}
...
##### लिंक्स और शीर्षकों के रूप में ऐसे क्षेत्रों की घोषणा विन्यास {#toc95}
...
##### स्वत: ध्यान में परिवर्तन के लिए फोकस मोड {#toc96}

यह विकल्प मोड ध्यान केंद्रित करने के लिए अगर ध्यान बदलाव लाये जाने की अनुमति देता है

##### स्वचालित कैरट आंदोलन के लिए फोकस मोड {#toc97}
...
##### ध्यान केंद्रित करने और ब्राउज़ मोड के ऑडियो संकेत {#toc98}
...
#### दस्तावेज़ स्वरूपण सेटिंग्स (NVDA + + नियंत्रण घ) {#toc99}
...
##### कर्सर के बाद घोषणा स्वरूपण परिवर्तन {#toc100}
...
### विन्यास फाइल और उपयोगकर्ता प्रोफाइल {#toc103}
...
### माइक्रोसॉफ्ट भाषण एपीआई संस्करण 4 + (4 SAPI) {#toc110}
...
### माइक्रोसॉफ्ट भाषण एपीआई संस्करण 5 + (5 SAPI) {#toc111}
...
### आउदिओलोगिक  ट्त्स३ {#toc112}

इस इतालवी भाषा के लिए एक वाणिज्यिक भाषण विशेष रूप से सिंथेसाइज़र है.तुम क्रम में आपके सिस्टम पर अधिष्ठापित के लिए यह NVDA साथ प्रयोग की जाने वाली सिंथेसाइज़र होगा.अधिक जानकारी के लिए कृपया [www.audiologic.it](http://www.audiologic.it) पर आउदिओलोगिक वेबसाइट पर जाएँ.
...
1. समर्थित ब्रेल दिखाता है [SupportedBrailleDisplays]यह खंड ब्रेल NVDA द्वारा समर्थित दिखाता है के बारे में जानकारी शामिल हैं.
