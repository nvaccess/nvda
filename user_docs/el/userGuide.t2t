...
++ Περιορισμοί του φορητού και του προσωρινού αντίγραφου ++
...
+++ Εκκίνηση στην Είσοδο των Windows (Windows Logon) +++
...
+++ Δημιουργία Συντόμευσης Επιφάνειας Εργασίας (ctrl+alt+n) +++
...
+++ Αντιγραφή της Φορητής Διαμόρφωσης στο Λογαριασμό του Τρέχοντος Χρήστη +++
...
++ Δημιουργία ενός Φορητού Αντίγραφου ++
...
++ Σχετικά με τις εντολές πληκτρολογίου του NVDA ++

+++ Το πλήκτρο τροποποίησης του NVDA +++
...
++ Αναφορά Πληροφοριών Συστήματος ++
%kc:beginInclude
...
+ Ανάγνωση Μαθηματικού Περιεχομένου +
...
+ μετακινήστε το δρομέα επανεξέτασης στο μαθηματικό περιεχόμενο.
...
+ Κατόπιν ενεργοποιήστε την ακόλουθη εντολή:
+
...
+ Εντολές Του NVDA Για Συγκεκριμένες Εφαρμογές+
...
+++ Γενικές Ρυθμίσεις (NVDA+control+g) +++
...
==== Αποθήκευση Διαμόρφωσης κατά την Έξοδο ====
...
==== Εμφάνιση επιλογών εξόδου κατά την έξοδο από το nvda ====
...
==== Αναπαραγωγή ήχων κατά την εκκίνηση ή την έξοδο από το nvda ====
...
==== Αυτόματη εκκίνηση του NVDA μετά την είσοδο στα Windows ====
...
==== Χρήση του NVDA στην οθόνη εισόδου των Windows (απαιτεί δικαιώματα διαχειριστή) ====
...
==== Χρήση τρεχόντων αποθηκευμένων ρυθμίσεων στην είσοδο και σε άλλες οθόνες ασφαλείας (απαιτεί δικαιώματα διαχειριστή) ====
...
==== Αυτόματος έλεγχος ενημερώσεων του NVDA ====
...
+++ Επιλογή Συνθέτη Ομιλίας (NVDA+control+s) +++
...
%kc:setting
==== Επίπεδο Σημείων Στίξης/Συμβόλων ====
Πλήκτρο: NVDA+p
...
==== Αποδοχή της γλώσσας της φωνής κατά την επεξεργασία χαρακτήρων και συμβόλων ====
...
==== Ποσοστό Αλλαγής Τόνου σε Κεφαλαία ====
...
==== Λέγε "κεφαλαίο" μετά από κεφαλαίο χαρακτήρα ====
...
==== Επέκταση σε κώδικα υπολογιστών για την λέξη στην οποία βρίσκεται ο δρομέας ====
...
==== Ρυθμός εναλλαγής φωτεινότητας (ms) ====
...
+++ Ρυθμίσεις Πληκτρολογίου (NVDA+control+k) +++
...
==== Χρήση του πλήκτρου Κλείδωμα Κεφαλαίων (Caps Lock) σαν το πλήκτρο τροποποιητή NVDA ====
...
==== Χρήση του Insert σαν το πλήκτρο τροποποιητή NVDA ====
...
==== Χρήση του Insert του αριθμητικού πληκτρολογίου σαν το πλήκτρο τροποποιητή NVDA ====
...
==== Διακοπή εκφώνησης με το πλήκτρο enter ====
...
==== Να επιτρέπεται η γρήγορη πλοήγηση στην ανάγνωση όλων ====
...
==== Ήχος μπιπ σε περίπτωση πληκτρολόγησης πεζών γραμμάτων όταν το πλήκτρο Κλείδωμα Κεφαλαίων (Caps Lock) είναι ενεργό ====
...
==== Διαχείριση εντολών από άλλες εφαρμογές ====
...
==== Αναφορά Αλλαγών του Σχήματος Ποντικιού ====
...
%kc:setting
==== Ενεργοποίηση παρακολούθησης ποντικιού ====
Πλήκτρο: NVDA+m
...
==== Αναφορά ρόλου όταν το ποντίκι μπαίνει σε αντικείμενο ====
...
==== Αναπαραγωγή ακουστικών συντεταγμένων κατά την κίνηση του ποντικιού ====
...
==== Έλεγχος της έντασης των ακουστικών συντεταγμένων από τη φωτεινότητα ====
...
%kc:setting
==== Ακολούθηση Εστίασης Συστήματος ====
Πλήκτρο: NVDA+7
...
==== Αναφορά Πλήκτρων Συντόμευσης Αντικειμένου ====
...
==== Αναφορά Πληροφορίας Θέσης Αντικειμένου ====
...
==== Εικασία Πληροφορίας Θέσης Αντικειμένου όταν δεν είναι διαθέσιμη ====
...
==== Αναφορά Λωρίδων Προόδου Υποβάθρου ====
...
%kc:setting
==== Αναφορά Αλλαγών Δυναμικού Περιεχομένου ====
Πλήκτρο: NVDA+5
...
==== Αυτόματη αναφορά όλων των διαθέσιμων υποψηφίων ====
...
==== Αναγγελία Επιλεγμένου Υποψηφίου ====
...
==== Να συμπεριλαμβάνονται πάντα σύντομες περιγραφές χαρακτήρων για τους υποψηφίους ====
...
==== Αναφορά αλλαγών στον κώδικα ανάγνωσης ====
...
==== Αναφορά αλλαγών στον κώδικα εισόδου ====
...
==== Αυτόματη Εκφώνηση Όλων κατά τη φόρτωση της σελίδας ====
...
==== Διαμόρφωση αναφοράς πεδίων όπως σύνδεσμοί και επικεφαλίδες ====
...
==== Αυτόματη Λειτουργία Εστίασης κατά τις αλλαγές εστίασης ====
...
==== Αυτόματη Λειτουργία Εστίασης κατά τις κινήσεις του κέρσορα ====
...
==== Ηχητική Ένδειξη των λειτουργιών Εστίασης και Περιήγησης ====
...
==== Περιορισμός των χειρονομιών που δεν αφορούν σε εντολές για να μην επηρεάζεται το έγγραφο ====
...
==== Αναγγελία Αλλαγών Μορφοποίησης μετά το δρομέα ====
...
+++ Προσωρινή Απενεργοποίηση Σκανδαλισμών +++
...
++ Προβολέας Αρχείου Καταγραφής Συμβάντων ++
...
++ Microsoft Speech API έκδοση 4 (SAPI 4) ++
...
++ Microsoft Speech API έκδοση 5 (SAPI 5) ++
...
++ Σειρά Focus/PAC Mate από τη Freedom Scientific ++
...
++ Οθόνες Braille Baum/Humanware/APH ++
...
++ Σειρά HIMS Braille Sense/Braille EDGE ++
...
++ Νεότερα Μοντέλα Papenmeier BRAILLEX ++
...
++ Παλαιότερα Μοντέλα Papenmeier Braille BRAILLEX ++
...
+ Συντομεύσεις τύπου ελέγχου braille και κατάστασης +
...
++ Προχωρημένη Διαμόρφωση Για Την Προφορά Συμβόλων ++
