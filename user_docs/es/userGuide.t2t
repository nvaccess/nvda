...
+ La ventana del lanzador de NVDA aparece con el acuerdo de licencia.
Pulsa ``flechaAbajo`` para leer el acuerdo de licencia si lo deseas.
+ Pulsa ``tab`` para desplazarte a la casilla de verificación "Acepto", entonces pulsa la ``barra espaciadora`` para marcarla.
+ Pulsa ``tab`` para desplazarte por las opciones, entonces pulsa ``intro`` sobre la opción deseada.
+
...
+ Desde el lanzador, asegúrate de que la casilla de verificación para aceptar la licencia esté marcada.
+ Pulsa ``Tab`` y activa el botón "Instalar NVDA en este ordenador".
+ Seguidamente, van las opciones para que NVDA utilice durante el inicio de sesión de windows y para crear un acceso directo en el escritorio.
...
+ Aparece un diálogo de Windows "Control de Cuenta de Usuario (UAC en inglés)" preguntándote "¿Quiere permitir que esta app haga cambios a su ordenador?".
+ Pulsa ``alt+s`` para aceptar el indicativo del UAC.
+ Se rellena una barra de progreso según NVDA se instale.
Durante este proceso NVDA emite un pitido cada vez más agudo.
Este proceso a menudo es rápido y puede no ser notificado.
+ Aparece un cuadro de diálogo confirmando que la instalación de NVDA ha sido exitosa.
El mensaje te avisa de que "Pulses Aceptar para arrancar la copia instalada".
Pulsa ``intro`` para iniciar la copia instalada.
+ Aparece el diálogo "Bienvenido a NVDA", y NVDA lee un mensaje de bienvenida.
...
+ Pulsa ``tab`` para desplazarte a "Utilizar ``bloqMayus`` como una tecla modificadora de NVDA".
...
+ Utiliza ``tab`` y ``barra espaciadora`` para ajustar las otras opciones en esta pantalla.
Estas establecen si NVDA arranca automáticamente.
+ Pulsa ``intro`` para cerrar el cuadro de diálogo con NVDA ahora en ejecución.
+
...
+ Abre el diálogo Gestos de entrada desde el modo exploración.
+ Busca el elemento "mueve a la siguiente pestaña" en la sección modo Exploración.
+ Asigna la tecla ``y`` para el gesto encontrado.
+ Busca el elemento "mueve a la pestaña anterior".
+ Asigna ``shift+y`` para el gesto encontrado.
+
...
+ A continuación, activa la siguiente orden:
+
...
+ Mueve el cursor al texto que contenga la nota.
+ Accede a las opciones para la selección según se describió anteriormente.
+ Elige Editar Nota.
+
...
%kc:setting
==== Abrir el diálogo Seleccionar Sintetizador ====
...
%kc:setting
==== Abrir el diálogo Seleccionar Pantalla Braille ====
...
%kc:setting
==== Abrir las opciones de Presentación de Objetos ====
...
%kc:setting
==== Abrir las opciones de modo Exploración ====
...
%kc:setting
==== Abrir las opciones de Formateado de Documento ====
...
Por favor conhsulta la documentación de la pantalla para descripciones de dónde pueden encontrarse estas teclas.
+++ Asignaciones de teclas para todos los modelos +++
%kc:beginInclude
|| Nombre | Tecla |
...
+++ Asignaciones de teclas para Brailliant BI 32, BI 40 y B 80 +++ 
%kc:beginInclude
|| Nombre | Tecla |
...
+++ Asignaciones de teclas para Brailliant BI 14 +++ 
%kc:beginInclude
|| Nombre | Tecla |
| tecla flecha arriba | joystick arriba |
| tecla flecha abajo | joystick abajo |
...
+ Asegúrate de que has instalado el [último controlador https://www.papenmeier-rehatechnik.de/en/service/downloadcenter/software/articles/software-braille-devices.html].
+ Abre el administrador de dispositivos de Windows.
+ Desplázate hacia abajo por la lista hasta "Controladores USB" o "Dispositivos USB".
+ Selecciona "dispositivo Papenmeier Braillex USB".
+ Abre las propiedades y cambia a la pestaña "Avanzadas".
...
+ Deshabilita la opción "Cargar VCP".
+
