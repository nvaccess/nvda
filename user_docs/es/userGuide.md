...
|Leer la selección |`NVDA+shift+flecha arriba` |`NVDA+shift+s` |Lee cualquier texto seleccionado|
|Leer texto del portapapeles |`NVDA+c` |`NVDA+c` |Lee cualquier texto en el portapapeles|
...
|Anunciar foco |`NVDA+tab` |`NVDA+tab` |Anuncia el control actual que tenga el foco.  Pulsándolo dos veces deletreará la información|
...
* Windows 8 y posterior: la incapacidad de admitir la entrada desde una pantalla táctil.
* Windows 8 y posterior: la incapacidad de proporcionar características tales como modo navegación y la verbalización de caracteres al escribir en las aplicaciones de la Tienda de Windows.
* Windows 8 y posterior: la atenuación de audio no está admitida.
...
Puedes leer más información acerca de la recopilación de datos por NV Access en la sección Opciones Generales, [Permitir al proyecto de NVDA recopilar estadísticas de uso de NVDA](#GeneralSettingsGatherUsageStats).
...
Si estás ejecutando NVDA en un dispositivo con una pantalla táctil y con Windows 8 o superior, también puedes controlar a NVDA directamente a través de órdenes táctiles.
...
Después de instalar MathPlayer, reinicia NVDA.
...
Puede descargarse desde https://www.dessci.com/en/products/mathtype/
* Adobe Reader.
...
En este punto, puedes utilizar órdenes de MathPlayer tales como las teclas de cursor para explorar la  expresión.
...
Por favor consulta la [documentación de MathPlayer acerca de órdenes de navegación](https://www.dessci.com/en/products/mathplayer/navigation_commands.htm) para información adicional.
...
Esto requiere primero que la opción Anunciar  Encabezados de Filas y columnas en las opciones de NVDA Formateado de Documentos, que se encuentra en el diálogo [Opciones de NVDA](#NVDASettings), esté activada.
...
##### Abrir Opciones Generales {#toc105}
...
Cuando esta opción está marcada, NVDA dirá la descipción del carácter cuando te muevas por caracteres.
...
##### Abrir el diálogo Seleccionar Sintetizador {#toc138}
...
| . {.hideHeaderRow} |.|
|---|---|
|Opciones |Predeterminado (Nunca), Nunca, sólo cuando sigue automáticamente, siempre|
|Predeterminado |Nunca|
...
| . {.hideHeaderRow} |.|
|---|---|
|Opciones |Predeterminado (Habilitado), Habilitado, Deshabilitado|
...
##### Abrir el diálogo Seleccionar Pantalla Braille {#toc160}
...
##### Abrir Opciones de Audio {#toc166}
...
Para conmutar la Cortina de Pantalla desde cualquier lugar, por favor asigna un gesto personalizado utilizando el diálogo [Gestos de Entrada](#InputGestures).
...
##### Abrir opciones de Teclado {#toc176}
...
Si no se elige ninguna tecla como la tecla NVDA podría ser imposible acceder a ciertas órdenes de NVDA.
Por lo tanto, el diálogo Opciones de NVDA mostrará un mensaje de error si todas las teclas están sin seleccionar  cuando se pulse Aceptar.
...
##### Abre las opciones de Ratón {#toc189}
...
##### Abrir las opciones de Presentación de Objetos {#toc206}
...
##### Abrir las opciones de modo Exploración {#toc224}
...
##### Abrir las opciones de Formateado de Documento {#toc238}
...
* "Anunciar 'tiene detalles' para anotaciones estructuradas ": habilita el anunciado si el texto o el control tiene más detalles.
  Se puede anunciar un resumen de los detalles adicionales asignando un gesto a "Anunciar resumen de cualquier detalle de anotación en el cursor del sistema" utilizando el [diálogo Gestos de Entrada](#InputGestures).
...
Para un tutorial introductorio, Por favor consulta [https://docs.python.org/3.7/howto/regex.html].
...
En Windows 7, 8 y 8.1, NVDA utiliza Espeak NG de forma predeterminada ([Windows OneCore](#OneCore) se utiliza en Windows 10 y posteriores por defecto).
...
Por favor consulta este artículo de Microsoft para una lista de voces disponibles: https://support.microsoft.com/en-us/windows/appendix-a-supported-languages-and-voices-4486e345-7730-53da-fcfe-55cc64300f01
...
#### Asignaciones de teclas para todos los modelos {#toc319}
...
#### Asignaciones de teclas para Brailliant BI 32, BI 40 y B 80 {#toc320}
...
#### Asignaciones de teclas para Brailliant BI 14 {#toc321}
...
Puedes descargarlos de aquí: http://www.himsintl.com/upload/HIMS_USB_Driver_v25.zip
...
Puedes encontrar más información acerca de las pantallas en https://en.seika-braille.com/down/index.html.
...
|Conmutar entre los modos de voz desactivado, pitar y hablar |`attributo2+attributo4`|
...
* Abrir documentos esternos desde el menú de NVDA, tales como la Guía del Usuario o el fichero de contribuyentes.
...
|-l LOGLEVEL |--log-level=LOGLEVEL |El nivel más bajo de mensaje registrado (debug 10, input/output 12, debug warning 15, info 20, disabled 100)|
