...
Hay muchas mejoras para la voz, en particular mejor respuesta con SAPI 4, SAPI 5 y voces de OneCore.
SAPI 5 ahora admite el aumento brusco de velocidad y el cambio automático de idioma.
Las voces SAPI 4 ahora admiten la atenuación de audio, el recorte del silencio inicial y el mantenimiento del dispositivo de audio activo.
...
Ahora se pueden determinar las tablas braille de entrada y de salida predeterminadas en función del idioma de NVDA.
Se ha añadido compatibilidad nativa con el dispositivo de gráficos táctiles Dot Pad de Dot Inc como pantalla braille multilínea.
Ha habido otras correcciones menores para las pantallas braille, sobre todo en torno a la conectividad.

Se han actualizado LibLouis braille translator, eSpeak-N y Unicode CLDR.
Están disponibles nuevas tablas braille Coptic, compact Cuneiform y Portugués.
...
Por favor, divulga  responsablemente los fallos de seguridad siguiendo la [política de seguridad de NVDA](https://github.com/nvaccess/nvda/blob/master/security.md).

* Evita que se muestre información potencialmente sensible en las pantallas braille cuando el dispositivo está bloqueado.
([GHSA-8f8q-2jc3-6rf4](https://github.com/nvaccess/nvda/security/advisories/GHSA-8f8q-2jc3-6rf4))
* Evita que el instalador cargue DLL no deseadas desde su directorio.
([GHSA-qf5h-qw92-rx2f](https://github.com/nvaccess/nvda/security/advisories/GHSA-qf5h-qw92-rx2f))

### Nuevas Características

* Tienda de Complementos:
  * Actualizaciones automáticas (#3208):
    * Ahora se pueden modificar los canales de actualización automática de los complementos.
      * Los canales de actualización automática pueden seleccionarse para los complementos instalados a través del submenú «Canal de actualización».
      * El canal de actualización automática por defecto puede configurarse desde el panel Tienda de complementos en la configuración de NVDA.
    * Ahora las actualizaciones automáticas pueden realizarse en segundo plano.
      * Esto puede activarse en el panel de la tienda de complementos en las opciones de NVDA cambiando «Actualizaciones automáticas» a «Actualizar automáticamente».
    * Las actualizaciones automáticas ahora pueden actualizar los complementos incompatibles a otra versión más moderna e incompatible.
      * Esto puede activarse en el panel de la tienda de complementos en las ocpiones de NVDA.
  * Añadida una acción para cancelar la instalación de complementos. (#15578, @hwf1324)
  * Añadida una acción para reintentar la instalación si falla la descarga/instalación de un complemento. (#17090, @hwf1324)
  * Las listas de complementos pueden ordenarse por columnas, incluida la fecha de publicación, en orden ascendente y descendente. (#15277, #16681, @nvdaes)
* Voz:
  * Ahora se admite el cambio automático de idioma al utilizar Microsoft Speech API versión 5 (SAPI5) y las voces de Microsoft Speech Platform. (#17146, @gexgd0419)
  * Ahora se admite el aumento brusco de velocidad al utilizar Microsoft Speech API versión 5 (SAPI5) y las voces de Microsoft Speech Platform, que admite una velocidad de hasta 6X. (#17606, @gexgd0419)
* Navegadores web:
  * El modo de selección nativa del modo exploración de NVDA (`NVDA+shift+f10`) ahora es compatible con Google Chrome, Edge y otras aplicaciones basadas en Chromium 134 o posterior. (#17838)
  * En Mozilla Firefox, NVDA anunciará el texto resaltado cuando se visite una URL que contenga un fragmento de texto. (#16910, @jcsteh)
  * O NVDA agora pode anunciar cuando el destino de un enlace apunta a la página actual. (#141, @LeonarddeR, @nvdaes)
* Microsoft Office:
  * Al editar en cuadros de texto de PowerPoint, ahora puedes moverte por frase con `alt+flecha arriba`/`alt+flecha abajo`. (#17015, @LeonarddeR)
  * En Word, ahora se anuncia la actualización de la selección cuando se utilizan órdenes de Word para ampliar o reducir la selección (`f8` o `shift+f8`). (#3293, @CyrilleB79)
  * En Word 16.0.18226 y superior o cuando se utiliza el modelo de objetos de Word, NVDA ahora anunciará si un encabezado está contraído tanto en voz como en braille. (#17499)
  * En Word con UIA, al utilizar las órdenes nativas de navegación extendida de tabla (`alt+inicio`, `alt+fin`, `alt+avPág`, y `alt+RePág`), ahora se anunciará el movimiento del cursor. (#17867, @CyrilleB79)
  * En Word, al utilizar la orden "anunciar foco", se anunciará el diseño del documento si se dispone de esta información y está activado el anunciado de descripción de objetos. (#15088, @nvdaes)
  * Ahora se anuncia el resultado de más atajos en Word y Outlook:
    * atajos de formato de fuente (#10271, @CyrilleB79)
    * contraer o expandir encabezados (#17545, @CyrilleB79)
* LibreOffice:
  * Al aumentar o disminuir el tamaño de la fuente en Writer utilizando los atajos de teclado correspondientes, NVDA anuncia el nuevo tamaño de la fuente. (#6915, @michaelweghorn)
  * Al aplicar el "Cuerpo de texto" o un estilo de encabezado de párrafo utilizando el atajo de teclado correspondiente en Writer 25.2 o posterior, NVDA anuncia el nuevo estilo de párrafo. (#6915, @michaelweghorn)
  * Al alternar el doble subrayado en Writer mediante el atajo de teclado correspondiente, NVDA anuncia el nuevo estado ("doble subrayado activado"/"doble subrayado desactivado"). (#6915, @michaelweghorn)
  * NVDA ahora puede informar de la sangría de la primera línea en LibreOffice 25.8 y posteriores. (#13052, @michaelweghorn)
* OCR:
  * En un resultado de reconocimiento, `NVDA+f5` actualiza manualmente el contenido reconocido. (#17715, @CyrilleB79)
  * Añadido un gesto no asignado para actualizar periódicamente el resultado del OCR de Windows. (#16897)
* La funcionalidad de acceso remoto, basada en el complemento NVDA Remote, se ha integrado en NVDA. (#4390, @ctoth, @tspivey, @daiverd, Colaboradores y financiadores de NVDA Remote)
* Ahora es posible especificar URLs espejo para usar en las actualizaciones de NVDA y en la tienda de complementos. (#14974, #17151, #17310, @christopherpross)
* Se ha añadido el soporte para matemáticas en PDFs. (#9288, @NSoiffer)
  * Esto funciona para fórmulas con MathML asociado, como algunos archivos generados por las versiones más recientes de TeX/LaTeX.
  * Actualmente esto sólo es compatible con Foxit Reader y Foxit Editor.
* Ahora se puede configurar NVDA para que diga la línea o párrafo actual al navegar con las teclas de navegación en braille. (#17053, @nvdaes)
* NVDA es capaz ahora de anunciar cambios de cursor de sistema al presionar los gestos `alt+upArrow` o `alt+downArrow`, por ejemplo en Visual Studio Code. (#17652, @LeonarddeR)
* Añadidas órdenes para mover el cursor de revisión al primer y último carácter del texto seleccionado, asignados a `NVDA+alt+inicio` y `NVDA+alt+fin`, respectivamente. (#17299, @nvdaes)
* Se ha añadido una opción general para evitar que la pantalla se apague al leer todo o al leer con braille.
Esta opción está activada por defecto, pero puede provocar un mayor agotamiento de la batería. (#17649, @LeonarddeR)
* NVDA ahora se traduce al Bosnio. (#17953)
* En Adobe Acrobat, NVDA ahora puede leer e interactuar con ecuaciones matemáticas en documentos PDF generados por versiones recientes de Microsoft Word. (#18056)
...
* Actualización de Componentes:
  * Actualizado el transcriptor braille LibLouis a [3.33.0](https://github.com/liblouis/liblouis/releases/tag/v3.33.0). (#17469, #17768, @LeonarddeR, @codeofdusk)
    * Añadidas nuevas tablas braille Coptic, compact Cuneiform y Portugués computerizado de 6 puntos.
  * Actualizado CLDR a la versión 46.0. (#17484, @OzancanKaratas)
  * Actualizado eSpeak NG a 1.52.0. (#17056)
* Cambios de la interfaz de NVDA:
  * El instalador de NVDA ya no reproduce un sonido cuando se inicia. (#14068)
  * Los cuadros de diálogo Anunciar destino del enlace, Información de formato de caracteres y verbalizar Selección incluyen ahora los botones "Cerrar" y "Copiar" para mayor comodidad del usuario. (#17018, @XLTechie)
  * El diálogo Salir ahora permite reiniciar NVDA con los complementos desactivados y el registro de depuración activado simultáneamente. (#11538, @CyrilleB79)
  * Se ha eliminado la posibilidad de no utilizar WASAPI para la salida de audio. (#16080)
  * Se ha eliminado la opción del modo exploración "Poner automáticamente el foco del sistema en los elementos enfocables", ahora el comportamiento está desactivado. (#17598)
  * NVDA ahora sólo advertirá sobre la incompatibilidad de complementos cuando se actualice a una nueva versión que tenga una API de complemento incompatible con la versión actual. (#17071, #17506)
  * Se ha eliminado el archivo "Coltributors" del menú NVDA. (#16922)
  * La licencia de NVDA está ahora formateada en HTML para mejorar la legibilidad. (#17600)
  * Se han añadido versiones abreviadas de las opciones de línea de órdenes más utilizadas: `-d` para `--disable-addons` y `-n` para `--lang`.
  La coincidencia de prefijos en los indicadores de línea de órdenes, por ejemplo, el uso de `--di` para `--disable-addons` ya no es compatible. (#11644, @CyrilleB79)
  * Cambios en el COM Registration Fixing Tool: (#12355, @XLTechie)
    * Ahora comienza con una explicación más amigable de su propósito, en lugar de una advertencia. (#12351)
    * Ahora se puede salir de la ventana inicial con `escape` o `alt+f4`. (#10799)
    * Ahora mostrará un mensaje al usuario, incluido el error, en el raro caso de que se produzca un error de Windows al intentar volver a registrar COM.
* Voz:
  * La versión 5 de Microsoft Speech API y las voces de Microsoft Speech Platform utilizan ahora WASAPI para la salida de audio, lo que puede mejorar la capacidad de respuesta de esas voces. (#13284, @gexgd0419)
  * Ahora se recortará el silencio al principio del habla cuando se utilicen voces OneCore, voces SAPI5 y algunos complementos de voz de terceros para mejorar su capacidad de respuesta. (#17614, @gexgd0419)
  * Las voces de la versión 4 de Microsoft Speech API utilizan ahora WASAPI para la salida de audio, de modo que pueden funcionar con funciones como la atenuación de audio, el recorte del silencio inicial y el mantenimiento del dispositivo de audio encendido.
  Si esto no funciona con tu voz SAPI 4, puedes desactivar WASAPI para SAPI 4 en la Configuración avanzada. (#17718, #17801, @gexgd0419)
  * La normalización Unicode está ahora activada por defecto para la salida de voz. (#17017, @LeonarddeR).
    * Aún puedes desactivar esta funcionalidad en la categoría Voz del cuadro de diálogo Opciones de NVDA.
* Las opciones de teclado para "Verbalizar caracteres al escribir" y "Verbalizar palabras al escribir» tienen ahora tres opciones: Desactivado, Sólo en controles de edición y Siempre. (#17505, @Cary-rowen)
  * Por defecto, "Verbalizar caracteres al escribir" está ahora en "Sólo en controles de edición".
* Ahora se pueden determinar las tablas braille de entrada y de salida predeterminadas en función del idioma de NVDA. (#17306, #16390, #290, @nvdaes)

### Corrección de Fallos

* Voz:
  * Se ha solucionado un problema por el que la lectura continua (leer todo) se detenía al final de la primera frase cuando se utilizaban algunos sintetizadores SAPI5. (#16691, @gexgd0419)
  * Los parámetros de voz, como la velocidad y el volumen, ya no se restablecerán a los valores predeterminados al utilizar el anillo de opciones del sintetizador para cambiar entre voces en el sintetizador SAPI5 y SAPI4. (#17693, #2320, @gexgd0419)
  * Se ha corregido un problema por el que no se podían cargar algunas voces SAPI4 (por ejemplo, IBM TTS Chinese). (#17726, @gexgd0419)
* Braille:
  * Soporte nativo para el dispositivo gráfico táctil Dot Pad de Dot Inc como pantalla braille multilínea. (#17007)
  * Ao usar o Seika Notetaker, os xestos de espazo e espazo con puntos amósanse agora correctamente na Caixa de diálogo Xestos de entrada. (#17047, @school510587)
  * NVDA ya no debería reproducir sonidos de error ni enviar spam al archivo de registro cuando se utiliza el modo braille de salida de voz de pantalla mientras no hay ninguna pantalla braille conectada. (#17092, @Emil-18)
  * Cuando se selecciona explícitamente el controlador de pantalla braille HID estándar como controlador de pantalla braille y se abre la lista de pantallas braille, NVDA identifica correctamente el controlador HID como controlador seleccionado en lugar de mostrar que no hay ningún controlador seleccionado. (#17537, @LeonarddeR)
  * El controlador Brailliant de Humanware es ahora más fiable a la hora de seleccionar el punto final de conexión correcto, lo que se traduce en una mayor estabilidad de la conexión y menos errores. (#17537, @LeonarddeR)
  * Las tablas braille personalizadas de scrachpad para desarrolladores ahora se ignoran correctamente cuando se ejecutan con los complementos desactivados. (#17565, @LeonarddeR)
  * Fixed an issue where some USB braille displays were not properly detected by NVDA. (#18114, @christiancomaschi)
* Microsoft Office:
  * La orden "Anunciar la URL de destino de un enlace" funciona ahora como se esperaba cuando se utiliza el modelo de objetos heredado en Word, Outlook, Excel y PowerPoint. (#17292, #17362, #17435, @CyrilleB79)
  * En Excel, el diálogo de lista de elementos (`NVDA+f7`) ya no falla al enumerar comentarios o fórmulas en algunos sistemas que no estén en inglés. (#11366, @CyrilleB79)
  * Mejoras en PowerPoint:
    * Anunciar el cursor del sistema ya no se interrumpe cuando el texto contiene caracteres anchos como emoji. (#17006 , @LeonarddeR)
    * El anunciado de la ubicación de los caracteres es ahora preciso (por ejemplo, al pulsar `NVDA+suprimir`. (#9941, @LeonarddeR)
    * NVDA ya no inicia "Leer todo" al iniciar una presentación de diapositivas y la opción del modo exploración "Leer todo automáticamente al cargar la página" está desactivado. (#17488, @LeonarddeR)
* LibreOffice:
  * Cuando se utiliza el método de entrada Pinyin de Microsoft para el chino y se activa la opción de compatibilidad Pinyin para utilizar la versión anterior, ya no se produce un error al escribir en Writer (y posiblemente en otras aplicaciones) mientras se muestra una ventana emergente IME. (#17198, @michaelweghorn)
  * El estado actual (marcado/desmarcado) de las casillas de verificación en los diálogos ahora también se anuncia en braille, no sólo en voz alta. (#17218, @michaelweghorn)
* Matemáticas:
  * Se ha corregido la lectura matemática de algunos elementos web.
  En concreto, MathML dentro de span y otros elementos que tengan el atributo `role=«math»`. (#15058)
  * Las ecuaciones matemáticas sólo representadas por una imagen y texto alt sin MathML para navegación enriquecida, son ahora tratadas como imágenes normales, en lugar de matemáticas sin contenido, permitiendo al usuario saltar a ellas con `g` y poder navegar por el texto alt por carácter. (#16007)
* IDEs:
  * NVDA ya no se bloqueará al seleccionar todo el texto en ciertos archivos de origen en Android Studio o IntelliJ Idea. (#17418, @thgcode)
  * En Visual Studio Code, NVDA ya no secuestra los gestos `alt+arribaFlecha` y `alt+abajoFlecha` para la navegación de frases. (#17082, @LeonarddeR)
  * Algunos elementos de sección se reconocen ahora correctamente como controles editables en Visual Studio Code. (#17573, @Cary-rowen)
  * En el Bloc de notas y otros documentos UIA, y en documentos Notepad++ en Windows 11, si la última línea está vacía, la "orden braille línea siguiente" moverá el cursor a la última línea.
  En cualquier documento, si el cursor está en la última línea, se moverá al final cuando se utilice esta orden. (#17251, #17430, @nvdaes)
* Perfiles de configuración:
  * El braille ya no es disfuncional al activar "leer todo" con un perfil de configuración asociado. (#17163, @LeonarddeR)
  * Se ha corregido un problema por el que determinadas opciones se guardaban explícitamente en el perfil de configuración activo incluso cuando el valor de esa opción era igual al valor de la configuración base. (#17157, @leonarddeR)
* Al deletrear, la normalización unicode funciona ahora de forma más adecuada:
  * Después de anunciar un carácter normalizado, NVDA ya no anuncia incorrectamente los caracteres posteriores como normalizados. (#17286, @LeonarddeR)
  * Los caracteres compuestos (como é) ahora se notifican correctamente. (#17295, @LeonarddeR)
* NVDA podrá leer los elementos del submenú emergente en la página de resultados de búsqueda de Thunderbird. (#4708, @thgcode)
* COM Registration Fixing Tool ya no anuncia como éxito en caso de fallar. (#12355, @XLTechie)
* NVDA ya no anunciará las entradas del historial del portapapeles de Windows 11 al cerrar la ventana mientras haya elementos presentes. (#17308, @josephsl)
* Si los plugins se recargan mientras un mensaje navegable está abierto, NVDA ya no fallará al anunciar movimientos posteriores del foco. (#17323, @CyrilleB79)
* Al utilizar aplicaciones como Skype, Discord, Signal y Phone Link para la comunicación de audio, la voz y los sonidos de NVDA ya no bajan de volumen. (#17349, @jcsteh)
* La apertura de la consola Python de NVDA ya no fallará en caso de que se produzca un error al recuperar variables de snapshot. (#17391, @CyrilleB79)
* En los navegadores web, los cambios en la selección de texto ya no fallan a veces en los controles de texto editables. (#17501, @jcsteh)
* Cuando los enlaces anclados apunten al mismo objeto en el que se coloca el cursor virtual, NVDA ya no falla al desplazarse al destino del enlace. (#17669, @nvdaes)
* El icono de la ventana NVDA Highlighter ya no está fijo en la barra de tareas después de reiniciar el Explorador. (#17696, @hwf1324)

### Cambios para Desarrolladores

Por favor consulta [la guía del desarrollador](https://www.nvaccess.org/files/nvda/documentation/developerGuide.html#API) para obtener información sobre el proceso de eliminación de la API de NVDA.

* Nota: esta es una versión que rompe la compatibilidad con la API de los complementos.
Los complementos tendrán que volver a comprobarse y actualizar su manifiesto.
...
* `ui.browseableMessage` podrá llamarse con opciones para presentar un botón para copiar al portapapeles y/o un botón para cerrar la ventana. (#17018, @XLTechie)
* Varios añadidos para identificar tipos de enlaces (#16994, @LeonarddeR, @nvdaes)
  * Un nuevo módulo `utils.urlUtils` con diferentes funciones para determinar los tipos de enlace
  * Se ha añadido un nuevo estado `INTERNAL_LINK` a `controlTypes.states.State`
  * Se ha añadido una nueva propiedad `linkType` en `NVDAObject`.
  Consulta el `treeInterceptor` por defecto, si existe.
  * El objeto `BrowseModeTreeInterceptor` tiene una nueva propiedad `documentUrl`
  * `BrowseModeTreeInterceptor` tiene un nuevo método `getLinkTypeInDocument` que acepta una URL para comprobar el tipo de enlace del objeto
  * Se ha añadido una función auxiliar `toggleBooleanValue` a `globalCommands`.
  Puede utilizarse en scripts para anunciar el resultado cuando se activa un booleano en `config.conf`
* Eliminado el requisito de sangrar las listas de parámetros de función con dos tabuladores de los Estándares de Codificación de NVDA, para ser compatible con el linting automático moderno. (#17126, @XLTechie)
* Añadido el [VS Code workspace configuration for NVDA](https://nvaccess.org/nvaccess/vscode-nvda) como submódulo git. (#17003)
* Se ha añadido una nueva función, `gui.guiHelper.wxCallOnMain`, que permite llamar de forma segura y sincrónica a funciones wx desde subprocesos ajenos a GUI, y obtener su valor de retorno. (#17304)
* Se ha añadido una nueva API de diálogo de mensajes a `gui.message`. (#13007)
  * Añadidas clases: `ReturnCode`, `EscapeCode`, `DialogType`, `Button`, `DefaultButton`, `DefaultButtonSet`, `MessageDialog`.
* En el módulo `brailleTables`, se ha añadido una función `getDefaultTableForCurrentLang` (#17222, @nvdaes)
* Añadida una clase de datos `updateCheck.UpdateInfo`, que encapsula metadatos sobre actualizaciones de NVDA. (#17310, @christopherpross)
* Recuperar la propiedad `labeledBy` ahora funciona para:
  * objetos en aplicaciones que implementen la relación `labelled-by` IAccessible2. (#17436, @michaelweghorn)
  * Elementos UIA que admitan la propiedad UIA `LabeledBy` correspondiente. (#17442, @michaelweghorn)
* Se ha añadido la posibilidad de asociar `wx.ComboBox` y una etiqueta `wx.StaticText` utilizando `gui.guiHelper.associateElements`. (#17476)
* Añadidos los siguientes puntos de extensión (#17428, @ctoth):
  * `inputCore.decide_handleRawKey`: se ejecuta cada vez que se pulsa una tecla
  * `speech.extensions.post_speechPaused`: se ejecuta cuando la voz se pausa o se desbloquea
* Cambios en el registro de detección automática de pantalla braille en `bdDetect.DriverRegistrar`: (#17521, @LeonarddeR)
  * Añadido el método `addUsbDevice` para registrar un dispositivo USB cada vez.
  * Añadido el parámetro `matchFunc` a `addUsbDevices` que también está disponible en `addUsbDevice`.
    * De este modo, la detección de dispositivos puede limitarse aún más en los casos en los que una combinación VID/PID sea compartida por varios dispositivos a través de varios controladores, o cuando un dispositivo HID ofrezca varios puntos finales, por ejemplo.
    * Consulta la documentación del método, así como los ejemplos en los controladores albatross y brailliantB para obtener más información.
* Se ha añadido una nueva función, `utils.mmdevice.getOutputDevices`, para enumerar los dispositivos de salida de audio. (#17678)
* Se ha añadido un nuevo punto de extensión `pre_synthSpeak` en `synthDriverHandler`, que se llamará antes de que el gestor de voz llame a `speak` del sintetizador actual. (#17648)
* NVDA admite el atributo `text-indent` del objeto IAccessible2. (#13052, @michaelweghorn)
* Cuando un script que utiliza `gesture.send` se activa con un gesto que incluye `numLock` como modificador, BloqNum ya no se desactiva. (#10827, @CyrilleB79)

#### Cambios de la API

Estos son cambios importantes en la API.
Por favor abre una incidencia en GitHub si tu complemento tiene algún problema con la actualización a la nueva API.

* Se ha eliminado la constante `addonStore.network.BASE_URL`.
Como la URL base de la Tienda de Complementos es ahora configurable directamente dentro de NVDA, no se planea reemplazarla. (#17099)
* Se ha eliminado la constante `updateCheck.CHECK_URL`.
Como la URL de comprobación de actualizaciones de NVDA es ahora configurable directamente dentro de NVDA, no se planea reemplazarla. (#17151)
* `NVDAObjects.UIA.winConsoleUIA.WinTerminalUIA` se ha eliminado sin un reemplazo público. (#14047, #16820, @codeofdusk)
* `NVDAObjects.IAccessible.ia2TextMozilla.FakeEmbeddingTextInfo` se ha eliminado. (#16768, @jcsteh)
* Se ha cambiado el nombre de los siguientes símbolos en `appModules.soffice` (#6915, @michaelweghorn):
...
* El argumento de la palabra clave `space` para `brailleDisplayDrivers.seikantk.InputGesture` ahora espera un `int` en lugar de un `bool`. (#17047, @school510587)
* Se ha eliminado la sección de configuración `[upgrade]` que incluía `[upgrade][newLaptopKeyboardLayout]`. (#17191)
* `updateCheck.checkForUpdate` devuelve ahora un objeto `UpdateInfo` en lugar de un diccionario. (#17310, @christopherpross)
* Se han actualizado los constructores de `updateCheck.UpdateResultDialog` y `updateCheck.UpdateDownloader` para que tomen objetos `UpdateInfo` en lugar de diccionarios de metadatos. (#17310, @christopherpross)
* Debido a la retirada del soporte winmm de NVDA (#17496, #17532, #17678):
  * Se han eliminado los siguientes símbolos de `nvwave` sin sustituirlos: `CALLBACK_EVENT`, `CALLBACK_FUNCTION`, `CALLBACK_NULL`, `HWAVEOUT`, `LPHWAVEOUT`, `LPWAVEFORMATEX`, `LPWAVEHDR`, `MAXPNAMELEN`, `MMSYSERR_NOERROR`, `usingWasapiWavePlayer`, `WAVEHDR`, `WAVEOUTCAPS`, `waveOutProc`, `WAVE_MAPPER`, `WHDR_DONE`, `WinmmWavePlayer`, y `winmm`.
  * Se han eliminado los siguientes símbolos de `nvwave`: `getOutputDeviceNames`, `outputDeviceIDToName`, `outputDeviceNameToID`.
  Utiliza `utils.mmdevice.getOutputDevices` en su lugar.
  * `nvwave.WasapiWavePlayer` se ha renombrado a `WavePlayer`.
  Además, la cabecera de su método `__init__` ha cambiado como sigue:
    * El parámetro `outputDevice` ahora sólo debería recibir argumentos de cadena.
    * Se han eliminado los parámetros obsoletos `closeWhenIdle` y `buffered`.
  * `gui.settingsDialogs.AdvancedPanelControls.wasapiComboBox` se ha eliminado.
  * La clave `WASAPI` se ha eliminado de la sección `audio` de la configuración.
  * Se ha eliminado la clave de configuración `config.conf[«speech»][«outputDevice»]`.
    Se ha sustituido por `config.conf[«audio»][«outputDevice»]`, que almacena un ID de dispositivo de punto final de audio del núcleo de Windows. (#17547)
* En `NVDAObjects.window.scintilla.ScintillaTextInfo`, si no hay texto seleccionado, el método `collapse` se anula para expandirse a la línea si el parámetro `end` se establece en `True` (#17431, @nvdaes)
* Se han eliminado los siguientes símbolos sin sustituirlos: `languageHandler.getLanguageCliArgs`, `__main__.quitGroup` y `__main__.installGroup` . (#17486, @CyrilleB79)
* Ya no se admite la coincidencia de prefijos en los indicadores de línea de órdenes, por ejemplo, el uso de `--di` para `--disable-addons`. (#11644, @CyrilleB79)
* La palabra clave `useAsFallBack` de `bdDetect.DriverRegistrar` ha sido renombrada a `useAsFallback`. (#17521, @LeonarddeR)
* Se ha eliminado la opción de configuración `[addonStore][showWarning]`.
En su lugar utiliza `addonStore.dataManager.addonDataManager.storeSettings.showWarning`. (#17597)
* `ui.browseableMessage` ahora toma un parámetro `sanitizeHtmlFunc`.
Por defecto es `nh3.clean` con argumentos predeterminados.
Esto significa que cualquier HTML pasado a `ui.browseableMessage` usando `isHtml=True` es ahora limpiado por defecto.
Para cambiar las reglas de limpieza, como la lista blanca de etiquetas o atributos, crea una función que llame a `nh3.clean` con los parámetros deseados. (#16985)
* `updateCheck.UpdateAskInstallDialog` ya no realiza automáticamente una acción cuando se pulsen los botones actualizar o posponer.
En su lugar, se ha añadido una propiedad `callback`, que devuelve una función que realiza la acción apropiada cuando se llame con el valor de retorno del diálogo. (#17582)
* Los diálogos abiertos con `gui.runScriptModalDialog` ahora son reconocidos como modales por NVDA. (#17582)
* Se han eliminado los siguientes símbolos API relacionados con la opción "Poner automáticamente el foco del sistema en los elementos enfocables" sin sustituirlos: (#17598)
...
* Porque las voces SAPI5 ahora usan `nvwave.WavePlayer` para emitir audio: (#17592, @gexgd0419)
  * `synthDrivers.sapi5.SPAudioState` se ha eliminado.
  * `synthDrivers.sapi5.SynthDriver.ttsAudioStream` se ha eliminado.
* Las instancias de `autoSettingsUtils.driverSetting.DriverSetting` con un `id` que comienza con un guión bajo (_) ya no se muestran en la configuración de NVDA. (#17599)
* Cambiada la configuración del eco de escritura del teclado de valores booleanos a enteros. (#17505, @Cary-rowen)
  * `config.conf[«keyboard»][«speakTypedCharacters»]` y `config.conf[“keyboard”][«speakTypedWords»]` utilizan ahora valores enteros.
  * Añadido el enum `TypingEcho` en `config.configFlags` para representar estos modos, 0=Off, 1=Only in edit controls, 2=Always.
  * `gui.settingsDialogs.KeyboardSettingsPanel.wordsCheckBox` y `gui.settingsDialogs.KeyboardSettingsPanel.charsCheckBox` se han eliminado.
* Se ha eliminado `gui.settingsDialogs.KeyboardSettingsPanel.wordsCheckBox` y `gui.settingsDialogs.KeyboardSettingsPanel.charsCheckBox`. Se ha cambiado el nombre de `winUser.paint` de `painStruct` a `paintStruct`, corrigiendo un error por el que al pasar un `PAINTSTRUCT` se producía una excepción. (#17744)
* `documentationUtils.getDocFilePath` y `installer.getDocFilePath` ya no buscan los ficheros `.txt` en carpetas de documentación local. (#17911, @CyrilleB79)
...
* El punto de extensión `braille.filter_displaySize` está obsoleto.
Por favor utiliza `braille.filter_displayDimensions` en su lugar. (#17011)
* Las funciones `gui.message.messageBox` y `gui.runScriptModalDialog`, y la clase `gui.nvdaControls.MessageDialog` están obsoletas.
Utiliza `gui.message.MessageDialog` en su lugar. (#17582)
* Los siguientes símbolos están obsoletos (#17486, @CyrilleB79):
  * `NoConsoleOptionParser`, `stringToBool`, `stringToLang` en `__main__`; utiliza los mismos símbolos en `argsParsing` en su lugar.
  * `__main__.parser`; utiliza `argsParsing.getParser()` en su lugar.
* `bdDetect.DeviceType` queda obsoleto en favor de `bdDetect.ProtocolType` y `bdDetect.CommunicationType` para tener en cuenta el hecho de que tanto la comunicación HID como la Serial pueden tener lugar a través de USB y Bluetooth. (#17537 , @LeonarddeR)

## 2024.4.2

Esta versión es un parche que corrige fallos con las pantallas braille y la lectura de matemáticas en Chromium.

### Corrección de fallos

* Se corrige un fallo con la lectura de matemáticas en navegadores Chromium  (Chrome, Edge). (#17421, @NSoiffer)
* Ahora, los dispositivos Humanware Brailliant BI 40X que ejecutan el firmware 2.4 funcionan como se espera. (#17518, @bramd)

## 2024.4.1

Esta versión es un parche que corrige un fallo al guardar diccionarios de pronunciación de símbolos.

### Corrección de fallos

* Se corrige un fallo por el que no se guardaban los diccionarios de pronunciación de símbolos y el diálogo no se cerraba. (#17344)
...
* Se corrige la lectura de atributos matemáticos en Adobe Reader, que daba como resultado un habla o braille incorrectos y pobres. (#17980)
* Correcciones para Windows 11:
...
* Se han añadido nuevas órdenes de navegación por tablas. (#957)
  * `control+alt+home/end` para saltar a la primera/última columna.
  * `control+alt+páginaArriba/páginaAbajo` para saltar a la primera/última fila.
...
* Para Microsoft Office 16.0.15000 y superiores en Windows 11, NVDA utilizará UI Automation para acceder a documentos de Microsoft Word por defecto, proporcionando una significativa mejora de rendimiento sobre el acceso al antiguo modelo de objetos. (#13437)
  * Esto incluye los documentos del propio Microsoft Word y también el lector y compositor de mensajes de Microsoft Outlook.
...
* Esta versión rompe la compatibilidad con los complementos existentes.
* Esta versión también elimina la compatibilidad con Adobe Flash.
...
* El sistema de compilación de NVDA ahora obtiene todas las dependencias de Python con pip y las almacena en un entorno virtual de Python. Todo esto se hace de forma transparente.
  ...
  * Para realizar pruebas unitarias, ejecuta `rununittests.bat [<extra unittest discover options>]`
...
* Actualizado el transcriptor braille liblouis a la versión 3.16.1:
  ...
  * Se añade la tabla braille Bashkir de grado 1
  * Se añade la tabla braille computerizada Coptic de 8 puntos
  * Se añaden tablas en braille literario ruso y braille literario ruso (detallado)
  * Se añade la tabla braille de grado 2 Afrikaans
...
* La existentcia de contenido marcado (resaltado) se informa tanto en voz como en braille en todos los navegadores web. (#11436)
  * Esto puede activarse y desactivarse mediante una nueva opción de Formato de documento de NVDA para subrayar.
...
* Los objetos específicos de NVDA que se encuentran por el recolector de basura cíclica de Python ahora se registran cuando se borran por el recolector para ayudar en la eliminación de los ciclos de referencia de NVDA. (#11499)
  * La mayoría de las clases de NVDA son rastreadas incluyendo NVDAObjects, appModules, GlobalPlugins, SynthDrivers, y TreeInterceptors.
  * Una clase que necesite ser rastreada debe heredar de garbageHandler.TrackedObject.
...
* En Internet Explorer, Google Chrome y Mozilla Firefox, ahora puedes navegar por artículos y grupos utilizando los scripts de navegación rápida. Estos scripts no están vinculados por omisión y pueden asignarse en el diálogo Gestos de Entrada cuando el diálogo se abra desde un documento en modo exploración. (#9227)
  * También se anuncian las figuras. Se consideran objetos y, por tanto, navegables con la tecla de navegación rápida o.
...
* Se añadió una Cortina de Pantalla que, al activarse, hace que toda la pantalla se vuelva negra en Windows 8 y posteriores. (#7857)
  * Añadido un script para habilitar la cortina de pantalla (hasta el próximo reinicio con una pulsación, o siempre mientras NVDA esté funcionando con dos pulsaciones), no se asigna ningún gesto por defecto.
  * Puede activarse y configurarse a través de la categoría "visión" del cuadro de diálogo de opciones de NVDA.
* Añadida la funcionalidad Resaltado de pantalla a NVDA. (#971, #9064)
  * Se puede activar y configurar el resaltado del foco, ddel navegador de objetos y de la posición del cursor en el modo exploración a través de la categoría "«visión" del cuadro de diálogo de opciones de NVDA.
  * Nota: Esta característica es incompatible con el complemento de resaltado de foco; sin embargo, el complemento puede seguir utilizándose mientras el resaltado incorporado esté desactivado.
...
* Como NVDA ya no depende de pyWin32, módulos tales como win32api y win32con ya no están disponibles para los complementos. (#9639)
  * las llamadas a win32api pueden sustituirse por llamadas directas a funciones win32 dll a través de ctypes.
  * las constantes win32con deben definirse en sus archivos.
...
* los métodos speakText y speakCharacter en objetos synthDriver ya no se admiten.
  * Esta funcionalidad es manejada por SynthDriver.speak.
...
* Las clases SynthDriver ya no deberían exponer índices a través de la propiedad lastIndex.
  * En su lugar, deben notificar la acción synthDriverHandler.synthIndexReached con el índice, una vez que todo el audio anterior haya terminado de reproducirse antes de ese índice.
...
* Añadido un módulo textUtils para simplificar las diferencias de cadena entre las cadenas de Python 3 y las cadenas de Windows unicode. (#9545)
  * Consulta la documentación del módulo y el módulo textInfos.offsets para ver ejemplos de implementación.
* Ahora se ha eliminado funcionalidad obsoleta. (#9548)
  * AppModules eliminados:
    * Windows XP sound recorder.
    * Klango Player, que es un software abandonado.
  * configobj.validate wrapper removed.
    * El nuevo código debería usar from configobj import validate en lugar de import validate
  * textInfos.Point y textInfos.Rect sustituidos por locationHelper.Point y locationHelper.RectLTRB respectivamente.
  * braille.BrailleHandler._get_tether y braille.BrailleHandler.set_tether se han eliminado.
  * config.getConfigDirs ha sido eliminado.
  * config.ConfigManager.getConfigValidationParameter ha sido reemplazado por getConfigValidation
  * inputCore.InputGesture.logIdentifier property ha sido eliminado.
    * Utiliza _get_identifiers en inputCore.InputGesture en su lugar.
  * synthDriverHandler.SynthDriver.speakText/speakCharacter han sido eliminados.
  * Eliminadas varias clases synthDriverHandler.SynthSetting.
    * Antes se mantenía por compatibilidad con versiones anteriores (#8214), ahora se considera obsoleto.
    * Ls controladores que utilizaban las clases SynthSetting deben actualizarse para usar las clases DriverSetting.
  * En particular, se ha eliminado parte del código heredado:
    * Compatibilidad con la lista de mensajes de Outlook anterior a 2003.
    * Una clase de superposición para el menú de inicio clásico, que sólo se encuentra en Windows Vista y versiones anteriores.
    * Se ha retirado la compatibilidad con Skype 7, ya que definitivamente ha dejado de funcionar.
* Un framework que permite a los desarrolladores crear proveedores de mejoras visuales; módulos que pueden cambiar el contenido de la pantalla, opcionalmente basados en la entrada de NVDA acerca de localizaciones de los objetos. (#9064)
  * Los complementos pueden agrupar sus propios proveedores en una carpeta visionEnhancementProviders.
  * Véanse los módulos vision y visionEnhancementProviders para la implementación del marco y ejemplos, respectivamente.
  * Los proveedores de mejora de la visión se activan y configuran a través de la categoría "visión" del cuadro de diálogo de las opciones de NVDA.
...
* Se introdujo displayModel.UNIT_DISPLAYCHUNK como una constante de unidad textInfos específica para DisplayModelTextInfo. (#10165)
  * Esta nueva constante permite recorrer el texto de un DisplayModelTextInfo de una forma más parecida a como se guardan los trozos de texto en el modelo subyacente.
...
* Los módulos externos (appModules y globalPlugins) ahora es menos probable que puedan romper la creación de NVDAObjects.
  * Las excepciones causadas por los métodos "chooseNVDAObjectOverlayClasses" y "event_NVDAObject_init" ahora se capturan y registran correctamente.
...
* Ahora puedes desactivar el modo exploración de forma predeterminada desactivando la nueva opción "Activar el modo exploración al cargar la página" en la configuración del modo exploración de NVDA. (#8716)
  * Ten en cuenta que cuando esta opción está desactivada, aún puedes activar el modo exploración manualmente pulsando NVDA+espacio.
...
* Los perfiles de configuración ahora se pueden activar manualmente con gestos. (#4209)
  * El gesto debe configurarse en el cuadro de diálogo «Gestos de entrada».
...
* Se agregó una opción experimental al panel de Configuración Avanzada que te permite detener el foco del sistema para que no siga al cursor del modo exploración (Poner automáticamente el foco del sistema en los elementos enfocables). (#2039) Aunque puede no ser adecuado desactivar esto en todos los sitios web, ello podría arreglar:
  * Efecto goma elástica: NVDA deshace esporádicamente la última pulsación del modo navegación saltando a la ubicación anterior.
  * En algunos sitios web, los cuadros de edición roban el foco del sistema al desplazarse por ellos.
  * Las pulsaciones de las teclas del modo exploración responden con lentitud.
...
* El resultado de la última orden ejecutada en la consola Python de NVDA ahora es accesible desde la variable _ (line). (#9782)
  * Ten en cuenta que esto ensombrece la función de traducción gettext también llamada «_». Para acceder a la función de traducción: del _
...
* Añadida una opción a las opciones de ratón de NVDA para hacer que NVDA maneje situaciones en las que el ratón esté controlado por otra aplicación. (#8452)
  * Esto permitirá a NVDA rastrear el ratón cuando un sistema es controlado remotamente usando TeamViewer u otro software de control remoto.
...
* En Mozilla Firefox y Google Chrome, el modo exploración ahora anuncia el elemento seleccionado en cuadros de lista y en árboles.
  * Esto funciona en Firefox 66 y posteriores.
  * Esto no funciona para ciertos cuadros de lista (controles de selección HTML) en Chrome.
...
* NVDA ya no carga automáticamente appModules, globalPlugins y controladores braille y de sintetizador desde el directorio de configuración de usuario de NVDA. Este código debería ser empaquetado en su lugar como un complemento con información correcta de versión, asegurándose de que el código incompatible no sea ejecutado con las versiones actuales de NVDA. (#9238)
  * Para los desarrolladores que necesiten probar el código mientras se está desarrollando, se activa el directorio “scratchpad” para desarrolladores de NVDA en la categoría Avanzado de las opciones de NVDA, y se coloca el código en el directorio “scratchpad” que se encuentra en el directorio de configuración de usuario de NVDA cuando esta opción esté activada.
...
* Los autores de complementos ahora pueden proporcionar información sobre la compatibilidad de las versiones de NVDA en los manifests de los complementos. (#6275, #9055)
  * minimumNVDAVersion: la versión mínima requerida de NVDA para que un complemento funcione correctamente.
  * lastTestedNVDAVersion: La última versión de NVDA con la que se ha probado un complemento.
...
* gui.nvdaControls ahora contiene dos clases para crear listas accesibles con casillas de verificación. (#7325)
  * CustomCheckListBox es una subclase accesible de wx.CheckListBox.
  * AutoWidthColumnCheckListCtrl añade casillas de verificación accesibles a una AutoWidthColumnListCtrl, que a su vez está basada en wx.ListCtrl.
...
* Se ha añadido el soporte para la detección automática de pantallas braille en segundo plano. (#1271)
  * Las pantallas ALVA, Baum/HumanWare/APH/Orbit, Eurobraille, Handy Tech, Hims, SuperBraille y HumanWare BrailleNote y Brailliant BI/B están actualmente admitidas.
  * Puedes activar esta función seleccionando la opción automática en la lista de pantallas braille del cuadro de diálogo de selección de pantallas braille de NVDA.
  * Por favor consulta la documentación para obtener más información.
...
* Varias mejoras al soporte braille en Microsoft Word con UI Automation habilitado:
  * Al igual que en otros campos de texto multilínea, cuando se sitúa al principio de un documento en Braille, la pantalla se desplaza de forma que el primer carácter del documento se encuentra al principio de la pantalla. (#8406)
  * Se ha reducido la presentación excesivamente verbosa del foco tanto en voz alta como en braille al enfocar un documento de Word. (#8407)
  * El enrutamiento del cursor en braille ahora funciona correctamente cuando se encuentra en una lista en un documento de Word. (#7971)
  * Las viñetas/números recién insertados en un documento Word se muestran correctamente tanto en voz alta como en braille. (#7970)
...
* Se han realizado algunos cambios en el módulo hwPortUtils: (#1271)
  * listUsbDevices produce ahora diccionarios con información sobre los dispositivos, incluidos hardwareID y devicePath.
...
* Ahora puedes registrar para que se te notifique acerca de acciones de guardar/reiniciar la configuración a través de las nuevas acciones config.pre_configSave, config.post_configSave, config.pre_configReset, y config.post_configReset. (#7598)
  * config.pre_configSave se utiliza para ser notificado cuando la configuración de NVDA está a punto de ser guardada, y config.post_configSave se llama después de que la configuración haya sido guardada.
  * config.pre_configReset y config.post_configReset incluyen un indicador de valores predeterminados de fábrica para especificar si las opciones se vuelven a cargar desde el disco (false) o se restablecen a los valores predeterminados (true).
...
* Ahora puedes conmutar control, shift, alt, windows y NVDA desde tu teclado braille y combinar estos modificadores con la entrada braille (ej.: pulsar control+s). (#7306)
  * Puedes asignar estos nuevos modificadores mediante las órdenes que encontrarás en Teclas emuladas del teclado del sistema en el cuadro de diálogo Gestos de entrada.
...
* Ahora es posible interactuar con gráficos en Microsoft Word y Microsoft PowerPoint, similar al soporte existente para gráficos en Microsoft Excel. (#7046)
  * En Microsoft Word:  En el modo exploración, sitúa el cursor sobre un gráfico inegrado y pulsa Intro para interactuar con él.
  * En Microsoft PowerPoint, cuando edites una diapositiva: ve a un objeto gráfico y pulsa Intro o Espacio para interactuar con el gráfico.
  * Para dejar de interactuar con un gráfico, pulsa escape.
* Nuevo idioma: Kyrgyz.
...
* Ahora es posible utilizar la entrada braille con una pantalla braille ALVA 640 Comfort. (#7733)
  * La funcionalidad de entrada braille de NVDA se puede utilizar con estas y otras pantallas BC6 con firmware 3.0.0 y superior.
...
* Se han reemplazado los controladores de pantallas braille HIMS Braille Sense/Braille EDGE/Smart Beetle y Hims Sync por un único controlador. El nuevo controlador se activará automáticamente para los antiguos usuarios del controlador syncBraille. (#7459)
  * Algunas teclas, especialmente las de desplazamiento, han sido reasignadas para seguir las convenciones utilizadas por los productos Hims. Consulta la guía del usuario para más detalles.
* Al escribir con el teclado en pantalla a través de la interacción táctil, por omisión ahora debes hacer doble tap en cada tecla del mismo modo en que activarías cualquier otro control. (#7309)
  * Para utilizar el modo existente de "escritura táctil", en el que basta con levantar el dedo de la tecla para activarla, activa esta opción en el nuevo cuadro de diálogo de opciones de Interacción táctil que encontrarás en el menú Preferencias.
* Ya no es necesario que el braille siga explícitamente al foco o a la revisión, ya que esto ocurrirá automáticamente por omisión. (#2385)
  * Ten en cuenta que el seguimiento automático a la revisión sólo se producirá cuando se utilice un cursor de revisión o una orden de navegación por objetos. El desplazamiento no activará este nuevo comportamiento.
...
* Añadida una bandera booleana oculta a la sección braille en la configuración: "outputPass1Only". (#7301, #7693, #7702)
  * El valor predeterminado de esta opción es «true». Si es false, se utilizarán las reglas multipase de liblouis para la salida braille.
...
* Los gestos de pantalla braille que emulan teclas modificadoras del teclado del sistema (tales como control y alt) ahora pueden conbinarse con otras teclas emuladas del teclado del sistema sin definición explícita. (#6213)
  * Por ejemplo, si tienes una tecla de la pantalla asociada a la tecla alt y otra tecla de la pantalla asociada a Flecha abajo, la combinación de estas teclas dará como resultado la emulación de alt+Flecha abajo.
* La clase braille.BrailleDisplayGesture ahora tiene una propiedad de modelo extra. Si se proporciona, pulsando una tecla generará una adicional, texto específico de identificador de modelo, esto permite a un usuario vincular gestos limitados a un modelo de pantalla braille específico.
  * Véase el controlador baum como ejemplo de esta nueva funcionalidad.
...
* NVDA ahora puede utilizar la funcionalidad OCR incluida en Windows 10 para reconocer el texto de imágenes o de aplicaciones inaccesibles. (#7361)
  * El idioma se puede configurar desde el nuevo cuadro de diálogo OCR de Windows 10 en las Preferencias de NVDA.
  * Para reconocer el contenido del objeto actual del navegador, pulsa NVDA+r.
  * Para más información, consulte la sección Reconocimiento de contenidos de la Guía del usuario.
* Ahora puedes elegir qué información de contexto se muestra en una pantalla braille cuando un objeto tiene el foco utilizando la nueva opción "Presentación de contexto del foco" en el diálogo Opciones de Braille. (#217)
  * Por ejemplo, las opciones "Rellenar pantalla para cambios de contexto" y "Sólo al retroceder" pueden hacer más eficaz el trabajo con listas y menús, ya que los elementos no cambiarán continuamente de posición en la pantalla.
  * Para más detalles y ejemplos, consulta la sección "Presentación de contexto del foco" de la Guía del usuario.
...
* Por omisión, NVDA ahora sólo muestra las partes de la información de contexto que haya cambiado en una pantalla braille cuando se enfoque un objeto. (#217)
  * Anteriormente, siempre mostraba toda la información de contexto posible, independientemente de si habías visto la misma información de contexto antes.
  * Puedes volver al comportamiento anterior cambiando la nueva opción "Presentación de contexto del foco" del cuadro de diálogo Opciones de Braille a "Rellenar siempre la presentación".
...
* NVDA ahora debe compilarse con Visual Studio Community 2015. Visual Studio Express ya no se soporta. (#7110)
  * Ahora también se requieren las herramientas y el SDK de Windows 10, que pueden activarse al instalar Visual Studio.
  * Consulta la sección Dependencias instaladas del archivo readme para obtener más información.
...
* La propiedad InputGesture.identifiers se ha cambiado tal que ya no se normaliza. (#6945)
  * Las subclases ya no necesitan normalizar los identificadores antes de devolverlos desde esta propiedad.
  * Si deseas identificadores normalizados, ahora hay una propiedad InputGesture.normalizedIdentifiers que normaliza los identificadores devueltos por la propiedad identifiers .
...
* Se eliminó algún código obsoleto:
  * `speech.REASON_*` constantes: `controlTypes.REASON_*` debería utilizarse en su lugar. (#6846)
  * `i18nName` para la configuración del sintetizador: `displayName` y `displayNameWithAccelerator` deberían utilizarse en su lugar. (#6846, #5185)
  * `config.validateConfig`. (#6846, #667)
  * `config.save`: `config.conf.save` debería utilizarse en su lugar. (#6846, #667)
...
* Ahora hay una unidad de prueba del framework para NVDA. (#7026)
  * Las pruebas unitarias y la infraestructura se encuentran en el directorio tests/unit. Consulta el docstring en el archivo tests\unit\init.py para más detalles.
  * Puedes ejecutar pruebas utilizando "scons tests". Consulta la sección "Ejecutar pruebas" de readme.md para más detalles.
  * Si estás enviando un pull request para NVDA, primero debes ejecutar las pruebas y asegurarte de que pasan.
...
* el constructor del nvwave.WavePlayer ahora tiene la palabra clave wantDucking como argumento que especifica si el audio de fondo debería atenuarse mientras se reproduce audio. (#3830)
  * Cuando esto está activado (que es el valor predeterminado), es esencial que se llame a WavePlayer.idle cuando sea apropiado.
* Mejorada la Entrada/salida para pantallas braille: (#5609)
  * Los controladores de pantalla braille seguros pueden declararse como tales utilizando el atributo BrailleDisplayDriver.isThreadSafe. Un controlador debe ser thread-safe para beneficiarse de las siguientes características.
  * Los datos se escriben en segundo plano en controladores de pantalla braille a prueba de hilos, lo que mejora el rendimiento.
  * hwIo.Serial extiende pyserial para llamar a un callable cuando se reciben datos en lugar de que los drivers tengan que hacer un poll.
  * hwIo.Hid proporciona soporte para pantallas braille que se comunican a través de USB HID.
  * hwPortUtils y hwIo pueden proporcionar opcionalmente un registro de depuración detallado, incluyendo los dispositivos encontrados y todos los datos enviados y recibidos.
* Hay varias propiedades nuevas accesibles de los gestos de la pantalla táctil: (#5652)
  * Los objetos MultitouchTracker contienen ahora una propiedad childTrackers que contiene los MultiTouchTrackers que componen el tracker. Por ejemplo, un doble toque de 2 dedos tiene seguidores hijos para dos toques de 2 dedos. Los propios toques con dos dedos tienen seguidores hijos para dos toques.
  * Los objetos MultiTouchTracker ahora también contienen una propiedad RawSingleTouchTracker si el rastreador fue el resultado de un solo dedo haciendo un tap, flick o hover. La propiedad SingleTouchTracker permite acceder al ID subyacente asignado al dedo por el sistema operativo y saber si el dedo sigue o no en contacto en el momento actual.
  * TouchInputGestures ahora tienen propiedades x e y, eliminando la necesidad de acceder al rastreador para casos triviales.
  * Los TouchInputGesturs ahora contienen una propiedad preheldTracker, que es un objeto MultitouchTracker que representa los otros dedos sostenidos mientras se realizaba esta acción.
* Se pueden dar dos nuevos gestos de pantalla táctil: (#5652)
  * Pulsar y mantener en plural (por ejemplo, pulsar dos veces y mantener)
  * Un identificador generalizado con el recuento de dedos eliminado para las retenciones (por ejemplo, retención+retención para 1dedo_retención+retención).
...
* Apoyo para edición o texto enriquecido en Google Chrome y navegadores basados en Chrome tales como Google Docs con el apoyo braille habilitado. (#2634)
  * Esto requiere Chrome versión 47 o posterior.
...
* En Windows 8 y posterior, NVDA ahora arranca mucho más rápido cuando se configuró para iniciarse después de autentificarse en Windows. (#308)
  * Si activaste esta opción con una versión anterior de NVDA, tendrás que desactivarla y activarla de nuevo para que el cambio surta efecto. Sigue este procedimiento:
    1. Abre el cuadro de diálogo opciones generales.
    1. Desmarca la casilla Iniciar automáticamente NVDA después de iniciar sesión en Windows.
    1. Pulsa el botón Aceptar.
    1. Abre el diálogo Opciones Generales de nuevo.
    1. Marca la casilla Iniciar automáticamente NVDA después de iniciar sesión en Windows.
    1. Pulsa el botón Aceptar.
...
* En lugar de un sólo atributo i18nName, synthDriverHandler.SynthSetting ahora tiene los atributos  displayNameWithAccelerator y displayName separados para evitar el anuncio del acelerador en el grupo de opciones del sintetizador en algunos idiomas.
  * Por razones de compatibilidad con versiones anteriores, en el constructor, displayName es opcional y se derivará de displayNameWithAccelerator si no se proporciona. Sin embargo, si tienes la intención de tener un acelerador para una opción, ambos deben proporcionarse.
  * El atributo i18nName está obsoleto y puede que se elimine en una futura versión.
...
* Se han implementado órdenes de voz para insertar una ruptura entre palabras y para cambiar el tono, volumen y velocidad. Mira BreakCommand, PitchCommand, VolumeCommand y RateCommand en el módulo speech. (#4674)
  * También existe speech.PhonemeCommand para insertar una pronunciación específica, pero las implementaciones actuales sólo admiten un número muy limitado de fonemas.
...
* Los encabezados de columna de tabla en Microsoft word se anuncian automáticamente para tablas donde se haya especificado un encabezado de fila por el autor a través de las propiedades de tabla de Microsoft word. (#4510)
  * Sin embargo, para las tablas en las que se han fusionado filas, esto no funcionará automáticamente. En este caso, puedes configurar los encabezados de columna manualmente en NVDA con NVDA+shift+c.
...
* Ahora es posible reiniciar NVDA o reiniciar NVDA con los complementos deshabilitados desde el diálogo salir de NVDA. (#4057)
  * NVDA también puede iniciarse con los complementos desactivados utilizando la opción de línea de órdenes --disable-addons.
...
* Para ejecutables que albergan muchas aplicaciones diferentes (ej.: javaw.exe), ahora el código puede proporcionarse para que cargue app modules específicos para cada aplicación en lugar de cargar el mismo app module para todas las aplicaciones incluídas. (#4360)
  * Consulta la documentación de código de appModuleHandler.AppModule para obtener más detalles.
  * Se ha implementado la compatibilidad con javaw.exe.
...
* Soporte para el Calendario en Microsoft Outlook 2007 y superior (#2943) incluyendo:
  * Anuncio de la hora actual al desplazarse con las flechas.
  * Indicación de si la hora seleccionada está dentro de alguna cita.
  * anuncio de la cita seleccionada al pulsar tabulador.
  * Filtrado inteligente de la fecha para que sólo se anuncie la fecha si la nueva hora o cita seleccionada es en un día distinto al anterior.
* Mejorado el soporte para la bandeja de entrada y otras listas de mensajes en Outlook 2010 y posterior (#3834) incluyendo:
  * La posibilidad de silenciar los encabezados de columna (de, asunto, etc.) desactivando la opción Anunciar Encabezados de fila y columna de la tabla en las opciones de Formato de documento.
  * Posibilidad de utilizar órdenes de navegación por la tabla (control + alt + flechas) para desplazarse por las distintas columnas.
...
* Mejorado el soporte para la lectura automática de encabezados de fila y columna en Microsoft Excel (#3568) incluyendo:
  * Soporte de rangos de nombres definidos en Excel para identificar las celdas de cabecera (compatible con el lector de pantalla Jaws).
  * Las órdenes establecer encabezado de columna (NVDA+shift+c) y establecer encabezado de fila (NVDA+shift+r) ahora almacenan la configuración en la hoja de trabajo para que esté disponible la próxima vez que se abra la hoja, y estará disponible para otros lectores de pantalla que admitan el esquema de rango de nombres definido.
  * Estas órdenes también pueden utilizarse ahora varias veces por hoja para establecer diferentes cabeceras para distintas regiones.
...
* Microsoft Excel: información en voz y en braille  para muchos más atajos de teclado para movimientos de selección (#4211) incluyendo:
  * Movimiento vertical de la página (rePág e avPág);
  * Movimiento horizontal de la página (alt+rePág y alt+avpág);
  * Ampliar selección (las teclas anteriores con Shift añadida; y
  * Seleccionar región actual (control+shift+8.
...
* Microsoft Powerpoint: cuando se mueven las formas de una diapositiva con las teclas de flecha, ahora se anuncia la ubicación actual de la forma (#4214) incluyendo:
  * Se anuncia la distancia entre la forma y cada uno de los márgenes de la diapositiva.
  * Si la figura cubre o es cubierta por otra figura, se anuncia la distancia solapada y de la figura solapada.
  * Para anunciar esta información en cualquier momento sin mover una figura, pulsa la orden anunciar localización (NVDA+suprimir).
  * Al seleccionar una figura, si está cubierta por otra figura, NVDA anunciará que está oscurecida.
* La orden anunciar localización (NVDA+suprimir) es más específica al contexto en algunas situaciones. (#4219):
  * En los campos de edición estándar y en el modo exploración, se anuncia la posición del cursor en porcentaje a través del contenido y de sus coordenadas de pantalla.
  * En las figuras de las presentaciones de PowerPoint, se anuncia la posición de la figura en relación con la diapositiva y otras figuras.
  * Si pulsas esta orden dos veces, se producirá el comportamiento anterior de anunciar la información de localización de todo el control.
...
* Ahora es posible cambiar la tecla de atajo utilizada para iniciar NVDA en traducciones donde el atajo normal causa problemas. (#2209)
  ...
  * Ten en cuenta que el texto de la opción Crear acceso directo en el escritorio del cuadro de diálogo Instalar NVDA, así como la tecla de acceso directo de la Guía del usuario, también deben actualizarse.
...
* Mejorado el soporte  para  regiones ARIA live en Firefox y otras aplicaciones Gecko de Mozilla:
  ...
  * El texto alternativo (como el atributo alt o aria-label) se incluye si no hay otro texto útil. (#3329)
  * Las actualizaciones de regiones vivas ya no se silencian si se producen al mismo tiempo que se mueve el foco. (#3777)
...
* Varias correcciones al soporte para aplicaciones Java accesibles:
  * El control enfocado inicialmente en un marco o diálogo ya no deja de ser anunciado cuando el marco o diálogo pasa a primer plano. (#3753)
  * La información de posición inútil ya no se anuncia para los botones de opción (por ejemplo, 1 de 1). (#3754)
  * Mejor información de los controles JComboBox (ya no se anuncia del html, se anuncian mejor los estados expandido y contraído). (#3755)
  * Al anunciar el texto de los diálogos, ahora se incluye parte del texto que antes faltaba. (#3757)
  * Los cambios en el nombre, el valor o la descripción del control enfocado se notifican ahora con mayor precisión. (#3770)
...
* En la consola de Python, ahora puedes pulsar  la tecla tab para completar el identificador actual. (#433)
  * Si hay varias posibilidades, puedes pulsar tabulador una segunda vez para elegir de una lista.
...
* La revisión plana ha sido reemplazada por los modos de revisión de objetos, documentos y pantalla. (#2996)
  * La revisión de objetos revisa el texto sólo dentro del navegador de objetos, la revisión de documentos revisa todo el texto de un documento en modo exploración (si lo hay) y la revisión de pantalla revisa el texto de la pantalla para la aplicación actual.
  * Las órdenes que antes se movían a/desde la revisión plana ahora alternan entre estos nuevos modos de revisión.
  * El navegador de objetos sigue automáticamente al cursor de revisión, de modo que siga siendo el objeto más profundo en la posición del cursor de revisión cuando se está en los modos de revisión de documentos o de pantalla.
  * Después de cambiar al modo de revisión de pantalla, NVDA permanecerá en este modo hasta que cambies explícitamente de nuevo al modo de revisión de documentos u objetos.
  * Cuando estés en el modo de revisión de documentos u objetos, NVDA puede cambiar automáticamente entre estos dos modos dependiendo de si te estás moviendo por un documento en modo exploración o no.
...
* La inclusión del módulo bisect en compilaciones binarias está en desuso y podrá eliminarse en una versión futura. (#3368)
  * Los complementos que dependen de bisect (incluido el módulo urllib2) deben actualizarse para incluir este módulo.
...
* Los controladores de pantalla braille ahora pueden soportar la selección manual de puertos. (#426)
  * Esto es muy útil para las pantallas braille que admiten la conexión a través de un puerto serie heredado.
  * Para ello se utiliza el método getPossiblePorts de la clase BrailleDisplayDriver.
* Ahora se soporta la entrada braille  desde teclados braille. (#808)
  * La entrada braille se engloba en la clase brailleInput.BrailleInputGesture o en una subclase de la misma.
  * Las subclases de braille.BrailleDisplayGesture (como se implementan en los controladores de pantalla braille) también pueden heredar de brailleInput.BrailleInputGesture. Esto permite que las órdenes de pantalla y la entrada braille sean manejados por la misma clase de gesto.
...
* NVDA ahora puede soportar entrada de caracteres asiáticos utilizando IME y métodos de servicio de entrada de texto en todas las aplicaciones, incluyendo:
  * Anunciado y navegación por las listas de candidatos;
  * Anunciado y navegación por las cadenas de composición; y
  * Anunciado de cadenas de lectura.
...
* Soporte experimental para pantallas Táctiles en Windows 8, incluyendo:
  * Lectura de texto directamente bajo el dedo mientras lo mueves
  * Muchos gestos para realizar navegación por objetos, revisión de textos y otras órdenes de NVDA.
...
* En Adobe Reader, ahora pueden anunciarse los números de página. (#2534)
  * En Reader XI, las etiquetas de página se notifican cuando están presentes, reflejando los cambios en la numeración de páginas en diferentes secciones, etc. En versiones anteriores, esto no es posible y sólo se anuncia los números de página secuenciales.
...
* Ahora se soportan los mensajes contextuales de Gettext. Esto permite que sean definidas múltiples traducciones para un solo mensaje en Inglés dependiendo del contexto. (#1524)
  * Para ello se utiliza la función pgettext(context, message).
  * Esto es compatible tanto con el propio NVDA como con los complementos.
  * xgettext y msgfmt de GNU gettext deben usarse para crear cualquier fichero PO y MO. Las herramientas de Python no soportan contextos de mensajes.
  * Para xgettext, pasa el argumento de línea de órdenes --keyword=pgettext:1c,2 para habilitar la inclusión de contextos de mensaje.
...
* Ahora se  anuncia mucha más información en documentos de Microsoft Word, incluyendo:
  * Información en línea, como los números de las notas a pie de página y de las notas finales, los niveles de los títulos, la existencia de comentarios, los niveles de anidamiento de las tablas, los enlaces y el color del texto;
  * Anunciar cuando se introducen secciones de documento tales como los historiales de comentarios, notas al pie y notas finales, e historiales de cabeceras y pies de página.
...
* Los objetos TextInfo ahora tienen un método activate() para activar la posición representada por el TextInfo.
  * Se utiliza en braille para activar la posición mediante los sensores de enrutamiento del cursor en una pantalla braille. Sin embargo, puede haber otros llamantes en el futuro.
...
* Se han movido o cambiado los nombres de varios controles y constantes de salida. (#228)
  * las constantes speech.REASON_* se han trasladado a controlTypes.
  * En controlTypes, speechRoleLabels y speechStateLabels han pasado a llamarse roleLabels y stateLabels, respectivamente.
...
* NVDA ahora puede instruir a los sintetizadores de voz para cambiar los idiomas para secciones en particular de voz.
  ...
  * Los objetos SynthDriver también deben proporcionar el argumento language a los objetos VoiceInfo (o anular el atributo language para recuperar el idioma actual). De lo contrario, se utilizará el idioma de la interfaz de usuario de NVDA.
...
* Los controladores de síntesis ahora se pasan como una secuencia de texto y órdenes de voz a verbalizar, en lugar de sólo texto y un índice.
  ...
  * Los controladores deben implementar SynthDriver.speak() en lugar de SynthDriver.speakText() y SynthDriver.speakCharacter().
  * Los métodos antiguos se utilizarán si no se implementa SynthDriver.speak(), pero están obsoletos y se eliminarán en una futura versión.
* se ha eliminado gui.execute(). Debería utilizarse wx.CallAfter() en su lugar.
* ha sido eliminado gui.scriptUI .
  * Para los diálogos de mensajes, utiliza wx.CallAfter(gui.messageBox, ...).
  * Para todos los demás diálogos, se deben utilizar diálogos wx reales en su lugar.
  * Una nueva función gui.runScriptModalDialog() simplifica el uso de diálogos modales desde scripts.
...
* Ahora se pueden anunciar los colores para algunos controles. El anunciado automático se puede configurar en el diálogo de preferencias de formateado de documentos. También se pueden anunciar bajo demanda utilizando la orden de anunciado de formato de texto (NVDA+f).
  * Inicialmente, esto es compatible con los controles de texto editables IAccessible2 estándar (como en las aplicaciones Mozilla), los controles RichEdit (como en Wordpad) y los controles de texto IBM Lotus Symphony.
...
* Toda la salida del usuario ahora se representa por una instancia inputCore.InputGesture. (#601)
  * Cada fuente de entrada subclasea la clase base InputGesture.
  * Las pulsaciones de teclas en el teclado del sistema están englobadas en la clase keyboardHandler.KeyboardInputGesture.
  * Las pulsaciones de botones, ruedas y otros controles en una pantalla braille se engloban en subclases de la clase braille.BrailleDisplayGesture. Estas subclases las proporciona cada controlador de pantalla braille.
...
* Todos los scripts ahora toman una sentencia InputGesture en lugar de una pulsación de tecla.
  * Los KeyboardInputGestures pueden enviarse al sistema operativo mediante el método send() del gesto.
...
* Las localizaciones ahora podrán proporcionar un fichero de mapa de gesto de entrada para añadir nuevos vínculos o sobreescribir los vínculos existentes para los scripts en cualquier sitio de NVDA. (#810)
  * Los mapas gestuales de localización deben colocarse en locale\LANG\gestures.ini, donde LANG es el código de idioma.
  * Véase inputCore.GlobalGestureMap para más detalles sobre el formato del fichero.
* Los nuevos comportamientos LiveText y Terminal NVDAObject facilitan la notificación automática de nuevo texto. Ver esas clases en NVDAObjects.behaviors para más detalles. (#936)
  ...
  * Consulta los módulos de aplicación mirc y putty para ver ejemplos de uso.
...
* Se han mejorado los controladores de la pantalla Braille para permitir que los botones, las ruedas y otros controles se vinculen a los scripts de NVDA:
  ...
  * Consulta braille.BrailleDisplayDriver para obtener más detalles y los controladores de pantalla braille existentes para ver ejemplos.
...
* NVDA ahora puede recuperar la mayoría de texto escrito en la pantalla. (#40, #643)
  * Esto permite leer los controles que no exponen la información de forma más directa/ fiable.
  * Entre los controles accesibles mediante esta función se incluyen: algunos elementos de menú que muestran iconos (por ejemplo, el menú Abrir con en archivos en Windows XP) (#151), campos de texto editables en aplicaciones Windows Live (#200), la lista de errores en Outlook Express (#582), el control de texto editable en TextPad (#605), listas en Eudora, muchos controles en Australian E-tax y la barra de fórmulas en Microsoft Excel.
...
* Los encabezados de fila y columna ahora pueden anunciarse. Esto es configurable desde el diálogo de preferencias de formato de documento.
  * Actualmente, esto se admite en documentos de aplicaciones Mozilla como Firefox (versión 3.6.11 y posteriores) y Thunderbird (versión 3.1.5 y posteriores). (#361)
* Introducidas órdenes para la revisión plana: (#58)
  * NVDA+tecládo numérico7 cambia a revisión plana, colocando el cursor de revisión en la posición del objeto actual, permitiéndote revisar la pantalla (o un documento si está dentro de uno) con las órdenes de revisión de texto.
  * NVDA+teclado numérico1 mueve el cursor de revisión al objeto representado por el texto en la posición del cursor de revisión, permitiéndote navegar por objetos desde ese punto.
...
* NVDA tiene ahora un sintetizador incorporado llammado eSpeak, desarrollado por Jonathan Duddington. Es muy ágil y ligero, y tiene soporte para muchos idiomas diferentes. Los sintetizadores Sapi todavía pueden ser utilizados, pero eSpeak será utilizado predeterminadamente. eSpeak no depende de ningún software especial para ser instalado, así que puede ser utilizado con NVDA en cualquier ordenador, en un lápiz de memoria USB, o cualquier otro. Para más información sobre eSpeak, o para encontrar otras versiones, ve a https://espeak.sourceforge.net/.
  * eSpeak no depende de la instalación de ningún software especial, por lo que puede utilizarse con NVDA en cualquier ordenador, en una memoria USB o en cualquier lugar.
  * Para más información sobre eSpeak, o para encontrar otras versiones, visita http://espeak.sourceforge.net/.
...
* Añadidos argumentos de línea de órdenes a NVDA:
  * -m, --minimal: no reproduce sonidos de inicio/salida y no muestra la interfaz al inicio si está configurado para ello.
  * -q, --quit: abandona cualquier otra instancia de NVDA que ya se esté ejecutando y luego sale
  * -s, --stderr-file fileName: especifica dónde debe colocar NVDA los errores y excepciones no detectados
  * -d, --debug-file fileName: especifica dónde debe colocar NVDA los mensajes de depuración
  * -c, --config-file: especifica un fichero de configuración alternativo
  * -h, -help: muestra un mensaje de ayuda con los argumentos de la línea de órdenes
