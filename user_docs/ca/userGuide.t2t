...
NVDA ha estat desenvolupat per en_[NV Access https://www.nvaccess.org/], amb contribucions de la comunitat.
...
++ Compatibilitat amb sintetitzadors de veu ++
...
NVDA incorpora en_[eSpeak https://espeak.sourceforge.net/], un sintetitzador de veu multilingüe gratuït i de codi obert.
...
++ Compatibilitat amb dispositius braille ++
...
Si en vols saber més, pots en_[veure la llicència completa. https://www.gnu.org/licenses/old-licenses/gpl-2.0.html]
...
+ Descàrrega i instal·lació de NVDA +
...
++ Restriccions en les versions portable i temporal ++
...
+++ Inici a l'inici de sessió de Windows +++
...
+++ Crear una drecera d'escriptori (Ctrl+Alt+n) +++
...
+++ Copiar la configuració de la versió portable al compte d'usuari actual +++
...
++ Ordres de teclat de NVDA ++

+++ Tecla modificadora de NVDA +++
...
+ mou el cursor de revisió al contingut matemàtic.
...
+ Llavors, activa la següent comanda: 
+
...
+++ Configuració general (NVDA+Ctrl+g) +++
...
==== Utilitza la configuració desada a la pantalla d'inici de sessió i a altres pantalles de seguretat ====
...
+++ Selecció del sintetitzador (NVDA+Ctrl+s) +++
...
==== Evita tallar paraules quan sigui possible ====
...
==== Utilitza Bloq Maj com a tecla modificadora de NVDA ====
Si aquesta casella de selecció està activada, s'usarà la tecla Bloqueig de majúscules com a tecla modificadora de NVDA.

==== Utilitza la tecla d'inserció del teclat expandit com a tecla modificadora de NVDA ====
...
==== Utilitza la tecla d'inserció del teclat numèric com a tecla modificadora de NVDA ====
...
==== Interrupció de la veu per a la tecla de retorn ====
...
==== Permet la lectura superficial en el perfil Verbalitza-ho tot ====
...
==== Emet un xiulet en escriure lletres minúscules quan el Bloqueig de majúscules està activat ====
...
==== Gestiona les tecles d'altres aplicacions ====
...
==== Anuncia els canvis en la forma del ratolí ====
...
%kc:setting
==== Habilita el seguiment de ratolí ====
Tecla: NVDA+m
...
==== La brillantor controla el volum de l'àudio ====
...
==== Informa dels indicadors de funció ====
...
==== Informa dels indicadors de funció d'ajuda ====
...
==== Informa de les tecles de drecera de l'objecte ====
...
==== Informa de la posició de l'objecte ====
...
==== Endevina la informació de posició de l'objecte quan no estigui disponible ====
...
==== Informa de les barres de progrés en segon pla ====
...
%kc:setting
==== Informa dels canvis dinàmics del contingut ====
Tecla: NVDA+5
...
+++ Configuració de la composició d'entrada +++
...
==== Informa automàticament de tots els candidats disponibles ====
...
==== Anuncia el candidat seleccionat ====
...
==== Inclou sempre la descripció curta dels caràcters en anunciar els candidats ====
...
==== Informa de canvis a la cadena de lectura ====
...
==== Informa de canvis a la cadena de composició ====
...
==== Configuració de la informació de camps com ara enllaços i encapçalaments ====
...
==== Mode de focus automàtic per als canvis de focus ====
...
==== Mode de focus automàtic per al moviment del cursor del sistema ====
...
==== Indicació audible del mode de focus i de navegació ====
...
=== Impedeix que els gestos que no són instruccions arribin al document ===
...
==== Anuncia els canvis de format després del cursor ====
...
+++ Desactiva temporalment tots els desencadenadors +++
...
Aquest botó obre la en_[pàgina de complements de NVDA https://addons.nvda-project.org/].
...
Per a més informació, pots consultar la Guia del desenvolupador disponible a en_[la secció de desenvolupament de la pàgina web de NVDA https://community.nvda-project.org/wiki/Development].

++ Torna a carregar els connectors ++
...
Pots consultar una llista més extensa dels sintetitzadors gratuïts i comercials que pots comprar o descarregar per usar amb NVDA, a la pàgina en_[https://www.nvda-project.org/wiki/ExtraVoices https://www.nvda-project.org/wiki/ExtraVoices]

++ eSpeak ++
El sintetitzador en_[eSpeak https://espeak.sourceforge.net/] ve incorporat directament a NVDA i no requereix cap controlador o component especial per instal·lar-se.
...
Si has instal·lat veus SAPI4 però el sintetitzador no apareix a la llista de sintetitzadors de NVDA, has d'instal·lar els fitxers binaris del temps d'execució de SAPI 4.0, que pots trobar a en_[https://activex.microsoft.com/activex/controls/sapi/spchapi.exe https://activex.microsoft.com/activex/controls/sapi/spchapi.exe].

++ Microsoft Speech API versió 5 (SAPI 5) ++
...
- Microsoft Speech Platform - Runtime (Versió 11) , x86: en_[https://www.microsoft.com/download/en/details.aspx?id=27225 https://www.microsoft.com/download/en/details.aspx?id=27225]
- Microsoft Speech Platform - Runtime Languages (Versió 11): en_[https://www.microsoft.com/download/en/details.aspx?id=27224 https://www.microsoft.com/download/en/details.aspx?id=27224]
...
Per a més informació, pots visitar la web d'Audiologic a www.audiologic.it.
...
Pots obtenir més informació sobre Nuance Vocalizer per a NVDA i sobre com comprar-lo, a la seva web en_[www.vocalizer-nvda.com https://www.vocalizer-nvda.com/].
...
Totes les línies Focus i PAC Mate de en_[Freedom Scientific https://www.freedomscientific.com/] són compatibles amb NVDA si es connecten per USB o Bluetooth.
Cal tenir instal·lats a l'ordinador els controladors dels terminals braille de Freedom Scientific.
Si encara no els tens, pots obtenir-los de en_[https://www2.freedomscientific.com/downloads/focus-40-blue/focus-40-14-blue-downloads.asp https://www2.freedomscientific.com/downloads/focus-40-blue/focus-40-14-blue-downloads.asp].
...
Els models ALVA BC640 i BC680 d'en_[Optelec https://www.optelec.com/] són compatibles si estan connectats via USB o Bluetooth.
...
++ Handy Tech Displays ++
NVDA és compatible amb totes les línies braille de de_[Handy Tech https://www.handytech.de/] quan aquestes es connecten via USB o Bluetooth.
...
++ MDV Lilli ++
NVDA és compatible amb la línia braille de Lilli, disponible a it_[MDV https://www.mdvbologna.it/].
No necessites tenir instal·lat cap controlador específic per usar aquestes línies braille.
...
NVDA és compatible amb algunes línies en_[Baum https://www.baum.de/cms/en/], en_[HumanWare https://www.humanware.com/] i en_[APH https://www.aph.org/] si es connecten via USB o Bluetooth.
Aquestes inclouen:
...
++ hedo ProfiLine USB ++
NVDA és compatible amb la hedo ProfiLine USB de de_[hedo Reha-Technik https://www.hedo.de/].
...
++ hedo MobilLine USB ++
NVDA és compatible amb la hedo MobilLine USB de de_[hedo Reha-Technik https://www.hedo.de/].
Primer has d'instal·lar els controladors USB del fabricant.
...
NVDA és compatible amb les sèries Brailliant BI i B de línies braille de en_[HumanWare https://www.humanware.com/], incloses la BI 32, BI 40 i B 80 quan es connecten via USB o Bluetooth.
Si les connectes via USB, primer has d'instal·lar els controladors USB del fabricant.
...
NVDA és compatible amb les línies braille Sense i Braille EDGE de en_[Hims https://www.hims-inc.com/] si es connecten per USB o Bluetooth. 
Si les connectes per USB, hauràs d'instal·lar els controladors USB de HIMS al teu ordinador.
Els pots descarregar del Centre de Recursos HIMS: en_[https://www.hims-inc.com/resource-center/ https://www.hims-inc.com/resource-center/]
...
++ HIMS SyncBraille ++
NVDA és compatible amb la línia SyncBraille de en_[HIMS https://www.hims-inc.com/].
...
NVDA és compatible amb la línia braille Seika versió 3, 4 i 5 (40 cel·les) i Seika80 (80 cel·les) de en_[Nippon Telesoft https://www.nippontelesoft.com/].
Pots trobar més informació sobre aquestes disposicions a en_[https://www.seika-braille.com/ https://www.seika-braille.com/].
Primer has d'instal·lar els controladors USB del fabricant.
...
NVDA és compatible amb els anotadors BrailleNote de en_[Humanware https://www.humanware.com] quan aquests actuen com a línia braille d'un lector de pantalles.
...
++ BRLTTY ++
en_[BRLTTY https://mielke.cc/brltty/] és un programa independent que es pot usar per complementar moltes línies braille.
Per a fer-lo servir, cal que instal·lis en_[BRLTTY for Windows https://brl.thefreecat.org/brltty/].
...
Revisa la en_[Documentació dels jocs de tecles BRLTTY https://mielke.cc/brltty/doc/KeyTables/] per conèixer com es mapegen les ordres BRLTTY amb els controls a les línies braille.
%kc:beginInclude
|| Nom | ordre BRLTTY |
...
++ Personalització avançada de la pronúncia de símbols ++
...
El format d'aquest fitxer es documenta a la secció Pronúncia de símbols a la guia de desenvolupadors NVDA, que pots trobar en anglès a la en_[secció per a desenvolupadors del lloc web de NVDA https://community.nvda-project.org/wiki/Development].
