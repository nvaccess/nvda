...
- Les subclasses del sapi5 synthDriver ara poden sobrescriure _getVoiceTokens i estendre __init__ per suportar els tokens de veu personalitzats com amb la sapi.spObjectTokenCategory per obtenir tokens des d'una localització personalitzada.
