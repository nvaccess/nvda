...
++ Braille vezérlőtípus-, állapot- és jelzőpontrövidítések ++
...
+ Mozgassa a kurzort a jegyzetet tartalmazó szövegrészhez.
+ Hívja elő a helyi menüt.
+ Válassza az Edit Note parancsot a lehetőségek közül.
+
...
==== Betűzés használata, ha támogatott ====
...
+ csomag: a bővítmény neve.
+ verzió: a bővítmény verziója.
+ összeférhetetlenségi ok: rövid leírás, miért tűnik a bővítmény összeférhetetlennek.
+
