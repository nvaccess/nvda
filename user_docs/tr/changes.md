 ...
 * Birden çok çökme sorununu  gideriyor
 * Baskurt 1. derece Braille tablosu eklendi
 * Coptic 8 noktalı bilgisayar braille tablosu eklendi
 * Rus edebi braille ve Rus edebi braille (ayrıntılı) tabloları eklendi
 * Afrikaca 2. derece braille tablosu eklendi
 * Rus 1. derece Braille tablosu kaldırıldı
