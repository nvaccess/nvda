...
+ La fenêtre du Lanceur NVDA apparaît avec le contrat de licence.
Appuyez sur ``flècheBas`` pour lire le contrat de licence si vous le souhaitez.
+ Appuyez sur ``tab`` pour passer à la case "J'accepte", puis appuyez sur la ``barre d'espace`` pour la cocher.
+ Appuyez sur ``tab`` pour parcourir les options, puis appuyez sur ``entrer`` sur l'option souhaitée.
+
...
+ Depuis le lanceur, assurez-vous que la case à cocher pour accepter la licence est cochée.
+ Appuyez sur ``Tab`` jusqu'au bouton "Installer NVDA sur cet ordinateur" et activez-le.
+ Ensuite, viennent des options pour utiliser NVDA lors de la connexion à Windows et pour créer un raccourci sur le bureau.
...
+ Une barre de progression se remplit au fur et à mesure de l'installation de NVDA.
...
+ Un dialogue apparaît confirmant que l'installation de NVDA a réussi.
Le message demande d'"Appuyer sur OK pour démarrer la copie installée".
Appuyez sur ``entrer`` pour démarrer la copie installée.
+ Le dialogue "Bienvenue dans NVDA" apparaît et NVDA lit un message de bienvenue.
...
+ Appuyez sur ``tab`` pour passer à "Utiliser ``verrouillage majuscule`` comme touche de modification NVDA".
...
+ Utilisez ``tab`` et ``barre d'espace`` pour ajuster les autres options sur cet écran.
Celles-ci définissent si NVDA doit démarrer automatiquement.
+ Appuyez sur ``entrer`` pour fermer le dialogue avec NVDA en cours d'exécution.
+
...
+ Ouvrez la boîte de dialogue des gestes de commandes à partir du mode navigation.
+ Recherchez l'élément "Aller à l'onglet suivant" dans la section Mode navigation.
+ Attribuez la touche `` y`` pour le geste trouvé.
+ Recherchez l'élément "Aller à l'onglet précédent".
+ Attribuez ``maj+y`` pour le geste trouvé.
+
...
+ Amenez le curseur au texte contenant la note.
+ Accédez aux options de sélection comme décrit plus haut.
+ Choisissez Éditer la Note.
+
...
%kc:setting
==== Ouvrir les paramètres de parole ====
...
%kc:setting
==== Ouvrir le dialogue sélection du synthétiseur ====
...
%kc:setting
==== Ouvrir le dialogue de sélection de l'afficheur braille ====
...
%kc:setting
==== Ouvrire les paramètres de souris ====
...
%kc:setting
==== Ouvrir les paramètres de présentation des objets ====
...
%kc:setting
==== Ouvrir les paramètres du mode navigation ====
...
%kc:setting
==== Ouvrir les paramètres de mise en forme des documents ====
...
Veuillez consulter la documentation du terminal pour savoir où se situent ces touches.
+++ Assignations des Touches pour tous les Modèles +++
%kc:beginInclude
|| Nom | Touche |
...
+++ Assignations de Touches pour les Brailliant BI 32, BI 40 et B 80 +++
%kc:beginInclude
|| Nom | Touche |
| Menu NVDA | c1+c3+c4+c5 (commande n) |
| Touche windows+d (minimiser toutes les applications) | c1+c4+c5 (commande d) |
...
+++ Assignations de Touches pour le Brailliant BI 14 +++
%kc:beginInclude
|| Nom | Touche |
...
+ Veuillez vous assurer que vous avez installé le [dernier pilote https://www.papenmeier-rehatechnik.de/en/service/downloadcenter/software/articles/software-braille-devices.html].
+ Ouvrez le Gestionnaire de périphériques Windows.
+ Faites défiler la liste jusqu'à "Contrôleurs USB" ou "Périphériques USB".
+ Sélectionnez "Périphérique USB Papenmeier Braillex".
+ Ouvrez les propriétés et passez à l'onglet "Avancé".
