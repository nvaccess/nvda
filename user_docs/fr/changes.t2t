...
- Un ScriptableObject bloqué (par exemple un globalplugin dont l'appel à la classe basique __INIT__ est manquant) ne bloquera plus le rendu des scripts de NVDA. (#5446)
...
= 2018.3.2 =
Ceci est une version mineure pour corriger un plantage sous Google Chrome quand on parcourt les tweets sur www.twitter.com. (#8777)
...
- Il y a maintenant une architecture de test unitaire pour NVDA. (#7026)
 - Les tests unitaires et l'infrastructure sont situés dans le répertoire tests/unit. veuillez consulter le docstring dans le fichier tests\unit\__init__.py pour plus de détails.
...
- Sous Windows 8 et au-delà, NVDA démarre maintenant beaucoup plus tôt quand il est configuré pour démarrer après la connexion à Windows. (#308)
 - Si vous avez configuré cela avec une version précédente de NVDA, vous devrez le désactiver puis le réactiver dans le dialogue Paramètres Généraux pour que le changement prenne effet. Suivez cette procédure :
  + Ouvrez le dialogue "Paramètres Généraux".
  + Décochez la case "Démarrer NVDA automatiquement après ma connexion à Windows".
  + Appuyez sur le bouton OK.
  + Ouvrez de nouveau le dialogue "Paramètres Généraux".
  + Cochez la case "Démarrer NVDA automatiquement après ma connexion à Windows".
  + Appuyez sur le bouton OK.
...
- Il est maintenant possible d'utiliser le mode navigation pour les pages sous Internet Explorer 10 lorsque l'on est en mode standard ; Ex : la page de connexion de www.gmail.com. (#3151)
...
- Les sous-classes de sapi5 synthDriver peuvent désormais remplacer _getVoiceTokens et étendre __init__ pour prendre en charge les jetons vocaux personnalisés, comme avec sapi.spObjectTokenCategory pour obtenir des jetons à partir d'un emplacement de registre personnalisé.
