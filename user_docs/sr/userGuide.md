...
* Mogućnost da se [povežete i kontrolišete drugi računar na kojem je NVDA pokrenut](#RemoteAccess) za udaljenu podršku ili saradnju
...
* Mogućnost pokretanja na Windows ekranu za prijavljivanje i [drugim bezbednim ekranima](#SecureScreens)
...
* Operativni sistemi: Sve 32-bitne i 64-bitne verzije Windowsa 8.1, Windowsa 10, Windowsa 11 i sve serverske operativne sisteme počevši od Windows Servera 2012 R2.
  ...
  * Imajte na umu da 32-bitni operativni sistemi više nemaju aktivnu podršku.
  * Napomena da Windows 8.1 i Windows Server verzije starije od 2022 više nemaju aktivnu podršku.
* barem 500 MB prostora.

#### Preporučeni sistemski zahtevi {#RecommendedSystemRequirements}

* Operativni sistemi: 64-bitne verzije Windowsa 10, Windowsa 11 i Windows server 2022.
  * podržane su AMD64 i ARM64 varijante Windowsa.
* barem 500 MB prostora.
* barem 4 GB RAM-a.
...
Osim engleskog, NVDA je preveden na 55 jezika uključujući: afrikanski, albanski, amharski, arapski, aragoneški, bosanski, bugarski, burmeški, katalonski, kineski (pojednostavljen i tradicionalan), hrvatski, češki, danski, holandski, farški, finski, francuski, galski, gruzijski, nemački(Nemačka i Švajcarska), grčki, hebrejski, hindi, mađarski, islandski, irski, italijanski, japanski, kannada, korejski, kirgijški, litvanski, makedonski, mongolski, nepalski, norveški, poljski, portugalski(Brazil i Portugal), pundžabi, rumunski, ruski, srpski, slovački, slovenački, španski(Kolumbija i Španija), švedski, tamilski, tajlandski, turski, ukrajinski i vietnamski.
...
Možda ćete morati da sačekate nekoliko sekundi dok se privremena NVDA kopija učita.
Nakon što se učita, NVDA će govoriti kroz ostatak procesa.
1. Prozor NVDA pokretača će se pojaviti sa dugmetom za otvaranje ugovora o licenci.
Pritisnite `strelicuDole` da čitate ugovor o licenci.
...
1. Dijalog će se pojaviti koji će potvrditi da je NVDA uspešno instaliran.
...
| Ime |Desktop taster |Laptop taster |opis|
|---|---|---|---|
|Izgovor upisanih znakova|`NVDA+2` |`NVDA+2` |Kontroliše kada NVDA izgovara znakove koje upišete. |
|Izgovor upisanih reči|`NVDA+3` |`NVDA+3` |Kontroliše kada će NVDA izgovarati reči koje upišete. |
...
Preporučujemo vam da počnete sa modulom "Basic Training for NVDA".
...
Ova opcija vam dozvoljava da izaberete da li će NVDA kopirati korisnička podešavanja trenutno pokrenute NVDA kopije u folder podešavanja trenutnog korisnika, za instaliranu NVDA kopiju.
...
Podrazumevano, NVDA je podešen tako da koristi desktop raspored, ali možete preći na laptop raspored u kategoriji tastatura [NVDA dijaloga NVDA podešavanja](#NVDASettings), koji se nalazi u podmeniju opcije NVDA menija.
...
Dodirivanje ekrana jednim prstom se jednostavno zove dodir.
...
Komande se neće izvršiti dok ste u režimu pomoći za unos.
...
|Pomeri se na početak izbora pregledom|`NVDA+alt+home` |`NVDA+alt+home` |Nema|Pomera pregledni kursor na prvi znak izabranog teksta|
|Pomeri se na kraj izbora pregledom|`NVDA+alt+end` |`NVDA+alt+end` |Nema|Pomera pregledni kursor na poslednji znak izabranog teksta|
...
Dobar način da zapamtite komande pregleda teksta kada koristite desktop raspored je da ih zamislite kao da su u mreži tri puta tri, u kojoj su odozgo na dole redovi, reči i znakovi a s leva na desno prethodni, trenutni i sledeći.
...
| Ime |Komanda |Opis|
|---|---|---|
|Pretraži tekst|NVDA+kontrol+f |Otvara dijalog pretrage|
|Pronađi sledeće |NVDA+f3 |Traži sledeće pojavljivanje trenutnog termina pretrage|
|Pronađi prethodni|NVDA+šift+f3 |Pretražuje prethodnu pojavu trenutnog termina pretrage|
...
Ali, NVDA ima režim ugrađenog izbora koji se može uključiti u određenim dokumentima režima pretraživanja koji ga mogu podržati (Mozilla Firefox, i bilo koji pretraživač zasnovan na Chromiumu 134 ili novijem) koji dozvoljava da izbor teksta u dokumentu prati izbor teksta NVDA režima pretraživanja.
...
Pritiskanje prečice `NVDA+f5` osvežava rezultat prepoznavanja.

### Windows optičko prepoznavanje znakova {#Win10Ocr}
...
NVDA pruža svoje dodatne funkcije za neke aplikacije kako bi olakšao određene zadatke ili pružio pristup funkcijama koje inače nisu pristupačne korisnicima čitača ekrana.
...
|Postavi zaglavlja redova|`NVDA+šift+r` |Pritiskanje jednom govori NVDA-u da je ovo prva ćelija zaglavlja u koloni koja sadrži zaglavlja redova, koje treba automatski izgovoriti kada se krećete po redovima nakon ove kolone. Ako se pritisne dva puta podešavanje će biti obrisano.|

<!-- KC:endInclude -->
Ova podešavanja se čuvaju u dokumentu kao markeri i kompatibilna su sa drugim čitačima ekrana kao što je Jaws.
Ovo znači da će korisnici drugih čitača ekrana koji kasnije otvore ovaj dokument automatski imati podešena zaglavlja kolona i redova.
...
<!-- KC:beginInclude -->
Za prijaljivanje bilo kojih komentara na trenutnoj poziciji kursora, pritisnite `NVDA+alt+c`.
Ako se pritisne dva puta informacija će biti prikazana u poruci koja se može istražiti.
<!-- KC:endInclude -->
Svi komentari dokumenta, uz druge revizijske promene, se takođe mogu prikazati u NVDA listi elemenata kada se izaberu napomene kao vrsta.
...
| Ime |Komanda |Opis|
|---|---|---|
|Postavi zaglavlja kolone|`NVDA+šift+c` |Pritiskanje jednom govori NVDA-u da je ovo prva ćelija zaglavlja u redu koji sadrži zaglavlja kolone, koja automatski treba izgovoriti kada se krećete po kolonama ispod ovog reda. Pritiskanje dva puta će obrisati ovo podešavanje.|
|Postavi zaglavlja redova|`NVDA+šift+r` |Pritiskanje jednom govori NVDA-u da je ovo prva ćelija zaglavlja u koloni koja sadrži zaglavlja redova, koje treba automatski izgovoriti kada se krećete po redovima nakon ove kolone. Ako se pritisne dva puta podešavanje će biti obrisano.|

<!-- KC:endInclude -->
Ova podešavanja će biti upisana u radnu svesku i biti kompatibilna sa drugim čitačima ekrana kao što je Jaws.
Ovo znači da će korisnici drugih čitača ekrana koji kasnije otvore ovu radnu svesku automatski imati podešena zaglavlja kolona i redova.
...
<!-- KC:beginInclude -->
Za prijaljivanje bilo kojih napomena na trenutno fokusiranoj ćeliji, pritisnite `NVDA+alt+c`.
Ako se pritisne dva puta informacija će biti prikazana u poruci koja se može istražiti.
...
Kada se označi, pojaviće se dijalog kada pokušate da izađete iz NVDA-a, pružajući sledeće mogućnosti:

* izlaz
* ponovno pokretanje
* ponovno pokretanje sa onemogućenim dodacima i omogućenim dnevnicima za otklanjanje greške
* ponovno pokretanje sa omogućenim dnevnicima za otklanjanje greške
* instaliranje odloženih ažuriranja (ako postoje).
...
Možete takođe ručno instalirati odloženo ažuriranje iz dijaloga za izlaz iz NVDA-a (ako je omogućen), iz NVDA menija, ili kada izvršite novu proveru iz menija pomoći.

##### Alternativna adresa ažuriranja {#UpdateMirror}

Ove kontrole vam dozvoljavaju da odredite alternativnu adresu koja će se koristiti za proveru NVDA ažuriranja.
Ovo može biti korisno na lokacijama na kojima je pristup NV Access serveru za NVDA ažuriranja spor ili nedostupan.

Tekstualno polje koje je samo za čitanje prikazuje trenutnu alternativnu adresu.
Ako nema alternativne adrese (koristi se NV Access za ažuriranja), "Nema alternativne adrese" će biti prikazano.

Ako želite da promenite alternativnu adresu ažuriranja, pritisnite dugme "Promeni..." kako biste otvorili dijalog [Podesi alternativnu adresu NVDA ažuriranja](#SetURLDialog).

Imajte na umu da kada koristite alternativnu adresu ažuriranja, pružalac alternativne adrese ima pristup svim [informacijama koje šalje provera ažuriranja](#GeneralSettingsCheckForUpdates).
Kontaktirajte pružaoca usluge alternativne adrese ažuriranja za detalje o načinu obrade podataka kako biste se uverili da ste saglasni sa načinom na koji će vaše informacije biti obrađene pre nego što podesite alternativnu adresu ažuriranja.

##### Spreči da se ekran isključi tokom čitanja na brajevom redu ili u režimu izgovori sve {#PreventDisplayTurningOff}

Ovo izborno polje, kada je omogućeno, obezbeđuje da ekran ostane uključen kada se čita u režimu izgovori sve ili sa brajevim redom (na primer kada se pritiskaju tasteri za pomeranje).
Ovo će izbeći situaciju u kojoj se ekran neočekivano zaključa tokom režima izgovori sve.
Ova opcija je podrazumevano omogućena.
Razmotrite onemogućavanje ove opcije ako primetite kraće trajanje baterije.
...
Prva opcija kategorije govor je dugme Promeni....
Ovo dugme aktivira dijalog [Izaberi sintetizatora](#SelectSynthesizer), koji vam dozvoljava da izaberete aktivnog sintetizatora govora.
...
Ako izaberete "Automatski", tabela će biti izabrana na osnovu trenutnog NVDA jezika.
...
U tom slučaju, brajev red neće pratiti sistemski fokus i kursor.
...
##### Obeleživač početka pasusa {#BrailleParagraphStartMarkers}

Ako se označi opcija "čitaj po pasusima", prikazaće se odabrani obeleživač početka pasusa kako bi se označio početak pasusa.
Ovo posebno može biti od pomoći u aplikacijama koje se koriste za čitanje dužih tekstova, kao što su oblikovani dokumenti ili knjige.
U takvim dokumentima, može biti korisno da znate gde počinju pasusi kako biste razumeli strukturu sadržaja, ili kako biste podesili markere ili napomene zasnovane na poziciji pasusa.

Opcije uključuju korišćenje dva razmaka kao suptilni znak pasusa, i simbol pasusa, obeleživač pasusa (¶), kao očigledniji način.

| . {.hideHeaderRow} |.|
|---|---|
|Opcije |Bez obeleživača pasusa, dva razmaka (  ), obeleživač pasusa (¶)|
|Podrazumevano |Bez obeleživača pasusa|
...
##### Prikazivanje formatiranja {#BrailleFormattingDisplay}

Ovo podešavanje određuje kako će NVDA prikazivati formatiranje teksta na brajevom redu.
Ovo podešavanje se primenjuje samo ako je NVDA podešen da [prikaže atribute fonta na brajevom redu](#DocumentFormattingFontAttributes).

| . {.hideHeaderRow} |.|
|---|---|
| Opcije | Podrazumevano (Liblouis), Liblouis, oznake |
| Podrazumevano | Liblouis |

| Opcija | Ponašanje |
|---|---|
| Liblouis | Koristi nativno brajevo formatiranje. Imajte na umu da će ova opcija pokazati samo podebljan, iskošen i podvučen tekst, i samo ako izabrana brajeva tabela podržava prikazivanje ovih atributa. |
| [Oznake](#BrailleFormattingDisplayTags) | Koristi oznake za opisivanje gde i kada se formatiranje teksta promenilo. |

###### Oznake {#BrailleFormattingDisplayTags}

Kada je opcija "Prikazivanje formatiranja" podešena na "oznake", na brajevom redu će biti prikazana oznaka formatiranja kada se prepozna promena u formatiranju.
Ove tačkice počinju kao ⣋ a završavaju se kao ⣙.
Oznaka formatiranja će sadržati jedan ili više simbola koji opisuju formatiranje teksta.
Sledeći simboli su definisani:

| Simbol | Značenje |
|---|---|
| ⠏ ("p") | Početak podebljanog |
| ⡏ ("b" sa tačkom 7) | Kraj podebljanog |
| ⠊ ("i") | Početak iskošenog |
| ⡊ ("i" sa tačkom 7) | Kraj iskošenog |
| ⠕ ("o") | Početak podvučenog |
| ⡕ ("o" sa tačkom 7) | Kraj podvučenog |
| ⠗ ("r")| Početan precrtanog |
| ⡗ ("r" sa tačkom 7) | Kraj precrtanog |

##### Izgovor znaka kada se kursor pomera po tekstu {#BrailleSpeakOnRouting}

Ako je ova opcija omogućena, NVDA će automatski izgovarati znak na poziciji kursora kada se prebacite na njega tasterima za pomeranje brajevog kursora.

Kako biste uključili ili isključili ovu opciju bilo gde, molimo podesite prilagođenu komandu korišćenjem [dijaloga ulaznih komandi](#InputGestures).

##### Izgovor tokom kretanja po redu ili pasusu {#BrailleSpeakOnNavigating}

Omogućavanje ove opcije će izazvati da NVDA izgovara redove ili pasuse do kojih se stigne navigacionim tasterima na brajevom redu.

Da biste uključili ili isključili ovu opciju bilo gde, molimo podesite prilagođenu prečicu za komandu "Uključuje i isključuje izgovor tokom navigacije po redovima ili pasusima na brajevom redu" u odeljku "brajevi redovi" [dijaloga ulaznih komandi](#InputGestures).

##### Izbegavaj razdvajanje reči kada je moguće {#BrailleSettingsWordWrap}

Ako je ovo omogućeno, reč koja je preduga kako bi stala na kraj brajevog reda neće biti razdvojena.
Umesto toga, na kraju reda ćete imati prazan prostor.
Kada pomerite red, moćićete da pročitate celu reč.
Ovo se ponekad zove "prelamanje reči".
Imajte na umu da ako je reč preduga kako bi stala na brajevom redu čak i kao samostalna, reč ipak mora da se razdvoji.

Ako je ova opcija onemogućena, što veći deo reči će biti prikazan, ali će ostatak biti odsečen.
Kada pomerite red, moćićete da pročitate ostatak reči.

Omogućavanje ove opcije će možda dozvoliti fluidnije čitanje, ali obično zahteva da češće pomerate brajev red.

##### Unikodna standardizacija {#BrailleUnicodeNormalization}

Kada je ova opcija omogućena, vrši se unikodna standardizacija teksta koji se prikazuje na brajevom redu.
Ovo može biti od koristi kada naiđete na znakove koji nisu poznati u određenoj brajevoj tabeli a koji imaju kompatibilnu alternativu, kao što su podebljani ili iskošeni znakovi koji se često koriste na društvenim mrežama.
Druge prednosti unikodne standardizacije su detaljnije objašnjene u [sekciji ekvivalentnog podešavanja govora](#SpeechUnicodeNormalization).

Kako biste uključili ili isključili unikodnu standardizaciju bilo gde, molimo podesite prilagođenu komandu korišćenjem [dijaloga ulaznih komandi](#InputGestures).
...
Ovo podešavanje određuje da li govor treba biti prekinut kada se brajev red pomera nazad ili napred.
Komande pomeranja na prethodni ili sledeći red uvek prekidaju govor.

Govor koji je u toku može predstavljati ometanje kada se čita brajevo pismo.
Iz ovog razloga je opcija podrazumevano omogućena, što znači da će se govor prekinuti kada se brajev red pomera.

Onemogućavanje ove opcije dozvoljava da čujete govor dok u isto vreme čitate brajevo pismo.
...
Ova opcija kontroliše kada će NVDA izgovoriti znakove koje upisujete na tastaturi.
Dostupne opcije su:

* Isključeno: NVDA neće izgovarati upisane znakove.
* Samo u poljima za uređivanje: NVDA će izgovoriti upisane znakove samo u poljima za uređivanje i drugim prostorima u kojima je moguće upisati tekst.
* Uvek: NVDA će izgovoriti sve upisane znakove.
...
Ova opcija kontroliše kada će NVDA izgovoriti reči koje upisujete na tastaturi.
Dostupne opcije su:

* Isključeno: NVDA neće izgovarati upisane reči.
* Samo u poljima za uređivanje: NVDA će izgovoriti upisane reči samo u poljima za uređivanje i drugim prostorima u kojima je moguće upisati tekst.
* Uvek: NVDA će izgovoriti sve upisane reči.
...
Ova opcija je podrazumevano omogućena, međutim neki korisnici će možda želeti da je onemoguće, kao što su korisnici koji pišu na vijetnamskom korišćenjem programa za pisanje UniKey budući da će izazvati neispravan upis znakova.

##### Vreme isteka za pritiskanje više tastera {#MultiPressTimeout}

Neke NVDA komande na tastaturi izvršavaju različite radnje u zavisnosti od toga koliko puta se isti taster brzo pritisne zaredom.
Primer ovoga je komanda "Prijavi trenutni znak navigacionog objekta".
Ova komanda prijavljuje znak ako se pritisne jednom, fonetski opis znaka ako se pritisne dva puta i numeričku vrednost znaka ako se pritisne tri puta.
Ova opcija podešava vreme isteka nakon kojeg će dodatni pritisak istog tastera započeti novu komandu, umesto da se smatra dodatnim pritiskanjem prve komande.
Za komandu iz primera, kraći period isteka vremena će izazvati da pritiskanje dva puta prijavi trenutni znak dva puta, umesto fonetskog opisa.
Podrazumevani istek vremena je 500 ms, to jest pola sekunde.
Povećavanje ovog isteka vremena može posebno biti od koristi za osobe koje koriste lepljive tastere, ili koje imaju motoričke poteškoće.
...
Ova opcija, koja je podrazumevano omogućena, dozvoljava vam da izaberete da li će svi vidljivi unosi automatski biti prijavljeni kada se lista unosa pojavi ili se njena stranica promeni.
...
Ali, za fonetske načine unosa kao što je kineski nova fonetika, možda će biti korisnije da ovu opciju isključite, budući da će svi simboli zvučiti isto i moraćete da koristite strelice da se krećete pojedinačno po stavkama kako biste dobili više informacija iz opisa znakova za svaki unos.
...
Za načine unosa u kojima se izbor može promeniti strelicama (kao što je kineski nova fonetika) ovo je neophodno, ali sa nekim načinima unosa možda će pisanje biti efikasnije sa ovom opcijom isključenom.
...
Ova opcija vam dozvoljava da izaberete da li će NVDA prijaviti nove simbole kada se pojave u složenom nizu.
...
Podrazumevano omogućena, ova opcija vam dozvoljava da odredite da li prečice (kao što su tasteri) koje nisu NVDA komande i uopšteno se ne smatraju komandama, treba sprečiti da dođu do dokumenta na kojem ste trenutno fokusirani.
...
* Font
  * Ime fonta
  * Veličina fonta
  * Atributi fonta [(Isključeno, Govor, Brajev red, Govor i brajev red)](#DocumentFormattingFontAttributes)
...
* Elementi
  * Naslovi
  * Linkovi
  * Vrsta linka (odredište na istoj stranici)
  * Slike
  * Liste
  * Citati
  * Grupisanja
...
Ova opcija vam dozvoljava da izaberete kako će se određeni atributi fonta, kao što su podebljanost, iskošenost, podvučenost i precrtanost prijaviti.
Izborni okvir atributa fonta ima četiri opcije:

* Isključeno: NVDA neće prijaviti ove atribute fonta.
* Govor: NVDA će izgovarati kada se ovi atributi fonta menjaju.
* Brajev red: NVDA će prikazati ove atribute na brajevom redu.
Način na koji se prikazuju se može podesiti u [NVDA brajevim podešavanjima](#BrailleFormattingDisplay).
* Govor i brajev red: NVDA će prijaviti atribute fonta korišćenjem oba metoda opisana iznad.
...
* Govor: Ako je izabran govor, kada se količina uvlačenja promeni, NVDA će izgovoriti nešto poput "Dvanaest razmak" ili "Četiri tabulator."
* Tonovi: Ako se izaberu tonovi, kada se količina uvlačenja promeni, tonovi označavaju količinu promene uvlačenja.
...
Podrazumevano, dobijaćete obaveštenja samo za dodatke koji imaju dostupna ažuriranja na istom [kanalu](#AddonStoreFilterChannel) (na primer stabilni, beta ili razvojni).
Možete podesiti kanale ažuriranja dodataka [pojedinačno za svaki dodatak](#AddonStoreUpdateChannel) ili za [sve dodatke](#DefaultAddonUpdateChannel).

Kada je opcija podešena na "Ažuriraj automatski", dodaci će se automatski ažurirati u pozadini.
Bićete upitani da ponovo pokrenete NVDA kada se ažuriranja završe.

| . {.hideHeaderRow} |.|
|---|---|
|Opcije |obavesti (podrazumevano), ažuriraj automatski, onemogućeno |
|Podrazumevano |Obavesti |

|Opcija |Ponašanje |
|---|---|
|Obavesti |Obavesti o dostupnim ažuriranjima dodataka |
|Ažuriraj automatski |Automatski ažuriraj dodatke u pozadini |
|Onemogućeno |Ne vrši automatske provere ažuriranja za dodatke |

##### Podrazumevani kanal ažuriranja {#DefaultAddonUpdateChannel}

Kada su [automatska ažuriranja dodataka](#AutomaticAddonUpdates) omogućena, podrazumevano, dodaci se ažuriraju samo u okviru istog [kanala](#AddonStoreFilterChannel).
Na primer, instalirana beta verzija će biti ažurirana samo na novije beta verzije.
Ova opcija podešavana podrazumevani kanal ažuriranja za sve dodatke.
Možete takođe promeniti kanal ažuriranja za [određeni dodatak pojedinačno iz prodavnice dodataka](#AddonStoreUpdateChannel).

| . {.hideHeaderRow} |.|
|---|---|
| Opcije | Isti (podrazumevano), bilo koji, ne ažuriraj, stabilni, beta ili razvojni, beta, razvojni |
| Podrazumevano | Isti |

| Podešavanje | Ponašanje |
|---|---|
| Isti | Dodaci će ostati na istom kanalu |
| Bilo koji | Dodaci će automatski biti ažurirani na najnoviju verziju, bez obzira na kanal |
| Ne ažuriraj| dodaci se neće podrazumevano automatski ažurirati, morate ručno omogućiti ažuriranje pojedinačnih dodataka |
| Stabilni | Dodaci će automatski biti ažurirani na stabilne verzije |
| Beta ili razvojni | Dodaci će se automatski ažurirati na beta ili  razvojne verzije |
| Beta | Dodaci će se automatski ažurirati na beta verzije |
| Razvojni | Dodaci će se automatski ažurirati na razvojne verzije |

##### Dozvoli da automatska ažuriranja instaliraju nekompatibilne dodatke {#AllowIncompatibleAddonUpdates}

Ovo podešavanje omogućava automatska ažuriranja za dodatke koji možda nisu u potpunosti kompatibilni sa trenutnom NVDA verzijom.
Podrazumevano, ovo je onemogućeno, što znači da će automatska ažuriranja ažurirati dodatke samo na verzije koje su označene kao kompatibilne sa trenutnom NVDA verzijom.
Automatska ažuriranja će ipak ažurirati verziju nekompatibilnog dodatka na kompatibilnu verziju kada je objavljena.
Omogućavanje ove opcije može biti korisno pri prelasku na verzije koje čine postojeće dodatke nekompatibilnim (prva verzija godine).
Ovo je posebno korisno za alfa i beta testere, koji testiraju kompatibilnost dodataka tokom ranih faza verzije koja čini dodatke nekompatibilnim.

##### Alternativan server {#AddonStoreMetadataMirror}

Ove kontrole vam dozvoljavaju da odredite alternativnu adresu koja će se koristiti za preuzimanje podataka prodavnice dodataka.
Ovo može biti korisno na lokacijama na kojima je pristup NV Access serveru prodavnice dodataka spor ili nedostupan.

Tekstualno polje koje je samo za čitanje prikazuje trenutnu alternativnu adresu.
Ako se ne koristi alternativna adresa (to jest koristi se NV Access server prodavnice dodataka), biće prikazano "Nema alternativne adrese".

Ako želite da promenite alternativnu adresu prodavnice dodataka, pritisnite dugme "Promeni..." kako biste otvorili dijalog [Podesi alternativni server prodavnice dodataka](#SetURLDialog).

#### Podešavanja daljinskog pristupa {#RemoteSettings}

Ova kategorija vam dozvoljava da podesite ponašanje [daljinskog pristupa](#RemoteAccess).

##### Omogući daljinski pristup {#RemoteEnable}

Koristite ovo izborno polje da biste omogućili ili onemogućili opciju daljinskog pristupa u NVDA-u.

Kada ovo izborno polje nije označeno, funkcija daljinskog pristupa jje u potpunosti nedostupna.

Molimo imajte na umu da kako biste mogli da nastavite vezu daljinskog pristupa na bezbednim ekranima kao što su upiti kontrole korisničkog naloga, morate da omogućite ovo podešavanje, sačuvate promene, a zatim da [kopirate vaša podešavanja u NVDA direktorijum sistemskih podešavanja](#GeneralSettingsCopySettings).
Daljinski pristup će nastaviti samo veze koje su započete instaliranom NVDA kopijom na bezbednim ekranima.
Ovo znači da ne možete da, na primer, započnete vezu daljinskog pristupa sa prenosnom NVDA kopijom i da se ta veza nastavi na bezbednim ekranima.

Sledeće opcije su dostupne samo ako je daljinski pristup omogućen.

##### Potvrda pre prekida veze kada se vaš računar kontroliše {#RemoteConfirmDisconnect}

Ova opcija kontroliše da li će biti neophodno da potvrdite prekid veze daljinskog pristupa kada ste povezani kao kontrolisani računar.

Kada je označena, NVDA će zahtevati potvrdu pre prekidanja veze.
Kada nije označena, NVDA će odmah prekinuti vezu bez potvrde.

##### Automatsko povezivanje nakon što se NVDA pokrene {#RemoteAutoconnect}

Ova opcija vam dozvoljava da automatski uspostavite vezu daljinskog pristupa nakon što se NVDA pokrene.
Ovo može biti korisno da biste, na primer, kontrolisali vaš kućni računar kada niste kod kuće.

Budite oprezni kada omogućite ovu opciju, budući da može povećati rizik neovlašćenog pristupa vašem računaru.

Za dodatne detalje o narednim opcijama, molimo pogledajte odeljak [uspostavljanje veze daljinskog pristupa](#RemoteAccessSetup)

##### Režim {#RemoteAutoconnectMode}

Izbor režima povezivanja za automatska povezivanja.

Ova opcija je dostupna samo kada je opcija [automatsko povezivanje nakon što se NVDA pokrene](#RemoteAutoconnect) označena.

|Opcija |Ponašanje |
|---|---|
|Dozvoli da ovaj računar bude kontrolisan |Koristite ovaj računar kao "kontrolisani" računar. Ovo dozvoljava korisniku "kontrolišućeg" računara da kontroliše ovaj računar kao da sedi ispred njega. |
|Kontroliši drugi računar |Koristite ovaj računar kao "kontrolišući" računar. Ovo vam dozvoljava da izvršavate komande na udaljenom računaru. |

##### Server {#RemoteAutoconnectServer}

Izaberite vrstu servera za automatska povezivanja.

Ova opcija je dostupna samo kada je opcija [automatsko povezivanje nakon što se NVDA pokrene](#RemoteAutoconnect) označena.

|Opcija |Ponašanje |
|---|---|
|Koristi postojeći |Koristite postojeći server daljinskog pristupa za uspostavljanje veze (preporučeno). |
|Napravi lokalni |Koristite ovu NVDA kopiju kao server daljinskog pristupa (za napredne korisnike). Ova opcija će možda zahtevati mrežna podešavanja koja su van opsega ovog uputstva. |

##### Adresa {#RemoteAutoconnectHost}

Koristite ovo polje za upisivanje adrese servera daljinskog pristupa kojeg želite da koristite za automatska povezivanja.
Ako server koristi neki drugi port a ne 6837, upišite ga nakon dvotačke (na primer `primer.com:1234`).

Ova opcija je dostupna samo kada je opcija [automatsko povezivanje nakon što se NVDA pokrene](#RemoteAutoconnect) označena, a [Server](#RemoteAutoconnectServer) podešen na "Koristi postojeći".

##### Port {#RemoteAutoconnectPort}

Koristite ovo polje da podesite TCP port koji želite da koristite za automatska povezivanja.

Ova opcija je dostupna samo kada je opcija [automatsko povezivanje nakon što se NVDA pokrene](#RemoteAutoconnect) označena, a [Server](#RemoteAutoconnectServer) podešen na "Napravi lokalni".

##### Šifra {#RemoteAutoconnectKey}

Koristite ovo polje da podesite šifru (lozinku) koju želite da koristite za automatska povezivanja.

Ova opcija je dostupna samo kada je opcija [automatsko povezivanje nakon što se NVDA pokrene](#RemoteAutoconnect) označena.

##### Obriši sve prihvaćene sertifikate {#RemoteDeleteFingerprints}

Ovo dugme vam dozvoljava da obrišete sve sertifikate servera daljinskog pristupa koje ste prethodno odobrili.
Ovo znači da ćete ponovo biti upitani da li želite da se povežete na sve neprepoznatljive servere daljinskog pristupa, čak  i na one koje ste prethodno odobrili.
Bićete upitani za potvrdu pre nego što se obrišu svi odobreni sertifikati.

Ova opcija je dostupna samo ako postoje odobreni sertifikati sačuvani u vašim podešavanjima.
...
#### Dijalog podešavanja alternativne adrese {#SetURLDialog}

Ovaj dijalog vam dozvoljava da odredite adresu alternativnog servera koji će se koristiti kada [ažurirate NVDA](#GeneralSettingsCheckForUpdates) ili [koristite prodavnicu dodataka](#AddonsManager).
Ovo može biti korisno na lokacijama na kojima je pristup NV Access serverima za ove funkcije spor ili nedostupan.

* Kada podešavate [alternativnu adresu za NVDA ažuriranja](#UpdateMirror), naslov ovog dijaloga će biti "Podesi alternativnu adresu NVDA ažuriranja".
* Kada podešavate [lternativnu adresu prodavnice dodataka](#AddonStoreMetadataMirror), naslov ovog dijaloga će biti "Podesi alternativni server prodavnice dodataka".

##### Adresa {#SetURLTextbox}

Upišite URL (Web adresu) alternativnog servera koji želite da koristite ovde.
Podržane su samo HTTP i HTTPS adrese.
Zbog vaše privatnosti, NV Access preporučuje korišćenje HTTPS adresa kad god je to moguće.

Ostavite ovo polje prazno ako želite da koristite podrazumevani NV Access server.

##### Testiraj... {#SetURLTest}

Pritisnite ovo dugme kako biste testirali alternativnu adresu koju ste upisali.
Morate biti povezani na internet kako bi test bio uspešan.
Preporučuje se da uvek prvo testirate adresu pre nego što je sačuvate.
...
##### Uklanjanje početne tišine u zvuku govora {#TrimLeadingSilenceSpeech}

Kada je omogućeno, NVDA će ukloniti tišine iz početka zvuka govora, što će možda poboljšati brzinu nekih sintetizatora govora.
Ova opcija je podrazumevano omogućena, i trebala bi da utiče samo na tišine na početku govora.
Ako primetite da neki neophodni periodi tišine takođe nedostaju (na primer pauze između dve rečenice) kada koristite dodatak govornog sintetizatora, možete u potpunosti isključiti ovu opciju kako biste rešili problem.

##### Koristi WASAPI za SAPI 4 zvučni izlaz {#UseWASAPIForSAPI4}

Ova opcija dozvoljava Microsoft Speech API version 4 (SAPI 4) glasovima da reprodukuju zvukove korišćenjem Windows Audio Session API-a (WASAPI).
Ovo može dozvoliti SAPI 4 glasovima da podržavaju dodatne funkcije, kao što su stišavanje pozadinskih zvukova, uklanjanje početnih tišina i održavanje zvučnog uređaja budnim.
Ali, neki SAPI 4 glasovi možda neće raditi sa trenutnom WASAPI implementacijom.
Ako primetite da SAPI 4 glas koji koristite prestane da radi, možete onemogućiti ovu opciju.
...
Standardne obrnute kose crte u polju zamene dakle treba duplirati, na primer "a\\\\b" treba upisati kako bi se dobila zamena "a\\b".
...
|---|---|---|---|
|Sačuvaj podešavanja |`NVDA+kontrol+c` |`NVDA+kontrol+c` |Čuva vaša trenutna podešavanja kako ne bi bila izgubljena kada zatvorite NVDA|
|Vrati podešavanja |`NVDA+kontrol+r` |`NVDA+kontrol+r` |Pritiskanje jednom vraća podešavanja na ona koja ste poslednji put sačuvali. Pritiskanje tri puta ih vraća na fabrička.|
...
## Daljinski pristup {#RemoteAccess}

Sa ugrađenom NVDA funkcijom daljinskog pristupa, možete kontrolisati drugi računar na kom je NVDA pokrenut ili da dozvolite nekome da kontroliše vaš računar.
Ovo olakšava pružanje ili dobijanje pomoći, saradnju, ili pristup vašem računaru sa udaljene lokacije.

Daljinski pristup je podrazumevano onemogućen radi vaše bezbednosti.
Možete omogućiti daljinski pristup [u podešavanjima daljinskog pristupa](#RemoteSettings).

### Početak {#RemoteAccessGettingStarted}

Pre nego što počnete, uverite se da je NVDA instaliran i pokrenut na oba računara.
Takođe se uverite da je opcija omogući daljinski pristup [u podešavanjima daljinskog pristupa](#RemoteSettings) označena na oba računara.
Funkcija daljinskog pristupa će nakon toga biti dostupna iz menija alati u NVDA meniju; nema potrebe za dodatnim preuzimanjima ili instalacijama.

Ako je NVDA pokrenut u [bezbednom režimu](#SecureMode), ne možete ručno uspostaviti novu vezu daljinskog pristupa.
Ali, NVDA će ipak automatski započeti novu vezu daljinskog pristupa ako je podešen da to radi opcijom [Automatsko povezivanje nakon što se NVDA pokrene](#RemoteAutoconnect).
Još uvek možete ručno prekinuti vezu u bezbednom režimu.

### Uspostavljanje veze daljinskog pristupa {#RemoteAccessSetup}

Veze daljinskog pristupa se podešavaju u dijalogu povezivanja daljinskog pristupa.
Otvorite NVDA meni i izaberite alati, zatim "Daljinski pristup", a nakon toga "Poveži se...".
Ili bilo gde pritisnite `NVDA+alt+r`.

#### Izbor režima (kontrolišući ili kontrolisan) {#RemoteAccessMode}

Morate da odlučite koji računar će biti kontrolisan (kontrolisani računar) i koji računar će ga kontrolisati (kontrolišući računar).

izborni okvir režima vam dozvoljava da izaberete da li će ovaj računar biti kontrolisan (druga osoba će vršiti interakciju sa vašim računarom) ili kontrolišući (vi ćete vršiti interakciju sa računarom neke druge osobe).

* Ako vam treba pomoć neke druge osobe sa vašim računarom, izaberite "Dozvoli da ovaj računar bude kontrolisan".
* Ako ćete vi pomoći nekoj drugoj osobi na njenom računaru, izaberite "Kontroliši drugi računar".

#### Povezivanje na postojeći server (uz dobijenu adresu i šifru) {#RemoteAccessJoin}

U ovom slučaju, druga osoba se ili već povezala na postojeći server, ili je lokalno uspostavila vezu.

1. Kao server, izaberite "Koristi postojeći".
1. U polje adrese, upišite adresu servera (i port ako ste ga dobili).
  * Možete uključiti port veze dodavajući dvotačku (":") i broj porta adresi servera.
Na primer, `primer.com:1234`.
1. U polje šifre, upišite šifru koju ste dobili.
Pažljivo upišite tačnu šifru koju ste dobili.
1. Pritisnite u redu.

#### Uspostavljanje veze putem postojećeg servera {#RemoteAccessConnectRelay}

Ako dozvoljavate drugoj osobi da se poveže sa vama putem interneta, najlakša opcija je da koristite postojeći server. Kako biste ovo uradili:

1. Kao server, izaberite "Koristi postojeći".
1. Kao adresu, upišite adresu postojećeg servera, kao što je `nvdaremote.com`.
Moraćete da date ovu adresu drugoj osobi.
  * Možete uključiti port veze dodavajući dvotačku (":") i broj porta adresi servera.
Na primer, `primer.com:1234`.
1. Za šifru: Osmislite dugu šifru koju nije lako pogoditi, ili aktivirajte dugme "Generiši šifru" kako bi šifra bila automatski generisana.
Moraćete da je date drugoj osobi.
  * Imajte na umu da šifra i identifikuje trenutnu vezu a u isto vreme je i lozinka, tako da je veoma važno da ne bude laka za pogađanje.
1. Pritisnite u redu.
1. Dajte detalje veze (kao što su adresa i šifra) drugoj osobi kako bi mogla da se poveže.

#### Korišćenje NVDA kao servera {#RemoteAccessConnectSelfHosted}

Ako ne želite da koristite postojeći server ili ste povezani putem lokalne mreže:

1. Kao server, izaberite "Napravi lokalni".
1. Ako se povezujete putem interneta, možete pritisnuti dugme "saznaj eksterni IP" kako bi se prikazala vaša eksterna IP (internet vidljiva) adresa.
Moraćete da date ovu eksternu IP adresu drugoj osobi.
1. Ako se povezujete putem lokalne mreže, moraćete da date vaš lokalni IP drugoj osobi.
Pronalaženje ovih podataka nije pokriveno ovom dokumentacijom.
1. Kao port, upišite port koji želite da koristite za dolazne daljinske veze.
Drugoj osobi će takođe ovo biti neophodno.
  * Ovo treba da bude port koji se ne koristi od strane neke druge usluge.
  * Podrazumevano, daljinski pristup koristi port 6837.
  * Ako se povezujete putem interneta, port možda mora da bude preusmeren.
  Ova dokumentacija ne objašnjava kako se portovi preusmeravaju.
  Možda ćete morati da kontaktirate administratora vaše mreže kako biste ovo uradili.
1. Za šifru: Osmislite dugu šifru koju nije lako pogoditi, ili aktivirajte dugme "Generiši šifru" kako bi šifra bila automatski generisana.
Moraćete da je date drugoj osobi.
  * Imajte na umu da šifra i identifikuje trenutnu vezu a u isto vreme je i lozinka, tako da je veoma važno da ne bude laka za pogađanje.
1. Pritisnite u redu.
1. Dajte detalje povezivanja (kao što su adresa i šifra) drugoj osobi kako bi mogla da se poveže.

### Korišćenje daljinskog pristupa {#RemoteAccessUsage}

Nakon što je veza daljinskog pristupa uspostavljena, možete se prebaciti između kontrolisanja udaljenog računara i vašeg, deliti privremenu memoriju, i isključiti govor daljinske veze:

* Pritisnite `NVDA+alt+tab` da se prebacite između kontrolisanja udaljenog i vraćanja na vaš računar.
* Pošaljite tekst vaše privremene memorije drugom računaru otvaranjem NVDA menija, izborom opcije alati, zatim "daljinski pristup", zatim "pošalji privremenu memoriju".
* Ako ste povezani kao kontrolišući računar, možete isključiti govor udaljenog računara na vašem računaru otvaranjem NVDA menija, a zatim izborom opcije alati, nakon toga "Daljinski pristup", a zatim "Isključi govor udaljenog računara".
* Ako ste povezani kao kontrolišući računar, možete poslati prečicu `kontrol+alt+delete` kontrolisanom računaru otvaranjem NVDA menija, izborom opcije alati, zatim "Daljinski pristup", a nakon toga "Pošalji kontrol+alt+delete".
  Kako bi ovo radilo, kontrolisani računar mora da ima instaliranu kopiju programa NVDA.
  Takođe, u zavisnosti od podešavanja kontrolisanog računara, ova funkcija možda neće uvek raditi.

### Kratak opis komandi daljinskog pristupa {#RemoteAccessGestures}

<!-- KC:beginInclude -->
| Ime |Komanda |Opis|
|---|---|---|
| Uspostavi ili prekini daljinsku vezu | `NVDA+alt+r` | Uspostavlja novu vezu daljinskog pristupa ili, ako je veza već uspostavljena, prekida je. |
| Prebaci kontrolisanje | `NVDA+alt+tab` | Prebacuje se između kontrolisanja udaljenog i lokalnog računara. |
| Poveži se | Nema komande | Započinje novu vezu daljinskog pristupa. Nedostupno u [bezbednom režimu](#SecureMode). |
| Kopiraj link| Nema komande | Kopira link daljinske veze u vašu privremenu memoriju. |
| Prekini vezu | Nema komadne | Prekida postojeću vezu daljinskog pristupa. |
| Isključi govor udaljenog računara | Nema komande | Isključuje ili uključuje dolazni govor sa udaljenog računara. |
| Pošalji privremenu memoriju | Nema komande | Šalje sadržaj privremene memorije udaljenom računaru. |
<!-- KC:endInclude -->
...
#### Sortiranje liste dodataka po kolonama {#AddonStoreSortByColumn}

Podrazumevano, lista dodataka je sortirana prema prikazanim imenima.
Izborni okvir "sortiraj po kolonama" se može koristiti kako biste sortirali listu prema dostupnim kolonama za svaku karticu.
Na primer, možda želite da sortirate dodatke prema izdavaču, dostupnoj verziji, i tako dalje.
Dodaci se mogu sortirati prema rastućem i opadajućem redosledu.
...
Ako preuzimanje ili instalacija bude neuspešna možete ponovo pokušati instalaciju.
Takođe je moguće otkazati instalaciju pre nego što izađete iz prodavnice dodataka.
...
Možete onemogućiti dodatak ako status dodatka prikazuje da je "omogućen", ili da ga omogućite ako je "onemogućen".
...
#### Menjanje kanala automatskog ažuriranja {#AddonStoreUpdateChannel}

Možete upravljati kanalima automatskog ažuriranja za dodatke sa kartica [instalirani i dodaci koji se mogu ažurirati](#AddonStoreFilterStatus).
Kada su [automatska ažuriranja dodataka](#AutomaticAddonUpdates) omogućena, dodaci će biti ažurirani na istom [kanalu](#AddonStoreFilterChannel) sa kog su instalirani po [podrazumevanim podešavanjima](#DefaultAddonUpdateChannel).
Iz menija radnji za dodatak, korišćenjem podmenija "kanal ažuriranja", možete izmeniti kanale na koje će dodatak biti ažuriran.

| Opcija | Ponašanje |
|---|---|
| Podrazumevani| Dodatak će pratiti [podrazumevani kanal ažuriranja](#DefaultAddonUpdateChannel) |
| Isti | Dodatak će ostati na istom kanalu |
| Bilo koji | Dodatak će automatski biti ažuriran na najnoviju verziju, bez obzira na kanal |
| Ne ažuriraj | Dodatak neće automatski biti ažuriran |
| Stabilni | Dodatak će automatski biti ažuriran na stabilne verzije |
| Beta ili razvojni | Dodatak će automatski biti ažuriran na beta ili razvojne verzije |
| Beta | Dodatak će automatski biti ažuriran na beta verzije |
| Razvojni | Dodatak će automatski biti ažuriran na razvojne verzije |
...
Ponekad, može doći do problema u Windows registru, koji izazivaju da se NVDA ponaša neobično.
Ovo može izazvati, na primer, instalacija ili deinstalacija određenih programa (kao što su Adobe Reader ili Math Player), kao i Windows ažuriranja i drugi događaji.
Alatka za ispravljanje COM registracije pokušava da ispravi ovakve probleme popravljanjem stavki pristupačnosti u registru.

Vrste problema koje ova alatka rešava uključuju:

* NVDA prijavljuje "nepoznato" ili "okno", kada se krećete po pretraživačima kao što su Firefox ili Edge, mail programima kao što su Thunderbird, Windows Exploreru, traci zadataka, i drugim programima.
* NVDA ne može da se prebacuje između režima fokusiranja i režima pretraživanja kada to očekujete.
* Dugmići čija su imena ranije bila izgovarana, iznenadno se prijavljuju samo kao "dugme".
* NVDA postaje veoma spor kada se krećete po pretraživačima dok koristite režim pretraživanja.

Zbog toga što ova alatka ispravlja stavke u Windows registru, zahteva administratorski pristup kako bi radila, slično instalaciji programa.
Ako vam je UAC (kontrola korisničkog naloga) omogućena, što je slučaj za većinu korisnika, moraćete da odobrite sve upite koji se prikazuju kada se kontrola korisničkog naloga prikaže, kako biste uspešno pokrenuli alatku.
...
Za detaljniju listu besplatnih i komercijalnih sintetizatora koje možete da kupite i preuzmete za korišćenje uz NVDA, molimo pogledajte [stranicu extra voices](https://github.com/nvaccess/nvda/wiki/ExtraVoices).
...
Brailliant BI i B serije redova kompanije [HumanWare](https://www.humanware.com/), uključujući BI 14, BI 32, BI 20X, BI 40, BI 40X i B 80, su podržane kada se povežu putem USB ili Bluetooth-a.
...
Slede tasterske prečice za Brailliant BI/B i BrailleNote touch redove uz NVDA.
...
Za BrailleNote Touch, molimo pogledajte odeljak [Brailliant BI Series / BrailleNote Touch](#HumanWareBrailliant).
...
|strelicaLevo |Razmak+tačka3, džojstik levo ili dpad levo|
...
Dot Pad kompanije Dot Inc je uređaj koji može da prikazuje osveživu taktilnu grafiku kao i brajevo pismo.
NVDA može da prikaže ili jedan red brajevog pisma na delu površine uređaja za prikazivanje brajevog pisma, ili više redova brajevog pisma na delu površine za taktilnu grafiku.
A300 model ima površinu za taktilnu grafiku koja je veličine 120 puta 80 tačaka, koja može da sadrži 8 redova sa po 20 ćelija u svakom.

Možete da podesite da li će NVDA prikazati brajevo pismo u jednom redu površine za brajevo pismo ili na delu površine za taktilnu grafiku opcijom brajevog odredišta u NVDA brajevim podešavanjima za ovaj drajver.

Tasteri za pomeranje su podržani, ali zbog ograničenih tastera na ovom uređaju, druge komande i mogućnosti prebacivanja trenutno nisu dostupne.

Kada izaberete Dot Pad drajver u NVDA-u, morate ručno izabrati USB / Bluetooth virtuelni serijski port na kom je Dot Pad povezan.
Ovaj drajver ne podržava automatsko prepoznavanje.

Molimo imajte na umu da zbog hardverskih ograničenja, Dot Pad neće ispravno osvežiti sve tačke dok je vaša ruka na uređaju.
Uverite se da ste u potpunosti podigli vašu ruku sa uređaja kada se krećete uz NVDA, i počnite ponovo da čitate tek nakon što se u potpunosti osveži.

<!-- KC:beginInclude -->

| Ime|Komanda|
|---|---|
|Pomeri brajev red nazad | `pan_left` |
|Pomeri brajev red napred | `pan_right` |
...
* Otvaranje eksternih dokumenata iz NVDA menija, kao što je datoteka korisničkog uputstva.
...
|`-n LANGUAGE` |`--lang=Jezik` |Zamenite podešen NVDA jezik. Podesite na "Windows" za trenutni korisnički podrazumevani, "en" za engleski, i tako dalje.|
...
|`-d` |`--disable-addons` |Dodaci neće imati nikakvog uticaja|
...
|Nema |`--create-portable-silent` |Pravi prenosnu NVDA kopiju (bez pokretanja nove kopije). Zahteva da `--portable-path` bude određen. Ova opcija će zanemariti upozorenja kada se kopija pravi u direktorijumima koji nisu prazni i može zameniti datoteke bez upozorenja.|
|Nema |`--portable-path=AdresaKopije` |Adresa na kojoj će prenosna kopija biti napravljena|

Kao što možete tiho da instalirate NVDA korišćenjem opcije komandne linije `--install-silent` u NVDA-u, možete ga tiho deinstalirati opcijom `/S` u deinstalaciji.

Deinstalacija NVDA-a se zove `uninstall.exe` i nalazi se u direktorijumu u kom je NVDA instaliran, `%ProgramFiles(x86)%\nvda` na 64-bitnom Windowsu, ili `%ProgramFiles%\nvda` na 32-bitnom Windowsu.

Slede opcije komandne linije za NVDA deinstalaciju:

| kratka |Duga |Opis|
|---|---|---|
|`/S` |Nema |tiha NVDA deinstalacija. |
