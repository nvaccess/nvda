...
Това позволява разделяне на звуците на NVDA в един канал (напр. левия), докато звуците от всички други приложения се поставят в другия канал (напр. десния).

Има нови команди за модифициране на пръстена от настройки на синтезатора, което позволява на потребителите да преминават към първата или последната настройка и да увеличават или намаляват текущата настройка с по-голяма стъпка.
...
Когато е активен, брайловият дисплей показва точно това, което NVDA ще изговори.
Добавена е поддръжка за брайловите устройства BrailleEdgeS2 и BrailleEdgeS3.
LibLouis беше обновен, като са добавени нови подробни (с указани главни букви) беларуски и украински брайлови таблици, заедно с испанска таблица за четене на гръцки текстове.
...
* Нови клавишни команди:
  ...
  * Добавени са команди за преминаване към началото, края, напред и назад през пръстена от настройки на синтезатора. (#13768, #16095, @rmcpantoja)
    ...
    * Намаляване и увеличаване на текущата настройка на пръстена от настройки на синтезатора с по-голяма стъпка (#13768):
      * Настолна подредба: `NVDA+Control+Page Up` или `NVDA+Control+Page Down`.
      * Лаптоп подредба: `NVDA+Control+Shift+Page Up` или `NVDA+Control+Shift+Page Down`.
  * Добавен е нов неприсвоен жест на въвеждане за превключване на докладването на фигури и надписи. (#10826, #14349)
* Брайл:
  * Добавена е поддръжка за брайловите устройства BrailleEdgeS2 и BrailleEdgeS3. (#16033, #16279, @EdKweon)
...
* Разделяне на звука: (#12985, @mltony)
  * Позволява отделяне на звуците на NVDA в един канал (напр. левия), докато звуците от всички други приложения се поставят в другия канал (напр. десния).
  * Функцията се включва и изключва чрез `NVDA+Alt+S`.
  * Силата на звука на другите приложения може да се регулира чрез `NVDA+Alt+Page Up` и `NVDA+Alt+Page Down`. (#16052, @mltony)
  * Звукът от другите приложения може да бъде изключен чрез `NVDA+Alt+Delete`. (#16052, @mltony)
...
* Магазин за добавки:
  ...
  * Действието за отзиви от общността ще бъде налично и уеб страницата за отзиви ще бъде показана в панела с подробности във всички раздели на магазина. (#16179, @nvdaes)
* Обновени компоненти:
  * Брайловият преводач LibLouis е обновен до [3.29.0](https://github.com/liblouis/liblouis/releases/tag/v3.29.0). (#16259, @codeofdusk)
    * Добавени са нови подробни (с указани главни букви) беларуски и украински брайлови таблици, заедно с испанска таблица за четене на гръцки текстове.
...
* Промяната на състоянието на елементите за отмятане за избор на колони се докладва автоматично при избиране на колони за показване в списъка със съобщения на Thunderbird. (#16323)
