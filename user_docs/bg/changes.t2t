...
- Неработещ ScriptableObject (например GlobalPlugin с липсваща заявка към основния клас __init__ метод) вече не нарушава обработката на скриптове в NVDA. (#5446)
...
- Вече има работна среда за тестване на елементи за NVDA. (#7026)
 - Тестовете за елементи и инфраструктурата са разположени в директорията tests/unit. За повече информация вижте docstring във файла tests\unit\__init__.py.
...
- Подкласовете на драйвера на синтезатора sapi5 вече могат да презаписват _getVoiceTokens и extend __init__, за да поддържат потребителски имена на гласовете, както със sapi.spObjectTokenCategory за получаване на имена от потребителско местоположение в регистъра на Windows.
