...
+ NVDA-installationsprogrammet viser licensaftalen.
Tryk på ``pil ned`` for at læse licensaftalen, hvis du ønsker dette.
+ Tryk på ``tab`` for at flytte til check boxen "Enig", og tryk derefter på ``mellemrumstasten`` for at markere det.
+ Tryk på ``tab`` for at gå gennem mulighederne, og tryk derefter på ``enter`` på den ønskede indstilling.
+
...
+ Fra startprogrammet skal du sikre dig, at check box for at acceptere licensen er markeret.
+ ``Tab`` til, og aktiver knappen "Installer NVDA på denne computer".
+ Dernæst er der muligheder for at bruge NVDA under Windows-logon og for at oprette en skrivebordsgenvej.
...
+ En Windows "Brugerkontokontrol (UAC)"-dialogboks vises og spørger "Vil du tillade denne app at foretage ændringer på din pc?".
+ Tryk på ``alt+y`` for at acceptere UAC-prompten.
+ En statuslinje vil gradvist bevæge sig på skærmen, efterhånden som NVDA installerer.
...
+ Der vises en dialogboks, der bekræfter, at installationen af NVDA er lykkedes.
...
+ Dialogboksen "Velkommen til NVDA" vises, og NVDA læser en velkomstmeddelelse.
...
+ Tryk på ``tab`` for at gå til "Brug ``caps Lock`` som en NVDA-tast".
...
+ Brug ``tab`` og ``mellemrumstasten`` for at justere de andre muligheder på denne skærm.
Disse bestemmer om NVDA starter automatisk.
+ Tryk på ``enter`` for at lukke dialogboksen. NVDA vil fortsætte med at køre.
+
...
+ Åbne dialogen til håndtering af kommandoer, når du er i gennemsynstilstand.
+ Find "Flytter til næste fane" under "Gennemsynstilstand".
+ Tildel bogstavet ``y`` som tastetryk.
+ Find "flytter til forrige fane".
+ Tildel bogstavet ``shift+y`` som tastetryk.
+
...
+ Flyt markøren til teksten, der indeholder noten.
+ Vis menuen til behandlingen af udvalgt tekst, som beskrevet ovenfor.
+ Vælg "Edit Note".
+
...
%kc:setting
==== Åbn dialogen for valg af talesyntese ====
Tast: ``NVDA+control+s``
...
%kc:setting
==== Åbn dialog til valg af punktdisplay ====
Tast: ``NVDA+control+a``
...
%kc:setting
==== Åbn indstillinger for objektpræsentation ====
Tast: ``NVDA+control+o``
...
%kc:setting
==== Åbn indstillinger for gennemsynstilstand ====
Tast: ``NVDA+control+b``
...
%kc:setting
==== Åbn indstillinger for dokumentformatering ====
Tast: ``NVDA+control+d``
...
Se venligst dokumentationen til dit display for at finde ud af, hvor du kan finde knapperne.
+++ Tastekombinationer til alle modeller +++
%kc:beginInclude
|| Navn | Tast |
...
+++ Tastekombinationer for Brailliant BI 32, BI 40 og B 80 +++
%kc:beginInclude
|| Navn | Tast |
...
+++ Tastekombinationer for Brailliant BI 14 +++
%kc:beginInclude
|| Navn | Tast |
| Pil op | joystick op |
...
+ Sørg for, at du har installeret [den seneste driver https://www.papenmeier-rehatechnik.de/en/service/downloadcenter/software/articles/software-braille-devices.html].
+ Åbn enhedshåndtering i Windows.
+ Gå ned til "USB-controllere" eller "USB-enheder".
+ Vælg "Papenmeier Braillex USB Device".
+ Åbn "Egenskaber" og gå til fanen "Avanceret".
...
+ Deaktivér indstillingen "Load VCP".
+
