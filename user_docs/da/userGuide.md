...
Du kan læse yderligere information om, hvilke data indsamles i NVDAs generelle indstillinger under [Tillad at NVDA-projektet indsamler brugsdata](#GeneralSettingsGatherUsageStats).
...
Læs venligst [dokumentationen om navigationskommandoer til MathPlayer](https://www.dessci.com/en/products/mathplayer/navigation_commands.htm) for flere oplysninger.
...
Dette kræver for det første, at "Oplæs kolonne- og rækkeoverskrifter" er slået til i NVDAs dokumentformateringsindstillinger, fundet i indstillingskategorien dokumentformatering under [NVDAs indstillingsdialog](#NVDASettings).
...
##### Åbn generelle indstillinger {#toc105}
...
##### Tillad at NVDA-projektet indsamler brugsdata om NVDA {#GeneralSettingsGatherUsageStats}
...
##### Åbn dialogen for valg af talesyntese {#toc138}
...
##### Åbn dialog til valg af punktdisplay {#toc161}
...
##### Punktdisplay[SelectBrailleDisplayDisplay] {#toc162}
...
Hvis du vil slå funktionen til og fra ved hjælp af en tastaturkommando eller bevægelse, kan du tildele et tastetryk eller en bevægelse ved at bruge [dialogen "Håndter Kommandoer"](#InputGestures).
...
##### Åbn tastaturindstillinger {#toc176}
...
##### Oplæs rolle når musen flyttes ind over et objekt {#MouseSettingsRole}
...
##### Åbn indstillinger for objektpræsentation {#toc206}
...
##### Åbn indstillinger for gennemsynstilstand {#toc224}
...
##### Åbn indstillinger for dokumentformatering {#toc238}
...
| . {.hideHeaderRow} |.|
|---|---|
|Indstillinger |Standard (Håndteret af det aktuelle program), Håndteret af det aktuelle program, Enkelt linjeskift, Flere linjeskift|
...
#### Avancerede Indstillinger {#toc246}
...
##### Tillad indlæsning af tilpasset kode fra mappen Developer Scratchpad {#toc249}
...
##### Åbn mappen Developer Scratchpad {#toc250}
...
| . {.hideHeaderRow} |.|
|---|---|
|Indstillinger |Automatisk, selektivt, globalt|
|Standard |Automatisk|
...
##### Benyt UI Automation til at få adgang til kontrolelementer for Microsoft Word-dokumenter {#toc252}
...
##### Interval for markøren (i MS) {#toc263}
...
##### Aktiverede logningskategorier {#toc266}
...
I Windows 7, 8 og 8.1, vil NVDA benytte eSpeak NG som standard ([Windows OneCore](#OneCore) benyttes i Windows 10 og nyere).
...
#### Tastekombinationer til alle modeller {#toc319}
...
#### Tastekombinationer for Brailliant BI 32, BI 40 og B 80 {#toc320}
...
#### Tastekombinationer for Brailliant BI 14 {#toc321}
