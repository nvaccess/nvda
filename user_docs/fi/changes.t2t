...
= 2018.3.2 =
Tämä versio kiertää ongelman, jossa Google Chrome kaatui selatessa twiittejä osoitteessa www.twitter.com. (#8777)
...
- Kun NVDA on määritetty käynnistymään Windowsiin kirjautumisen jälkeen, se käynnistyy nyt paljon aiemmin Windows 8:ssa ja uudemmissa. (#308)
 - Jos olet ottanut tämän asetuksen käyttöön aiemmassa NVDA:n versiossa, sinun on poistettava se käytöstä ja otettava sitten uudelleen käyttöön Yleiset asetukset -valintaikkunassa, jotta muutos tulee voimaan. Tee seuraavasti:
  + Avaa Yleiset asetukset -valintaikkuna.
  + Poista valinta Käynnistä automaattisesti sisäänkirjautumisen jälkeen -valintaruudusta.
  + Paina OK-painiketta.
  + Avaa Yleiset asetukset -valintaikkuna uudestaan.
  + Valitse Käynnistä automaattisesti sisäänkirjautumisen jälkeen -valintaruutu.
  + Paina OK-painiketta.
...
- Selaustilan käyttäminen on nyt mahdollista Internet Explorer 10:ssä (esim. www.gmail.com -kirjautumissivulla) yhteensopivuustilassa oltaessa. (#3151)
