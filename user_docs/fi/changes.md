...
Tässä versiossa esitellään NVDA:n etäkäyttötoiminto, jonka avulla voidaan hallita toista NVDA:ta käyttävää tietokonetta etäyhteyden kautta.

Puheeseen on tehty useita parannuksia, erityisesti SAPI 4-, SAPI 5- ja OneCore-äänien vasteaikaan liittyen.
SAPI 5 tukee nyt tehostettua puhenopeutta ja automaattista kielen vaihtamista.
SAPI 4 -äänet tukevat nyt äänen vaimennusta, alun hiljaisuuden poistamista sekä äänilaitteen pitämistä aktiivisena.

Lisäosakaupan automaattista päivitysjärjestelmää on paranneltu. Voit nyt valita automaattisten päivitysten kanavat ja suorittaa päivitykset taustalla.

Lisätty uudet komennot tekstintunnistustuloksen manuaaliseen päivittämiseen sekä ajoittaisen päivityksen käyttöönottamiseen tai käytöstä poistamiseen.

Alkuperäinen valintatila on nyt käytettävissä Chromessa ja Edgessä.

Microsoft Officen ja LibreOfficen tuki on parantunut, erityisesti siten, että useampien pikanäppäimien toiminnot ilmoitetaan käyttäjälle.

Oletusarvoiset pistekirjoituksen syöttö- ja tulostustaulukot voidaan nyt määrittää NVDA:n kielen perusteella.
NVDA:han on lisätty sisäänrakennettu tuki Dot Inc:n Dot Pad -kohografiikkalaitteelle monirivisenä pistenäyttönä.
Tehty muita pieniä korjauksia pistenäyttöihin, erityisesti yhdistämiseen liittyen.

LibLouis-pistekääntäjä, eSpeak-NG ja Unicode CLDR on päivitetty.
Uudet koptin, tiivistetyn nuolenpääkirjoituksen ja portugalin 6 pisteen tietokonemerkistön pistetaulukot ovat nyt käytettävissä.

### Tärkeitä huomautuksia

* Tämä versio ei ole yhteensopiva olemassa olevien lisäosien kanssa.

### Tietoturvakorjaukset

Ilmoita tietoturvaongelmista vastuullisesti NVDA:n tietoturvakäytäntöä noudattaen.

* Estää mahdollisesti arkaluontoisten tietojen näyttämisen pistenäytöllä laitteen ollessa lukittuna.
([GHSA-8f8q-2jc3-6rf4](https://github.com/nvaccess/nvda/security/advisories/GHSA-8f8q-2jc3-6rf4))
* Estää asennusohjelmaa lataamasta ei-toivottuja DLL-tiedostoja hakemistostaan.
([GHSA-qf5h-qw92-rx2f](https://github.com/nvaccess/nvda/security/advisories/GHSA-qf5h-qw92-rx2f))

### Uudet ominaisuudet

* Lisäosakauppa:
  * Automaattiset päivitykset (#3208):
    * Lisäosien automaattisen päivityksen kanavien muokkaaminen on nyt mahdollista.
      * Asennettujen lisäosien automaattisen päivityksen kanavat voidaan valita "Päivityskanava"-alivalikosta.
      * Oletusarvoinen automaattisen päivityksen kanava voidaan määrittää NVDA-asetusten Lisäosakauppa-paneelista.
    * Automaattiset päivitykset voidaan nyt suorittaa taustalla.
      * Tämä voidaan ottaa käyttöön NVDA-asetusten Lisäosakauppa-paneelissa vaihtamalla "Automaattiset päivitykset" -kohtaan "Päivitä automaattisesti".
    * Automaattiset päivitykset voivat nyt päivittää yhteensopimattomia lisäosia uudempaan yhteensopimattomaan versioon.
      * Tämä voidaan ottaa käyttöön NVDA-asetusten Lisäosakauppa-paneelissa.
  * Lisätty toiminto, joka peruuttaa lisäosien asennuksen. (#15578, @hwf1324)
  * Lisätty toiminto, joka yrittää uudelleen lisäosan latauksen tai asennuksen epäonnistuessa. (#17090, @hwf1324)
  * Lisäosaluettelot voidaan lajitella sarakkeiden, kuten julkaisupäivämäärän, perusteella nousevassa ja laskevassa järjestyksessä. (#15277, #16681, @nvdaes)
* Puhe:
  * Microsoft Speech API versio 5 (SAPI 5) ja Microsoft Speech Platform -äänet tukevat nyt automaattista kieen vaihtamista. (#17146, @gexgd0419)
  * Microsoft Speech API versio 5 (SAPI 5) ja Microsoft Speech Platform -äänet tukevat nyt tehostettua puhenopeutta. (#17606, @gexgd0419)
* Verkkoselaimet:
  * NVDA:n selaustilan alkuperäistä valintatilaa (`NVDA+Vaihto+F10`) tuetaan nyt Google Chromessa, Edgessä sekä muissa Chromium 134:ään tai sitä uudempaan pohjautuvissa sovelluksissa. (#17838)
  * NVDA ilmoittaa Mozilla Firefoxissa korostetun tekstin avattaessa tekstikatkelman sisältävää URL-osoitetta. (#16910, @jcsteh)
  * NVDA ilmoittaa nyt, kun linkin kohde osoittaa nykyiselle sivulle. (#141, @LeonarddeR, @nvdaes)
* Microsoft Office:
  * PowerPointin tekstikentissä muokattaessa on nyt mahdollista siirtyä lause kerrallaan näppäinyhdistelmällä `Alt+Ylänuoli` tai `Alt+Alanuoli`. (#17015, @LeonarddeR)
  * Valinnan päivittyminen ilmoitetaan nyt Wordissa, kun sen laajentamiseen tai supistamiseen käytetään komentoja `F8` tai `Vaihto+F8`. (#3293, @CyrilleB79)
  * NVDA ilmoittaa nyt sekä puheella että pistekirjoituksella Word 16.0.18226:ta ja sitä uudempia versioita tai Word-objektimallia käytettäessä, jos otsikko on kutistettu. (#17499)
  * Kohdistimen liikkuminen ilmoitetaan nyt Wordissa UIA-rajapintaa käytettäessä, kun käytetään alkuperäisiä taulukkonavigointikomentoja (`Alt+Home`, `Alt+End`, `Alt+Page up` ja `Alt+Page down`). (#17867, @CyrilleB79)
  * Asiakirjan asettelu ilmoitetaan Wordissa, jos tieto on saatavilla ja objektien kuvausten ilmoittaminen on käytössä "Puhu kohdistus" -komentoa käytettäessä. (#15088, @nvdaes)
  * Wordissa ja Outlookissa ilmoitetaan nyt aiempaa useamman pikanäppäimen suorittamat toiminnot:
    * fontin muotoilupikanäppäimet (#10271, @CyrilleB79)
    * otsikon kutistaminen ja laajentaminen (#17545, @CyrilleB79)
* LibreOffice:
  * NVDA ilmoittaa uuden fonttikoon Writerissa, kun sitä suurennetaan tai pienennetään pikanäppäimillä. (#6915, @michaelweghorn)
  * NVDA ilmoittaa uuden kappaletyylin, kun Writer 25.2:ssa tai uudemmassa otetaan käyttöön leipäteksti- tai otsikkokappaletyyli pikanäppäimellä. (#6915, @michaelweghorn)
  * Kun Writerissa vaihdetaan kaksoisalleviivausta pikanäppäimellä, NVDA ilmoittaa uuden tilan ("kaksoisalleviivaus käytössä" tai "kaksoisalleviivaus pois"). (#6915, @michaelweghorn)
  * NVDA ilmoittaa nyt ensimmäisen rivin sisennyksen LibreOffice 25.8:ssa ja sitä uudemmissa versioissa. (#13052, @michaelweghorn)
* Tekstintunnistus:
  * `NVDA+F5` päivittää tunnistetun sisällön manuaalisesti tunnistustuloksen ikkunassa. (#17715, @CyrilleB79)
  * Lisätty määrittämätön näppäinkomento Windowsin tekstintunnistustuloksen ajoittaisen päivityksen käyttöönottamiseen ja käytöstä poistamiseen. (#16897)
* Etäkäyttötoiminto, joka perustuu NVDA-etäkäyttö-lisäosaan, on nyt integroitu NVDA:han. (#4390, @ctoth, @tspivey, @daiverd, NVDA-etäkäytön tekijät ja rahoittajat)
* NVDA-päivityksiä ja lisäosakauppaa varten on nyt mahdollista määrittää peilipalvelimien URL-osoitteet. (#14974, #17151, #17310, @christopherpross)
* Lisätty tuki PDF-tiedostoissa olevalle matemaattiselle sisällölle. (#9288, @NSoiffer)
  * Tämä toimii MathML:ää sisältäville kaavoille, kuten uudemmilla TeX- tai LaTeX-versioilla luoduissa tiedostoissa.
  * Tätä tuetaan toistaiseksi vain Foxit Readerissa ja Foxit Editorissa.
* NVDA voidaan nyt määrittää puhumaan nykyinen rivi tai kappale liikuttaessa pistenäytön siirtymisnäppäimillä. (#17053, @nvdaes)
* NVDA ilmoittaa nyt kohdistimen muutoksista esimerkiksi Visual Studio Codessa painettaessa `Alt+Ylänuoli`- tai `Alt+Alanuoli`-näppäinyhdistelmää. (#17652, @LeonarddeR)
* Lisätty komennot, joilla tarkastelukohdistin siirretään valitun tekstin ensimmäiseen ja viimeiseen merkkiin. Näppäinkomennot ovat `NVDA+Alt+Home` ja `NVDA+Alt+End`. (#17299, @nvdaes)
* Lisätty Yleiset-kategoriaan asetus, joka estää näytön sammumisen jatkuvassa luvussa tai pistenäytöllä luettaessa.
Tämä asetus on oletusarvoisesti käytössä, mutta se saattaa kuluttaa akkua tavallista enemmän. (#17649, @LeonarddeR)
* NVDA on nyt käännetty bosniaksi. (#17953)
* NVDA lukee ja käsittelee nyt Adobe Acrobatissa Microsoft Wordin uudemmilla versioilla luotujen PDF-tiedostojen matemaattiset kaavat. (#18056)

### Muutokset

* Päivitetyt komponentit:
  * LibLouis-pistekääntäjä päivitetty versioksi [3.33.0](https://github.com/liblouis/liblouis/releases/tag/v3.33.0). (#17469, #17768, @LeonarddeR, @codeofdusk)
    * Lisätty seuraavat uudet pistetaulukot: kopti, tiivis nuolenpääkirjoitus sekä portugalin 6 pisteen tietokonemerkistö.
  * CLDR päivitetty versioksi 46.0. (#17484, @OzancanKaratas)
  * eSpeak NG päivitetty versioksi 1.52.0. (#17056)
* Käyttöliittymän muutokset:
  * NVDA:n asennusohjelma ei enää toista ääntä käynnistettäessä. (#14068)
  * Linkin kohteen, merkin muotoilutiedot ja valitun tekstin näyttävään valintaikkunaan on nyt lisätty Sulje- ja Kopioi-painikkeet käyttäjän mukavuuden vuoksi. (#17018, @XLTechie)
  * NVDA:n voi nyt käynnistää uudelleen sulkemisvalintaikkunasta siten, että lisäosat ovat poissa käytöstä ja virheenkorjausloki on käytössä samanaikaisesti. (#11538, @CyrilleB79)
  * WASAPIn käyttöä äänentoistossa ei voi enää poistaa käytöstä. (#16080)
  * Selaustilan asetus "Siirrä järjestelmän kohdistus automaattisesti kohdistettaviin elementteihin" on poistettu, eikä tämä toiminto ole enää käytettävissä. (#17598)
  * NVDA varoittaa lisäosien yhteensopimattomuudesta vain päivitettäessä uuteen versioon, jonka lisäosarajapinta ei ole yhteensopiva nykyisen version kanssa. (#17071, #17506)
  * "Tekijät"-vaihtoehto on poistettu NVDA:n Ohje-valikosta. (#16922)
  * NVDA:n lisenssi on nyt HTML-muodossa luettavuuden parantamiseksi. (#17600)
  * Useimmin käytetyille komentorivivalitsimille on lisätty lyhyet versiot: `-d` vastaa valitsinta `--disable-addons` ja `-n` valitsinta `--lang`.
  Komentorivivalitsimien etuliitteen vastaavuutta ei enää tueta, esim. `--di` ei enää vastaa `--disable-addons`-valitsinta. (#11644, @CyrilleB79)
  * Muutoksia COM-rekisteröintien korjaustyökaluun: (#12355, @XLTechie)
    * Se näyttää nyt aluksi varoituksen sijaan käyttäjäystävällisemmän selityksen tarkoituksestaan. (#12351)
    * Alkuikkunan voi nyt sulkea painamalla `Esc` tai `Alt+F4`. (#10799)
    * Se näyttää nyt käyttäjälle virheilmoituksen, jos COM-uudelleenrekisteröintien aikana ilmenee harvinainen Windows-virhe.
* Puhe:
  * Microsoft Speech API versio 5- ja Microsoft Speech Platform -äänet käyttävät nyt WASAPIa äänen toistoonn, mikä saattaa parantaa näiden äänien vastetta. (#13284, @gexgd0419)
  * Puheen alussa oleva hiljaisuus poistetaan vasteen parantamiseksi OneCore-, SAPI 5 -ääniä sekä kolmannen osapuolen äänilisäosia käytettäessä. (#17614, @gexgd0419)
  * SAPI 4 -äänet käyttävät nyt WASAPIa äänen toistoon, jotta ne toimivat äänen vaimennuksen, puheen alun hiljaisuuden poistamisen ja äänilaitteen aktiivisena pitämisen kanssa.
  Jos tämä ei toimi käyttämäsi SAPI 4 -äänen kanssa, voit lisäasetuksista poistaa WASAPIn käytöstä SAPI 4:lle. (#17718, #17801, @gexgd0419)
  * Unicode-normalisointi on nyt oletusarvoisesti käytössä puheella. (#17017, @LeonarddeR).
    * Tämän toiminnallisuuden käytöstä poistaminen on edelleen mahdollista NVDA:n asetusvalintaikkunan Puhe-kategoriasta.
...
* Pistekirjoituksen oletusarvoiset syöttö- ja tulostustaulukot voidaan nyt määrittää NVDA:n kielen perusteella. (#17306, #16390, #290, @nvdaes)

### Korjatut virheet

* Puhe:
  * Korjattu ongelma, jonka vuoksi jatkuva luku pysähtyi ensimmäisen lauseen lopussa joitakin SAPI 5 -syntetisaattoreita käytettäessä. (#16691, @gexgd0419)
  * Ääniparametrien, kuten nopeuden ja voimakkuuden, oletusarvoja ei enää palauteta vaihdettaessa SAPI 5- ja SAPI 4 -syntetisaattoreiden ääniä syntetisaattorin asetusrengasta käyttäen. (#17693, #2320, @gexgd0419)
  * Korjattu ongelma, jonka vuoksi joitakin SAPI 4 -ääniä (esim. kiinankielistä IBM TTS:ää) ei voitu ladata. (#17726, @gexgd0419)
* Pistekirjoitus:
  * Sisäänrakennettu tuki Dot Inc:n Dot Pad -kohografiikkalaitteelle monirivisenä pistenäyttönä. (#17007)
  * Seika Notetakerin Väli- ja Väli+pisteet-näppäinkomennot näytetään nyt oikein Näppäinkomentojen valintaikkunassa. (#17047, @school510587)
  * NVDA ei enää toista virheääniä tai täytä lokitiedostoa käytettäessä "Näytä puhetuloste" -pistekirjoitustilaa ilman kytkettyä pistenäyttöä. (#17092, @Emil-18)
  * Kun "HID Braille" on valittu pistenäyttöajuriksi ja pistenäyttöluettelo avataan, NVDA tunnistaa oikein HID-ajurin valituksi sen sijaan, että näyttäisi "ei valittua ajuria". (#17537, @LeonarddeR)
  * Humanware Brailliant -pistenäyttöajuri on nyt luotettavampi oikean yhteyspisteen valinnassa, mikä parantaa yhteyden vakautta ja vähentää virheitä. (#17537, @LeonarddeR)
  * Kehittäjän scratchpad-hakemiston mukautetut pistetaulukot jätetään nyt asianmukaisesti huomiotta, kun NVDA:ta käytetään ilman lisäosia. (#17565, @LeonarddeR)
  * Korjattu ongelma, jonka vuoksi jotkin USB-pistenäytöt eivät tunnistuneet oikein. (#18114, @christiancomaschi)
* Microsoft Office:
  * Linkin URL-osoitteen ilmoittava näppäinkomento toimii nyt odotetusti Wordissa, Outlookissa, Excelissä ja PowerPointissa vanhaa objektimallia käytettäessä. (#17292, #17362, #17435, @CyrilleB79)
  * Kommenttien tai kaavojen näyttäminen ei enää epäonnistu elementtilistassa (`NVDA+F7`) joissain ei-englanninkielisissä järjestelmissä. (#11366, @CyrilleB79)
  * Parannuksia PowerPointiin:
    * Kohdistimen ilmoittaminen ei enää häiriinny, kun tekstissä on leveitä merkkejä, kuten emojeja. (#17006 , @LeonarddeR)
    * NVDA ilmoittaa nyt merkin sijainnin tarkasti (esimerkiksi painettaessa `NVDA+Delete`). (#9941, @LeonarddeR)
    * NVDA ei enää aloita jatkuvaa lukemista diaesityksen käynnistyessä, jos selaustilan asetus "Lue sivu automaattisesti sen latauduttua" on poistettu käytöstä. (#17488, @LeonarddeR)
* LibreOffice:
  * Kun käytetään kiinalaista Microsoft Pinyin -syöttömenetelmää ja otetaan käyttöön sen yhteensopivuusasetus edellisen version käyttämiseksi, Writerissa (ja mahdollisesti muissa sovelluksissa) kirjoittaminen ei enää aiheuta virhettä IME-ponnahdusikkunan ollessa näkyvissä. (#17198, @michaelweghorn)
  * Valintaruutujen nykyinen tila (valittu/ei valittu) ilmoitetaan nyt myös pistenäytöllä. (#17218, @michaelweghorn)
* Matemaattinen sisältö:
  * Matemaattisen sisällön lukeminen on nyt korjattu tietyissä verkkosivun elementeissä.
  Erityisesti MathML-sisältö span- ja muissa elementeissä, joilla on `role="math"`-attribuutti. (#15058)
  * Matemaattiset yhtälöt, jotka on esitetty vain kuvana ja alt-tekstinä ilman MathML:ää monipuolista navigointia varten, käsitellään nyt tavallisina kuvina eikä matemaattisina elementteinä, joissa ei ole sisältöä, mikä mahdollistaa niihin siirtymisen `G`:llä ja alt-tekstin selaamisen merkeittäin. (#16007)
* Integroidut kehitysympäristöt:
  * NVDA ei enää kaadu valittaessa kaikki tiettyjen lähdekooditiedostojen sisältämä teksti Android Studiossa tai IntelliJ Ideassa. (#17418, @thgcode)
  * NVDA ei enää kaappaa Visual Studio Codessa `Alt+Ylänuoli`- ja `Alt+Alanuoli`-näppäinkomentoja lausenavigointiin. (#17082, @LeonarddeR)
  * Tietyt osioelementit tunnistetaan nyt oikein muokattaviksi säätimiksi Visual Studio Codessa. (#17573, @Cary-rowen)
  * Windows 11:ssä pistenäytön "Siirrä seuraavalle riville" -komento siirtää Muistiossa, muissa UIA-dokumenteissa sekä Notepad++:ssa kohdistimen viimeiselle riville myös silloin, kun se on tyhjä.
  Jos ollaan asiakirjan viimeisellä rivillä, tämä komento siirtää kohdistimen sen loppuun. (#17251, #17430, @nvdaes)
* Asetusprofiilit:
  * Pistekirjoitus ei enää lakkaa näkymästä, kun jatkuva luku aktivoidaan siihen liitetyn määritysprofiilin kautta. (#17163, @LeonarddeR)
  * Korjattu ongelma, jonka vuoksi tietyt asetukset tallentuivat käytössä olevaan asetusprofiiliin myös silloin, kun niiden arvo oli sama kuin perusasetuksissa. (#17157, @leonarddeR)
* Unicode-normalisointi toimii nyt aiempaa tarkoituksenmukaisemmin kirjainten tavaamisessa:
  * Kun NVDA on lukenut normalisoidun merkin, seuraavia merkkejä ei enää tulkita virheellisesti normalisoiduiksi. (#17286, @LeonarddeR)
  * Yhdistetyt merkit (kuten é) puhutaan nyt oikein. (#17295, @LeonarddeR)
* NVDA pystyy nyt lukemaan ponnahdusalavalikon kohteet Thunderbirdin hakutulossivulla. (#4708, @thgcode)
* COM-rekisteröintien korjaustyökalu ei enää ilmoita onnistumisesta, jos korjausten suorittaminen epäonnistui. (#12355, @XLTechie)
* NVDA ei enää ilmoita Windows 11:n leikepöydän historiaan tallennetuista merkinnöistä, kun ikkuna suljetaan ja kohteita on tallennettuna. (#17308, @josephsl)
* Jos liitännäiset ladataan uudelleen selattavan ilmoituksen ollessa avoinna, NVDA ei enää jätä ilmoittamatta seuraavista kohdistuksen siirroista. (#17323, @CyrilleB79)
* NVDA:n puhe ja äänet eivät enää vaimene, kun esim. Skypeä, Discordia, Signalia tai Puhelinlinkkiä käytetään äänikeskusteluihin. (#17349, @jcsteh)
* NVDA:n Python-konsolin avaaminen ei enää epäonnistu, jos tilannevedosmuuttujien hakemisen aikana tapahtuu virhe. (#17391, @CyrilleB79)
* Muokattavien tekstikenttien valitun tekstin muutokset eivät enää jää toisinaan ilmoittamatta verkkoselaimissa. (#17501, @jcsteh)
* Kun ankkurilinkit osoittavat samaan kohteeseen, jossa virtuaalikohdistin on, NVDA vierittää nyt asianmukaisesti linkin osoittamaan kohteeseen. (#17669, @nvdaes)
* NVDA:n korostusikkunan (NVDA Highlighter) kuvake ei enää jää näkyviin tehtäväpalkkiin, kun Resurssienhallinta käynnistetään uudelleen. (#17696, @hwf1324)
...
Tämä versio korjaa virheitä, jotka liittyvät pistenäyttöjen käyttöön sekä matemaattisten kaavojen lukemiseen Chromiumissa.

### Korjatut virheet

* Korjattu virhe, joka ilmeni luettaessa matemaattisia kaavoja Chromium-pohjaisissa selaimissa (Chrome, Edge jne.). (#17421, @NSoiffer)
* Humanware Brailliant BI 40X -pistenäytöt, joissa on laiteohjelmiston versio 2.4, toimivat nyt odotetusti. (#17518, @bramd)

## 2024.4.1

Tämä on korjauspäivitys puhesymbolisanastojen tallennusvirheen korjaamiseksi.

### Korjatut virheet

* Korjattu virhe, joka aiheutti sen, ettei puhesymbolisanastoja tallennettu eikä valintaikkunaa suljettu. (#17344)
...
Kaikkia pisterivejä hyödynnetään nyt käytettäessä monirivistä pistenäyttöä HID Braille -protokollan kautta.
...
* Kaikkien rivien pistesoluja hyödynnetään käytettäessä monirivistä pistenäyttöä HID Braille -pistenäyttöajurin kautta. (#16993, @alexmoon)
...
* Pistekirjoitus:
  ...
  * Seika Notetakerin ajuri tuottaa nyt asianmukaisesti pistesyötteen väli- ja askelpalautin-näppäimille sekä pisteet+väli/askelpalautin-komennoille. (#16642, @school510587)
...
Tämä on pieni julkaisu, jossa on korjattu automaattisessa lisäosapäivitysilmoituksessa ilmennyt virhe.
...
* Windows 11:
  ...
  * NVDA puhuu taas näkyvät ehdokkaat IME-käyttöliittymää avattaessa. (#14023, @josephsl)
...
* NVDA pitää äänilaitteen aktiivisena puheen päätyttyä estääkseen seuraavan puhejakson alun leikkautumisen joillakin äänilaitteilla, kuten Bluetooth-kuulokkeilla. (#14386, @jcsteh, @mltony)
...
* Matemaattisten attribuuttien virheellinen lukeminen korjattu Adobe Readerissa. Ongelma vaikutti puheeseen ja pistekirjoitukseen. (#17980)
* Windows 11:n korjaukset:
  * NVDA puhuu jälleen fyysisen näppäimistösyötteen ehdotukset. (#16283, @josephsl)
...
* Korjaukset Chromium-pohjaisille selaimille UIA:ta käytettäessä:
  * Korjattu NVDA:n jumiutumisen aiheuttaneet virheet. (#16393, #16394)
...
* Korjattu virhe, joka aiheutti sen, että äänikoordinaatit ilmaistiin sovelluksen ollessa lepotilassa ja "Ilmaise hiiren koordinaatit äänimerkeillä" -asetuksen ollessa käytössä. (#8059, @hwf1324)
* NVDA ei enää ohita Adobe Readerissa kaavoihin lisättyä vaihtoehtoista tekstiä PDF:issä. (#12715)
* Korjattu virhe, joka aiheutti sen, ettei NVDA lukenut Geekbenchin valintanauhaa ja asetuksia. (#16251, @mzanm)
...
* Lisätty tuki Bluetooth Low Energy -yhteyttä hyödyntäville HID Braille -pistenäytöille. (#15470)
* Uusi alkuperäinen valintatila (otetaan käyttöön ja poistetaan käytöstä näppäinkomennolla `NVDA+Vaihto+F10`) on nyt käytettävissä  NVDA:n selaustilassa Mozilla Firefoxissa.
Kun se on käytössä, tekstin valitseminen selaustilassa vaikuttaa myös Firefoxin omaan, alkuperäiseen valintaan.
Tekstinkopiointikomento `Ctrl+C` välitetään suoraan Firefoxille, jolloin muotoilutkin kopioidaan pelkän NVDA:n tekstiesityksen sijaan.
...
* SAPI 4 -syntetisaattoriajuri tukee nyt asianmukaisesti puhuttuun tekstiin sisällytettyjä äänenvoimakkuuden, nopeuden ja korkeuden muutoksia. (#15271, @LeonarddeR)
...
* Korjattu virhe, joka aiheutti sen, että jos aiempi NVDA-prosessi ei sulkeutunut oikein, NVDA:n asennus saattoi epäonnistua ja joutua palautumattomaan tilaan. (#16122)
...
Virheenkorjauksia lisäosakauppaan, Microsoft Officeen, Edgen pikavalikoihin sekä Windowsin laskimeen.
...
* Pistekirjoitus:
  ...
  * Korjattu virhe, jossa Albatross-pistenäytöt yrittävät alustaa itsensä, vaikka toinen pistenäyttö on kytkettynä. (#15226)
* Lisäosakauppa:
  * Korjattu virhe, joka aiheutti yhteensopimattomien lisäosien näyttämisen, vaikka "Näytä yhteensopimattomat lisäosat" -valintaruudun valinta oli poistettu. (#15411)
  ...
  * Korjattu virhe, joka esti käytössä olevien yhteensopivuusohitettujen lisäosien päivittämisen tai korvaamisen ulkoisesta lähteestä asennetulla versiolla. (#15417)
  * Korjattu virhe, joka aiheutti sen, ettei NVDA puhunut mitään lisäosan asennuksen jälkeen ennen kuin se käynnistettiin uudelleen. (#14525)
  * Korjattu virhe, joka aiheutti sen, ettei lisäosia voitu asentaa, jos aiempi lataus epäonnistui tai peruutettiin. (#15469)
...
* Pistekirjoitus:
  * Kun pistenäyttöä käytetään HID Braille -ajurilla, dpadia voidaan käyttää nuolinäppäinten ja Enterin jäljittelemiseen.
...
* Pistekirjoitus:
  ...
  * NVDA ei enää vaihda tarpeettomasti Ei pistenäyttöä -ajuriin useasti automaattisen tunnistuksen aikana, minkä ansiosta loki on selkeämpi ja muistin käyttö vähenee. (#14524)
...
* Windows 11:
  ...
  * NVDA puhuu taas ehdokaskohteet kirjoitettaessa esim. kiinan- ja japaninkielistä tekstiä. (#14509)
  * NVDA:n Ohje-valikon Tekijät- ja Lisenssi-kohteiden avaaminen on taas mahdollista. (#14725)
* Microsoft Office:
...
* Korjattu virhe, joka aiheutti NVDA:n jumiutumisen ja lokitiedoston täyttymisen, kun UIA-tuki pakotettiin käyttöön tietyissä päätteissä ja konsoleissa. (#14689)
...
* Korjattu NVDA:n asetusten tallentamiseen ja lataamiseen, syntetisaattorien vaihtaminen mukaan lukien, liittyvä virhe. (#14760)
* Korjattu virhe, joka sai tekstintarkastelun "pyyhkäise ylös" -kosketuseleen vaihtamaan sivua sen sijaan, että olisi siirtänyt edelliselle riville. (#15127)
...
* Korjattu ongelma, jonka vuoksi asetusmuutokset eivät tallentuneet oikein vaihdettaessa "Oletus"-asetuksen ja sen arvojen välillä. (#14133)
...
* Korjattu virhe, joka ilmeni siirryttäessä Firefoxissa taulukon ensimmäiseen ja viimeiseen sarakkeeseen. (#14554)
...
* Korjattu virhe, joka aiheutti sen, että jos NVDA jää jumiin järjestelmää lukittaessa, NVDA sallii pääsyn työpöydälle Windowsin lukitusnäytöllä oltaessa. (#14416)
* Korjattu virhe, joka aiheutti sen, että jos NVDA jää jumiin järjestelmää lukittaessa, NVDA ei toimi oikein, ikään kuin laite olisi edelleen lukittu. (#14416)
* Korjattu Windowsin "unohdin PIN-koodini" -prosessin sekä päivitys/asennuskokemuksen saavutettavuusongelmia. (#14368)
* Korjattu virhe, joka ilmeni yritettäessä asentaa NVDA:ta joissakin Windows-ympäristöissä, esim. palvelinversiossa. (#14379)
...
* Korjattu ongelma, jonka vuoksi puheentarkastelun teksti tallennettiin välimuistiin Windowsia lukittaessa.
...
eSpeak on päivitetty, ja se sisältää 3 uutta kieltä: valkovenäjä, luxemburg ja Pohjois-Ylämaan sekoitus.
...
* Korjattu virhe, joka mahdollisti kahden samanaikaisen Näppäinkomennot-valintaikkunan avautumisen. (#13854)
...
* Korjattu virhe, jonka vuoksi NVDA ei ilmoittanut "Suojattu työpöytä" suojatulle työpöydälle siirryttäessä.
...
* Korjattu virhe, joka aiheutti sen, etteivät näppäinkomennot aina toimineet. (#14065)
...
* Uusia taulukkonavigointikomentoja on lisätty. (#957)
  * `Ctrl+Alt+Home/End` siirtävät ensimmäiseen tai viimeiseen sarakkeeseen.
  * `Ctrl+Alt+Page up/Page down` siirtävät ensimmäiseen tai viimeiseen riviin.
...
Tehty parannuksia pistenäyttöajureihin, Seika Notetaker, Papenmeier ja HID Braille mukaan lukien.
...
* Microsoft Office 16.0.15000:ssa ja uudemmissa NVDA käyttää Windows 11:ssä oletusarvoisesti UI Automation -rajapintaa Word-asiakirjoissa, mikä parantaa merkittävästi suorituskykyä vanhaan objektimalliin verrattuna. (#13437)
  * Tämä koskee sekä Microsoft Word -asiakirjoja että viestien lukemista ja kirjoittamista Microsoft Outlookissa.
...
* Korjattu ongelma, jonka vuoksi useiden asetusvalintaikkunoiden samanaikainen avaaminen oli mahdollista. (#12818)
* Korjattu ongelma, jonka vuoksi jotkin Focus Blue -pistenäytöt lakkasivat toimimasta sen jälkeen kun tietokone herätettiin lepotilasta. (#9830)
...
* Estetty virhe, joka aiheutti tekstin lukemista kahteen kertaan Windows-konsolia ja -päätettä käytettäessä. (#13261)
...
* Korjattu virhe, joka aiheutti NVDA:n kaatumisen Papenmeier-pistenäyttöajuria valittaessa. (#13348)
...
* HID Braille -protokolla voidaan poistaa käytöstä Lisäasetukset-paneelin asetuksella. (#13180)
...
eSpeak-syntetisaattori ja LibLouis-pistekääntäjä on päivitetty.
...
* Tämä versio ei ole yhteensopiva olemassa olevien lisäosien kanssa.
* Adobe Flashin tuki on poistettu tästä versiosta.
...
* Seika-pistenäyttöjen ohjain korjattu. (#10787)
...
Parannuksia symbolien lausumissääntöihin, puhesanastoihin, pistekirjoitusilmoituksiin ja pikanäppäinten käyttöön jatkuvassa luvussa.
...
* Käyttäjille ilmoitetaan nyt heidän yrittäessään luoda puhesanastomerkintöjä virheellisillä säännöllisen lausekkeen korvauksilla. (#11407)
...
* Päivitetty liblouis-pistekääntäjä versioksi 3.16.1:
  * Korjaa useita kaatumisongelmia.
  * Lisätty baškiirin tason 1 pistekirjoitustaulukko.
  * Lisätty tietokonemerkistöä käyttävä koptilainen 8 pisteen pistetaulukko.
  * Lisätty venäläisiä pistetaulukoita: kaunokirjallinen pistekirjoitus ja kaunokirjallinen pistekirjoitus (yksityiskohtainen).
  * Lisätty afrikaansin tason 2 pistetaulukko.
  * Poistettu venäläinen tason 1 pistetaulukko.
* Etsi seuraava- ja Etsi edellinen -komennot eivät keskeytä lukemista selaustilassa jatkuvaa lukua käytettäessä, jos Salli pikanäppäimet jatkuvassa luvussa -asetus on käytössä. Jatkuva luku jatkaa sen sijaan seuraavan tai edellisen löytyneen hakusanan jälkeen. (#11563)
...
* Merkitty (korostettu) sisältö ilmoitetaan sekä puheena että pistekirjoituksella kaikissa verkkoselaimissa. (#11436)
  * Tämä voidaan ottaa käyttöön ja poistaa käytöstä NVDA:n uudella asiakirjojen muotoilu -kategoriassa olevalla korostusasetuksella.
...
* Kun Salli pikanäppäimet jatkuvassa luvussa -asetus on käytössä, luetteloista ja taulukoista poistuminen nuolinäppäimillä jatkuvassa luvussa ei enää aiheuta jatkuvaa ilmoitusta poistumisesta. (#10706)
...
* Pikanavigointikomennoilla on nyt mahdollista liikkua artikkeleittain ja ryhmittäin Internet Explorerissa, Google Chromessa sekä Mozilla Firefoxissa. Näihin komentoihin ei oletusarvoisesti ole liitetty näppäimiä, mutta ne voidaan määrittää Näppäinkomennot-valintaikkunasta, kun se avataan selaustila-asiakirjan ollessa avoimena. (#9485, #9227)
  * Myös kuvat ilmoitetaan. Ne katsotaan objekteiksi, joten niiden välillä voi liikkua O-pikanavigointinäppäimellä.
...
* Lisätty näyttöverho, joka käytössä ollessaan pimentää koko ruudun Windows 8:ssa ja uudemmissa. (#7857)
  * Lisätty skripti näyttöverhon käyttöönottamiselle (yksi painallus ottaa sen käyttöön seuraavaan uudelleenkäynnistykseen asti tai kaksi painallusta pitää sen käytössä niin kauan kuin NVDA on käynnissä). Oletusarvoista näppäinkomentoa ei ole määritetty.
  * Voidaan ottaa käyttöön ja määrittää NVDA:n asetusvalintaikkunan Näkö-kategoriansta.
...
* Valittu kohde ilmoitetaan nyt listaruuduissa ja puunäkymissä selaustilassa oltaessa Mozilla Firefoxissa ja Google Chromessa.
  * Toimii Firefox 66:ssa ja sitä uudemmissa.
...
* NVDA ei enää lataa käyttäjän omia sovellusmoduuleita, yleisliitännäisiä tai pistenäyttö- ja syntetisaattoriajureita käyttäjän asetushakemistosta. Tällainen koodi tulee sen sijaan pakata lisäosaksi, jossa on oikeat versiotiedot, jotta varmistetaan, ettei yhteensopimatonta koodia suoriteta NVDA:n nykyisillä versioilla. (#9238)
  * Kehittäjien, jotka haluavat testata koodiaan, tulee ottaa käyttöön kehittäjän scratchpad-hakemisto NVDA-asetusten Lisäasetukset-kategoriasta, ja sijoittaa koodinsa "scratchpad"-hakemistoon, joka löytyy käyttäjän NVDA-asetusten hakemistosta, kun tämä asetus on otettu käyttöön.
...
* Lisätty tuki useille Windows 10:n viimeisimmissä versioissa esitellyille moderneille syöttöominaisuuksille. Näitä ovat emojipaneeli (Fall Creators -päivitys), sanelu (Fall Creators -päivitys), fyysisen näppäimistösyötteen ehdotukset (huhtikuun 2018 päivitys) sekä pilvileikepöydän liittäminen (maaliskuun 2018 päivitys). (#7273)
...
* Jos käyttäjä on sallinut käyttötilastojen lähettämisen, NVDA lähettää nyt päivitystä tarkistettaessa nykyisen syntetisaattorin ja käytössä olevan pistenäytön nimen, jotta niiden ajureiden tulevaa kehitystä voidaan priorisoida paremmin. (#8217)
...
* Useita parannuksia Microsoft Wordin pistenäyttötukeen UI Automationin ollessa käytössä:
  ...
  * Kohdistimen siirtäminen pistenäytön kosketuskohdistinnäppäimillä toimii nyt asianmukaisesti oltaessa Word-asiakirjan luettelossa. (#7971)
  * Uudet Word-asiakirjaan lisätyt luettelomerkit ja numerot ilmaistaan asianmukaisesti sekä puheella että pistenäytöllä. (#7970)
...
* Vuorovaikutus Microsoft Wordin ja PowerPointin kaavioiden kanssa on nyt mahdollista samalla tavoin kuin Excelissä. (#7046)
  ...
  * PowerPointissa diaa muokattaessa: Siirry Sarkain-näppäimellä kaavio-objektiin ja paina Enteriä tai Välilyöntiä ollaksesi vuorovaikutuksessa kaavion kanssa.
...
* Pistekirjoituksen syöttäminen on nyt mahdollista ALVA 640 Comfort -pistenäytöllä. (#7733)
  * NVDA:n pistesyöttötoiminnallisuutta voidaan käyttää tällä laitteella sekä muilla BC6-näytöillä, joissa on laiteohjelmiston versio 3.0.0 tai uudempi.
...
* Kun näyttönäppäimistöllä kirjoitetaan kosketusvuorovaikutuksen avulla, kutakin näppäintä on oletusarvoisesti kaksoisnapautettava samoin kuin mitä tahansa muutakin säädintä aktivoitaessa. (#7309)
  * Kosketuskirjoitustila, jossa sormen nostaminen näppäimeltä riittää sen painamiseen, otetaan käyttöön uudessa Kosketuksen vuorovaikutus -valintaikkunassa, joka löytyy Asetukset-valikosta.
* Pistenäyttöä ei ole enää tarpeen määrittää seuraamaan erikseen kohdistusta tai tarkastelukohdistinta, sillä se tapahtuu nyt oletuksena automaattisesti. (#2385)
  * Huom: Tarkastelukohdistinta seurataan automaattisesti vain tekstintarkastelu- tai objektinavigointikomentoa käytettäessä. Näytön vierittäminen ei aktivoi tätä toiminnallisuutta.
...
* NVDA voi nyt käyttää Windows 10:n tekstintunnistustoimintoa kuvien tai esteellisten sovellusten tekstin tunnistamiseen. (#7361)
  ...
  * Katso lisätietoja käyttöoppaan Sisällöntunnistus-luvusta.
* Uudella Pistekirjoitusasetukset-valintaikkunan "Kohdistuskontekstin näyttäminen" -asetuksella voit nyt valita, mitä kontekstitietoja pistenäytöllä näytetään kohdistuksen siirtyessä objektiin. (#217)
  * Esimerkiksi "täytä näyttö kontekstin muuttuessa"- ja "vain taaksepäin vieritettäessä" -asetukset voivat tehdä luetteloiden ja valikoiden käytöstä tehokkaampaa, koska kohteiden sijainti näytöllä ei jatkuvasti muutu.
  * Katso lisätietoja ja esimerkkejä käyttöoppaan "Kohdistuskontekstin näyttäminen" -luvusta.
...
* NVDA näyttää nyt pistenäytöllä oletusarvoisesti vain osan muuttuneista kontekstitiedoista kohdistuksen siirtyessä objektiin. (#217)
  * Aiemmin tietoja näytettiin mahdollisimman paljon riippumatta siitä, onko ne jo näytetty.
...
* Korjattu harvinainen ongelma, jossa sarjaporttien skannaus teki joissakin järjestelmissä pistenäyttöajureista käyttökelvottomia. (#6462)
...
* Kun moderni Microsoftin syöttömenetelmän ehdokaslista suljetaan , kohdistus palautetaan asianmukaisesti joko syöttömenetelmään tai kohdeasiakirjaan. (#4145)
...
* Kun NVDA on määritetty käynnistymään Windowsiin kirjautumisen jälkeen, se käynnistyy nyt paljon aiemmin Windows 8:ssa ja uudemmissa. (#308)
  * Jos olet ottanut tämän asetuksen käyttöön aiemmassa NVDA:n versiossa, sinun on poistettava se käytöstä ja otettava sitten uudelleen käyttöön Yleiset asetukset -valintaikkunassa, jotta muutos tulee voimaan. Tee seuraavasti:
    ...
    1. Avaa Yleiset asetukset -valintaikkuna uudelleen.
...
* Kaikille NVDA:n asetusvalintaikkunoille ja asiakirjojen muotoiluasetuksille on nyt mahdollista määrittää syöte-eleitä (näppäinkomentoja, kosketuseleitä jne) Syöte-eleet-valintaikkunaa käyttäen. (#4898)
...
* Riviotsikot luetaan nyt automaattisesti Microsoft wordissa sellaisissa taulukoissa, joiden otsikkosolun tekijä on nimenomaisesti määritellyt taulukon ominaisuuksissa. (#4510)
  * Tämä ei toimi yhdistettyjä rivejä sisältävissä taulukoissa. Tällaisissa tilanteissa voit silti määrittää sarakeotsikot manuaalisesti näppäinkomennolla NVDA+Vaihto+C.
...
* Tuki Microsoft Outlook 2007:n ja sitä uudempien versioiden kalenterille (#2943) mukaan lukien:
  * Nykyisen kellonajan ilmoittaminen nuolinäppäimillä liikuttaessa.
  * Ilmoitus, jos valittuna ajankohtana on tapaamisia.
  * Valitun tapaamisen lukeminen Sarkainta painettaessa.
  * Päiväyksen älykäs suodatus, jolloin se luetaan vain, jos uusi valittuna oleva ajankohta tai tapaaminen on eri päivänä kuin edellinen.
* Paranneltu tuki Outlook 2010:n ja sitä uudempien versioiden Saapuneet- sekä muiden kansioiden viestiluetteloille (#3834) mukaan lukien:
  * Mahdollisuus sarakeotsikoiden (lähettäjä, aihe jne.) hiljentämiseen poistamalla käytöstä "Lue taulukon rivi- ja sarakeotsikot" -asetus asiakirjojen muotoiluasetuksista.
...
* Paranneltu tuki sarakkeiden ja rivien otsikoiden automaattiselle lukemiselle Microsoft Excelissä (#3568) mukaan lukien:
  * Tuki Excelin nimetyille alueille JAWS-ruudunlukijan kanssa yhteensopivien otsikkosolujen tunnistamista varten.
  * Määritä sarakeotsikot (NVDA+Vaihto+C)- ja Määritä riviotsikot (NVDA+Vaihto+R) -komennot tallentavat nyt asetuksensa laskentataulukkoon siten, että ne ovat käytettävissä seuraavan kerran taulukkoa avattaessa ja myös muille ruudunlukijoille, jotka tukevat määritetyn nimialueen rakennetta.
  * Näitä komentoja on nyt mahdollista käyttää useita kertoja samassa laskentataulukossa otsikoiden määrittämiseen eri alueille.
...
* Microsoft Excel: Entistä useammat valinnan siirtämiskomennot antavat palautetta sekä puheena että pistekirjoituksella (#4211) mukaan lukien:
  ...
  * Valinnan laajentaminen (edellä mainitut näppäimet yhdessä Vaihto-näppäimen kanssa)
  * Nykyisen alueen valitseminen (Ctrl+Vaihto+8)
...
* Microsoft PowerPoint: Muodon nykyinen sijainti luetaan siirrettäessä sitä diassa nuolinäppäimillä (#4214) mukaan lukien:
  * Muodon ja dian reunojen välinen etäisyys luetaan.
...
* Lue sijainti -komento (NVDA+Delete) on joissakin tapauksissa tilannekohtaisempi. (#4219):
  * Kohdistimen sijainti ilmoitetaan tavallisissa muokkauskentissä ja selaustilassa sisällön prosenttiosuutena sekä ruudun koordinaatteina.
  * Muodon sijainti ilmoitetaan PowerPoint-esityksissä suhteessa diaan ja muihin muotoihin.
...
* Asiakirjojen muotoiluasetukset -valintaikkunassa olevalla uudella asetuksella on nyt mahdollista valita, tunnistetaanko asiakirjojen sisältö napsautettavaksi. Asetus on oletusarvoisesti käytössä (toimii kuten aiemmin). (#3556)
...
* Kun Salli pikanäppäimet jatkuvassa luvussa -asetus on käytössä, NVDA ilmoittaa nyt tarkemmin jatkuvassa luvussa selaustilan pikanavigointikomentoja käytettäessä uuden kentän (ts. sanoo otsikkoa otsikoksi sen sijaan, että lukisi vain sen tekstin). (#3689)
* Säilön loppuun tai alkuun siirtävät pikanavigointikomennot noudattavat nyt Salli pikanäppäimet jatkuvassa luvussa -asetusta (ts. ne eivät enää keskeytä jatkuvaa lukua). (#3675)
...
* ARIA:n aktiivisten alueiden tukea paranneltu Firefoxissa ja muissa Mozilla Gecko -sovelluksissa:
  ...
  * Vaihtoehtoinen teksti (kuten alt-attribuutti tai aria-label) näytetään nyt, mikäli muuta käyttökelpoista tekstiä ei ole. (#3329)
  * Aktiivisten alueiden päivityksiä ei enää jätetä huomiotta, mikäli ne tapahtuvat samanaikaisesti kohdistuksen siirtyessä. (#3777)
...
* Näppäimistöasetukset-valintaikkunan uusi "Salli pikanäppäimet jatkuvassa luvussa" -asetus mahdollistaa asiakirjassa liikkumisen selaustilan pikanavigointia sekä riveittäin/kappaleittain siirtäviä komentoja käyttäen jatkuvan luvun aikana. Asetus on oletusarvoisesti poissa käytöstä. (#2766)
...
* Korjattu ongelma, jonka vuoksi HumanWaren Brailliant BI- ja B-sarjan pistenäytön ajuria ei näytetty Pistekirjoitusasetukset-valintaikkunassa joissakin järjestelmissä, vaikka kyseinen näyttö oli yhdistettynä USB:n kautta.
...
* Korjattu ongelma, joka aiheutti joissakin tilanteissa Freedom Scientificin pistenäyttöajurin toimimattomuutta, kun portiksi oli määritetty USB. (#3509, #3662)
* Korjattu ongelma, jonka vuoksi Freedom Scientificin pistenäyttöjen näppäimiä ei tunnistettu joissakin tilanteissa. (#3401, #3662)
...
* Kokonaistarkastelu on korvattu objektin-, asiakirjan- ja ruuduntarkastelutiloilla. (#2996)
  * Objektin tarkastelu lukee vain navigointiobjektissa olevaa tekstiä, asiakirjan tarkastelu kaikkea mahdollisesti selaustila-asiakirjassa olevaa tekstiä ja ruudun tarkastelu ruudulla olevaa tekstiä nykyisessä sovelluksessa.
  * Aiemmin kokonaistarkasteluun ja siitä pois siirtäneet komennot vaihtavat nyt näiden uusien tarkastelutilojen välillä.
  * Navigointiobjekti seuraa automaattisesti tarkastelukohdistinta siten, että se pysyy tarkastelukohdistimen kohdalla asiakirjan- tai ruudun tarkastelu -tiloissa oltaessa.
  * NVDA pysyy ruudun tarkastelu -tilassa siihen vaihtamisen jälkeen kunnes vaihdetaan takaisin asiakirjan- tai objektin tarkastelu -tilaan.
  * NVDA voi vaihtaa automaattisesti asiakirjan- tai objektin tarkastelu -tilassa oltaessa näiden kahden tilan välillä riippuen siitä, liikutaanko selaustila-asiakirjassa vai ei.
...
* Lukumerkkijono luetaan nyt oikein Windows XP:ssä esim. Easy Dots IME -syöttömenetelmällä.
* Yksinkertaistetun kiinan Microsoft Pinyin -syöttömenetelmän ehdokaslista luetaan nyt oikein vaihdettaessa sivuja vasemmalla ja oikealla nuolella ja avattaessa sitä ensimmäistä kertaa Home-näppäimellä Windows 7:ssä.
...
* HumanWare Brailliant BI/B -pistenäyttöajuri on nyt mahdollista valita, kun näyttö on kytketty tietokoneeseen bluetoothilla, mutta ei vielä kertaakaan USB:llä.
...
* NVDA tukee nyt aasialaisten kielten merkkien kirjoittamista IME- ja Tekstipalvelu-syöttömenetelmillä kaikissa sovelluksissa. Lisäksi on mahdollista:
  * Ehdokaslistojen lukeminen ja niissä liikkuminen.
  * Koostemerkkijonojen lukeminen ja niissä liikkuminen.
  * Lukumerkkijonojen lukeminen.
...
* Kokeellinen tuki kosketusnäytöille Windows 8:ssa, mukaan lukien:
  * Kun sormea liikutetaan, NVDA lukee sen alla olevan tekstin.
...
* Sivunumerot luetaan nyt Adobe Readerissa. (#2534)
  * Reader XI:ssä ilmoitetaan sivun nimikkeet, jos ne ovat käytettävissä, jolloin huomioidaan esimerkiksi eri osioiden sivunumeroinnin muutokset. Tämä ei ole mahdollista vanhemmissa versioissa, ja lisäksi vain peräkkäiset sivunumerot luetaan.
...
* Puhesanastot tallentuvat nyt oikein käytettäessä Korvattava teksti- ja Korvaava teksti -kentissä #-merkkiä. (#961)
...
* NVDA:n toiminnallisuuden laajentaminen on tehty helpommaksi lisäosien hallinnalla (löytyy NVDA-valikosta Työkalut-valikon alta), joka mahdollistaa liitännäisiä ja ajureita sisältävien lisäosapakettien (.nvda-addon-tiedostojen) asentamisen ja poistamisen. Huomaa, että käsin asetushakemistoon kopioidut vanhemmat liitännäiset ja ajurit eivät näy lisäosien hallinnassa. (#213)
...
* Asiakirjojen muotoiluasetukset -valintaikkunasta on nyt mahdollista määrittää, luetaanko asiakirjojen kehykset. (#1900)
...
* NVDA lukee nyt Mozilla Gecko -moottoria käyttävien sovellusten (esim. Firefoxin) selaustila-asiakirjojen tietyt osat sellaisessa tilanteessa, jossa elementin tyyli on display:table. (#1373)
...
* Handy Tech -pistenäyttöjä on nyt mahdollista käyttää ilman yleisajuria. (#854)
...
* Puhesanastovalintaikkunoiden sanastomerkintälistan Säännöllinen lauseke- ja Sama kirjainkoko -sarakkeiden sisältö näytetään nyt NVDA:ssa määritetyllä kielellä sen sijaan, että ne näytettäisiin aina englanniksi.
...
* Korjattu ongelma, jonka vuoksi jotkin kohteet näytettiin tyhjinä Adobe Reader -dokumenteissa, esim. sisällysluettelon linkit Apple iPhone iOS 4.1 -käyttöohjeessa.
...
* Adobe Reader 10 ei enää kaadu sen jälkeen, kun koodattujen asiakirjojen asetuksista poistutaan ennen käsittelyvalintaikkunan ilmestymistä. (#1218)
...
* Otettu käyttöön kokonaistarkastelun komennot: (#58)
  * NVDA+Laskinnäppäimistön 7 vaihtaa kokonaistarkasteluun ja sijoittaa tarkastelukohdistimen nykyisen objektin kohdalle, mikä mahdollistaa koko ruudun tai asiakirjan lukemisen tekstintarkastelukomennoilla.
  * NVDA+Laskinnäppäimistön 1 siirtää tarkastelukohdistimen sen kohdalla olevan tekstin sisältävään objektiin, mikä mahdollistaa objekteittain liikkumisen kyseisestä kohdasta lähtien.
...
* Korjattu ongelma, joka aiheutti sen, että osaa tiettyjen PDF-asiakirjojen tekstistä ei voitu lukea.
...
* Samanaikainen puhe ja äänimerkit eivät  enää aiheuta ajoittaisia jumiutumisia käytettäessä sisäänrakennettua eSpeak-puhesyntetisaattoria. Eniten tätä tapahtui esim. kopioitaessa suurta tiedostomäärää Resurssienhallinnassa.
...
* Poistettu viive, joka esiintyi siirryttäessä muutoin kuin merkeittäin (esimerkiksi sanoittain tai riveittäin) suurten pelkkää tekstiä sisältävien asiakirjojen loppua kohti Mozilla Geckon näennäispuskureissa. (#155)
...
* Puhesanastot (aiemmin käyttäjän sanastot) voivat nyt olla joko kirjainkoon huomioivia tai sellaisia, joissa kirjainkoolla ei ole väliä, ja korvattavat merkkijonot voivat olla valinnaisesti säännöllisiä lausekkeita. (#39)
...
* Korjattu Adobe Reader -versioiden 8 ja 9 alkeellinen tuki, jotta PDF-asiakirjojen lukeminen on mahdollista.
...
* NVDA:ssa on nyt sisäänrakennettu eSpeak-puhesyntetisaattori, joka tukee useita kieliä ja on erittäin herkkä ja kevyt. SAPI-syntetisaattoreita voidaan edelleen käyttää, mutta eSpeakia käytetään oletusarvoisesti.
  * eSpeak ei tarvitse erikoisohjelmistoa toimiakseen, joten sitä voidaan käyttää NVDA:ssa millä tahansa tietokoneella, USB-muistitikulta tai mistä tahansa muusta sijainnista.
  * Katso lisätietoja tai lataa muita versioita menemällä osoitteeseen https://espeak.sourceforge.net/.
...
* NVDA:han on lisätty komentoriviparametreja:
  * -m, --minimal: käynnistys- tai sulkemisääniä ei toisteta eikä käyttöliittymää näytetä käynnistettäessä, jos niin on määritelty.
...
* Lisätty asetusvalintaikkunat näennäispuskureille ja asiakirjojen muotoilulle.
...
* Lisätty SAPI 4 -tuki. Ajureita on kaksi, yksi Serotek Corporationin lahjoittamaan koodiin perustuva ja yksi ActiveVoice.ActiveVoice-COM-rajapintaa käyttävä. Molemmissa on ongelmia, joten kannattaa kokeilla, kumpi toimii parhaiten.
