...
* Lisäosakauppa:
  * Korjattu bugi, joka aiheutti sen, että yhteensopimattomat lisäosat näytettiin, vaikka "Näytä yhteensopimattomat lisäosat" -valintaruudun valinta oli poistettu. (#15411)
...
eSpeak-NG, LibLouis-pistekirjoituskääntäjä ja Unicode-CLDR on päivitetty.
...
* Päivitetyt osat:
  ...
  * LibLouis-pistekirjoituskääntäjä päivitetty versioksi [3.26.0](https://github.com/liblouis/liblouis/releases/tag/v3.26.0). (#14970)
...
* Lisätty kokeellinen asetus UIA-ilmoitustuen hyödyntämiseen Windows Terminalissa päätteen uuden tai muuttuneen tekstin lukemista varten, mikä parantaa vakautta ja reagointikykyä. (#13781)
...
* Päivitetty LibLouis-pistekirjoituskääntäjä versioksi [3.24.0](https://github.com/liblouis/liblouis/releases/tag/v3.24.0). (#14436)
...
* Päivitetty LibLouis-pistekirjoituskääntäjä versioksi [3.23.0](https://github.com/liblouis/liblouis/releases/tag/v3.23.0). (#14112)
...
* Suorituskykyä ja vakautta paranneltu Microsoft Visual Studiossa, Windows Terminalissa sekä muissa UI Automation -pohjaisissa sovelluksissa. (#11077, #11209)
...
* Tekstin lukeminen, pistekirjoituksen tulostus sekä salasanan lukemisen estäminen toimivat nyt odotetusti Visual Studio 2022:n upotetussa Windows Terminal -säätimessä. (#14194)
...
* Päivitetty liblouis-pistekirjoituskääntäjä versioksi [3.22.0](https://github.com/liblouis/liblouis/releases/tag/v3.22.0). (#13775)
...
Lisäksi on erilaisia Windows 11:n bugikorjauksia sellaisille sovelluksille kuten  Laskin, konsoli, Terminal, Sähköposti ja emojipaneeli.
...
* Liblouis-pistekirjoituskääntäjä päivitetty versioksi [3.21.0](https://github.com/liblouis/liblouis/releases/tag/v3.21.0). (#13141, #13438)
...
* Estetty bugi, joka aiheutti tekstin lukemista kahteen kertaan Windows-konsolia ja Windows Terminalia käytettäessä. (#13261)
...
* Ratkaistu tietoturvavaroitus `GHSA-xc5m-v23f-pgr7`.
  * Välimerkkien ja symboleiden puhumisen valintaikkuna on nyt poissa käytöstä suojatussa tilassa.
...
Päivityksiä eSpeak-NG:hen ja LibLouis-pistekirjoituskääntäjään, mukaan lukien uusi venäläinen ja vendalainen taulukko.
...
* Päivitetty liblouis-pistekirjoituskääntäjä versioksi [3.19.0](https://github.com/liblouis/liblouis/releases/tag/v3.19.0). (#12810)
...
eSpeak-syntetisaattoria ja LibLouis-pistekirjoituskääntäjää on päivitetty.
...
* Päivitetty liblouis-pistekirjoituskääntäjä versioksi [3.18.0](https://github.com/liblouis/liblouis/releases/tag/v3.18.0). (#12526)
...
Päivityksiä Unicode-CLDR:ään, matemaattisiin symboleihin ja LibLouis-pistekirjoituskääntäjään.
...
* Liblouis-pistekirjoituskääntäjä päivitetty versioksi [3.17.0](https://github.com/liblouis/liblouis/releases/tag/v3.17.0). (#12137)
...
Tämä versio sisältää uusia kiinalaisia syöttömenetelmiä ja päivitetyn Liblouis-pistekirjoituskääntäjän sekä elementtilistan.
Tilannekohtainen ohje on nyt käytettävissä painettaessa F1 NVDA:n valintaikkunoissa.
Parannuksia symboleiden lausumissääntöihin, puhesanastoihin, pistekirjoitusilmoituksiin ja pikalukuun.
...
* Päivitetty liblouis-pistekirjoituskääntäjä versioksi 3.16.1:
...
* NVDA:n ei pitäisi enää ajoittain jäätyä Microsoft Wordissa siirryttäessä nopeasti nuolinäppäimillä ylös ja alas tai merkkejä kirjoitettaessa pistenäytön ollessa käytössä. (#11431, #11425, #11414)
...
Tämän version merkittävimpiä uusia ominaisuuksia ovat mm. tuki uudelle Nattiqin pistenäytölle, parempi tuki ESET Antivirus -ohjelmiston graafiselle käyttöliittymälle ja Windows Terminalille, suorituskyvyn parannuksia 1Passwordille ja Windows OneCore -syntetisaattorille sekä monia muita tärkeitä bugikorjauksia ja parannuksia.
...
* Lisätty tuki Windows Terminalille. (#10305)
...
* Päivitetty liblouis-pistekirjoituskääntäjä versiosta 3.12 versioksi [3.14.0](https://github.com/liblouis/liblouis/releases/tag/v3.14.0). (#10832, #11221)
...
* Päivitetty liblouis-pistekirjoituskääntäjä versioksi 3.12. (#10161)
...
* Päivitetty Liblouis-pistekirjoituskääntäjä muutoksella 58d67e63. (#10094)
...
* Liblouis-pistekirjoituskääntäjä päivitetty versioksi 3.10.0. (#9439)
...
* Lisätty komentoriviparametri `--enable-start-on-logon`, jonka avulla voi määrittää, asettaako   hiljainen asennus NVDA:n käynnistymään Windowsiin kirjauduttaessa. Määritä arvoksi true, jos haluat ottaa käyttöön kirjauduttaessa käynnistämisen tai false, jos et halua ottaa sitä käyttöön. Mikäli --enable-start-on-logon-argumenttia ei määritetä, NVDA käynnistyy oletusarvoisesti kirjauduttaessa, ellei sitä ole poistettu käytöstä aiemmassa asennuksessa. (#8574)
...
* Päivitetty liblouis-pistekirjoituskääntäjä versioksi 3.8.0. (#9013)
...
* Kun NVDA käynnistetään `--portable-path`-komentoriviparametrilla, annettua hakemistopolkua käytetään nyt luotaessa NVDA:n massamuistiversiota. (#8623)
...
* Päivitetty liblouis-pistekirjoituskääntäjä versioksi 3.7.0. (#8697)
...
* Päivitetty liblouis-pistekirjoituskääntäjä versioksi 3.6.0. (#8365)
...
* Päivitetty liblouis-pistekirjoituskääntäjä versioksi 3.5.0. (#7839)
...
* Päivitetty liblouis-pistekirjoituskääntäjä versioksi 3.3.0. (#7565)
...
* Päivitetty liblouis-pistekirjoituskääntäjä versioksi 3.2.0. (#6935)
...
* Symboleiden puhuminen -valintaikkunan ulkoasua on muutettu siten, että sen koko leveyttä käytetään symboliluettelolle. (#6101)
...
* Liblouis-pistekirjoituskääntäjä päivitetty versioksi 2.6.5. (#5574)
...
* Symboleiden puhuminen -valintaikkunassa on nyt mahdollista määrittää, lähetetäänkö todelliset merkit syntetisaattoreille (esim. tauon pitämiseksi tai äänensävyn muuttamiseksi). (#5234)
...
* Liblouis-pistekirjoituskääntäjä päivitetty versioksi 2.6.4. (#5341)
...
* Liblouis-pistekirjoituskääntäjä päivitetty versioksi 2.6.3. (#5137)
...
* Jos "Käytä puheäänen kieltä merkkejä ja symboleita käsiteltäessä" -asetus on käytössä, Välimerkkien ja symboleiden puhuminen -valintaikkunassa käytetään nyt asianmukaisesti puheäänen kieltä. Lisäksi valintaikkunan otsikossa näytetään kieli, jonka merkkien puhumista muokataan. (#4930)
...
* Uusia symboleita on nyt mahdollista lisätä Symboleiden puhuminen -valintaikkunassa. (#4354)
...
Uudessa asettelussa käytetään nuolinäppäimiä yhdessä NVDA-näppäimen kanssa sekä tekstintarkastelukomennoissa myös muita muuntonäppäimiä.
...
* liblouis-pistekirjoituskääntäjä päivitetty versioksi 2.5.1. (#2319, #2480, #2662, #2672)
...
* Käyttäjän tekemät muutokset välimerkkien ja symboleiden puhumiseen otetaan heti käyttöön sen sijaan, että tarvitsisi käynnistää NVDA uudelleen tai poistaa automaattinen kielen vaihtaminen käytöstä.
...
* Nyt on mahdollista valita välimerkkien ja muiden symboleiden lukemisen taso. (#332)
...
* Käyttäjät voivat nyt muuttaa välimerkkien ja muiden symboleiden lukutapaa sekä tasoa, jolla ne puhutaan. (#271, #1516)
...
* Kun komentonäppäinten lukeminen on otettu käyttöön, välilyönnin painaminen yhdessä muiden muuntonäppäinten kuin Vaihdon kanssa (kuten Ctrl ja Alt) ilmoitetaan nyt komentonäppäimeksi. (#1424)
...
* Liblouis-pistekirjoituskääntäjä päivitetty versioksi 2.1.1. Tämä päivitys korjaa joitakin kiinalaiseen pistekirjoitukseen sekä käännöstaulukossa määrittelemättömiin merkkeihin liittyviä ongelmia. (#484, #499)
