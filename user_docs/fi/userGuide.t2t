...
+ Näyttöön tulee NVDA:n asennusohjelman ikkuna, jossa näytetään käyttöoikeussopimus.
Lue sopimus halutessasi painamalla ``Nuoli alas``.
+ Siirry "Hyväksyn"-valintaruudun kohdalle painamalla ``Sarkainta`` ja valitse se painamalla ``Välilyöntiä``.
+ Liiku vaihtoehtojen välillä painamalla ``Sarkainta`` ja valitse haluamasi painamalla ``Enter``.
+
...
+ Varmista, että käyttöoikeussopimuksen hyväksymisvalintaruutu on valittuna asennusohjelmassa.
+ Siirry ``Sarkaimella`` "Asenna"-painikkeen kohdalle ja paina sitä.
+ Seuraavana ovat asetukset NVDA:n käyttämiseen Windowsin sisäänkirjautumisen aikana ja työpöydän pikakuvakkeen luomiseen.
...
+ Näkyviin tulee Windowsin käyttäjätilien valvonnan valintaikkuna, jossa kysytään, haluatko sallia tämän sovelluksen tehdä muutoksia tietokoneeseesi.
+ Hyväksy muutosten tekeminen painamalla ``Alt+Ä``.
+ Edistymispalkki täyttyy NVDA:n asentuessa.
...
+ Näyttöön tulee valintaikkuna, joka vahvistaa, että NVDA:n asennus on onnistunut.
Ilmoitus neuvoo käynnistämään asennetun version painamalla OK.
Käynnistä asennettu versio painamalla ``Enter``.
+ "Tervetuloa NVDA:han" -valintaikkuna tulee näkyviin, ja NVDA lukee tervetuloviestin.
...
+ Siirry kohtaan "Käytä ``Caps Lockia`` NVDA-näppäimenä" painamalla ``Sarkainta``.
...
+ Käytä ``Sarkainta`` ja ``Välilyöntiä`` muiden tässä näytössä olevien asetusten säätämiseen.
...
+ Avaa Näppäinkomennot-valintaikkuna selaustilan ollessa aktiivisena.
+ Etsi Selaustila-osiosta "Siirtää seuraavan välilehden kohdalle" -komento.
+ Määritä löytyneelle komennolle ``Y``-näppäin.
+ Etsi "Siirtää edellisen välilehden kohdalle" -komento.
+ Määritä löytyneelle komennolle ``Vaihto+Y``-näppäimet.
+
...
+ Siirretään kohdistin kommentin sisältävään tekstiin.
+ Avataan valinnan vaihtoehdot, kuten yllä on kuvailtu.
+ Valitaan Edit note.
+
...
%kc:setting
==== Avaa objektien lukemisen asetukset ====
...
%kc:setting
==== Avaa asiakirjojen muotoiluasetukset ====
...
Kokeile seuraavaa:
+ Varmista, että olet asentanut [uusimman ajurin https://www.papenmeier-rehatechnik.de/en/service/downloadcenter/software/articles/software-braille-devices.html].
+ Avaa Windowsin laitehallinta.
+ Selaa luetteloa alaspäin kohtaan "USB-ohjaimet" tai "USB-laitteet".
+ Valitse "Papenmeier Braillex USB Device".
+ Avaa ominaisuudet ja vaihda "Lisäasetukset"-välilehdelle.
...
+ Poista "Load VCP" -asetus käytöstä.
+
