...
Tämä pika-aloitusopas sisältää kolme pääosaa: lataaminen, alkuasetukset ja NVDA:n käyttäminen.
...
| Nimi |Näppäinkomento pöytäkoneissa |Näppäinkomento kannettavissa |Kuvaus|
|---|---|---|---|
|Ikkunan nimi |`NVDA+T` |`NVDA+T` |Lukee aktiivisen ikkunan nimen. Kahdesti painettaessa nimi tavataan ja kolmesti painettaessa se kopioidaan leikepöydälle.|
|Ilmoita kohdistus |`NVDA+Sarkain` |`NVDA+Sarkain` |Ilmoittaa nykyisen säätimen, jossa järjestelmän kohdistus on. Kahdesti painettaessa tiedot tavataan.|
|Lue ikkuna |`NVDA+B` |`NVDA+B` |Lukee koko nykyisen ikkunan (hyödyllinen valintaikkunoissa).|
...
|Lue kellonaika |`NVDA+F12` |`NVDA+F12` |Ilmoittaa kerran painettaessa kellonajan ja kahdesti painettaessa päivämäärän. Ajan ja päivämäärän muoto vastaa Windowsin asetuksissa määriteltyä muotoa tehtäväpalkin kellolle.|
|Lue tekstin muotoilut |`NVDA+F` |`NVDA+F` |Lukee tekstin muotoilutiedot. Kahdesti painettaessa tiedot näytetään selaustilassa.|
|Ilmoita linkin kohde |`NVDA+K` |`NVDA+K` |Puhuu kerran painettaessa kohdistimen tai kohdistuksen kohdalla olevan linkin kohteen URL-osoitteen. Kahdesti painettaessa se näytetään erillisessä ikkunassa tarkempaa tarkastelua varten.|

#### Valitse, mitä tietoja NVDA lukee {#ToggleWhichInformationNVDAReads}
...
|Puhu komentonäppäimet |`NVDA+4` |`NVDA+4` |Kun tämä on käytössä, NVDA puhuu kaikki painetut näppäimet, jotka eivät ole kirjaimia. Näitä ovat sellaiset näppäinyhdistelmät kuin Ctrl+jokin kirjain.|
|Käytä hiiren seurantaa |`NVDA+M` |`NVDA+M` |Kun tämä on käytössä, NVDA lukee hiiriosoittimen alla olevan tekstin. Tällä tavalla on mahdollista löytää asioita ruudulta hiirtä liikuttamalla sen sijaan, että käytettäisiin objektinavigointia.|
...
Täydellinen luettelo pikanavigointinäppäimistä on käyttöoppaan [Selaustila](#BrowseMode) -osiossa.
...
Jos luot massamuistiversion suoraan NVDA:n latauspaketista, paina Luo massamuistiversio -painiketta.
...
Luettelo esimerkiksi sisältää kohteita, joten niihin pääsemiseksi on siirryttävä luettelon sisään.
...
| Nimi |Näppäinkomento pöytäkoneissa |Näppäinkomento kannettavissa |Kosketusele |Kuvaus|
|---|---|---|---|---|
|Lue nykyinen objekti |NVDA+laskinnäppäimistön 5 |NVDA+Vaihto+O |Ei mitään |Lukee nykyisen navigointiobjektin. Kahdesti painettaessa tiedot tavataan ja kolmesti painettaessa objektin nimi ja arvo kopioidaan leikepöydälle.|
...
|Siirrä järjestelmän kohdistus tai -kohdistin tarkastelukohtaan |NVDA+Vaihto+laskinnäppäimistön miinus |NVDA+Vaihto+Askelpalautin |Ei mitään |Siirtää kerran painettaessa järjestelmän kohdistuksen nykyiseen navigointiobjektiin tai kahdesti painettaessa järjestelmäkohdistimen tarkastelukohdistimen kohdalle.|
|Lue tarkastelukohdistimen sijainti |NVDA+Vaihto+laskinnäppäimistön Del |NVDA+Vaihto+Del |Ei mitään |Lukee tarkastelukohdistimen kohdalla olevan tekstin tai objektin sijaintitiedot. Näitä tietoja voivat olla esim. asiakirjan luettu osuus prosentteina, etäisyys sivun reunasta tai tarkka paikka ruudulla. Kahdesti painaminen saattaa antaa lisätietoja.|
|Siirrä tarkastelukohdistin tilariville |Ei mitään |Ei mitään |Ei mitään |Lukee tilarivin, mikäli sellainen löytyy. Lisäksi navigointiobjekti siirretään sen kohdalle.|
...
| Nimi |Näppäinkomento pöytäkoneissa |Näppäinkomento kannettavissa |Kosketusele |Kuvaus|
|---|---|---|---|---|
|Siirrä ylimmälle riville |Vaihto+laskinnäppäimistön 7 |NVDA+Ctrl+Home |none |Siirtää tarkastelukohdistimen ylimmälle riville.|
|Siirrä edelliselle riville |Laskinnäppäimistön 7 |NVDA+Nuoli ylös |Pyyhkäisy ylös (tekstitila) |Siirtää tarkastelukohdistimen edelliselle riville.|
|Puhu nykyinen rivi |Laskinnäppäimistön 8 |NVDA+Vaihto+piste |Ei mitään |Puhuu tarkastelukohddistimen kohdalla olevan rivin. Kahdesti painettaessa rivi tavataan normaalisti ja kolmesti painettaessa merkkikuvauksia käyttäen.|
|Siirrä seuraavalle riville |Laskinnäppäimistön 9 |NVDA+Nuoli alas |Pyyhkäisy alas (tekstitila) |Siirtää tarkastelukohdistimen seuraavalle riville.|
|Siirrä alimmalle riville |Vaihto+laskinnäppäimistön 9 |NVDA+Ctrl+End |Ei mitään |Siirtää tarkastelukohdistimen alimmalle riville.|
|Siirrä edelliseen sanaan |Laskinnäppäimistön 4 |NVDA+Ctrl+Nuoli vasemmalle |Pyyhkäisy vasemmalle kahdella sormella (tekstitila) |Siirtää tarkastelukohdistimen edellisen sanan kohdalle.|
|Puhu nykyinen sana |Laskinnäppäimistön 5 |NVDA+Ctrl+piste |Ei mitään |Puhuu tarkastelukohdistimen kohdalla olevan sanan. Kahdesti painettaessa sana tavataan normaalisti ja kolmesti painettaessa merkkikuvauksia käyttäen.|
|Siirrä seuraavaan sanaan |Laskinnäppäimistön 6 |NVDA+Ctrl+Nuoli oikealle |Pyyhkäisy oikealle kahdella sormella (tekstitila) |Siirtää tarkastelukohdistimen seuraavan sanan kohdalle.|
|Siirrä rivin alkuun |Vaihto+laskinnäppäimistön 1 |NVDA+Home |Ei mitään |Siirtää tarkastelukohdistimen nykyisen rivin alkuun.|
|Siirrä edelliseen merkkiin |Laskinnäppäimistön 1 |NVDA+Nuoli vasemmalle |Pyyhkäisy vasemmalle (tekstitila) |Siirtää tarkastelukohdistimen seuraavan merkin kohdalle nykyisellä rivillä.|
|Puhu nykyinen merkki |Laskinnäppäimistön 2 |NVDA+piste |Ei mitään |Puhuu nykyisen merkin tarkastelukohdistimen kohdalla olevalta riviltä. Kahdesti painettaessa luetaan merkin kuvaus tai esimerkki sen käytöstä. Kolmesti painettaessa luetaan sen numeerinen arvo desimaaleina ja heksadesimaaleina.|
|Siirrä seuraavaan merkkiin |Laskinnäppäimistön 3 |NVDA+Nuoli oikealle |Pyyhkäisy oikealle (tekstitila) |Siirtää tarkastelukohdistimen tekstissä seuraavan merkin kohdalle nykyisellä rivillä.|
|Siirrä rivin loppuun |Vaihto+laskinnäppäimistön 3 |NVDA+End |Ei mitään |Siirtää tarkastelukohdistimen tekstissä nykyisen rivin loppuun.|
|Siirrä edelliselle sivulle |`NVDA+Page up` |`NVDA+Vaihto+Page up` |Ei mitään |Siirtää tarkastelukohdistimen tekstissä edelliselle sivulle, mikäli sovellus tukee sitä.|
|Siirrä seuraavalle sivulle |`NVDA+Page down` |`NVDA+Vaihto+Page down` |Ei mitään |Siirtää tarkastelukohdistimen tekstissä seuraavalle sivulle, mikäli sovellus tukee sitä.|
|Jatkuva luku |Laskinnäppäimistön plus |NVDA+Vaihto+A |Pyyhkäisy alas kolmella sormella (tekstitila) |Lukee tarkastelukohdistimen nykyisestä kohdasta alkaen siirtäen samalla sitä.|
...
Tätä jäljittelyä on kahdessa muodossa: pistesyötteen liittäminen suoraan johonkin näppäinpainallukseen ja virtuaalisten muuntonäppäinten käyttäminen.
...
NVDA tarjoaa komennot Ctrl-, Alt-, Vaihto-, Win- ja NVDA-näppäinten tilan vaihtamiseen sekä komennot joillekin näiden näppäinten yhdistelmille, mikä mahdollistaa sellaisten näppäinpainallusten jäljittelyn, joissa muuntonäppäimiä pidetään alhaalla.
Käytä näitä tilanvaihtokomentoja painamalla ensin haluamiesi muuntonäppäinten komentoa (tai komentosarjaa).
...
Jos vaihdat vahingossa muuntonäppäinten tilaa, tilanvaihtokomennon uudelleen suorittaminen poistaa ne käytöstä.

Lyhennepistekirjoitusta syötettäessä muuntonäppäinten tilanvaihtonäppäimien käyttäminen aiheuttaa syötteesi kääntämisen ikään kuin olisit painanut pisteitä 7 ja 8.
Lisäksi jäljitelty näppäinpainallus ei voi tuottaa pistekirjoitusta, joka on kirjoitettu ennen muuntonäppäimen painamista.
...
Turvallisuussyistä uutta Windows-versiota käytettäessä näytetään vahvistusviesti siitä, että näyttöverho pimentää ruudun kokonaan.
...
Asetukset tulevat voimaan tietyissä valintaikkunoissa välittömästi painamalla Käytä-painiketta, eikä valintaikkunaa tarvitse sulkea.
...
##### Salli käyttötilastojen kerääminen {#GeneralSettingsGatherUsageStats}
...
##### Ääni {#SpeechSettingsVoice}

Ääni-vaihtoehto on yhdistelmäruutu, jossa on luettelo kaikista käytössä olevan syntetisaattorin äänistä.
...
Mikäli välimerkit luetaan väärällä kielellä tiettyä syntetisaattoria tai ääntä käytettäessä, tämän asetuksen käytöstä poistaminen pakottaa NVDA:n käyttämään yleistä kieliasetusta.
...
Kun tämä asetus on käytössä, NVDA sanoo merkin kuvauksen, kun siirryt tekstissä merkki kerrallaan.
...
Viivästetty merkin kuvaus peruuntuu, jos tuona aikana puhutaan muuta tekstiä tai jos painetaan `Ctrl`-näppäintä.

#### Valitse syntetisaattori {#SelectSynthesizer}

<!-- KC:setting -->

##### Avaa Valitse syntetisaattori -valintaikkuna {#toc138}
...
##### Avaa Valitse pistenäyttö -valintaikkuna {#toc161}
...
Tällä asetuksella voidaan Windows 8:ssa ja sitä uudemmissa käyttöjärjestelmissä valita, pienentääkö NVDA muiden sovellusten äänenvoimakkuutta puhuessaan vai koko ajan käynnissä ollessaan.
...
Muuta näyttöverhon tilaa mistä tahansa määrittämällä mukautettu näppäinkomento [Näppäinkomennot-valintaikkunaa](#InputGestures) käyttäen.

Oletusarvoisesti toistetaan ääni, kun näyttöverho otetaan käyttöön tai poistetaan käytöstä.
...
##### Avaa näppäimistöasetukset {#toc176}
...
##### Valitse NVDA-toiminto-näppäimet {#KeyboardSettingsModifiers}
...
Jos yhtään näppäintä ei ole valittu, joidenkin NVDA-komentojen käyttäminen voi olla mahdotonta.
Tämän vuoksi Asetukset-valintaikkuna näyttää virheilmoituksen, mikäli näppäimiä ei ole valittuna OK- tai Käytä-painiketta painettaessa.
Kun virheilmoitus on kuitattu, vähintään yksi näppäin on valittava ennen kuin valintaikkuna voidaan sulkea asianmukaisesti OK-painiketta painamalla.
...
##### Ilmoita hiiren alla olevan objektin rooli {#MouseSettingsRole}
...
Tästä asetuskategoriasta, joka on käytettävissä vain tietokoneissa, joissa on Windows 8 tai uudempi käyttöjärjestelmä sekä kosketusominaisuuksia, voidaan määrittää, miten NVDA on vuorovaikutuksessa kosketusnäyttöjen kanssa.
...
##### Avaa objektien lukemisen asetukset {#toc206}
...
##### Avaa selaustilan asetukset {#toc224}
...
##### Avaa asiakirjojen muotoiluasetukset {#toc238}
 ...
 * Tyhjien rivien ohittaminen rivien sisennystä ilmoitettaessa
...
Tämä asetus muuttaa tapaa, jolla NVDA rekisteröi Microsoft UI Automation -saavutettavuusrajapinnan käynnistämiä tapahtumia.
...
Vaikka kohdistuksen seuranta on luotettavampaa useammissa tilanteissa, suorituskyky heikkenee merkittävästi, erityisesti sellaisissa sovelluksissa kuin Microsoft Visual Studio.
...
Excelin UI automation -rajapinnan toteutus muuttuu jatkuvasti, eikä Microsoft Officen vanhemmat versiot kuin 16.0.13522.10000 anna välttämättä tarpeeksi tietoja, jotta tästä asetuksesta olisi mitään hyötyä.
...
Turvallisuussyistä tämä asetus tulisi pitää poissa käytöstä.
...
##### Käytä WASAPIa äänen toistamiseen {#WASAPI}
...
Tämä asetus mahdollistaa äänen toistamisen Windowsin äänentoistorajapinnan (WASAPI) kautta.
...
* Äänikohtainen: sanasto, jonka säännöt vaikuttavat käytössä olevan syntetisaattorin ääneen.
...
Tutustumisopas löytyy osoitteesta [https://docs.python.org/3.7/howto/regex.html].
...
* Lähetä todellinen merkki syntetisaattorille -yhdistelmäruudusta voit määrittää, milloin itse symboli (vastakohtana sen korvaavalle tekstille) lähetetään syntetisaattorille.
 ...
 * ei koskaan: Todellista merkkiä ei koskaan lähetetä syntetisaattorille.
 * aina: Todellinen merkki lähetetään aina syntetisaattorille.
 * vain jos symbolitaso on alempi: Todellinen merkki lähetetään vain, jos määritetty puheen symbolitaso on alempi kuin kyseiselle symbolille määritetty.
 ...
 * Näppäinkomentoa, jossa käytetään muuntonäppäimiä, ei välttämättä voi liittää jäljiteltävään näppäinkomentoon, jossa ei muunto
...
Jos et ole aiemmin asentanut lisäosia, lisäosakauppa näyttää luettelon asennettavissa olevista lisäosista.
Mikäli olet asentanut lisäosia, luettelo näyttää tällä hetkellä asennettuina olevat lisäosat.
...
Asennetuille, päivitettävissä ja saatavilla oleville sekä yhteensopimattomille lisäosille on eri näkymät.
...
Saatavilla ja päivitettävissä olevat lisäosat voidaan suodattaa sisältämään asennettavissa olevia [yhteensopimattomia lisäosia](#incompatibleAddonsManager).
...
Valitse lisäosa "Saatavilla"- tai "Päivitettävissä"-välilehdeltä.
...
Jos NVDA on asennettu ja käynnissä järjestelmässäsi, voit myös aloittaa asennuksen avaamalla lisäosatiedoston suoraan selaimesta tai resurssienhallinnasta.
...
Voit selata yhteensopimattomia lisäosia [saatavilla ja päivitettävissä olevien lisäosien välilehtiä](#AddonStoreFilterStatus) käyttäen.
Asennettuina olevia yhteensopimattomia lisäosia voit selata [yhteensopimattomien lisäosien välilehteä](#AddonStoreFilterStatus) käyttäen.

## Lisätyökalut {#ExtraTools}
### Lokin tarkastelu {#LogViewer}

Lokin tarkastelulla, joka löytyy NVDA-valikon Työkalut-alivalikosta, voidaan tutkia kaikkia NVDA:n edellisen käynnistyksen jälkeen tulleita lokimerkintöjä.
Näppäinkomento NVDA+F1 avaa lokin tarkastelun sekä näyttää kehittäjätietoa nykyisestä navigointiobjektista.
...
NVDA käyttää oletusarvoisesti tätä syntetisaattoria Windows 7:ssä, 8:ssa ja 8.1:ssä (Windows 10:ssä ja uudemmissa [Windows OneCorea](#OneCore)).
...
Katso luettelo saatavilla olevista äänistä tästä Microsoftin artikkelista: https://support.microsoft.com/fi-fi/windows/liite-a-tuetut-kielet-ja-%C3%A4%C3%A4net-4486e345-7730-53da-fcfe-55cc64300f01
...
Ne voi ladata osoitteesta https://support.freedomscientific.com/Downloads/Focus/FocusBlueBrailleDisplayDriver.
...
HID-näppäimistöemulointi on mahdollista poistaa käytöstä näppäinkomennolla ALVA-näytöissä, joissa on viimeisin laiteohjelmisto.
...
#### Brailliant BI 32, BI 40 ja B 80 {#toc320}
...
Voit ladata ne täältä: http://www.himsintl.com/upload/HIMS_USB_Driver_v25.zip
...
Lisätietoa näytöistä löytyy osoitteesta https://en.seika-braille.com/down/index.html.

#### Seika-versiot 3, 4 ja 5 (40 solua), Seika80 (80 solua) {#SeikaBrailleDisplays}

* Nämä näytöt eivät vielä tue NVDA:n automaattista pistenäytön tunnistusta.
* Määritä manuaalisesti valitsemalla "Seika"
...
PC-näppäimistön emulointia ei tueta BrailleNote QT:ssa.
...
Se voidaan ottaa käyttöön tai poistaa käytöstä vaihtamalla "HID-näppäimistösyötteen emulointi" -asetusta näppäinkomentoa käyttäen.
Alla kuvaillut pistekirjoitusnäppäimistön toiminnot ovat käytettävissä vain, kun "HID-näppäimistösyötteen emulointi" on poistettu käytöstä.
...
|Vaihda HID-näppäimistösyötteen emuloinnin asetusta |`switch1Left+joystick1Down`, `switch1Right+joystick1Down`|
...
|Vaihda HID-näppäimistösyötteen emuloinnin asetusta |`l1+joystick1Down`, `l8+joystick1Down`|
