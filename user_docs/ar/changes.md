...
عند بدء تشغيل NVDA، سيعلمُك مستودع الإضافات في حال وجود تحديثات متوفرة لأي من الإضافات

توجد الآن خيارات لتطبيق تطبيع Unicode على مخرجات النُطق وبطريقة برايل.
...
* عند إنشاء ننسخة محمولة، سيُنشَأ مجلد جديد افتراضيا لها. 
...
* إصلاحات خاصة ب Windows 11:
  ...
  * لم يعُدْ NVDA يكرر الإعلان "سجل الحافظة" عند التنقُّل ضمن عناصر قائمة لوحة رموز المشاعر. (#16532, @josephsl)
