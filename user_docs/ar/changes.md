...
* إضافةُ مفاتيح أوامر جديدة:
  ...
  * ضبط الإعداد الأول والأخير في دائرة إعدادات النُطق (ليس له مفتاح افتراضي). (#13768)
...
* تقسيم خروج الصوت: (#12985, @mltony)
  ...
  * يمكنُ ضبطُ مستوى صوت التطبيقات الأخرى عبر مفاتيح الاختصار `NVDA+alt+pageUp` و `NVDA+alt+pageDown`. (#16052, @mltony)
  * ويمكنُ كتمُ أصوات كل التطبيقات الأخرى بالضغط على `NVDA+alt+delete`. (#16052, @mltony)
...
* إصلاحات في Windows 11:
  ...
  * في إصدار 24H2 (تحديث 2024 Windows الخاص بالخوادم 2025)، يمكن الآن استخدام الفأرة أو التفاعُل باللمس في نافذة الإعدادات السريعة. (#16348, @josephsl)
