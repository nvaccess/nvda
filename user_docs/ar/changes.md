...
أبرزُ ما يحمله هذا الإصدار هو خاصية التحكُّم عن بُعد Remote Access، والتي تُتيح لك التحكُّم عن بُعد في حاسوب آخر عبر حاسوبك، على أن يعمل NVDA على كلٍ من الحاسوبين.

هناك العديد من التحسينات على النُطق، خاصة ما يتعلق باستجابة آلات النُطق SAPI 4، و SAPI 5 و OneCore.
تدعم آلة SAPI 5 الآن زيادة معدَّل السرعة، والتحويل التلقائي بين اللغات.
ستعمل خصائص نمط خفض الأصوات، وإزالة فترات الصمت التي تسبق النُطق، وإبقاء جهاز إخراج الصوت نَشِطا مع آلة SAPI 4.

حُسِّن نظام التحديث التلقائي في مستودع الإضافات، حيثُ يمكنك الآن تحديد قناة التحديثات التلقائية، وتشغيل التحديثات التلقائية في الخلفية.

أُضيفت أوامر جديدة لتحديث نتيجة التعرُّف على المحتوى (OCR) يدويا، وللتبديل بين تفعيل وتعطيل التحديث التلقائي باستمرار لنتيجة التعرف على المحتوى.
...
أصبحت جداول إخراج وإدخال برايل الافتراضية تابعةً للغة واجهة NVDA.
أُدمج دعمُ جهاز عرض الرسومات البارزة Dot Pad من شركة Dot Inc كشاشة برايل متعددة الأسطر.
إضافة لعدد من الإصلاحات الثانوية على دعم برايل، خاصةً فيما يتعلق بالاتصال.

كما حصل كل من مترجم برايل LibLouis  وآلة النُطق eSpeak-NG  ومكتبة الرموز والوجوه التعبيرية Unicode CLDR على تحديثات.
كما أُضيفت جداول برايل جديدة: قبطي وومسماري وبرتغالي حاسوبي ذو ست نقاط.
...
يُرجى الإبلاغ عن المشكلات الأمنية باتباع [السياسة الأمنية](https://github.com/nvaccess/nvda/blob/master/security.md).

* عدم إظهار معلومات حساسة على شاشة برايل عندما يكون الجهاز مغلقا.
([GHSA-8f8q-2jc3-6rf4](https://github.com/nvaccess/nvda/security/advisories/GHSA-8f8q-2jc3-6rf4))
* منع مثبّت البرنامج من جلب ملفات DLL غير المرغوب فيها.
([GHSA-qf5h-qw92-rx2f](https://github.com/nvaccess/nvda/security/advisories/GHSA-qf5h-qw92-rx2f))

### المستجدات

* في مستودع الإضافات:
  * التحديثات التلقائية (#3208):
    * يمكن الآن ضبطُ قناة تحديث الإضافات البرمجية.
      * يمكن تعيين قنوات التحديث التلقائي للإضافات المُثبَّتة عبر قائمة قناة التحديث الفرعية.
      * يمكن تعيين قناة التحديث التلقائي الافتراضية عبر تصنيف مستودع الإضافات في إعدادات NVDA.
    * تعمل التحديثات التلقائية الآن في الخلفية.
      * يمكن تفعيل ذلك عبر تصنيف مستودع الإضافات ضمن إعدادات NVDA بتغيير خيار التحديثات التلقائية إلى التحديث تلقائيا.
    * يمكن لخاصية التحديثات التلقائية الآن تحديث الإضافات البرمجية غير المتوافقة إلى نسخة أخرى أحدث غير متوافقة.
      * يمكن تفعيل ذلك عبر تصنيف مستودع الإضافات في إعدادات NVDA.
  * إضافةُ أمر لإلغاء تثبيت الإضافات. (#15578, @hwf1324)
  * إضافةُ أمر إعادة محاولة تنزيل أو تثبيت الإضافات، في حال تعثُّر العملية. (#17090, @hwf1324)
  * إمكانية ترتيب قوائم الإضافات وِفقا للأعمدة، بما في ذلك تاريخ النشر، تصاعديًا أو تنازليًا. (#15277, #16681, @nvdaes)
* النُطق:
  * التحويل التلقائي بين اللغات يعمل الآن عند استخدام  Microsoft Speech API الإصدار 5 (SAPI5) وأصوات Microsoft Speech Platform. (#17146, @gexgd0419)
  * زياداةُ معدّل سرعة النُطق تعمل الآن مع آلات النُطق Microsoft Speech API الإصدار 5 (SAPI5) و أصوات Microsoft Speech Platform، حيث يمكن زيادة السرعة لستة أضعاف. (#17606, @gexgd0419)
* متصفحات شبكة الإنترنت:
  * ستعمل خاصية نمط التحديد المحلي في نمط التصفُّح التي تُنشَّط بالضغط على (`NVDA+shift+f10`) في كل من متصفّحَي Google Chrome و Edge وسائر التطبيقات المستندة على Chromium 134 . (#17838)
  * في Mozilla Firefox، سيُعلن NVDA عن النص المميز بصريا إذا كان الرابط يقود لنص، وقد سبقت زيارته. (#16910, @jcsteh)
  * يمكن ل NVDA الآن الإشارة إلى كون الرابط داخليا يقود لموضع آخر في الصفحة نفسها. (#141, @LeonarddeR, @nvdaes)
* في Microsoft Office:
  * أثناء تحرير مربعات النص في PowerPoint؛ يمكنك الآن الانتقال بين الجُمَل باستخدام  `alt+السهم العلوي`/` alt+السهم السفلي`. (#17015, @LeonarddeR)
  * في Word، سيُعلَن عن تحديث التحديد عند استخدام أوامر Word لتوسيع أو تقليص نطاق التحديد (`F8` أو `Shift+F8`). (#3293, @CyrilleB79)
  * في Word 16.0.18226 aوما بعده، أو حال استخدام نموذج كائن Word، سيُعلن NVDA عن حالة العنوان إن كان موسّعًا أو مطويا نُطقا وعبر برايل. (#17499)
  * في Word، حال تفعيل أتمتة واجهة المستخدم UIA, سيُعلَن عن حركة مؤشّر التحرير عند استخدام أوامر Word الخاصة بالتنقل في الجدول (`alt+home`, `alt+end`, `alt+pageUp`, and `alt+pageDown`),. (#17867, @CyrilleB79)
  * في Word، عند تنفيذ أمر "قراءة الكائن المحدد (حيثُ مؤشّر النظام)" سيُعلَن عن تخطيط العرض المختار حاليا، إن كانت هذه المعلومة متوفرةً وكان أمر الإعلان عن وصف الكائن مفعَّلاً. (#15088, @nvdaes)
  * سيُعلَن الآن عن نتائج المزيد من اختصارات الأوامر عند تنفيذها في Word و Outlook:
    * اختصارات تنسيق الخط (#10271, @CyrilleB79)
    * طي العنوان أو توسيعُه (#17545, @CyrilleB79)
* في LibreOffice:
  * عند تكبير أو تصغير حجم الخط في برنامج معالجة النصوص Writer باستخدام اختصارات لوحة المفاتيح، سيعلن NVDA عن حجم الخط الجديد. (#6915, @michaelweghorn)
  * عند اختيار نمط "متن النص" أو "العنوان" من أنماط الفقرة في Writer  الإصدار 25.2 فما بعده باستخدام الاختصارات المخصصة لذلك؛ سيُعلن NVDA عن النمط المختار. (#6915, @michaelweghorn)
  * عند تبديل حالة التسطير المزدوج في Writer باستخدام مفتاح الاختصار المخصص لذلك؛ سيُعلن NVDA عن الحالة الحالة (تفعيل التسطير المزدوج أو تعطيل التسطير المزدوج) (#6915, @michaelweghorn)
  * يمكن ل NVDA الآن الإعلان عن المسافة البادئة للسطر الأول في LibreOffice 25.8 فما بعده. (#13052, @michaelweghorn)
* خاصية التعرُّف على المحتوى (OCR):
  * في نتيجة التعرُّف على المحتوى، سيعمل الاختصار `NVDA+f5`  على تحديث النتيجة المتعرَّف عليها يدويا. (#17715, @CyrilleB79)
  * إضافةُ أمر (لم يُعيَّن له اختصار افتراضيا) للتبديل بين تفعيل وتعطيل التحديث التلقائي لنتيجة التعرُّف على المحتوى باستخدام خاصية  OCR. (#16897)
* أصبحت خاصية التحكُّم عن بُعد Remote Access المستندة على الإضافة البرمجية NVDA Remote مُدمجةً ضمن NVDA نفسه. (#4390, @ctoth, @tspivey, @daiverd, المنشئون لإضافة NVDA Remote والمساهمون في تطويرها)
* يمكن الآن تعيين عناوين URL للنسخة المطابقة (المرآة) لكل من تحديثات NVDA ومستودع الإضافات. (#14974, #17151, #17310, @christopherpross)
* إضافة دعم المحتوى الرياضي في ملفات PDF. (#9288, @NSoiffer)
  * هذا يعمل مع امعادلات المرتبطة بMATHML، مثل بعض الملفات التي أُنشئت بواسطة إصدارات أحدث من TEX/LATEX.
  * هذا يعمل حاليا فقط في Foxit Reader و Foxit Editor.
* يمكن ضبط NVDA لنُطق الحرف أو السطر عند استخدام مفاتيح سطر برايل للتنقُّل. (#17053, @nvdaes)
* يمكن ل NVDA الآن قراءة موضع مؤشّر التحرير إذا نُقِل بالضغط على `alt+سهم لأعلى` أو `alt+سهم لأسفل`، على سبيل المثال: في Visual Studio Code. (#17652, @LeonarddeR)
* إضافةُ أمرين لنقل مؤشّر الاستعراض إلى الحرف الأول والحرف الأخير من النص المحدد، مع تعيين الاختصارين: `NVDA+alt+home` and `NVDA+alt+end` لتنفيذهما. (#17299, @nvdaes)
* إضافة خيار للإعدادات العامة لمنع قفل الشاشة أثناء القراءة المستمرة أو القراءة عبر سطر برايل.
هذا الخيار يعمل افتراضيا، غير أنه قد يؤدي لاستنزاف البطارية. (#17649, @LeonarddeR)
* تُرجِمَ NVDA إلى اللغة البوسنوية. (#17953)
* في Adobe Acrobat، يمكن الآن قراءة معادلات الرياضيات في مستندات PDF المُنشَأة بواسطة الإصدارات الحديثة من Microsoft Word. (#18056)

### التغييرات

* تحديثات للمكوّنات:
  * تحديث مترجم برايل LibLouis إلى الإصدار [3.33.0](https://github.com/liblouis/liblouis/releases/tag/v3.33.0). (#17469, #17768, @LeonarddeR, @codeofdusk)
    * أُضيفت جداول برايل جديدة: قبطي، مسماري، وبرتغالي حاسوبي ذو ست نقاط.
  * حُدِّثت مكتبة الرموز والوجوه التعبيرية CLDR إلى الإصدار 46.0. (#17484, @OzancanKaratas)
  * تحديث آلة eSpeak NG إلى اللإصدار 1.52.0. (#17056)
* تغييرات على واجهة NVDA:
  * لم تعُد هناك نغمةٌ صوتية تعمل عند تشغيل ملف تثبيت NVDA. (#14068)
  * ضُمِّنت مربعات الحوار الخاصة بمعلومات وجهة الرابط ومعلومات التنسيق وعرض النص المحدد على زرين للنسخ والإغلاق، لتجربة استخدام أفضل. (#17018, @XLTechie)
  * أُضيف خيارٌ لمربّع حوار الخروج من NVDA، يُتيح لك إعادة تشغيل NVDA مع تعطيل الإضافات البرمجية وتفعيل وضع فحص الأخطاء. (#11538, @CyrilleB79)
  * لم يعُدْ بالإمكان إلغاء استخدام WASAPI  لإخراج الصوت (#16080)
  * أُزيل خيار "نقل مؤشّر النظام تلقائيا للعناصر القابلة لذلك" من شاشة إعدادات نمط التصفُّح. هذه الخاصية لا تعمل الآن. (#17598)
  * سيُصدر NVDA تنبيها حول عدم تواُق الإضافات البرمجية فقط عند التحديث لإصدار جديد غير متوافق مع واجهة التطبيقات المستخدمة في الإضافات الحالية. (#17071, #17506)
  * أُزيلَ ملف "أسماء المساهمين" من قائمة NVDA. (#16922)
  * ستُعرَضُ اتفاقية ترخيص NVDA كملف بتنسيق HTML لقراءة أفضل. (#17600)
  * أُضيفت صيغ مختصرة لخيارات سطر الأوامر الأكثر استخداما: `-d` لأمر `--disable-addons` وـ `-n` لأمر `--lang`.
  البادئة المطابقة لبداية بعض خيارات سطر الأوامر مثل: `--di` for `--disable-addons` لم تعُدْ تعمل. (#11644, @CyrilleB79)
  * تغييرات خاصة بأداة معالجة أخطاء سجل النظام الشائعة: (#12355, @XLTechie)
    * تظهر الآن رسالةٌ توضّح للمستخدم وظيفة هذه الأداة بدلا من التنبيه. (#12351)
    * يمكن الخروج من نافذة البدء هذه بالضغط على مفتاح الهروب `escape` أو `alt+f4`. (#10799)
    * ستُعرَضُ الآن رسالةٌ للمستخدم تتضمّن الخطأ، ضمن أخطاء Windows نادرة الحدوث أثناء محاولة إصلاح مشكلات سجل النظام.
* تغييرات متعلقة بالنُطق:
  * يمكن الآن استخدام WASAPI  مع أصوات Microsoft Speech API الإصدار 5 (SAPI5) و Microsoft Speech Platform لإخراج النُطق مما قد يُحسّن استجابة تلك الأصوات. (#13284, @gexgd0419)
  * سيُزال الصمت الذي سبق النُطق عند استخدام أصوات OneCore و SAPI5 وأصوات بعض إضافات آلات النُطق الأخرى لتحسين استجابتها. (#17614, @gexgd0419)
  * تستخدم أصوات Microsoft Speech API الإصدار الرابع (SAPI4) WASAPI لإخراج الصوت، مما يُتيح الاستفادة من ميزات نمط خفض الأصوات، وإزالة الصمت الذي يسبق النُطق، وإبقاء جهاز إخراج الصوت نَشِطًا أثناء استخدامها.
  إذا لم تعمل مع صوت SAPI 4  لديك؛ يمكنك تعطيل استخدام WASAPI مع SAPI 4 عبر تصنيف الإعدادات المتقدمة. (#17718, #17801, @gexgd0419)
  * أصبح خيار تسوية Unicode مفعّلًا افتراضيا لإخراج النُطق. (#17017, @LeonarddeR).
    * يمكنك تعطيل هذه الخاصية عبر تصنيف إعدادات النُطق من NVDA.
* أصبح لإعدادَي لوحة المفاتيح: "نُطق الأحرف المكتوبة" و"نُطق الكلمات المكتوبة" ثلاثة خيارات: "تعطيل"، و"في حقول التحرير فقط" و"دائما". (#17505, @Cary-rowen)
  * افتراضيا، ستُنطَق الأحرف المكتوبة فقط في مناطق التحرير.
* ستُحددَّدُ جداول برايل للإدخال والإخراج الافتراضية بناءً على لغة NVDA. (#17306, #16390, #290, @nvdaes)

### الإصلاحات

* إصلاحات متعلقة بالنُطق:
  * عولجت مشكلةُ توقُّف النُطق بعد قراءة الجملة الأولى أثناء القراءة المستمرة (قراءة الكل) عند استخدام بعض المحركات المعتمدة ل SAPI5  (#16691, @gexgd0419)
  * لن تعود إعدادات النُطق مثل: مستوى الصوت وسرعته للقيم الافتراضية عند التبديل بين الأصوات عبر دائرة إعدادات النُطق حال استخدام  SAPI5 أو SAPI4. (#17693, #2320, @gexgd0419)
  * أُصلحت مشكلة تعذُّر تفعيل بعض أصوات SAPI4 (مثل أصوات IBM TTS الصينية) (#17726, @gexgd0419)
* إصلاحات متعلقة بالخط البارز Braille:
  * أُدمج دعمُ جهاز عرض الرسومات البارزة Dot Pad من شركة Dot Inc كشاشة برايل متعددة الأسطر. (#17007)
  * عند استخدام شاشة برايل Seika Notetaker؛ ستُعرَضُ مفاتيح الاختصار "المسافة" أو "المسافة مع النقاط"، بشكل صحيح ضمن مربّع حوار تخصيص اختصارات NVDA. (#17047, @school510587)
  * لن يُصدر NVDA تنبيهات صوتية بوجود أخطاء أو يُثقل عارض التقارير بها إذا فُعِّل نمط برايل: "عرضُ مخرجات النُطق" في حال عدم وجود سطر برايل متصل. (#17092, @Emil-18)
  * عند تحديد أسطر برايل الإلكترونية الداعمة لتقنية HID القياسية على أنها معرف سطر برايل المحدد، إذا كانت قائمة أسطر برايل مفتوحة، سيحدد NVDA معرّف HID على أنه سطر برايل المختار بدلا من عرض "لا يوجد برايل". (#17537, @LeonarddeR)
  * أصبح معرِّف سطر Humanware Brailliant  أفضل في الاتصال، بحيث بات الاتصال به أكثر استقرارا وقلت نسبة حدوث أخطاء. (#17537, @LeonarddeR)
  * سيتجاهل NVDA الآن جداول برايل المخصصة الموجودة في مسودة المطور؛ إذا بدأ عملُه مع تعطيل الإضافات البرمجية.(#17565, @LeonarddeR)
  * إصلاح مشكلة عدم اكتشاف NVDA لبعض شاشات برايل عند وصلها عبر USB. (#18114, @christiancomaschi)
* Microsoft Office:
  * سيعمل أمر "الإعلان عن عنوان URL  الذي يقود إليه الرابط" كما هو متوقَع عند استخدام النموذج البرمجي القديم الخاص ب Word و Outlook و Excel و PowerPoint. (#17292, #17362, #17435, @CyrilleB79)
  * في Excel, لن تخفق قائمة عناصر التصفُّح، التي تُفعَّل بالضغط على (`NVDA+f7`) في عرض قائمة التعليقات والمعادلات الرياضية، في بعض الأنظمة غير الإنجليزية. (#11366, @CyrilleB79)
  * تحسيناتٌ في PowerPoint:
    * لن تتعثّر قراءة موضع مؤشّر التحرير عندما يتضمن النص حروفا عريضة مثل الرموز والوجوه التعبيرية (emoji). (#17006 , @LeonarddeR)
    * أصبح الإعلان عن موقع الحرف أدق (على سبيل المثال: عند الضغط على `NVDA+delete`. (#9941, @LeonarddeR)
    * لن يبدأ NVDA القراءة المتواصلة لكامل النص بعد بدء عرض الشريحة إذا كان خيار نمط التصفُّح "القراءة الآلية للنص فور تحميل الصفحة" معطَّلاً. (#17488, @LeonarddeR)
* في LibreOffice:
  * عند استخدام طريقة إدخال Microsoft Pinyin للغة الصينية وتمكين خيار توافق Pinyin لاستخدام الإصدار السابق، فإن الكتابة في Writer (وربما التطبيقات الأخرى) أثناء انبثاق IME لن تؤدي لحدوث خطأ (#17198, @michaelweghorn)
  * ستظهر حالة مربّعات التحديد الحالية في مربعات الحوار (محدد/غير محدد) على سطر برايل أيضا. (#17218, @michaelweghorn)
* المحتوى الرياضي:
  * إصلاح أخطاء قراءة الرياضيات في بعض عناصر صفحة الإنترنت.
  خصوصا، MATHML داخل حلقة والعناصر الأخرى التي لها السمة `rol =" Math "`. (#15058)
  * ستُعامَلُ المعادلات الرياضية التي ليست MathML والتي أُضيفت كصورة مع نص بديل على أنها صورة عادية، بدلا من اعتبارها مادة رياضية فارغة؛ وذلك ليسهُل الانتقال إليها بحرف `g` كسائر الرسومات. (#16007)
* IDEs:
  * لن ينهار NVDA عند تحديد النص كاملا في بعض الملفات في Android Studio أو IntelliJ Idea. (#17418, @thgcode)
  * في Visual Studio Code؛ ستعمل اختصارات التنقُّل `alt+سهم لأعلى`و `alt+سهم لأسفل` كما ينبغي. (#17082, @LeonarddeR)
  * في Visual Studio Code؛ سيتعرف NVDA على بعض العناصر القابلة للتحرير على أنها كذلك. (#17573, @Cary-rowen)
  * في المفكرة (Notepad) والمستندات الأخرى التي يتوصل إليها باستخدام أتمتة واجهة المستخدم UIA والمستندات في Notepad ++ على Windows 11 ، إذا كان السطر الأخير فارغًا؛ سيؤدي استخدام أمر "تمرير برايل للسطر التالي" لنقل المؤشر إلى السطر الأخير.
  في أي مستند، إذا كان المؤشّر في السطر الأخير؛ سينقله هذا الأمر للنهاية. (#17251, #17430, @nvdaes)
* الأوضاع:
  * لن يحدث خلل في عرض برايل عند تفعيل القراءة المتواصلة لكامل النص أثناء تفعيل الوضع الخاص بها (وضع القراءة المتصلة). (#17163, @LeonarddeR)
  * إصلاح مشكلة حفظ بعض الإعدادات في ملف الوضع النَشِط حتى وإن كانت قيمة الإعداد مطابقة لقيمته في الوضع الأساسي. . (#17157, @leonarddeR)
* ستعمل خاصية تسوية Unicode عند التهجئة بشكل أفضل:
  * بعد قراءة حرف Unicode؛ لن يُشير NVDA خطأً بعد الحرف التالي أنه "موحَّد. (#17286, @LeonarddeR)
  * ستُقرأ الأحرف المركبة (مثل é) بشكل صحيح. (#17295, @LeonarddeR)
* سيقرأ NVDA عناصر قائمة السياق المنبثقة في صفحة نتائج البحث في Thunderbird بشكل صحيح(#4708, @thgcode)
* لم تعُدْ أداة معالجة أخطاء سجل النظام الشائعة تظهر رسالة تفيد النجاح العملية في حال إخفاقها. (#12355, @XLTechie)
* لن يقرأ NVDAشيئا من عناصر سجل الحافظة في Windows 11 بعد إغلاق النافذة بينما يكون التركيز على أحد عناصرها. (#17308, @josephsl)
* إذا أُعيد تحميل الملحقات أثناء وجود رسالة قابلة للتصفُّح (مثل رسالة معلومات التنسيق)؛ لن يخفق NVDA في قراءة الموضع الذي ينتقل إليه التركيز (موضع مؤشر النظام). (#17323, @CyrilleB79)
* عند استخدام تطبيقات للاتصال الصوتي مثل:  Skype وـ Discord وـ Signal والهاتف؛ لن ينخفض مستوى صوت NVDA. (#17349, @jcsteh)
* لن يتعثّر فتح بوابة Python حال حدوث خطأ أثناء محاولة الحصول على بيانات المتغيرات الفورية. (#17391, @CyrilleB79)
* في متصفحات شبكة الإنترنت؛ لم يعُدْ NVDA يخفق أحيانا في قراء النص المحدد في حقول التحرير. (#17501, @jcsteh)
* عندما تكون وجهة الرابط هي ذات الكائن حيث يوجد المؤشّر الافتراضي؛ لن يخفق NVDA في الانتقال إليها.(#17669, @nvdaes)
* لن تظهر أيقونة التمييز البصري الخاصة ب NVDA كنافذة متجمدة في شريط المهام بعد إعادة تشغيل مستكشف الملفات. (#17696, @hwf1324)

### تعديلاتٌ للمطورين

يرجى الرجوع إلى [دليل المطورين] (https://www.nvaccess.org/files/nvda/documentation/developerguide.html#api) للحصول على معلومات حول عملية إزالة واجهة برمجة تطبيقات NVDA.
...
في Word أو Excel، يمكن الآن الضغط مرتين على مفتاح الاختصار الخاص بقراءة التعليق لقراءة التعليق أو الملاحظة في مربع حوار قابل للتصفُّح.
...
حُسِّنت دقة توجيه مؤشر برايل، وأُضيف دعم لمفاتيح توجيه برايل في PowerPoint.
...
تحديث eSpeak NG، وقد تضمَّن دعمًا للغتي الفارويز والإكسكستان.

تحديث LibLouis بإضافة جداول برايل جديدة للغتين التايلاندية واليونانية العالمية ذات أحرف من خلية واحدة.

هناك أيضًا عدد من الإصلاحات، تشمل تتبُّع الفأرة في Firefox، ووضع النُطق عند الطلب.
...
* مستجدات متعلقة ببرايل:
  * يمكن الآن تغيير الطريقة التي يعرض بها NVDA بعض خصائص تنسيق النص بطريقة برايل.
    الخيارات المتاحة هي:
    * Liblouis (الافتراضي): يستخدم علامات التنسيق المعرَّفة في جدول برايل المحدد.
...
* يمكن الآن الضغط على أمر قراءة التعليق في Microsoft Word وأمر قراءة الملاحظات في Microsoft Excel مرتين لإظهار التعليق أو الملاحظة في رسالة قابلة للتصفُّح. (#16800, #16878, @Cary-Rowen)
* يمكن الآن ضبطُ NVDA لعرض خصائص الخط نُطقًا وبرايل كلٌّ على حِدة. (#16755)
...
* سيؤخَذُ ما ضُبِطَ من إعدادات عبر خيارات سطر الأوامر `-c`/`--config-path` و `--disable-addons` بعين الاعتبار عند التحديث من داخل NVDA. (#16937)
* تحديثاتٌ للمكوِّنات:
  * تحديث مترجم LibLouis Braille إلى [3.31.0](https://github.com/liblouis/liblouis/releases/tag/v3.31.0). (#17080، @LeonarddeR, @codeofdusk)
    * إصلاح ترجمة الأرقام في جدول برايل الإسباني.
    * جداول برايل جديدة:
      * تايلاندي الدرجة الأولى
      * يوناني عالمي (أحرف ذات خلية واحدة)
    * جداول غُيِّرت أسماؤها:
      * غُيِّر اسم الجدول "تايلاندي ست نقاط" إلى "تايلاندي الدرجة 0) لدواعي التناسُق.
      * غُيِّر اسم جدول برايل "اليوناني الدولي" إلى "يوناني دولي (أحرف ذات خليتين) لإبراز الفرق بين الجدولين اليونانيَينِ.
  * تحديث آلة eSpeak NG إلى 1.52-dev `961454ff`. (#16775)
    * أُضيفت لغات جديدة: جزر فارو وإكسكستان.
* عند استخدام شاشة برايل متعددة الأسطر عبر معرِّف برايل HID القياسي، ستُستخدم جميع أسطر الخلايا. (#16993، @alexmoon)
...
* إصلاحات متعلقة ببرايل:
  * يمكن الآن استخدام مفاتيح توجيه مفاتيح مؤشِّر برايل لتحريك مؤشر النص في Microsoft PowerPoint. (#9101)
  ...
  * سيعمل معرِّف مفكرات Seika Notetaker الآن على تنفيذ إدخال مفاتيح الاختصار المتمثلة في المسافة أو المسافة للخلف، أو النقاط المقترنة بأحدهما بشكل صحيح. (#16642, @school510587)
...
* لن يخفق NVDA -كما كان يحدث أحيانًا- في فتح الرسائل القابلة للتصفح (مثل الضغط على `NVDA+f` مرتين). (#16806, @LeonarddeR)
...
يُرجى الرجوع إلى [دليل المطورين](https://www.nvaccess.org/files/nvda/documentation/developerGuide.html#API) للحصول على معلومات حول ما أُهمِلَ وأُزيل من واجهة برمجة التطبيقات الخاصة بـ NVDA.
...
* أُصلحت قراءة بعض خصائص الرياضيات في Adobe Reader والتي كانت تُنطَق أو تُعرَضُ بشكل خاطئ على سطر برايل. (#17980)
...
* منع إمكانية الوصول إلى مستوى النظام للمستخدمين غير الصرَّح لهم بذلك..
...
* منع المستخدم غير المصرَّح له من تحديث إعدادات النُطق وعارض برايل عبر شاشة القفل. ([GHSA-grvr-j2h8-3qm4](https://github.com/nvaccess/nvda/security/advisories/GHSA-grvr-j2h8-3qm4))
...
* إصلاح خلل إمكانية فتح بوابة python عبر عارض السجل على شاشة القفل.
...
* إضافة وظيفة جديدة لعناصر التحكُّم ذات "المؤشّر قيد العمل". (#10644)
...
* ستُحرَّر كافة مفاتيح الفأرة التي كانت في وضع التثبيت، بعد الخروج من NVDA، وقد كانت سابقا تظل قيد التثبيت. (#13410)
...
* في Windows 11، أصبح ممكنا كما -كان سابقا- تصفُّح عناصر واجهة المستخدم والتفاعل معها،
...
إُطلِق هذا الإصدار للعمل على التوقف  الذي يحدث عند الحركة على التغريدات بموقع [www.twitter.com](http://www.twitter.com). بتطبيق Google Chrome. (#8777)=
...
* إذا فُعِّلت خاصية نطق اختصارات لوحة المفاتيح, فإن البرنامج الآن يقوم بالإعلان عن مفاتيح الوسائط المتعددة (multimedia keys) مثل الإعلان عن مفاتيح التشغيل والإيقاف والصفحة الرئيسية إلخ بالضغط عليهم وذلك في معظم لوحات المفاتيح
...
* تحسين أداء التعامل مع ويندوز لايفمايل، فصار من الممكن نطق الرسائل النصية والتعامل مع كل من محرر الرسائل النصية ومؤلِّف (HTML).
...
* عند تعذُّر تفعيل أحد آلات النُطق؛ ستظهر رسالة تنبيه عند اختيارها تُفيدُ هذا.
