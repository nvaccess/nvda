...
Si prega di divulgare responsabilmente i problemi di sicurezza seguendo la [politica di sicurezza](https://github.com/nvaccess/nvda/blob/master/security.md) di NVDA.
...
* Microsoft Office:
  ...
  * Il risultato di un numero maggiore di scorciatoie da tastiera è ora segnalato in Word e Outlook:
    * scorciatoie per la formattazione del carattere (#10271, @CyrilleB79)
    * comprimi o espandi intestazione (#17545, @CyrilleB79)
* LibreOffice:
...
* Aggiornamenti dei componenti:
  * Aggiornato il traduttore Braille LibLouis alla versione [3.33.0](https://github.com/liblouis/liblouis/releases/tag/v3.33.0). (#17469, #17768, @LeonarddeR, @codeofdusk)
    * Aggiunte nuove tabelle Braille computerizzato a 6 punti per il copto, il cuneiforme compatto e il portoghese.
  * Aggiornato CLDR alla versione 46.0. (#17484, @OzancanKaratas)
  * Aggiornato eSpeak NG alla versione 1.52.0. (#17056)
...
Si tratta di una versione correttiva per risolvere i bug relativi ai display braille e alla lettura della matematica in Chromium.

### Bug corretti

* Risolto bug relativo alla lettura della matematica nei browser Chromium (Chrome, Edge). (#17421,@NSoiffer)
* I dispositivi Humannware Brailliant BI 40X che eseguono la versione firmware 2.4 ora funzionano come previsto. (#17518, @bramd)

## 2024.4.1

Questa è una versione patch per correggere un bug che non permetteva il salvataggio dei simboli dei dizionari.

### Bug corretti

* Risolto un bug per cui i dizionari dei simboli non venivano salvati e la finestra di dialogo non si chiudeva. (#17344)
...
* Aggiornamento dei componenti:
  * Aggiornata LibLouis Braille translator alla versione [3.31.0](https://github.com/liblouis/liblouis/releases/tag/v3.31.0). (#17080, @LeonarddeR, @codeofdusk)
...
Questa è una versione patch per correggere un bug con la notifica di aggiornamento automatico add-on
