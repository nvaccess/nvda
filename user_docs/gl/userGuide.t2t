...
+ A ventá do lanzador do NVDA aparece co acordo de licenza.
Preme ``frecha Abaixo`` para ler o acordo de licenza se o desexas.
+ Preme ``tab`` para desprazarte cara a caixa de verificación "Acepto", entón preme a ``barra espaciadora`` para marcala.
+ Preme ``tab`` para desprazarte polas opcións, entón preme ``intro`` sobre a opción desexada.
+
...
+ Dende o lanzador, asegúrate de que a caixa de verificación para aceptar a licenza estea marcada.
+ Preme ``Tab`` e activa o botón "Instalar NVDA neste computador".
+ Seguidamente, van as opcións para que o NVDA use durante o inicio de sesión de windows e para crear un acceso directo no escritorio.
...
+ Aparece un diálogo de Windows "Control de Conta de Usuario (UAC en inglés)" preguntándoche "¿Quere permitir que esta app faga cambios ao seu computador?".
+ Preme ``alt+s`` para aceptar o indicativo do UAC.
+ Rechéase unha barra de progreso según o NVDA se instale.
...
+ Aparece una caixa de diálogo confirmando que a instalación do NVDA foi exitosa.
A mensaxe avísache de que "Premas Aceptar para arrancar a copia instalada".
Preme ``intro`` para iniciar a copia instalada.
+ Aparece o diálogo "Benvido a NVDA", e o NVDA le unha mensaxe de benvida.
...
+ Preme ``tab`` para desprazarte cara "Usar ``bloqMaius`` coma unha tecla modificadora de NVDA".
...
+ Usa ``tab`` e ``barra espaciadora`` para axustar as outras opcións nesta pantalla.
Estas estabrecen se o NVDA arranca automáticamente.
+ Preme ``intro`` para pechar a caixa de diálogo co NVDA agora en execución.
+
...
+ Abre o diálogo Xestos de entrada dende o modo exploración.
+ Procura o elemento "move á seguinte pestana" na seción modo Exploración.
+ Asigna a tecla ``y`` para o xesto atopado.
+ Procura o elemento "move á pestana anterior".
+ Asigna ``shift+y`` para o xesto atopado.
+
...
+ move o cursor de revisión ao contido matemático.
...
+ Move o cursor ao texto que conteña a nota.
+ Accede ás opcións para a seleción segundo se descrebiu arriba.
+ Escolle Editar Nota.
+
...
+ Asegúrate de que instalaches o [derradeiro controlador https://www.papenmeier-rehatechnik.de/en/service/downloadcenter/software/articles/software-braille-devices.html].
+ Abre o administrador de dispositivos de Windows.
+ Desprázate cara abaixo pola listaxe ate "Controladores USB" ou "Dispositivos USB".
+ Seleciona "dispositivo Papenmeier Braillex USB".
+ Abre as propriedades e cambia á pestana "Avanzadas".
...
+ Deshabilita a opción "Cargar VCP".
+
