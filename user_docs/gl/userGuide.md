...
* Sistemas operativos: todas as edicións de 32 e 64 bits do Windows 7, Windows 8, Windows 8.1, Windows 10 Windows 11 e todos os sistemas operativos servidor comezando dende o Windows Server 2008 R2..
 * Para o Windows 7, NVDA require do Service Pack 1 ou superior.
 * Para o Windows Server 2008 R2, NVDA require do Service Pack 1 ou superior.
...
|Ler a seleción |`NVDA+shift+frecha arriba` |`NVDA+shift+s` |Le calquera texto selecionado|
|Ler texto do portapapeis |`NVDA+c` |`NVDA+c` |Le calquera texto no portapapeis|
...
|Anunciar foco |`NVDA+tab` |`NVDA+tab` |Anuncia o control actual que teña o foco. Preméndoo dúas veces deletreará a información|
...
* Windows 8 e posterior: a incapacidade de admitir a entrada dende una pantalla táctil.
* Windows 8 e posterior: a incapacidade de proporcionar características coma o modo navegación e a fala de caracteres ao se escreber nas aplicacións da Tenda de Windows.
* Windows 8 e posterior: a atenuación de audio non está admitida.
...
Podes ler máis información sobre a recopilación de datos por NV Access na seción Opcións Xerais, [Permitir ao proxeto do NVDA recopilar estadísticas de uso do NVDA](#GeneralSettingsGatherUsageStats).
...
Se estás a executar o NVDA nun dispositivo cunha pantalla tactil e está executando Windows 8 ou superior, tamén podes controlar ao NVDA directamente a través de ordes tactiles.
...
Usando MathPlayer 4 from Design Science, NVDA pode ler e navegar interactivamente polo contido matemático soportado.
Esto require que MathPlayer 4 estea instalado no computador.
MathPlayer está dispoñible coma unha descarga gratuita dende: https://www.dessci.com/en/products/mathplayer/.
Despois de instalar MathPlayer, reinicia o NVDA.
...
Pode descargarse dende https://www.dessci.com/en/products/mathtype/
* Adobe Reader.
...
Neste punto, podes utilizar ordes de MathPlayer como as teclas de cursor para explorar a  expresión.
...
Por favor consulta a [documentación de MathPlayer acerca de ordes de navegación](https://www.dessci.com/en/products/mathplayer/navigation_commands.htm) para información adicional.
...
Esto require primeiro que a opción Anunciar  Cabeceiras de Filas e columnas nas opcións de NVDA Formateado de Documentos, que se atopa no diálogo [Opcións do NVDA](#NVDASettings), estea activada.
En segundo lugar, NVDA necesita saber que fila ou columna contén a cabeceira en calquera táboa dada.
...
##### Permitir que o Proxecto NVDA Recolla Estadísticas de Uso do NVDA {#GeneralSettingsGatherUsageStats}
...
| . {.hideHeaderRow} |.|
|---|---|
|Optións |Habilitado, Deshabilitado|
...
##### Abrir o diálogo Selecionar Sintetizador {#toc138}
...
| . {.hideHeaderRow} |.|
|---|---|
|Opcións |Predeterminado (Nunca), Nunca, só cando segue automáticamente, sempre|
...
##### Abrir o diálogo Selecionar Pantalla Braille {#toc160}
...
Para obter unha listaxe dos sintetizadores que admite o NVDA, por favor consulta a seción [Sintetizadores de Voz admitidos](#SupportedSpeechSynths).

Un elemento especial que sempre aparecerá nesta listaxe é "Sen voz", que che permite usar o NVDA sen saída de voz.
Esto pode ser útil para alguén que só desexe usar o NVDA con braille, ou quizáis para desenvolvedores videntes que só desexen usar o Visualizador de voz.

#### Audio {#AudioSettings}

<!-- KC:setting -->

##### Abrir Opcións de Audio {#toc166}
...
Para conmutar a Cortina de Pantalla dende calquera sitio, por favor asigna un xesto persoalizado usando o diálogo [Xestos de Entrada](#InputGestures).
...
##### Abrir opcións de Teclado {#toc176}
...
Se non se escolle ningunha tecla como a tecla NVDA podería ser imposible acceder a certas ordes de NVDA.
Polo tanto, o diálogo Opcións do NVDA amosará unha mesaxe de erro se todas as teclas están sen seleccionar  cando se prema Aceptar.
Despois de descartar a mesaxe de erro, debes seleccionar polo menos unha antes de poder premer Aceptar para pechar o diálogo correctamente.
...
##### Abre as opcións do Rato {#toc189}
...
##### Anunciar rol cando o rato entra nos Obxectos {#MouseSettingsRole}
...
Esta categoría de opcións, só dispoñible en computadores que executen Windows 8 e posterior con capacidades tactiles, permítenche configurar o xeito no que NVDA interactúa con pantallas tactiles.
Esta categoría contén as seguintes opcións:
...
##### Abrir as opcións de Presentación de Obxectos {#toc206}
...
##### Abrir as opcións de modo Exploración {#toc224}
...
##### Abrir as opcións de Formateado de Documento {#toc238}
...
* "Anunciar 'ten detalles' para anotacións estructuradas ": habilita o anunciado se o texto ou o control ten máis detalles.
  Pódese anunciar un resumo dos detalles adicionais asignando un xesto a "Anunciar resumo de calquera detalle de anotación no cursor do sistema" usando o [diálogo Xestos de Entrada](#InputGestures).
...
Para un titorial introductorio, Por favor consulta [https://docs.python.org/3.7/howto/regex.html].
...
Usando NVDA+F1 abrirase o visualizador do rexistro e amosarase a información do desenvolvedor sobre o navegador de obxectos actual.

Ademáis de ler o contido, tamén podes gardar unha copia do ficheiro do rexistro, ou refrescar o visualizador tal que se amose a saída máis recente dende que o visualizador do rexistro foi aberto.
Estas accións están dispoñibles baixo o menú de visualizador do Rexistro.
...
Non obstante, se fas clic ou colocas o foco dentro do visualizador,  NVDA deterá temporalmente a actualización do texto, tal que poderás seleccionar ou copiar sinxelamente o contido existente.
...
En Windows 7, 8 y 8.1, o NVDA usa Espeak NG de xeito predeterminado ([Windows OneCore](#OneCore) úsase en Windows 10 e posteriores por defecto).
...
Se non os tes aínda, podes obtelos dende https://www2.freedomscientific.com/downloads/focus-40-blue/focus-40-14-blue-downloads.asp.
...
#### Asignacións de teclas para todos os modelos {#toc319}
...
#### Asignacións de teclas para Brailliant BI 32, BI 40 e B 80 {#toc320}
...
#### Asignacións de teclas para Brailliant BI 14 {#toc321}
...
Podes descargalos de aquí: http://www.himsintl.com/upload/HIMS_USB_Driver_v25.zip
...
Podes atopar máis información acerca das pantallas en https://en.seika-braille.com/down/index.html.
...
|Conmutar entre os modos de voz desactivado, pitar e falar |`attributo2+attributo4`|
...
|-l LOGLEVEL |--log-level=LOGLEVEL |O nivel máis baixo de mensaxe rexistrada (debug 10, input/output 12, debug warning 15, info 20, disabled 100)|
...
Se requires información adicional ou asistencia referente ao NVDA, por favor visita o sitio Web de NVDA en NVDA_URL.
