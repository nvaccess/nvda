...
* Sistemas operativos: todas as edicións de 32 e 64 bits do Windows 8.1, Windows 10 Windows 11 e todos os sistemas operativos servidor comezando dende o Windows Server 2008 R2..
  ...
  * Ten en conta que os sistemas operativos de 32 bits xa non están baixo un soporte activo.
  * Ten en conta que Windows 8.1 e Windows Server versións máis vellas que 2022 xa non están baixo soporte activo.
* ao menos 500 MB de espazo de almacenamento.

#### Requerimentos do sistema recomendados {#RecommendedSystemRequirements}

* Sistemas operativos: ediciòns de 64 bits de Windows 10, Windows 11 e Windows Server 2022.
  * ambas variantes AMD64 e ARM64 de Windows sopórtanse.
* ao menos 500 MB de espazo de almacenamento.
...
Ademáis do inglés, o NVDA traduciuse a 55 linguas, entre elas: Afrikaans, albanés, amárico, árabe, aragonés, bosnio, búlgaro, birman, catalán, chinese (simplificado e tradicional), croata, checo, danés, neerlandés, farsi, finés, francés, galego, Xeorxiano, alemán (Alemania e Suiza), grego, hebreo, hindi, húngaro, islandés, irlandés, italiano, xaponés, canarés, coreano, kirguís, lituano, macedonio, mongol, nepalí, noruego, polaco, portugués (Brasil e Portugal), punjabí, rumano, ruso, serbio, eslovaco, esloveno, español (Colombia e España), sueco, tamil, tailandés, turco, ucraniano e vietnamita.
...
https://www.nvaccess.org/downloadhttps://www.nvaccess.org/download
...
Pode que teñas que esperar uns segundos mentres se carga unha copia temporal do NVDA.
Unha vez cargada, o NVDA falará durante o resto do proceso.
1. Aparecerá a xanela do lanzador do NVDA cun botón para abrir o acordo de licenza.
Preme frecha abaixo para ler o acordo de licenza.
...
1. Aparecerá unha caixa de diálogo para confirmar que a instalación do NVDA se realizou correctamente.
...
| Nome |Tecla de escritorio |Tecla de Portátil |Descripción|
|---|---|---|---|
|Pronunciar caracteres ao se escrebir |`NVDA+2` |`NVDA+2` |Controla cando NVDA anuncia os caracteres que escrebes. |
|Falar palabras ao se escrebir|`NVDA+3` |`NVDA+3` |Controla cando o NVDA anuncia palabras que escrebes. |
...
Recomendamos comezar polo módulo "Formación básica para NVDA".
...
Esta opción permíteche escoller se o NVDA debe ou non copiar a configuración de usuario do NVDA actualmente en execución na configuración para o usuario actualmente conectado, para a copia instalada do NVDA.
...
Por defecto, o NVDA está configurado para usar a distribución Escritorio, aíndaque podes cambiar á distribución Portátil na categoría Teclado da Caixa de diálogo [Opcións de NVDA](#NVDASettings), que se atopa en Preferencias no menú NVDA.
...
Tocar unha vez cun dedo coñécese sinxelamente como tap ou toque.
...
As ordes reais non se executarán mentres se estea no modo de axuda de entrada.
...
|Anunciar localización do cursor |NVDA+suprimir do teclado numérico |NVDA+suprimir |Anuncia información acerca da localización do texto ou do obxecto na posición do cursor do sistema. Por exemplo, esto podería incluir a porcentaxe do documento, a distancia dende a marxe da páxina oo da posición exacta da pantalla. Premer dúas veces pode proporcionar detalles adicionais.|
...
|Mover al inicio de la selección en revisión |`NVDA+alt+inicio` |`NVDA+alt+inicio` |No |Despraza o cursor de revisión ao primeiro carácter do texto selecionado|
|Mover ao final da seleción en revisión |`NVDA+alt+fin` |`NVDA+alt+fin` |Non |Despraza o cursor de revisión ao último carácter do texto selecionado|
...
Unha boa maneira de lembrar as ordes básicas de revisión de texto cando se usa a distribución escritorio é pensar en elas como se estiveran nunha grella de tres por tres, na que de arriba a abaixo son liña, palabra e carácter e de esquerda a dereita son anterior, actual e seguinte.
...
| Nome |Tecla |Descripción|
|---|---|---|
|Procurar texto |NVDA+control+f |Abre o diálogo de procura|
|Procurar seguinte |NVDA+f3 |Busca a seguinte ocurrencia do termo buscado actual|
|Procurar anterior |NVDA+shift+f3 |procura a aparición anterior do termo de procura actual|
...
Sin embargo, o NVDA ten un Modo de Seleción Nativo que pode activarse en documentos particulares do Modo exploración que o soporten (Mozilla Firefox e calquera navegador baseado en Chromium 134 ou máis recente) que fai que a seleción nativa do documento siga á seleción do Modo exploración do NVDA.
...
Premendo `NVDA+f5` actualízase o resultado do recoñecemento.
...
O NVDA proporciona as súas proprias funcións adicionais para algunhas aplicacións co eido de facilitar determinadas tarefas ou proporcionar acceso a funcións que, de outro xeito, non serían accesibles para os usuarios de lectores de pantalla.
...
| Nome |Tecla |Descripción|
|---|---|---|
|Estabrecer cabeceiras de columna |`NVDA+shift+c` |Premendo esto unha vez dille ao NVDA que esta é a primeira celda de cabeceira na fila que contén cabeceiras de columna, que deberían anunciarse automáticamente ao moverse entre columnas por debaixo de esta fila. Premendo dúas veces borrarase a configuración.|
|Estabrecer cabeceiras de fila |`NVDA+shift+r` |Premendo esto unha vez dille ao NVDA que esta é a primeira celda de cabeceira na columna que contén cabeceiras de fila, que deberían anunciarse automáticamente ao moverse entre filas despois desta columna. Premendo dúas veces borrarase a configuración.|

<!-- KC:endInclude -->
Estas opcións gardaranse no documento como marcadores, compatibles con outros lectores de pantalla coma Jaws.
Esto significa que os usuarios doutros lectores de pantalla que abran este documento posteriormente terán automáticamente as cabeceiras de fila e columna xa configurados.
...
<!-- KC:endInclude -->
Todos os comentarios para el documento, xunto con outros cambios rastreados, tamén poden seren listados na Listaxe de Elementos de NVDA cando se seleciona Anotacións como tipo.
...
Esto significa que os usuarios doutros lectores de pantalla que abran este libro máis adiante terán automáticamente as cabeceiras de fila e columna xa configuradas.
...
O NVDA ofrece soporte mellorado para Poedit 3.5 o máis novo.
...
##### Abrir Opcións Xerais {#OpenGeneralSettings}
...
Cando estea marcada, aparecerá un diálogo cando tentes saír do NVDA, ofrecendo as seguintes posibilidades:

* saír
* reiniciar
* reiniciar cos complementos desactivados e o rexistro de depuración activado
* reiniciar co rexistro de depuración activado
* instalar as actualizacións pendentes (se as houbera).
...
Premendo este botón copias a túa configuración de usuario do NVDA actualmente gardada ao directorio de sistema de configuración do NVDA, tal que NVDA utilizaráo cando se execute durante o inicio de sesión, Control de Contas de Usuario (UAC) e outras [pantallas seguras](#SecureScreens)  de Windows.
...
* Unha ID única para o usuario actual do NVDA, esto cambia unha vez ao mes
...
Tamén podes instalar manualmente a actualización pendente dende a Caixa de diálogo Saír do NVDA (se está activado), dende o menú NVDA ou ao realizar unha nova comprobación dende o menú Axuda.

##### Espello de Actualización {#UpdateMirror}

Estes controis permítenche especificar unha URL alternativa a usar para buscar actualizacións do NVDA.
Esto pode ser útil en lugares onde o acceso ao servidor de actualización de NV Access NVDA é lento e non está dispoñible.

A Caixa de texto de só lectura amosa a URL espello actual.
Se non se está a usar ningún espello (é dicir, se se está a usar o servidor de actualización de NV Access), aparecerá "Sen espello".

Se desexas cambiar o espello de actualización, preme o botón "Cambiar..." para abrir a [caixa de diálogo Estabrecer espello de actualización](#SetURLDialog).

Por favor ten en conta que ao usar un espello de actualización, o operador do espello ten acceso a toda a [información enviada con comprobacións de actualización] (#GeneralSettingsCheckForUpdates).
Ponte en contacto co operador do espello de actualización para obter detalles sobre as súas políticas de manexo de datos para asegurarte de que esteas cómodo co xeito en que se tratará a túa información antes de configurar unha réplica de actualización.

##### Evita que a pantalla se apague durante ler todo ou a lectura en braille {#PreventDisplayTurningOff}

Esta caixa de verificación, cando está activada, garante que a pantalla permaneza acesa ao ler con dicir todo ou en braille (por exemplo, ao premer os botóns de desprazamento).
Isto evita que a pantalla se bloquee de forma inesperada durante un ler todo.
Esta opción está activada por defecto.
Considera desactivar esta opción se estás a sufrir unha duración da batería máis curta.

#### Opcións de Voz {#SpeechSettings}

<!-- KC:setting -->

##### Abre opcións de Voz {#OpenSpeechSettings}
...
A primeira opción da categoría Configuración de voz é o botón Cambiar....
Este botón activa o diálogo [Selecionar sintetizador](#SelectSynthesizer), que che permite seleccionar o sintetizador de voz activo.
...
Cando esta opción estea habilitada, realízase a normalización unicode no texto que estea falándose polo NVDA.
Esto é beneficioso cando se falan caracteres que se poden representar de varios xeitos.
O NVDA usa o algoritmo NFKC (Normalization Form Compatibility Composition en inglés), que proporciona os seguintes beneficios, entre outros:

1. As versións negriña e cursiva de caracteres que son parte do estándar unicode e son comunmente usados nas redes sociais normalízanse aos seus equivalentes máis compatibles.
Por exemplo, a letra latina "h" tamén pode presentarse como "𝐡" (negria), "ℎ" (cursiva), etc. pero sempre se falará como "h" cando a normalización estea habilitada.
Este aspecto da normalización tamén axuda a ler ecuacións no editor de ecuacións de Microsoft Word.

1. Normalización a caracteres compostos.
Por exemplo, o carácter  "ü" (u con diérese), un carácter común en linguas como alemán e turco pode representarse en dúas formas:
  1. Un carácter autónomo unicode (ü)
  1. Unha descomposición en dous caracteres (ü), a saber, a letra latina normal u e unha modificadora diérese
  A normalización Unicode asegúrase de que só se usará unha forma en toda a saída de voz, que é a variante dun carácter.

1. Descomposición de algunha ligadura, Incluindo "ĳ" (ligadura ij) a súa forma de dúas letras ("ij").

1. Ordenación estable de modificadores en caracteres compostos, por exemplo en hebreo antigo.

Para conmutar a normalización Unicode dende calquera lugar, por favor asigna un xesto persoalizado usando o [diálogo Xestos de Entrada](#InputGestures).

| . {.hideHeaderRow} |.|
|---|---|
|Opcións |Predeterminado (Activado), Activado, Desactivado|
|Predeterminado |Activado|

##### Anunciar "Normalizado" ao navegar por caracteres {#SpeechReportNormalizedForCharacterNavigation}

Esta opción é unha caixa de verificación que, cando se marca, di ao NVDA que anuncie explícitamente que un carácter se normalizou cando se falou coma un carácter individual según cando se deletrea.
Por exemplo, cando esta opción se habilita, deletrear o carácter  "ĳ" pronunciaráo como "i j normalizado".

Ten en conta que esta opción só está dispoñible cando "[Normalización Unicode](#SpeechUnicodeNormalization)" estea habilitada.
...
##### Abrir o diálogo Selecionar Sintetizador {#OpenSelectSynthesizer}
...
Se seleciona "Automático", a táboa selecionarase segundo a lingua actual do NVDA.
...
Neste caso, o braille non seguirá o foco do sistema nin o cursor do sistema.
...
| . {.hideHeaderRow} |.|
|---|---|
|Opcións |Predeterminada (Nunca), Nunca, só ao se seguir automáticamente, Sempre|
...
##### Marca de comezo do parágrafo {#BrailleParagraphStartMarkers}

Se "Ler por parágrafos" está marcada, a marca de comezo selecionada amosarase para indicar o comezo dun parágrafo.
Esto pode ser especialmente útil en aplicacións usadas para ler pezas longas de texto, coma documentos estructurados ou libros.
Neses documentos, saber onde comezan os parágrafos podería ser útil para comprender a estructura do contido, ou para establecer marcadores ou anotacións baseadas na posición do parágrafo.

As opción inclúen usar dous espazos como un sutil salto de parágrafo, e o símbolo de parágrafo, marca de parágrafo (¶), coma un máis obvio.

| . {.hideHeaderRow} |.|
|---|---|
|Opcións |Sen marca de comezo de parágrafo, Doble espazo (  ), Marca de parágrafo (¶)|
|Predeterminado |Sen marca de comezo de parágrafo|
...
| . {.hideHeaderRow} |.|
|---|---|
|Opcións |Predeterminado (Habilitado), Habilitado, Deshabilitado|
|Predeterminado |Habilitado|

##### Formato da Pantalla {#BrailleFormattingDisplay}

Esta opción determina cómo o NVDA amosará o formato do texto en braille.
Esta opción só ten efecto se o NVDA se estabrece a [amusar atributos de fonte en braille](#DocumentFormattingFontAttributes).

| . {.hideHeaderRow} |.|
|---|---|
| Opcións | Predeterminado (Liblouis), Liblouis, Etiquetas |
| Predeterminado | Liblouis |

| Opción | Comportamento |
|---|---|
| Liblouis | Usa formato braille nativo. Ten en conta que esta opción só indicará texto en negriña, cursiva e subliñado, e só se a táboa braille selecionada soporta o indicado destes atributos. |
| [Etiquetas](#BrailleFormattingDisplayTags) | Usa etiquetas que describen cómo e onde cambia o formato do texto. |

###### Etiquetas {#BrailleFormattingDisplayTags}

Cando "Formato da pantalla" se estabrece a "Etiquetas", amósase una etiqueta de formato en braille cando se detecta un cambio no formato.
Estas etiquetas comezan con ⣋ e rematan con ⣙.
Unha etiqueta de formato conterá un ou máis símbolos que describen o formato do texto.
Os seguintes símbolos están definidos:

| Símbolo | significado |
|---|---|
| ⠃ ("b") | Comezar negriña |
| ⡃ ("b" co punto 7) | Remate da negriña |
| ⠊ ("i") | Comezo da cursiva |
| ⡊ ("i" co punto 7) | Remate da cursiva |
| ⠥ ("u") | Comezo do subliñado |
| ⡥ ("u" co punto 7) | Remate do subliñado |
| ⠎ ("s")| Comezo do tachado |
| ⡎ ("s" co punto 7) | Remate do tachado |

##### Falar carácter ao enrutar o cursor no texto {#BrailleSpeakOnRouting}

Se esto está habilitado, o NVDA falará automáticamente o carácter no cursor cando se enrute cara el cos sensores do cursor braille.

Para conmutar esta opxión dende calquera sitio, por favor asigna un xesto persoalizado usando o [diálogo Xestos de Entrada](#InputGestures).

##### Falar ao navegar por liña ou parágrafo {#BrailleSpeakOnNavigating}

Activar esta opción fará que NVDA diga as liñas ou os parágrafos alcanzados usando os controis de navegación da pantalla braille.

Para alternar esta opción desde calquera lugar, asigna un xesto persoalizado a "speakOnNavigatingByUnit" na sección "Braille" do [diálogo de xestos de entrada](#InputGestures).

##### Evitar palabras partidas cando sexa posible {#BrailleSettingsWordWrap}

Se esto está habilitado, unha palabra que sexa demasiado longa para caber ao final da pantalla braille non se partirá.
A cambio, haberá algúns espazos en branco ao final da pantalla.
Cando despraces a pantalla, poderás ler a palabra enteira.
Esto chámase ás veces "word wrap".
Ten en conta que se a palabra é demasiado longa para caber na pantalla incluso por si mesma, a palabra aínda debe partirse.

Se esto se deshabilita, amosarase a maior parte posible da palabra, pero o resto cortarase.
Cando despraces a pantalla, entón poderás ler o resto da palabra.

Habilitar esta opción pode permitir unha lectura máis fluida, pero xeralmente require desprazarse máis pola pantalla.

##### Normalización unicode {#BrailleUnicodeNormalization}

Cando esta opción está activada, realízase a normalización unicode no texto que se braillifica na pantalla braille.
Esto resulta beneficioso cando se atopan caracteres en braille que son descoñecidos nunha táboa braille concreta e que teñen unha alternativa compatible, coma os caracteres en negriña e cursiva que se usan habitualmente nas redes sociais.
Outros beneficios da normalización unicode explícanse con máis detalles na [seción equivalente para a voz](#SpeechUnicodeNormalization).

Para conmutar a normalización Unicode dende calquera sitio, por favor asigna un xesto persoalizado usando o [diálogo Xestos de Entrada](#InputGestures).

| . {.hideHeaderRow} |.|
|---|---|
|Opcións |Predeterminado (Deshabilitado), Habilitado, Deshabilitado|
|Predeterminado |Deshabilitado|

##### Interrumpir fala mentres se despraza {#BrailleSettingsInterruptSpeech}

Esta opción determina se a fala debe interrumpirse cando a pantalla Braille se despraza cara atrás ou adiante.
As ordes de liña anterior e seguinte sempre interrumpen a fala.

A fala continua pode ser unha distracción ao ler en Braille.
Por esta razón, a opción está activada por defecto, interrumpindo a fala ao se desplazar en braille.

A desactivación desta opción permite escoitar a fala mentres se le simultáneamente en Braille.
...
##### Abrir o diálogo Selecionar Pantalla Braille {#OpenSelectBrailleDisplay}
...
##### Abrir Opcións de Audio {#OpenAudioSettings}
...
Por defecto a separación de son está deshabilitada.
...
* Separación de son deshabilitada: o NVDA non aplica ningún procesamento de división de son.
...
* NVDA á esquerda e aplicacións nas dúas canles: NVDA falará na canle esquerda, mentres que outras aplicacións reproducirán sons nas dúas canles esquerda e dereita.

Hai máis modos avanzados de separación de son dispoñibles na caixa combinada nas opcións do NVDA.
Entre estos modos, "NVDA en ambas canles e as aplicacións en ambas canles" obriga a que todos os sons vaian a ambas canles.
Este modo pode diferir do modo "Separación de son deshabilitada" en caso de que outro procesamento de audio interfira cos volúmenes das canles.
...
Para mitigar esto, por favor reinicia o NVDA e seleciona o modo "NVDA en ambas canles e aplicacións en ambas canles".
...
* Separación de son deshabilitada.
* NVDA na esquerda e as aplicacións na dereita.
* NVDA na esquerda e as aplicacións en ambas.
...
##### Abrir opcións de Teclado {#OpenKeyboardSettings}
...
As opción dispoñibles son:

* Desactivado: o NVDA non anunciará os caracteres escritos.
* Só nos controis de edición: NVDA só anunciará os caracteres escritos nos controis de edición e noutras áreas onde se pode escribir texto.
* Sempre: NVDA anunciará todos os caracteres escritos.
...
* Desactivado: NVDA non anunciará palabras escritas.
* Só nos controis de edición: NVDA só anunciará palabras escritas nos controis de edición e outras áreas onde se pode escribir texto.
* Sempre: NVDA anunciará todas as palabras escritas.
...
Esta opción está activada de forma predeterminada, aínda que certos usuarios queiran desactivala, como aqueles que escriben vietnamita co software de escritura UniKey, xa que provocará a entrada de caracteres incorrecta.

##### Tempo de espera de pulsación de múltiples teclas {#MultiPressTimeout}

Algúns Xestos do teclado en NVDA realizan diferentes accións en función de cántas veces se prema a mesma tecla en rápida sucesión.
Un exemplo desto é a orde "Anunciar o carácter actual do navegador de obxectos".
Esta orde anuncia o carácter se se preme unha vez, unha descripción fonética do carácter se se preme dúas veces e o valor numérico do carácter se se preme tres veces.
Esta opción configura o tempo de espera tras o que unha pulsación adicional da mesma tecla iniciará un novo xesto, a cambio de tomarse como unha pulsación posterior da primeira.
Para a orde do exemplo, un tempo de espera demasiado curto fará que dúas pulsacións anuncien dúas veces o carácter actual, a cambio da descripción fonética.
O tempo de espera por defecto é de 500 ms, é dicir, medio segundo.
Aumentar este tempo de espera pode ser especialmente útil para as persoas que usan sticky keys, ou que teñen unha discapacidade física.

#### Rato {#MouseSettings}

<!-- KC:setting -->

##### Abre as opcións do Rato {#OpenMouseSettings}
...
##### Abrir as opcións de Presentación de Obxectos {#OpenObjectPresentationSettings}
...
Esta opción, que está activada por defecto, permíteche escoller se todos os candidatos visibles deben anunciarse automaticamente ou non cando aparece unha lista de candidatos ou se cambia a súa páxina.
...
Non obstante, para métodos de entrada fonética como o novo fonético chinés, pode ser máis útil desactivar esta opción, xa que todos os símbolos soarán igual e terás que utilizar as teclas de frecha para navegar polos elementos da lista individualmente para obter máis información das descricións de caracteres de cada candidato.
...
Para os métodos de entrada onde a selección se pode cambiar coas teclas de frecha (como a nova fonética chinesa), isto é necesario, pero para algúns métodos de entrada pode ser máis eficiente escribir con esta opción desactivada.
...
Esta opción permíteche escoller se NVDA debe informar ou non de novos símbolos tal e como aparecen na cadea de composición.
...
##### Abrir as opcións de modo Exploración {#OpenBrowseModeSettings}
...
Activada de xeito predeterminado, esta opción permíteche escoller se os xestos (como as pulsacións de teclas) que non dan como resultado un comando NVDA e que non se consideran unha tecla de comando en xeral, deben quedar atrapados ao pasar ao documento no que está enfocado actualmente.
...
##### Abrir as opcións de Formateado de Documento {#OpenDocumentFormattingSettings}
...
* Fonte
  * Nome de fonte
  * Tamano de fonte
  * Atributos de fonte [(Desactivado, fala, Braille, fala e braille)](#DocumentFormattingFontAttributes)
...
* Elementos
  * Cabeceiras
  * Ligazóns
  * Tipo de ligazón (destiño á mesma páxina)
  * Gráficos
  * Listaxes
  * Citas
  * Grupos
...
##### Atributos de fonte {#DocumentFormattingFontAttributes}

Esta opción permíteche selecionar cómo se anuncian determinados atributos de fonte, coma negriña, cursiva, subliñado e tachado.
A Caixa combinada atributos de fonte ten catro opcións:

* Desactivado: o NVDA non anunciará estos atributos de fonte.
* Fala: o NVDA anunciará o cambio destos atributos de fonte.
* Braille: o NVDA amosará estos atributos en braille.
O xeito exacto de como se amosan pode configurarse en [opción braille do NVDA](#BrailleFormattingDisplay).
* Fala e braille: o NVDA anunciará os atributos de fonte usando os dous métodos anteriores.
...
* Voz: se se selecciona a voz, cando cambie a cantidade de sangría, NVDA dirá algo así como "doce espazos" ou "catro tabulacións".
* Tons: se se selecciona Tons, cando a cantidade de sangría cambia, os tons indican a cantidade de cambio de sangría.
...
##### Actualizacións automáticas {#AutomaticAddonUpdates}

Cando esta opción está axustada a "Notificar", a Tenda de Complementos notificarache antes de que o NVDA arranque se calquera actualización de complemento está dispoñible.
Esta comprobación realízase cada 24 horas.
De xeito predeterminado, as notificacións só se producirán para os complementos con actualizacións dispoñibles na mesma [canle] (#AddonStoreFilterChannel) (por exemplo, estable, beta ou dev).
Podes configurar canles de actualización de complementos [individualmente para cada complemento](#AddonStoreUpdateChannel) ou para [todos os complementos](#DefaultAddonUpdateChannel).

Cando se define en "Actualizar automaticamente", os complementos actualizaranse automaticamente en segundo plano.
Solicitaráseche que reinicies o NVDA cando rematen as actualizacións.

| . {.hideHeaderRow} |.|
|---|---|
|Opcións | Notificar (predeterminado), Actualizar automaticamente, Desactivado |
|Predeterminada |Notificar |

|Opción |Comportamento |
|---|---|
|Notificar |Notificar cando hai actualizacións dispoñibles para os complementos |
|Actualizar automaticamente |Actualizar automaticamente os complementos en segundo plano |
|Deshabilitada |Non comproba automáticamente as actualizacións de complementos |

##### Canle de actualización predeterminado {#DefaultAddonUpdateChannel}

Cando as [Actualizacións automáticas de complementos](#AutomaticAddonUpdates) están activadas, de xeito predeterminado, os complementos só se actualizan á mesma [canle](#AddonStoreFilterChannel).
Por exemplo, unha versión beta instalada só se actualizará a unha versión beta máis recente.
Esta opción define a canle de actualización predeterminada para todos os complementos.
Tamén podes cambiar a canle de actualización dun [complemento específico individualmente desde a tenda de complementos] (#AddonStoreUpdateChannel).

| . {.hideHeaderRow} |.|
|---|---|
| Opcións | mesmo (predeterminado), Calquera, Non actualizar, Estable, Beta ou dev, Beta, Dev |
| Predeterminado | Mesmo |

| Opción | Comportamento |
|---|---|
| Mesmo | Os complementos permanecerán na súa canle |
| Calquera | Os complementos actualizaranse automaticamente á última versión, independentemente da canle |
| Non actualizar | Os complementos non se actualizarán automaticamente por defecto, debes activalos individualmente |
| Estable | Os complementos actualizaranse automaticamente a versións estables |
| Beta ou dev | Os complementos actualizaranse automaticamente ás versións beta ou de desenvolvemento |
| Beta | Os complementos actualizaranse automaticamente ás versións beta |
| Dev | Os complementos actualizaranse automaticamente ás versións de desenvolvemento |

##### Permitir que as actualizacións automáticas instalen complementos incompatibles {#AllowIncompatibleAddonUpdates}

Esta opción permite actualizacións automáticas de complementos que poden non ser totalmente compatibles coa versión actual de NVDA.
Por defecto, está desactivado, o que significa que as actualizacións automáticas só se actualizarán ás versións de complementos marcadas como compatibles coa versión actual do NVDA.
As actualizacións automáticas seguirán actualizando unha versión de complemento incompatible a unha versión compatible cando se publique.
Activar isto pode ser útil para pasar a usar versións de ruptura de complementos (a primeira versión do ano).
Isto é especialmente útil para os probadores alfa e beta, que están a probar a compatibilidade dos complementos durante as primeiras fases dunha versión de ruptura de complementos.

##### Servidor espello {#AddonStoreMetadataMirror}

Estes controis permítenche especificar unha URL alternativa para descargar os datos da tenda de complementos.
Isto pode ser útil en lugares onde o acceso ao servidor de tenda de complementos de NV Access é lento ou non está dispoñible.

A caixa de texto de só lectura mostra a URL espello actual.
Se non se está a usar ningún espello (é dicir, se estás a usar o servidor NV Access Add-on Store), amósase "Ningún espello".

Se desexas cambiar o espello da tenda de complementos, preme o botón "Cambiar..." para abrir o [diálogo Establecer o espello da tenda de complementos] (#SetURLDialog).

#### Remote Access Settings {#RemoteSettings}

Esta categoría permíteche configurar o comportamento de [Acceso remoto](#AccesoRemoto).

##### Activar Acceso Remoto {#RemoteEnable}

Usa esta caixa de verificación para activar ou desactivar a función de acceso remoto de NVDA.

Cando isto non está marcado, a función de acceso remoto non está totalmente dispoñible.

Por favor ten en conta que para continuar unha sesión de acceso remoto en pantallas seguras como as solicitudes de control de contas de usuario, debes activar esta configuración, gardar os cambios e, a continuación, [copiar a súa configuración no directorio de configuración do sistema de NVDA](#GeneralSettingsCopySettings).
...
As seguintes opcións só están dispoñibles se o acceso remoto está activado.
...
##### Conectar automaticamente despois de que se arranque NVDA {#RemoteAutoconnect}

Esta opción permíteche establecer automaticamente unha sesión de acceso remoto cando se arranque o NVDA.
Isto podería ser útil, por exemplo, para controlar o ordenador da casa cando estás fóra da mesma.

Ten coidado ao activar esta opción, xa que pode aumentar o risco de acceso non autorizado ao seu ordenador.
...
Selecciona o modo de conexión para conexións automáticas.

Esta opción só está dispoñible cando se marca [Conectar automaticamente despois de iniciar NVDA](#RemoteAutoconnect).
...
Seleciona o tipo de servidor para conexións automáticas.

Esta opción só está dispoñible cando se marca [Conectar automaticamente despois de iniciar NVDA](#RemoteAutoconnect).

|Opción |Comportamento |
|---|---|
|Usar existente |Usa un servidor de acceso remoto existente para mediar na conexión (recomendado). |
|Host localmente |Usa esta instancia de NVDA como servidor de acceso remoto (avanzado). Esta opción pode requirir unha configuración de rede que está fóra do alcance deste manual. |

##### Host {#RemoteAutoconnectHost}

Usa este campo para definir a URL do servidor de acceso remoto que desexas usar para as conexións automáticas.
Se o servidor usa un porto que non sexa 6837, inclúeo despois de dous puntos (por exemplo, `example.com:1234`).

Esta opción só está dispoñible cando se marca [Conectar automaticamente despois de iniciar NVDA](#RemoteAutoconnect) e [o Servidor](#RemoteAutoconnectServer) está definido en "Usar existente".

##### Porto {#RemoteAutoconnectPort}

Usa este campo para definir o porto TCP que desexes usar para as conexións automáticas.

Esta opción só está dispoñible cando se marca [Conectar automaticamente despois de iniciar NVDA](#RemoteAutoconnect) e [Servidor](#RemoteAutoconnectServer) está definido como "Host locally".

##### Chave {#RemoteAutoconnectKey}

Usa este campo para definir a chave (contrasinal) que desexes usar para as conexións automáticas.

Esta opción só está dispoñible cando se marca [Conectar automaticamente despois de iniciar NVDA](#RemoteAutoconnect).

##### Eliminar todas as pegadas dixitais de confianza {#RemoteDeleteFingerprints}

Este botón permíteche esquecer as pegadas dixitais de todos os servidores de acceso remoto de confianza.
...
Pediráseche que confirmes antes de que se eliminen todas as pegadas dixitais de confianza.

Esta opción só está dispoñible se hai pegadas dixitais de confianza almacenadas na túa configuración.
...
#### Estabrecer o diálogo de espello {#SetURLDialog}

Este diálogo permíteche especificar a URL dun espello para usar cando [actualices o NVDA](#GeneralSettingsCheckForUpdates) ou [usar a tenda de complementos](#AddonsManager).
Isto pode ser útil en lugares onde o acceso aos servidores de NV Access para estas funcións sexa lento ou non estéa dispoñible.

* Ao configurar o [Espello de actualización de NVDA](#UpdateMirror), o título deste diálogo será "Establecer o espello de actualización de NVDA".
* Ao configurar o [Espello da Tenda de Complementos] (#AddonStoreMetadataMirror), o título deste diálogo será "Establecer servidor espello de tenta de complementos".

##### URL {#SetURLTextbox}

Introduce aquí a URL (enderezo web) do espello que desexes usar.
Só se admiten URLs HTTP e HTTPS.
Para a túa privacidade, NV Access recomenda usar URL HTTPS sempre que sexa posible.

Deixa isto en branco para usar o servidor NV Access predeterminado.

##### Proba... {#SetURLTest}

Preme este botón para probar a URL espello que introduciches.
Debes estar conectado a Internet para que a proba teña éxito.
Recoméndase que probes sempre o URL antes de gardalo.
...
Para realizar cambios nas Opcións Avanzadas, os controis deben estar habilitados confirmando coa caixa de verificación, que entendes os resgos de modificar estas opción
...
* Só onde é necesario: onde o modelo de obxectos de Microsoft Word non está dispoñible en absoluto
...
##### Recorta o silencio inicial no audio da voz {#TrimLeadingSilenceSpeech}

Cando estea activado, o NVDA eliminará o silencio do inicio do audio da voz, o que pode mellorar a capacidade de resposta dalgúns sintetizadores de voz.
Esta opción está activada de xeito predeterminado e só debería afectar ao silencio ao comezo da fala.
Se atopas que tamén faltan algúns períodos de silencio necesarios (por exemplo, unha pausa entre dúas frases) ao utilizar un complemento de sintetizador de voz, podes desactivar esta función por completo para resolver o problema.

##### Usar WASAPI para a saída de audio SAPI 4 {#UseWASAPIForSAPI4}

Esta opción permite que as voces de Microsoft Speech API versión 4 (SAPI 4) emitan audio a través da API de sesión de audio de Windows (WASAPI).
Isto pode permitir que as voces de SAPI 4 funcionen con máis funcións, como a redución de audio, o recorte do silencio e manter o dispositivo de audio esperto.
Non obstante, algunhas voces SAPI 4 poderían non funcionar coa implementación actual de WASAPI.
Se atopas que a voz SAPI 4 que estás a usar deixa de funcionar, podes desactivar esta opción.

| . {.hideHeaderRow} |.|
|---|---|
|Opcións |Predeterminado (Activado), Desactivado, Activado|
|Predeterminado |Activado|
...
As barras inclinadas normais no campo Substitución deberían duplicarse, por exemplo. Debe teclear "a\\\\b" para obter a substitución "a\\b".
...
| Nome |Tecla Sobremesa |Tecla Portátil |Descripción|
|---|---|---|---|
|Gardar configuración |`NVDA+control+c` |`NVDA+control+c` |Garda a túa configuración actual para que non se perda ao saír de NVDA|
|Reverter a configuración |`NVDA+control+r` |`NVDA+control+r` |Premer unha vez restablece a túa configuración á última vez que a gardaches. Premendo tres veces, restablecerá a configuración predeterminada de fábrica.|
...
Coa función de acceso remoto integrada de NVDA, podes controlar outro computador que execute NVDA ou permitir que alguén controle o teu computador.
Isto facilita proporcionar ou recibir asistencia, colaborar ou acceder ao teu propio computador de xeito remoto.

O acceso remoto está desactivado de forma predeterminada pola túa seguridade.
You can enable Remote Access [in Remote Access settings](#RemoteSettings).

### Comezando {#RemoteAccessGettingStarted}

Antes de comezar, asegúrate de que o NVDA estea instalado e funcionando nos dous computadores.
...
### Usar o acceso remoto {#RemoteAccessUsage}
...
* Preme `NVDA+alt+tab` para alternar entre controlar e volver ao teu propio ordenador.
...
### Resumo de teclas de ordes do acceso remoto {#RemoteAccessGestures}

<!-- KC:beginInclude -->
| Nome |Clave |Descrición|
|---|---|---|
...
| Alternar o control | `NVDA+alt+tab` | Cambia entre controlar o computador remoto e o local. |
| Connect | None | Starts a new Remote Access session. Unavailable in [secure mode](#SecureMode). |
| Copiar ligazón | Non | Copia unha ligazón á sesión remota no portapapeis. |
| Desconectar | Non | Finaliza unha sesión de acceso remoto existente. |
| Silenciar o control remoto | Non | Silencia ou activa a voz procedente do computador remoto. |
...
#### Ordear a listaxe de complementos por columna {#AddonStoreSortByColumn}

Por defecto, a listaxe de complementos está ordeada polo nome de visualización dos complementos.
A caixa combinada "Ordear por columnas" pódese usar para ordenar a lista polas columnas dispoñibles para cada pestana.
Por exemplo, podes querer ordear os complementos por editor, versión dispoñible, etc.
Os complementos pódense ordear en orde ascendente ou descendente.
...
Se a descarga ou a instalación falla, podes tentar de novo a instalación.
Tamén é posible cancelar a instalación antes de saír da tenda de complementos.
...
Por defecto, despois de que o NVDA arranque, notificaráseche se calquera actualización de complemento está dispoñible.
Para deprender máis acerca de configurar este comportamento, consulta ["Notificacións de Actualización"](#AutomaticAddonUpdates).
...
Podes desactivar un complemento se o estado do complemento indica que está "activado" ou activalo se o complemento está "desactivado".
...
#### Cambiar a canle de actualización automática {#AddonStoreUpdateChannel}

Podes xestionar as canles de actualización automática dos complementos desde as [pestanas de complementos instalados e actualizables] (#AddonStoreFilterStatus).
Cando as [Actualizacións automáticas de complementos](#AutomaticAddonUpdates) están habilitadas, os complementos actualizaranse á mesma [canle](#AddonStoreFilterChannel) dende que se instalaron por [predeterminado](#DefaultAddonUpdateChannel).
Desde o menú de accións dun complemento, mediante o submenú "Actualizar canle", podes modificar as canles nas que se actualizará automaticamente un complemento.

| Opción | Comportamento |
|---|---|
| Predeterminado | O complemento seguirá a [canle de actualización predeterminada](#DefaultAddonUpdateChannel) |
| Mesmo | O complemento permanecerá na mesma canle |
| Calquera | O complemento actualizarase automaticamente á última versión, independentemente da canle |
| Non actualizar | O complemento non se actualizará automaticamente |
| Estable | O complemento actualizarase automaticamente a versións estables |
| Beta ou dev | O complemento actualizarase automaticamente ás versións beta ou de desenvolvemento |
| Beta | O complemento actualizarase automaticamente ás versións beta |
| Dev | O complemento actualizarase automaticamente ás versións de desenvolvemento |
...
### Tenda de Complementos {#AddonStoreMenuItem}
...
Ás veces, poden desenvolverse problemas co Rexistro de Windows, que provocan que NVDA se comporte de forma anormal.
Isto pode ser causado por, por exemplo, a instalación ou desinstalación de determinados programas (como Adobe Reader ou Math Player), así como actualizacións de Windows e outros eventos.
A ferramenta COM Registration Fixing  tenta solucionar estes problemas reparando as entradas de accesibilidade do rexistro.

Os tipos de problemas que esta ferramenta pode solucionar inclúen:

* NVDA anuncia "descoñecido" ou "panel", ao navegar en navegadores como Firefox ou Edge, programas de correo como Thunderbird, Windows Explorer, a barra de tarefas e outros programas.
* NVDA non pode cambiar entre o modo foco e o modo exploración cando o esperas.
* Botóns que anteriormente tiñan os seus nomes pronunciados, de súpeto só se indican como "botón".
* NVDA é moi lento ao navegar nos navegadores mentres usa o modo exploración.

Dado que esta ferramenta corrixe entradas no rexistro de Windows, require acceso de administrador para funcionar, igual que cando se instala un programa.
Se tes activado o UAC (Control de acceso de usuarios), como fan a maioría dos usuarios, terás que seguir as indicacións que che presente UAC para executar a ferramenta con éxito.
...
Para obter unha lista aínda máis extensa de sintetizadores gratuítos e comerciais que podes mercar e descargar para usar con NVDA, consulta a [páxina de voces extra](https://github.com/nvaccess/nvda/wiki/ExtraVoices).
...
As series das pantallas liBrailliant BI e B de [HumanWare](https://www.humanware.com/), incluíndo as BI 14, BI 32, BI 20X, BI 40, BI 40X e B 80, admítense cando se conectan a través de USB ou de bluetooth.
...
* NLS eReader
  * Ten en conta que a Zoomax actualmente non está admitida sen controladores externos

A continuación móstranse as asignacións de teclas para as pantallas táctiles Brailliant BI/B e BrailleNote con NVDA.
Por favor consulta a documentación da pantalla para descripcións de onde poden atoparse estas teclas.

#### Asignacións de teclas para todos os modelos {#HumanWareBrailliantKeyAssignmentForAllModels}
...
#### Asignacións de teclas para Brailliant BI 32, BI 40 e B 80 {#HumanWareBrailliantKeyAssignmentForBI32BI40AndB80}
...
#### Asignacións de teclas para Brailliant BI 14 {#HumanWareBrailliantKeyAssignmentForBI14}
...
Para BrailleNote Touch, consulta a sección [Serie BrailleNote BI / BrailleNote Touch](#HumanWareBrailliant).
...
|tecla frecha esquerda |espazo+punto3, joystick á esquerda ou dpad á esquerda|
...
O Dot Pad de Dot Inc é un dispositivo que pode mostrar gráficos táctiles e braille actualizables.
NVDA pode amosar unha única liña de braille na liña de visualización braille dedicada dos dispositivos ou varias liñas de braille na súa área de gráficos táctiles.
O modelo A300 ten unha área de gráficos táctiles de 120 por 80 puntos, que poden caber 8 liñas de 20 celas cada unha.

Pode configurar se NVDA mostra braille na liña de visualización braille dedicada ou na área de gráficos táctiles mediante a opción Destino Braille na configuración de Braille de NVDA para este controlador.

Admítense as teclas de panorámica, pero debido aos botóns limitados do dispositivo, outros comandos e capacidades de enrutamento non están dispoñibles actualmente.

Ao seleccionar o controlador Dot Pad en NVDA, debes seleccionar manualmente o porto serie virtual USB/Bluetooth ao que está conectado o Dot Pad.
Este controlador non admite a detección automática.

Ten en conta que, debido ás limitacións do hardware, o Dot Pad non actualizará todos os puntos correctamente mentres a túa man estea no dispositivo.
Asegúrate de levantar a man completamente do dispositivo cando navegues con NVDA e só comeza a ler de novo unha vez que estea totalmente actualizado.

<!-- KC:beginInclude -->

| Nome |Tecla|
|---|---|
|Desprazar cara atrás a pantalla braille | `pan_left` |
|Despraza a pantalla braille cara adiante | `pan_dereita` |
...
* Abrir documentos externos desde o menú de NVDA, como o ficheiro da guía de usuario.
...
|`-n LANGUAGE` |`--lang=LANGUAGE` |Anular o idioma configurado de NVDA. Establécese como "Windows" para o usuario predeterminado actual, "en" para inglés, etc.|
|`-m` |`--minimal` |sen sons, sen interfaz, sen mensaxe de comezo, etc.|
|`-s` |`--secure` |Inicia o NVDA en [Modo Seguro](#SecureMode)|
|`-d` |`--disable-addons` |Os complementos non terán ningún efecto|
...
|None |`--create-portable-silent` |Crea unha copia portátil de NVDA (sen iniciar a nova copia). Require que se especifique `--portable-path`. Esta opción suprime os avisos ao escribir en directorios non baleiros e pode sobrescribir ficheiros sen aviso.|
|None |`--portable-path=PORTABLEPATH` |A ruta onde se creará unha copia portable|

Do mesmo xeito que podes instalar NVDA en silencio pasando a opción de liña de ordes `--install-silent` a NVDA, pódese desinstalar silenciosamente pasando o comando `/S` ao desinstalador.

O desinstalador de NVDA chámase `uninstall.exe` e reside no directorio de instalación de NVDA, `%ProgramFiles(x86)%\nvda` en Windows de 64 bits, ou `%ProgramFiles%\nvda` en Windows de 32 bits.

As seguintes son as opcións da liña de comandos para o desinstalador de NVDA:

| Curto |Longo |Descripción|
|---|---|---|
|`/S` |None |Silenciar a desinstalación do NVDA. |
