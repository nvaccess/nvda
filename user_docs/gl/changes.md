...
Esta versión introduce o Aceso Remoto de NVDA, que che permite controlar un computador remoto executando NVDA dende outro dispositivo executando tamén NVDA.

Hai moitas melloras para a voz, en particular mellor resposta con SAPI 4, SAPI 5 e voces de OneCore.
SAPI 5 agora admite o aumento rápido de velocidade e o cambio automático de lingua.
As voces SAPI 4 agora admiten a atenuación de audio, o corte do silencio inicial e o mantemento do dispositivo de audio aceso.

Mellorouse o sistema de actualizacións automáticas da tenda de complementos, o que permite selecionar canles para as actualizacións automáticas e executalas no fondo.

New commands have been added to manually refresh an OCR result, and to toggle periodically refreshing OCR results.

A seleción nativa agora está dispoñible en Chrome e en Edge.

A compatibilidade con Microsoft Office e con LibreOffice mellorou, sobre todo co anunciado de máis atallos de teclado.

Agora pódense determinar as táboas braille de entrada e de saída predeterminadas dependendo da lingua do NVDA.
Engadiuse compatibilidade nativa co dispositivo de gráficos táctiles Dot Pad de Dot Inc como pantalla braille multiliña.
Houberon outros arranxos menores para as pantallas braille, sobre todo en torno á conectividade.

Actualizáronse LibLouis braille translator, eSpeak-NG e Unicode CLDR.
Están dispoñibles novas táboas braille Coptic, compact Cuneiform e portugués de 6 puntos.
...
Por favor, divulga  responsablemente os fallos de seguridade seguindo a [política de seguridade do NVDA](https://github.com/nvaccess/nvda/blob/master/security.md).

* Evita que se amose información potencialmente sensible nas pantallas braille cando o dispositivo está bloqueado.
([GHSA-8f8q-2jc3-6rf4](https://github.com/nvaccess/nvda/security/advisories/GHSA-8f8q-2jc3-6rf4))
* Evita que o instalador cargue DLL non desexadas dende o seu cartafol.
([GHSA-qf5h-qw92-rx2f](https://github.com/nvaccess/nvda/security/advisories/GHSA-qf5h-qw92-rx2f))

### Novas Características

* Tenda de Complementos:
  * Actualizacións automáticas (#3208):
    * Ahora se pueden modificar los canales de actualización automática de los complementos.
      * As canles de actualización automática poden selecionarse para os complementos instalados a través do submenú «Canle de actualización».
      * A canle de actualización automática por defecto pode configurarse dende o panel Tenda de complementos na configuración do NVDA.
    * Agora as actualizacións automáticas poden facerse de fondo.
      * Esto pode activarse no panel da tenda de complementos nas opcións do NVDA cambiando "Actualizacións automáticas" a "Actualizar automáticamente".
    * As actualizacións automáticas agora poden actualizar os complementos incompatibles a outra versión máis nova e incompatible.
      * Esto pode activarse no panel da tenda de complementos nas ocpións do NVDA.
  * Engadida unha acción para cancelar a instalación de complementos. (#15578, @hwf1324)
  * Engadida unha acción para reintentar a instalación se falla la descarga/instalación dun complemento. (#17090, @hwf1324)
  * As listaxes de complementos poden ordearse por columnas, incluida a data de publicación, en orde ascendente e descendente. (#15277, #16681, @nvdaes)
* Voz:
  * Agora admítense o cambio automático de lingua ao se  usar Microsoft Speech API versión 5 (SAPI5) e as voces de Microsoft Speech Platform. (#17146, @gexgd0419)
  * Agora admítese o aumento rápido de velocidade ao se usar Microsoft Speech API versión 5 (SAPI5) e as voces de Microsoft Speech Platform, que admite unha velocidade de hasta 6X. (#17606, @gexgd0419)
* Navegadores web:
  * O modo de seleción nativa do modo exploración do NVDA (`NVDA+shift+f10`) agora é compatible con Google Chrome, Edge e outras aplicacións baseadas en Chromium 134 ou posterior. (#17838)
  * En Mozilla Firefox, o NVDA anunciará o texto resaltado cando se visite unha URL que conteña un fragmento de texto. (#16910, @jcsteh)
  * O NVDA agora pode anunciar cando o destiño dunha ligazón apunta á páxina actual. (#141, @LeonarddeR, @nvdaes)
* Microsoft Office:
  * Ao se editar en caixas de texto de PowerPoint, agora podes moverte por frase con `alt+frecha arriba`/`alt+frecha abaixo`. (#17015, @LeonarddeR)
  * En Word, agora anúnciase a actualización da seleción cando se usan ordes de Word para ampliar ou reducir a seleción (`f8` ou `shift+f8`). (#3293, @CyrilleB79)
  * En Word 16.0.18226 e superior ou cando se usa o modelo de obxectos de Word, o NVDA agora anunciará se una cabeceira está contraída tanto en voz coma en braille. (#17499)
  * En Word con UIA, ao se usar as ordes nativas de navegación extendida de táboa (`alt+inicio`, `alt+fin`, `alt+avPáx`, e `alt+RePáx`), agora anunciarase o movemento do cursor. (#17867, @CyrilleB79)
  * En Word, ao se usar a orde "anunciar foco", anunciarase o deseño do documento se se dispón desta información e está activado o anunciado de descripción de obxectos. (#15088, @nvdaes)
  * Agora anúnciase o resultado de máis atallos en Word y Outlook:
    * atallos de formato de fonte (#10271, @CyrilleB79)
    * contraer ou expandir cabeceiras (#17545, @CyrilleB79)
* LibreOffice:
  * Ao aumentar ou diminuir o tamaño da fonte en Writer usando os atallos de teclado correspondentes, o NVDA anuncia el novo tamaño da fonte. (#6915, @michaelweghorn)
  * Ao aplicar o "Corpo de texto" ou un estilo de encabezado de parágrafo usando o atallo de teclado correspondente en Writer 25.2 ou posterior, o NVDA anuncia o novo estilo de parágrafo. (#6915, @michaelweghorn)
  * Ao alternar o dobre subliñado en Writer mediante o atallo de teclado correspondente, o NVDA anuncia o novo estado ("dobre subliñado activado"/"dobre subliñado desactivado"). (#6915, @michaelweghorn)
  * O NVDA agora pode anunciar a sangría da primeira liña en LibreOffice 25.8 e posteriores. (#13052, @michaelweghorn)
* OCR:
  * Nun resultado de recoñecemento, `NVDA+f5` actualiza manualmente o contido recoñecido. (#17715, @CyrilleB79)
  * Engadido un xesto non asignado para actualizar de cotío o resultado do OCR de Windows. (#16897)
* A funcionalidade de acceso remoto, baseada no complemento NVDA Remote, integrouse no NVDA. (#4390, @ctoth, @tspivey, @daiverd, Contribuintes e financiadores do NVDA Remote)
* Agora é posible especificar URLs espello para usar nas actualizacións do NVDA e na tenda de complementos. (#14974, #17151, #17310, @christopherpross)
* Engadiuse o soporte para matemáticas en PDFs. (#9288, @NSoiffer)
  * Esto funciona para fórmulas con MathML asociado, como algúns arquivos xerados polas versións máis recentes de TeX/LaTeX.
  * Actualmente esto só é compatible con Foxit Reader e Foxit Editor.
* Agora pódese configurar o NVDA para que diga a liña ou o parágrafo actual ao navegar coas teclas de navegación en braille. (#17053, @nvdaes)
* O NVDA é capaz agora de anunciar cambios do cursor de sistema ao premer os xestos `alt+upArrow` ou `alt+downArrow`, por exemplo en Visual Studio Code. (#17652, @LeonarddeR)
* Engadidas ordes para mover o cursor de revisión ao primeiro e último carácter do texto selecionado, asignados a `NVDA+alt+inicio` e `NVDA+alt+fin`, respectivamente. (#17299, @nvdaes)
* Engadiuse unha opción xeral para evitar que a pantalla se apague ao ler todo ou ao ler co braille.
Esta opción está activada por defecto, pero pode producir un maior esgotamento da batería. (#17649, @LeonarddeR)
* O NVDA agora tradúcese ao Bosnio. (#17953)
...
* Actualización de Compoñentes:
  * Actualizado el transcriptor braille LibLouis a [3.33.0](https://github.com/liblouis/liblouis/releases/tag/v3.33.0). (#17469, #17768, @LeonarddeR, @codeofdusk)
    * Engadidas novas táboas braille Coptic, compact Cuneiform y Portugués computerizado de 6 puntos.
  * Actualizado CLDR á versión 46.0. (#17484, @OzancanKaratas)
  * Actualizado eSpeak NG a 1.52.0. (#17056)
* Cambios da interfaz do NVDA:
  * O instalador do NVDA xa non reproduce un son cando arranca. (#14068)
  * As caixas de diálogo Anunciar destino dal ligazón, Información de formato de caracteres e falar Seleción inclúen agora os botóns "Pechar" e "Copiar" para maior comodidade do usuario. (#17018, @XLTechie)
  * O diálogo saír agora permite reiniciar o NVDA cos complementos desactivados e o rexistro de depuración activado ao mesmo tempo. (#11538, @CyrilleB79)
  * Eliminouse a posibilidade de non usar WASAPI para a saída de audio. (#16080)
  * Eliminouse a opción do modo exploración "Poñer automáticamente o foco do sistema nos elementos enfocables", agora o comportamento está desactivado. (#17598)
  * O NVDA agora só avisará sobre a incompatibilidade de complementos cando se actualice a unha nova versión que teña unha API de complemento incompatible coa versión actual. (#17071, #17506)
  * Eliminouse o arquivo "Coltributors» do menú NVDA. (#16922)
  * A licencia do NVDA está agora formateada en HTML para mellorar a lexibilidade. (#17600)
  * Engadíronse versións abreviadas das opcións de liña de órdenes máis usadas: `-d` para `--disable-addons` y `-n` para `--lang`.
  A coincidencia de prefixos nos indicadores de liña de ordes, por exemplo, o uso de `--di` para `--disable-addons` xa non é compatible. (#11644, @CyrilleB79)
  * Cambios para COM Registration Fixing Tool: (#12355, @XLTechie)
    * Agora comeza cunha explicación máis amigable do seu propósito, a cambio dunha advertencia. (#12351)
    * Agora pódese saír da xanela inicial con `escape` ou `alt+f4`. (#10799)
    * Agora amosará unha mensaxe ao usuario, incluido o erro, no extraño caso de que se produza un erro de Windows ao tentar voltar a rexistrar COM.
* Voz:
  * A versión 5 de Microsoft Speech API e as voces de Microsoft Speech Platform usan agora WASAPI para a saída de audio, o que pode mellorar a capacidade de resposta desas voces. (#13284, @gexgd0419)
  * Agora recortarase o silenzo ao comezo da fala cando se usen voces OneCore, voces SAPI5 e algúns complementos de voz de terceiros para mellorar a súa capacidade de resposta. (#17614, @gexgd0419)
  * As voces da versión 4 de Microsoft Speech API usan agora WASAPI para a saída de audio, de xeito que poden funcionar con funciones como a atenuación de audio, o recorte do silenzo inicial e o mantemento do dispositivo de audio aceso.
  Se esto non funciona coa túa voz SAPI 4, podes desactivar WASAPI para SAPI 4 na Configuración avanzada. (#17718, #17801, @gexgd0419)
  * A normalización Unicode está agora activada por defecto para a saída de voz. (#17017, @LeonarddeR).
    * Aínda podes desactivar esta funcionalidade na categoría Voz da caixa de diálogo Opcións de NVDA.
* As opcións de teclado para "Falar caracteres ao se escrebir" e "Falar palabras ao se escrebir» teñen agora tres opciones: Desactivado, Sólo en controles de edición y Siempre. (#17505, @Cary-rowen)
  * Por defecto, "Falar caracteres ao se escrebir" está agora en "Só en controis de edición".
* Agora pódense determinar as táboas braille de entrada e de saída predeterminadas en función da lingua do NVDA. (#17306, #16390, #290, @nvdaes)

### Arranxo de fallos

* Voz:
  * Arranxouse un problema polo que a lectura continua (ler todo) detíñase ao final da primeira frase cando se usaban algúns sintetizadores SAPI5. (#16691, @gexgd0419)
  * Os parámetros de voz, como a velocidade e o volume, xa non se restablecerán aos valores predeterminados ao usar o anel de opción do sintetizador para cambiar entre voces no sintetizador SAPI5 e SAPI4. (#17693, #2320, @gexgd0419)
  * Arranxouse un problema polo que non se podían cargar algunhas voces SAPI4 (por exemplo, IBM TTS Chinese). (#17726, @gexgd0419)
* Braille:
  * Soporte nativo para o dispositivo gráfico táctil Dot Pad de Dot Inc como pantalla braille multiliña. (#17007)
  * O NVDA xa non debería reproducir sons de erro nin enviar spam ao arquivo de rexistro cando se usa o modo braille de saída de voz de pantalla mentres non hae ningunha pantalla braille conectada. (#17092, @Emil-18)
  * O NVDA Xa non debería reproducir sons de erro nin enviar spam ao arquivo de rexistro cando se usa o modo braille de saída de voz de pantalla mentres non hai ningunha pantalla braille conectada. (#17092, @Emil-18)
  * Cando se seleciona explícitamente o controlador de pantalla braille HID estándar como controlador de pantalla braille e se abre a listaxe de pantallas braille, o NVDA identifica correctamente o controlador HID como controlador seleccionado a cambio de amosar que non hai ningún controlador selecionado. (#17537, @LeonarddeR)
  * O controlador do Brailliant de Humanware é agora máis fiable á hora de selecionar o punto final de conexión correcto, o que se traduce nunha maior estabilidade da conexión e menos erros. (#17537, @LeonarddeR)
  * As táboas braille persoalizadas de scrachpad para desenvolvedores agora ignóranse correctamente cando se executan cos complementos desactivados. (#17565, @LeonarddeR)
  * Fixed an issue where some USB braille displays were not properly detected by NVDA. (#18114, @christiancomaschi)
* Microsoft Office:
  * A orde "Anunciar a URL de destiño dunha ligazón" funciona agora como se esperaba cando se usa o modelo de obxectos herdado en Word, Outlook, Excel e PowerPoint. (#17292, #17362, #17435, @CyrilleB79)
  * En Excel, o diálogo de listaxe de elementos (`NVDA+f7`) xa non falla ao enumerar comentarios ou fórmulas nalgúns sistemas que non estean en inglés. (#11366, @CyrilleB79)
  * Melloras en PowerPoint:
    * Anunciar o cursor do sistema xa non se interrumpe cando o texto contén caracteres anchos como emoji. (#17006 , @LeonarddeR)
    * O anunciado da ubicación dos caracteres é agora preciso (por exemplo, ao premer `NVDA+suprimir`. (#9941, @LeonarddeR)
    * O NVDA xa non comeza "Ler todo" ao comezar unha presentación de diapositivas e a opción do modo exploración "Ler todo automáticamente ao cargar a páxina" está desactivado. (#17488, @LeonarddeR)
* LibreOffice:
  * Cando se usa o método de entrada Pinyin de Microsoft para o chinese e actívase a opción de compatibilidade Pinyin para usar a versión anterior, xa non se produce un erro ao escrebir en Writer (e posiblemente noutras aplicacións) mentres se amosa unha xanela emerxente IME. (#17198, @michaelweghorn)
  * O estado actual (marcado/desmarcado) das caixas de verificación nos diálogos agora tamén se anuncia en braille, non só en voz alta. (#17218, @michaelweghorn)
* Matemáticas:
  * Arranxouse a lectura matemática de algúns elementos web.
  En concreto, MathML dentro de span e outros elementos que teñan o atributo `role=«math»`. (#15058)
  * As ecuacións matemáticas só representadas por unha imaxe e texto alt sen MathML para navegación enriquecida, agora trátanse como imáxes normais, a cambio de matemáticas sen contido, permitindo ao usuario saltar a elas con `g` e poder navegar polo texto alt por carácter. (#16007)
* IDEs:
  * O NVDA xa non se bloqueará ao selecionar todo o texto en certos ficheiros de orixe en Android Studio ou IntelliJ Idea. (#17418, @thgcode)
  * En Visual Studio Code, o NVDA xa non secuestra os xestos `alt+arribaFrecha` e `alt+abaixoFrecha` para a navegación de frases. (#17082, @LeonarddeR)
  * Algúns elementos de seción recoñécense agora correctamente coma controis editables en Visual Studio Code. (#17573, @Cary-rowen)
  * No Bloc de notas e outros documentos UIA, e en documentos Notepad++ en Windows 11, se a última liña está valdeira, a "orde braille liña seguinte" moverá o cursor á última liña.
  En calquera documento, se o cursor está na derradeira liña, moverase ao final cando se use esta orde. (#17251, #17430, @nvdaes)
* Perfís de configuración:
  * O braille xa non é disfuncional ao activar "ler todo" cun perfil de configuración asociado. (#17163, @LeonarddeR)
  * Arranxouse un problema polo que determinadas opcións gardábanse explícitamente no perfil de configuración activo incluso cando o valor desa opción era igual ao valor da configuración base. (#17157, @leonarddeR)
* Ao deletrear, a normalización unicode funciona agora de xeito máis adecuado:
  * Despois de anunciar un carácter normalizado, o NVDA xa non anuncia incorrectamente os caracteres posteriores como normalizados. (#17286, @LeonarddeR)
  * Os caracteres compostos (coma é) agora notifícanse correctamente. (#17295, @LeonarddeR)
* O NVDA poderá ler os elementos do submenú emerxente na páxina de resultados de procura de Thunderbird. (#4708, @thgcode)
* COM Registration Fixing Tool xa non anuncia como éxito en caso de fallar. (#12355, @XLTechie)
* O NVDA xa non anunciará as entradas do historial do portapapeis de Windows 11 ao pechar a xanela mentres haxa elementos presentes. (#17308, @josephsl)
* Se os plugins se recargan mentres unha mensaxe navegable está aberta, o NVDA xa non fallará ao anunciar movementos posteriores do foco. (#17323, @CyrilleB79)
* Ao usar aplicacións como Skype, Discord, Signal e Phone Link para a comunicación de audio, a voz e os sons do NVDA xa non baixan o volume. (#17349, @jcsteh)
* A apertura da consola Python de NVDA xa non fallará no caso de que se produza un erro ao recuperar variables de snapshot. (#17391, @CyrilleB79)
* Nos navegadores web, os cambios na seleción de texto xa non fallan ás veces nos controis de texto editables. (#17501, @jcsteh)
* Cando as ligazóns ancorados apunten ao mesmo obxecto no que se coloca o cursor virtual, o NVDA xa non falla ao desprazarse ao destiño da ligazón. (#17669, @nvdaes)
* A icona da xanela NVDA Highlighter xa non está fixo na barra de tarefas despois de reiniciar o Explorador. (#17696, @hwf1324)

### Cambios para Desenvolvedores

Por favor consulta [a guía do desenvolvedor](https://www.nvaccess.org/files/nvda/documentation/developerGuide.html#API) para obter información sobre o proceso de eliminación da API do NVDA.

* Nota: esta é unha versión que rompe a compatibilidade coa API dos complementos.
Os complementos terán que voltar a comprobarse e actualizar o seu manifesto.
* Actualización de componentes:
  * Actualizado Ruff a 0.8.1. (#17102, #17260, #17473)
  * Actualizado Comtypes a 1.4.6. (#17061, @LeonarddeR)
  * Actualizado wxPython a 4.2.2. (#17181, @dpy013)
  * Actualizado SCons a 4.8.1. (#17254)
  * Actualizados sphinx a 8.1.2 y sphinx-rtd-theme a 3.0.1. (#17284, @josephsl)
  * Actualizado Robot Framework a 7.1.1. (#17329, @josephsl)
  * Actualizado configobj a 5.1.0 commit `8be5462`. (#17328)
  * Actualizado pre-commit a 4.0.1. (#17260)
  * Actualizado typing-extensions a 4.12.2. (#17438, @josephsl)
  * Actualizado licensecheck a 2024.3. (#17440, @josephsl)
  * Actualizado markdown a 3.7. (#17459, @josephsl)
  * Actualizado nh3 0.2.19. (#17465, @josephsl)
  * Actualizado nuitka a 2.5.4. (#17458, @josephsl)
  * Actualizado schedule a 1.2.2. (#17455, @josephsl)
  * Actualizado requests a 2.32.3. (#17456, @josephsl)
* `ui.browseableMessage` pode chamarse con opcións para presentar un botón para copiar ao portapapeis e/ou un botón para pechar a xanela. (#17018, @XLTechie)
* Varios engadidos para identificar tipos de ligazóns (#16994, @LeonarddeR, @nvdaes)
  * Un novo módulo `utils.urlUtils` con diferentes funcións para determinar os tipos de ligazón
  * Engadiuse un novo estado `INTERNAL_LINK` a `controlTypes.states.State`
  * Engadiuse unha nova propiedade `linkType` en `NVDAObject`.
  Consulta o `treeInterceptor` por defecto, se existe.
  * O obxecto `BrowseModeTreeInterceptor` ten unha nova propiedade `documentUrl`
  * `BrowseModeTreeInterceptor` ten un novo método `getLinkTypeInDocument` que acepta unha URL para comprobar o tipo de ligazón do obxecto
  * Engadiuse unha función auxiliar `toggleBooleanValue` a `globalCommands`.
  Pode usarse en scripts para anunciar o resultado cando se activa un booleano en `config.conf`
* Eliminado o requisito de sangrar as listaxes de parámetros de función con dous tabuladores dos Estándares de Codificación de NVDA, para seren compatible co linting automático moderno. (#17126, @XLTechie)
* Engadido o [VS Code workspace configuration for NVDA](https://nvaccess.org/nvaccess/vscode-nvda) como submódulo git. (#17003)
* Engadiuse una nova función, `gui.guiHelper.wxCallOnMain`, que permite chamar de xeito seguro e sincrónico a funcións wx dende subprocesos alleos a GUI, e obter o seu valor de retorno. (#17304)
* Engadiuse unha nova API de diálogo de mensaxes a `gui.message`. (#13007)
  * Engadidas crases: `ReturnCode`, `EscapeCode`, `DialogType`, `Button`, `DefaultButton`, `DefaultButtonSet`, `MessageDialog`.
* No módulo `brailleTables`, engadiuse unha función `getDefaultTableForCurrentLang` (#17222, @nvdaes)
* Engadida unha crase de datos `updateCheck.UpdateInfo`, que encapsula metadatos sobre actualizacións de NVDA. (#17310, @christopherpross)
* Recuperar a propiedade `labeledBy` agora funciona para:
  * obxectos en aplicacións que implementen a relación `labelled-by` IAccessible2. (#
  * Elementos UIA que admitan a propiedade UIA `LabeledBy` correspondente. (#17442, @michaelweghorn)
* Engadiuse a posibilidade de asociar `wx.ComboBox` e unha etiqueta `wx.StaticText` usando `gui.guiHelper.associateElements`. (#17476)
* Engadidos os seguintes puntos de extensión (#17428, @ctoth):
  * `inputCore.decide_handleRawKey`: execútase cada vez que se preme unha tecla
  * `speech.extensions.post_speechPaused`: execútase cando a fala se pausa ou se desbloquea
* Cambios no rexistro de detección automática de pantalla braille en `bdDetect.DriverRegistrar`: (#17521, @LeonarddeR)
  * Engadido o método `addUsbDevice` para rexistrar un dispositivo USB cada vez.
  * Engadido o parámetro `matchFunc` a `addUsbDevices` que tamén está dispoñible en `addUsbDevice`.
    * De este xeito, a detección de dispositivos pode limitarse aínda máis nos casos nos que unha combinación VID/PID sexa compartida por varios dispositivos a través de varios controladores, ou cando un dispositivo HID ofreza varios puntos finais, por exemplo.
    * Consulta a documentación do método, así coma os exemplos nos controladores albatross e brailliantB para obter máis información.
* Engadiuse unha nova función, `utils.mmdevice.getOutputDevices`, para enumerar os dispositivos de saída de audio. (#17678)
* Engadiuse un novo punto de extensión `pre_synthSpeak` en `synthDriverHandler`, que se chamará antes de que o xestor de voz chame a `speak` do sintetizador actual. (#17648)
* O NVDA admite o atributo `text-indent` do obxecto IAccessible2. (#13052, @michaelweghorn)
* Cando un script que usa `gesture.send` se activa cun xesto que inclúe `numLock` como modificador, BloqNum xa non se desactiva. (#10827, @CyrilleB79)

#### Cambios na API

Estos son cambios importantes na API.
Por favor abre unha incidencia en GitHub se o teu complemento ten algún problema coa actualización á nova API.

* Eliminouse a constante `addonStore.network.BASE_URL`.
Como a URL base da Tenda de Complementos é agora configurable directamente dentro do NVDA, non se prantexa remprazala. (#17099)
* Eliminouse a constante `updateCheck.CHECK_URL`.
Como a URL de comprobación de actualizacións do NVDA é agora configurable directamente dentro do NVDA, non se prantexa remprazala. (#17151)
* `NVDAObjects.UIA.winConsoleUIA.WinTerminalUIA` eliminouse sen un remprazo público. (#14047, #16820, @codeofdusk)
* `NVDAObjects.IAccessible.ia2TextMozilla.FakeEmbeddingTextInfo` eliminouse. (#16768, @jcsteh)
* Cambiouse o nome dos seguintes símbolos en `appModules.soffice` (#6915, @michaelweghorn):
...
* O argumento da palabra chave `space` para `brailleDisplayDrivers.seikantk.InputGesture` agora espera un `int` a cambio de un `bool`. (#17047, @school510587)
* Eliminouse a seción de configuración `[upgrade]` que incluía `[upgrade][newLaptopKeyboardLayout]`. (#17191)
* `updateCheck.checkForUpdate` devolve agora un obxecto `UpdateInfo` a cambio dun diccionario. (#17310, @christopherpross)
* Actualizáronse os constructores de `updateCheck.UpdateResultDialog` e `updateCheck.UpdateDownloader` para que tomen obxectos `UpdateInfo` a cambio de diccionarios de metadatos. (#17310, @christopherpross)
* Debido á retirada do soporte winmm de NVDA (#17496, #17532, #17678):
  * Elimináronse os seguintes símbolos de `nvwave` sen sustituilos: `CALLBACK_EVENT`, `CALLBACK_FUNCTION`, `CALLBACK_NULL`, `HWAVEOUT`, `LPHWAVEOUT`, `LPWAVEFORMATEX`, `LPWAVEHDR`, `MAXPNAMELEN`, `MMSYSERR_NOERROR`, `usingWasapiWavePlayer`, `WAVEHDR`, `WAVEOUTCAPS`, `waveOutProc`, `WAVE_MAPPER`, `WHDR_DONE`, `WinmmWavePlayer`, e `winmm`.
  * Elimináronse os seguintes símbolos de `nvwave`: `getOutputDeviceNames`, `outputDeviceIDToName`, `outputDeviceNameToID`.
  Usa `utils.mmdevice.getOutputDevices` a cambio.
  * `nvwave.WasapiWavePlayer` renomeouse a `WavePlayer`.
  ...
  * `gui.settingsDialogs.AdvancedPanelControls.wasapiComboBox` eliminouse.
  * A clave `WASAPI` eliminouse da seción `audio` da configuración.
  * Eliminouse a chave de configuración `config.conf[«speech»][«outputDevice»]`.
    Sustituiuse por `config.conf[«audio»][«outputDevice»]`, que almacena un ID de dispositivo de punto final de audio do núcleo de Windows. (#17547)
* En `NVDAObjects.window.scintilla.ScintillaTextInfo`, se non hai texto selecionado, o método `collapse` anúlase para expandirse á liña se o parámetro `end` establécese en `True` (#17431, @nvdaes)
* Elimináronse os seguintes símbolos sen sustituilos: `languageHandler.getLanguageCliArgs`, `__main__.quitGroup` e `__main__.installGroup` . (#17486, @CyrilleB79)
* Xa non se admite a coincidencia de prefixos nos indicadores de liña de ordes, por exemplo, o uso de `--di` para `--disable-addons`. (#11644, @CyrilleB79)
* A palabra chave `useAsFallBack` de `bdDetect.DriverRegistrar` foi renomeada a `useAsFallback`. (#17521, @LeonarddeR)
* Eliminouse a opción de configuración `[addonStore][showWarning]`.
A cambio usa `addonStore.dataManager.addonDataManager.storeSettings.showWarning`. (#17597)
* `ui.browseableMessage` agora toma un parámetro `sanitizeHtmlFunc`.
Por defecto é `nh3.clean` con argumentos predeterminados.
Esto significa que calquera HTML pasado a `ui.browseableMessage` usando `isHtml=True` agora é desinfectado por defecto.
Para cambiar as regras de limpeza, como a listaxe branca de etiquetas o atributos, crea unha función que chame a `nh3.clean` cos parámetros desexados. (#16985)
* `updateCheck.UpdateAskInstallDialog` xa non realiza automáticamente unha acción cando se preman os botóns actualizar ou pospoñer.
A cambio, engadiuse unha propiedade `callback`, que devolve unha función que realiza a acción apropriada cando se chame co valor de retorno do diálogo. (#17582)
* Os diálogos abertos con `gui.runScriptModalDialog` agora son recoñecidos como modais polo NVDA. (#17582)
* Elimináronse os seguintes símbolos API relacionados coa opción "Poñer automáticamente o foco do sistema nos elementos enfocables" sen sustituilos: (#17598)
...
* Porque as voces SAPI5 agora usan `nvwave.WavePlayer` para emitir audio: (#17592, @gexgd0419)
  * `synthDrivers.sapi5.SPAudioState` eliminouse.
  * `synthDrivers.sapi5.SynthDriver.ttsAudioStream` eliminouse.
* As instancias de `autoSettingsUtils.driverSetting.DriverSetting` cun `id` que comeza cun guión baixo (_) xa non se amosan na configuración do NVDA. (#17599)
* Cambiada a configuración do eco de escritura do teclado de valores booleanos a enteiros. (#17505, @Cary-rowen)
  * `config.conf[«keyboard»][«speakTypedCharacters»]` e `config.conf[“keyboard”][«speakTypedWords»]` usan agora valores enteiros.
  * Engadido o enum `TypingEcho` en `config.configFlags` para representar estos modos, 0=Off, 1=Only in edit controls, 2=Always.
  * `gui.settingsDialogs.KeyboardSettingsPanel.wordsCheckBox` e `gui.settingsDialogs.KeyboardSettingsPanel.charsCheckBox` elimináronse.
* Eliminouse `gui.settingsDialogs.KeyboardSettingsPanel.wordsCheckBox` e `gui.settingsDialogs.KeyboardSettingsPanel.charsCheckBox`. cambiouse o nome de `winUser.paint` de `painStruct` a `paintStruct`, arranxando un erro polo que ao pasar un `PAINTSTRUCT` producíase unha excepción. (#17744)
* `documentationUtils.getDocFilePath` e `installer.getDocFilePath` xa non procuran os ficheiros `.txt` en cartafois de documentación local. (#17911, @CyrilleB79)
...
* O punto de extensión `braille.filter_displaySize` está obsoleto.
Por favor usa `braille.filter_displayDimensions` a cambio. (#17011)
* As funcións `gui.message.messageBox` e `gui.runScriptModalDialog`, e a crase `gui.nvdaControls.MessageDialog` están obsoletas.
Usa `gui.message.MessageDialog` a cambio. (#17582)
* Os seguintes símbolos están obsoletos (#17486, @CyrilleB79):
  * `NoConsoleOptionParser`, `stringToBool`, `stringToLang` en `__main__`; usa os mesmos símbolos en `argsParsing` a cambio.
  * `__main__.parser`; usa `argsParsing.getParser()` a cambio.
* `bdDetect.DeviceType` queda obsoleto en favor de `bdDetect.ProtocolType` e `bdDetect.CommunicationType` para ter en conta o feito de que tanto a comunicación HID como a Serial poden ter lugar a través de USB e Bluetooth. (#17537 , @LeonarddeR)

## 2024.4.2

Este é una versión parche para arranxar erros con dispositivos braille e ca lectura de matemáticas en Chromium.

### Arranxo de erros

* Arranxado un fallo ca lectura de matemáticas en navegadores Chromium (Chrome, Edge). (#17421, @NSoiffer)
* Os dispositivos Humanware Brailliant BI 40X executando a versión de firmware 2.4 agora funcionan como se esperaba. (#17518, @bramd)

## 2024.4.1

Esta é una versión parche para arranxar un erro ao gardar os diccionarios de símbolos.

### Arranxo de fallos

* Arranxado un erro onde os diccionarios de símbolos non se gardaban e o diálogo non se podía pechar. (#17344)

## 2024.4

Esta versión inclúe un número de melloras en Microsoft Office, en braille e en formato de documentos.

En Word ou Excel, agora é posible facer doble pulsación ao xesto de comentario para ler o comentario ou a nota nun diálogo explorable.
Ahora podes usar a orde de selección do cursor de revisión para escoller texto en PowerPoint.
O NVDA tamén xa non braillifica caracteres lixo ao amosar texto nas cabeceiras de fila ou columna en táboas en Word ao usar o modelo de obxectos.

O NVDA agora pode configurarse para anunciar atributos de fonte na fala e no braille por separado.

Engadiuse una nova opción para configurar o tempo de espera para realizar un xesto con múltiples pulsacións, como a orde anunciar hora e data.

Agora podes configurar como o NVDA amosa o formato de texto en braille, e configura ao NVDA para amosar o comezo do parágrafo en braille.
O NVDA agora pode falar o carácter no cursor cando se realice una función  de enrutamento do cursor braille.
Mellorouse a fiabilidade do enrutamento do cursor e engadiuse compatibilidade coas teclas de enrutamento en PowerPoint.
Agora usaranse todas as liñas de celdas cando se use unha pantalla braille multilínea mediante HID braille .
O NVDA xa non é inestable despois de reiniciar NVDA durante un escaneo automático de Braille Bluetooth.

A versión mínima requerida de Poedit que funciona co NVDA é agora a versión 3.5.

eSpeak NG actualizouse, engadindo o soporte para as linguas Faroés e Xextan.

LibLouis actualizouse, engadindo novas táboas Braille para Thai e braille Grego internacional con letras dunha soa celda aceptadas.

Tamén houbo un número de arranxos, incluíndo o seguemento do rato en Firefox, e o modo de voz baixo demanda.

### Novas Características

* Novas características braille:
  * Agora é posible cambiar o xeito en que o NVDA amosa certos atributos de formato de texto en braille.
    As opción dispoñibles son:
    * Liblouis (predeterminado): Usa as marcas de formato definidas na táboa braille selecionada.
    * Etiquetas: usa marcas de comezo e fin para indicar onde comezan e rematan certos atributos de fonte. (#16864)
  * Cando a opción "Ler por parágrafos" estea activada, o NVDA agora pode configurarse para indicar o comezo do parágrafo en braille. (#16895, @nvdaes)
  * Cando se realice unha acción de enrutamento do cursor braille, o NVDA agora pode falar automáticamente o carácter no cursor. (#8072, @LeonarddeR)
    * Esta opción está desactivada por defecto.
      Podes habilitar "Falar carácter ao enrutar o cursor no texto" nas opción braille do NVDA.
* A orde comentarios The en Microsoft Word e a orde notas en Microsoft Excel agora poden premerse dúas veces para amosar o comentario ou a nota nuna mensaxe explorable. (#16800, #16878, @Cary-Rowen)
* O NVDA agora pode configurarse para anunciar atributos de fonte na vala e no braille por separado. (#16755)
* O tempo de espera para realizar unha pulsación múltiple de teclas agora é configurable; esto podería ser especialmente útil para persoas con deficiencias físicas. (#11929, @CyrilleB79)

### Cambios

* As opcións de liña de ordes  `-c`/`--config-path` e `--disable-addons` agora respétanse ao lanzar una actualización dende dentro do NVDA. (#16937)
* Actualizacións de componentes:
  * Actualizado o transcriptor braille LibLouis a [3.31.0](https://github.com/liblouis/liblouis/releases/tag/v3.31.0). (#17080, @LeonarddeR, @codeofdusk)
    * Arranxada a transcripción de números no Braille español.
    * Novas táboas Braille:
      * Thai grao 1
      * Braille Grego Internacional (Letras dunha soa celda aceptadas)
    * Táboas renomeadas:
      * "Thai de 6 puntos" foi renomeada a "Thai grao 0" por razón de consistencia.
      * A tabla existente "Braille grego internacional" renomeouse a "Braille grego internacional (letras de dúas celdas aceptadas)" para clarificar a distinción entre os dous sistemas gregos.
  * eSpeak NG actualizouse a 1.52-dev commit `961454ff`. (#16775)
    * Engadidas novas linguas Faroés e Xextan.
* Cando se usa una pantalla braille multilínea a través do controlador estándar HID, usaránse todas as liñas de celdas. (#16993, @alexmoon)
...
* Arranxos de braille:
  * Agora é posible usar os sensores de enrutamento das pantallas braille para mover ao cursor de texto en Microsoft PowerPoint. (#9101)
  * Ao acesar a Microsoft Word sen UI Automation, o NVDA xa non saca caracteres lixo en cabeceiras de táboa definidas coas ordes establecer cabeceiras de fila e columna. (#7212)
  * O controlador da Seika Notetaker agora xenera correctamente a entrada braille para espazo, retroceso e xestos con puntos con espazo e retroceso. (#16642, @school510587)
  * O enrutamento do cursor agora é moito máis confiable cando una liña contén una ou máis selectores de variación Unicode ou caracteres descompostos. (#10960, @mltony, @LeonarddeR)
  * O NVDA xa non lanza un erro cando se despraza a pantalla braille cara adiante nalgúns controis vacíos de edición. (#12885)
  * O NVDA xa non é inestable despois de se reiniciar durante un escaneo automático de Braille Bluetooth. (#16933)
* Agora é posible  usar as ordes de selección do cursor de revisión para seleccionar texto en Microsoft PowerPoint. (#17004)
* No modo de voz baixo demanda, o NVDA non fala nada cando se abre una mensaxe ao en Outlook, cando se carga una páxina nova en un navegador ou cando se amosa una diapositiva nova nunha presentación de PowerPoint. (#16825, @CyrilleB79)
* En Mozilla Firefox, mover o rato sobre o texto antes ou despois dunha ligazón agora anuncia o texto de xeito fiable. (#15990, @jcsteh)
* O NVDA xa non falla ocasionalmente ao abrir mensaxes explorables (como ao premer `NVDA+f` dúas veces). (#16806, @LeonarddeR)
* Actualizar o NVDA mentres estean pendentes actualización de complementos xa non resulta en que o complemento sexa borrado. (#16837)
* Agora é posible interactuar con listas despregables de validación de Datos en Microsoft Excel 365. (#15138)
* O NVDA xa non é tan lento cando te despraces cara arriba ou abaixo por ficheiros longos en VS Code. (#17039)
* O NVDA xa non deixa de respostar despois de manter premeda una frecha durante moito tempo mentres se estea en modo exploración, particularmente en Microsoft Word e en Microsoft Outlook. (#16812)
* O NVDA xa non le a última liña cando o cursor estea sobre a penúltima liña dun control de edición multiliña en aplicacións Java. (#17027)

### Cambios para Desenvolvedores

Por favor consulta [a Guía do Desenvolvedor](https://www.nvaccess.org/files/nvda/documentation/developerGuide.html#API) para información sobre as obsolescencias da API do NVDA e o proceso de borrado.
...
* Engadido un ficheiro `.editorconfig` ao repositorio do to NVDA para que varios IDEs recollan as regras básicas predeterminadas do estilo de código do NVDA. (#16795, @LeonarddeR)
* Engadido o soporte para diccionarios persoalizados de símbolos da fala. (#16739, #16823, @LeonarddeR)
  * Os diccionarios pódense proporcionar en cartafoles locais específicos nun caquete de complementos, ej.: `locale\en`.
  * Os metadatos do diccionario poden engadirse a una sección `symbolDictionaries` opcional no manifesto do complemento.
  * Por favor consulta a [sección Custom Diccionarios de símbolos da fala Na guía do desenvolvedor](https://www.nvaccess.org/files/nvda/documentation/developerGuide.html#AddonSymbolDictionaries) para máis detalles.
* Agora é posible redirixir oxectos recuperados dende cordinadas na pantalla, usando o método `NVDAObject.objectFromPointRedirect`. (#16788, @Emil-18)
* Executar SCons co parámetro `--all-cores` escollerá automáticamente o número máximo de núcleos de CPU dispoñibles. (#16943, #16868, @LeonarddeR)
* A info do desenvolvedor agora inclúe información sobre a arquitectura da aplicación (como AMD64) para o navegador de obxectos. (#16488, @josephsl)

#### Obsolescencias

* A clave de configuración `bool` `[documentFormatting][reportFontAttributes]` está obsoleta para borrar en 2025.1, a cambio usa `[fontAttributeReporting]`. (#16748)
  * A clave nova ten un valor `int` emparellando un `OutputMode` `enum` con opcións para a fala, o braille, a fala e o braille e desactivado.
  * Os consumidores da API poden usar o valor `bool` como anteriormente, ou verificar `OutputMode` se manexas fala ou braille específicamente.
  * Estas claves actualmente están sincronizadas ate 2025.1.
* `NVDAObjects.UIA.InaccurateTextChangeEventEmittingEditableText` is deprecated with no replacement. (#16817, @LeonarddeR)

## 2024.3.1

Este é un parche lanzado para arranxar un fallo coa notificación automática de actualización de complementos.

### Arranxo de Fallos

* Cando se comproban automáticamente as actualizacións de complementos, o NVDA xa non se conxela en conexións malas. (#17036)
...
actualizárohse eSpeak-NG, o transcriptor braille Liblouis e o Unicode CLDR.
...
atualizáronse eSpeak, LibLouis, Sonic rate boost e Unicode CLDR.
...
* Alterouse a especificación de configuración, borráronse ou modificáronse chaves:
...
atualizáronse eSpeak e LibLouis.
...
* Engadíronse novas ordes de navegación por táboas. (#957)
  * `control+alt+home/end` para saltar á primeira/última columna.
  * `control+alt+pageUp/pageDown` para saltar á primeira/última fila.
...
* Para Microsoft Office 16.0.15000 e superiores en Windows 11, o NVDA utilizará UI Automation para aceder a documentos de Microsoft Word por defecto, proporcionando unha significativa mellora de rendemento sobre o aceso ao vello modelo de obxectos. (#13437)
  * Esto inclúe os documentos do proprio Microsoft Word e tamén o lector e compositor de mensaxes de Microsoft Outlook.
...
* Esta versión rompe a compatibilidade cos complementos existentes.
* Esta versión tamén elimina a compatibilidade con Adobe Flash.
...
* Actualizado o transcriptor braille liblouis á versión 3.16.1:
  * Abórdanse moitas fallas
  * Engádese a táboa Braille baskir de grao 1
  * Engádese a táboa braille computerizada Coptic de 8 puntos
  * Engádense táboas braille literario ruso y braille literario ruso (detallado)
  * Engádese a táboa braille de grao 2 Afrikaans
  * Elimínase a táboa braille rusa de grao 1
...
* A existentcia de contido marcado (resaltado) infórmase tanto en voz coma en braille en todos os navegadores web. (#11436)
  * Esto pode activarse e desactivarse mediante unha nova opción de Formato de documento de NVDA para subriñar.
...
* Os obxectos específicos de NVDA que se atopan polo recolector de basura cíclica de Python agora rexístranse cando se borran polo recolector para axudar na eliminación dos ciclos de referencia de NVDA. (#11499)
  * A mayoría das crases de NVDA son rastrexadas incluindo NVDAObjects, appModules, GlobalPlugins, SynthDrivers, e TreeInterceptors.
  * Unha crase que necesite seren rastrexada debe herdar de garbageHandler.TrackedObject.
...
* En Internet Explorer, Google Chrome e Mozilla Firefox, agora podes navegar por artigos e grupos usando os scripts de navegación rápida. Estos scripts non están vinculados por omisión e poden asignarse no diálogo Xestos de Entrada cando o diálogo se abra dende un documento en modo exploración. (#9227)
  * Tamén se anuncia as figuras. Considéranse obxectos e, polo tanto, navegables coa tecla de navegación rápida o.
...
* Engadiuse unha Cortina de Pantalla que, ao se activar, fai que toda a pantalla se torne negra en Windows 8 e posteriores. (#7857)
  * Engadido un script para habilitar a cortina de pantalla (ate o seguinte reinicio cunha pulsación, ou sempre mentres NVDA estea funcionando con dúas pulsacións), non se asigna ningún xesto por defecto.
  * Pode activarse e configurarse a través da categoría "visión" da Caixa de diálogo de opcións do NVDA.
* Engadida a funcionalidade Resaltado de pantalla ao NVDA. (#971, #9064)
  * Pódese activar e configurar o resaltado do foco, do navegador de obxectos e da posición do cursor no modo exploración a través da categoría "visión" da Caixa de diálogo de opcións do NVDA.
  * Nota: Esta característica é incompatible co complemento de resaltado do foco; sen embargo, o complemento pode seguir usándose mentres o resaltado incorporado estea desactivado.
...
* Como o NVDA xa non depende de pyWin32, módulos como win32api e win32con xa non están dispoñibles para os complementos. (#9639)
  * as chamadas a win32api poden sustituirse por chamadas directas a funcións win32 dll a través de ctypes.
  * as constantes win32con deben definirse nos seus arquivos.
...
* os métodos speakText e speakCharacter en obxectos synthDriver xa non se admiten.
  * Esta funcionalidade é manexada por SynthDriver.speak.
...
* As clases SynthDriver xa non deberían expoñer índices a través da propiedade lastIndex.
  * A cambio, deben notificar a acción synthDriverHandler.synthIndexReached co índice, unha vez que todo o audio anterior terminara de reproducirse antes dese índice.
...
* Cambiáronse varias funcións da fala para devolver as secuencias de fala. (#10098)
  ...
  * getSpeechTextForProperties ahora se llama getPropertiesSpeech
...
* Engadido un módulo textUtils para simplificar as diferencias de cadea entre as cadeas de Python 3 e as cadeas de Windows unicode. (#9545)
  * Consulta a documentación do módulo e do módulo textInfos.offsets para ver exemplos de implementación.
* Agora borrouse funcionalidade obsoleta. (#9548)
  * AppModules eliminados:
    * Windows XP sound recorder.
    * Klango Player, que é un software abandonado.
  * configobj.validate wrapper removed.
    * O novo código debería usar from configobj import validate a cambio de import validate
  * textInfos.Point e textInfos.Rect sustituidos por locationHelper.Point e locationHelper.RectLTRB respectivamente.
  * braille.BrailleHandler._get_tether e braille.BrailleHandler.set_tether elimináronse.
  * config.getConfigDirs foi eliminado.
  * config.ConfigManager.getConfigValidationParameter foi remprazado por getConfigValidation
  * inputCore.InputGesture.logIdentifier property foi eliminado.
    * Usa _get_identifiers en inputCore.InputGesture a cambio.
  * synthDriverHandler.SynthDriver.speakText/speakCharacter foron eliminados.
  * Eliminadas varias crases synthDriverHandler.SynthSetting.
    * Antes mantíñase por compatibilidade con versións anteriores (#8214), agora considérase obsoleto.
    * Os controladores que usaban as crases SynthSetting deben actualizarse para usar as crases DriverSetting.
  * En particular, eliminouse parte do código herdado:
    * Compatibilidade coa listaxe de mensaxes de Outlook anterior a 2003.
    * Unha crase de superposición para o menú de inicio clásico, que só se atopa en Windows Vista e versións anteriores.
    * Retirouse a compatibilidade con Skype 7, xa que definitivamente deixou de funcionar.
* Un framework que permite aos desenvolvedores crear proveedores de melloras visuais; módulos que poden cambiar o contido da pantalla, opcionalmente baseados na entrada do NVDA acerca de localizacións dos obxectos. (#9064)
  * Oos complementos poden agrupar os seus proprios proveedores nun cartafol visionEnhancementProviders.
  * Consulta os módulos vision y visionEnhancementProviders para a implementación do marco e exemplos, respectivamente.
  * Os proveedores de mellora da visión actívanse e configúranse a través da categoría «visión» da Caixa de diálogo de opcións do NVDA.
...
* Introduciuse displayModel.UNIT_DISPLAYCHUNK coma unha constante de unidade textInfos específica para DisplayModelTextInfo. (#10165)
  * Esta nova constante permite percorrer o texto dun DisplayModelTextInfo dun xeito máis semellante a como se gardan os anacos de texto no modelo subxacente.
...
* Os módulos externos (appModules e globalPlugins) agora é menos probable que podan romper a creación de NVDAObjects.
  * As excepcións causadas polos métodos "chooseNVDAObjectOverlayClasses" y "event_NVDAObject_init" agora captúranse e rexístranse correctamente.
...
* Agora podes desactivar o modo Exploración de xeito predeterminado desactivando a nova opción "Activar o modo Exploración ao se cargar a páxina" na configuración do modo exploración do NVDA. (#8716)
  * Ten en conta que cando esta opción está desactivada, aínda podes activar o modo exploración manualmente premendo NVDA+espazo.
...
* Os perfís de configuración agora pódense activar manualmente con xestos. (#4209)
  * O xesto debe configurarse na Caixa de diálogo "Xestos de entrada".
...
* Engadiuse unha opción experimental ao panel de Configuración Avanzada que che permite deter o foco do sistema para que non siga ao cursor do modo exploración (Poñer automáticamente o foco do sistema nos elementos enfocables). (#2039) aíndaque pode non ser adoitado desactivalo en todos os sitios web, esto poderá arranxar:
  * Efecto goma elástica: o NVDA desfai esporádicamente a última pulsación do modo exploración saltando á localización anterior.
  * Nalgúns sitios web, as caixas de edición rouban o foco do sistema ao desprazarse por eles.
  * As pulsacións das teclas do modo exploración responden con lentitude.
...
* O resultado da última orde executada na consola Python do NVDA agora é acesible dende a variable _ (line). (#9782)
  * Ten en conta que esto asombra a función de traducción gettext tamén chamada «_». Para aceder á función de traducción: del _
...
* Engadida unha opción ás opcións do rato do NVDA para facer que o NVDA manexe situacións nas que o rato estea controlado por outra aplicación. (#8452)
  * Esto permitirá ao NVDA rastrexar o rato cando un sistema é controlado remotamente usando TeamViewer ou outro software de control remoto.
...
* En Mozilla Firefox e Google Chrome, o modo exploración agora anuncia o elemento selecionado en caixas de listaxe e en árbores.
  * Esto funciona en Firefox 66 e posteriores.
  * Esto non funciona para certas caixas de listaxe (controis de seleción HTML) en Chrome.
...
* O NVDA xa non carga automáticamente appModules, globalPlugins e controladores braille e de sintetizador dende o directorio de configuración de usuario do NVDA. Este código debería ser empaquetado no seu lugar coma un complemento con información correcta de versión, asegurándose de que o código incompatible non sexa executado coas versións actuais do NVDA. (#9238)
  * Para os desenvolvedores que necesiten probar o código mentres se está desenvolvendo, se activa o directorio “scratchpad” para desenvolvedores do NVDA na categoría Avanzado das opción do NVDA, e colócase o código no directorio “scratchpad” que se atopa no directorio de configuración de usuario do NVDA cando esta opción estea activada.
...
* Os autores de complementos agora poden proporcionar información sobre a compatibilidade das versións do NVDA nos manifests dos complementos. (#6275, #9055)
  * minimumNVDAVersion: a versión mínima requerida de NVDA para que un complemento funcione correctamente.
  * lastTestedNVDAVersion: a última versión de NVDA coa que se probou un complemento.
...
* gui.nvdaControls agora contén dúas clases para crear listaxes accesibles con caixas de verificación. (#7325)
  * CustomCheckListBox é unha subcrase accesible de wx.CheckListBox.
  * AutoWidthColumnCheckListCtrl engace caixas de verificación acesibles a unha AutoWidthColumnListCtrl, que á súa vez está baseada en wx.ListCtrl.
...
* Engadiuse o soporte para a deteción automática de pantallas braille en segundo plano. (#1271)
  * As pantallas ALVA, Baum/HumanWare/APH/Orbit, Eurobraille, Handy Tech, Hims, SuperBraille e HumanWare BrailleNote e Brailliant BI/B están admitidas actualmente.
  * Podes activar esta función selecionando a opción automática na listaxe de pantallas braille da Caixa de diálogo de seleción de pantallas braille do NVDA.
  * Por favor consulta a documentación para obter máis información.
...
* Varias melloras ao soporte braille en Microsoft Word co UI Automation habilitado:
  * Igual que noutros campos de texto multiliña, cando se sitúa ao comezo dun documento en Braille, a pantalla desprázase de xeito que o primeiro carácter do documento se atope ao comezo da pantalla. (#8406)
  * Reduciuse a presentación excesivamente verbosa do foco tanto en voz alta coma en braille ao enfocar un documento de Word. (#8407)
  * O enrutamento do cursor en braille agora funciona correctamente cando se atopa nunha listaxe nun documento de Word. (#7971)
  * As viñetas/números recén insertados nun documento Word amósanse correctamente tanto en voz alta como en braille. (#7970)
...
* Realizáronse algúns cambios no módulo hwPortUtils: (#1271)
  * listUsbDevices produce agora diccionarios con información sobre os dispositivos, incluidos hardwareID y devicePath.
...
* Agora podes rexistrar para que se che notifique acerca de acións de gardar/reiniciar a configuración a través das novas acións config.pre_configSave, config.post_configSave, config.pre_configReset, e config.post_configReset. (#7598)
  * config.pre_configSave úsase para sermos notificados cando a configuración do NVDA está a punto de se gardar, e config.post_configSave chámase despois de que a configuración fora gardada.
  * config.pre_configReset e config.post_configReset inclúen un indicador de valores predeterminados de fábrica para especificar se as opción se voltan a cargar dende o disco (false) ou se restabrecen aos valores predeterminados (true).
...
* Agora podes conmutar control, shift, alt, windows e NVDA dende o teu teclado braille e combinar estos modificadores coa entrada braille (ex.: premer control+s). (#7306)
  * Podes asignar estos novos modificadores mediante as ordes que atoparás en Teclas emuladas do teclado do sistema na Caixa de diálogo Xestos de entrada.
...
* Agora é posible interactuar con gráficos en Microsoft Word e Microsoft PowerPoint, similar ao soporte existente para gráficos en Microsoft Excel. (#7046)
  * En Microsoft Word:  no modo exploración, sitúa el cursor sobre un gráfico inegrado e preme Intro para interactuar con el.
  * En Microsoft PowerPoint, cando edites unha diapositiva: vai a un obxecto gráfico e preme Intro ou Espazo para interactuar co gráfico.
  * Para deixar de interactuar cun gráfico, preme escape.
* Nova lingua: Kyrgyz.
...
* Agora é posible usar a entrada braille cunha pantalla braille ALVA 640 Comfort. (#7733)
  * A funcionalidade de entrada braille do NVDA pódese usar con estas e outras pantallas BC6 con firmware 3.0.0 e superior.
...
* Reemplazáronse os controladores de pantallas braille HIMS Braille Sense/Braille EDGE/Smart Beetle e Hims Sync por un único controlador. O novo controlador activarase automáticamente para os antigos usuarios do controlador syncBraille. (#7459)
  * Algunhas teclas, especialmente as de desprazamento, foron reasignadas para seguir as convencións usadas polos productos Hims. Consulta a guía do usuario para máis detalles.
* Ao se escrebir co teclado en pantalla a través da interación tactil, por defecto agora debes facer dobre tap en cada tecla do mesmo xeito no que activarías calquera outro control. (#7309)
  * Para usar o modo existente de "escritura táctil", no que chega con levantar o dedo da tecla para activala, activa esta opción na nova Caixa de diálogo de opcións de Interación táctil que atoparás no menú Preferencias.
* Xa non é necesario que o braille sega explícitamente ao foco ou á revisión, xa que esto ocorrirá automáticamente por omisión. (#2385)
  * Ten en conta que o seguemento automático á revisión só se producirá cando se use un cursor de revisión ou unha orde de navegación por obxectos. O desprazamento non activará este novo comportamento.
...
* Engadida unha bandeira booleana oculta á seción braille na configuración: "outputPass1Only". (#7301, #7693, #7702)
  * O valor predeterminado desta opción é "true". Se é false, usaranse as regras multipase de liblouis para a saída braille.
...
* Os xestos de pantalla braille que emulan teclas modificadoras do teclado do sistema (coma control e alt) agora poden conbinarse con outras teclas emuladas do teclado do sistema sen definición explícita. (#6213)
  * Por exemplo, se tes unha tecla da pantalla asociada á tecla alt e outra tecla da pantalla asociada a Frecha abaixo, a combinación destas teclas dará como resultado a emulación de alt+Frecha abaixo.
* A clase braille.BrailleDisplayGesture agora ten unha propiedade de modelo extra. Se se proporciona, premendo unha tecla xerará unha adicional, texto específico de identificador de modelo, esto permite a un usuario vencellar xestos limitados a un modelo de pantalla braille específico.
  * Véxase o controlador baum como exemplo desta nova funcionalidade.
...
* O NVDA agora pode usar a funcionalidade OCR incluida no Windows 10 para recoñecer o texto de imaxes ou de aplicacións inaccesibles. (#7361)
  * A lingua p´pódese configurar dende a nova Caixa de diálogo OCR de Windows 10 nas Preferencias do NVDA.
  * Para recoñecer o contido do obxecto actual do navegador, preme NVDA+r.
  * Para máis información, consulta a sección Recoñecemento de contidos da Guía do usuario.
* Agora podes escoller que información de contexto se amosa nunha pantalla braille cando un obxecto ten o foco usando a nova opción "Presentación de contexto do foco" no diálogo Opcións de Braille. (#217)
  * Por exemplo, as opcións "Rechear pantalla para cambios de contexto" e "Só ao retroceder" poden facer máis eficaz o traballo con listaxes e menús, xa que os elementos non cambiarán continuamente de posición na pantalla.
  * Para máis detalles e exemplos, consulta a sección "Presentación de contexto do foco" da Guía do usuario.
...
* De xeito predeterminado, o NVDA agora só amosa as partes da información de contexto que cambiara nunha pantalla braille cando se enfoque un obxecto. (#217)
  * Anteriormente, sempre amosaba toda a información de contexto posible, independientemente de se viras a mesma información de contexto antes.
  * Podes voltar ao comportamento anterior cambiando a nova opción "Presentación de contexto do foco" da caixa de diálogo Opcións de Braille a "Rechear sempre a presentación".
...
* NVDA agora debe compilarse co Visual Studio Community 2015. Visual Studio Express xa non se soporta. (#7110)
  * Agora tamén se requiren as ferramentas e o SDK de Windows 10, que poden activarse ao instalar Visual Studio.
  * Consulta a seción Dependencias instaladas do arquivo readme para obter máis información.
...
* A propiedade InputGesture.identifiers cambiouse tal que xa non se normaliza. (#6945)
  * As subceases xa non necesitan normalizar os identificadores antes de devolvelos dende esta propiedade.
  * Se desexas identificadores normalizados, agora hai unha propiedade InputGesture.normalizedIdentifiers que normaliza os identificadores devoltos pola propiedade identifiers.
...
* Borrouse algún código obsoleto:
  * `speech.REASON_*` constants: `controlTypes.REASON_*` debería usarse a cambio. (#6846)
  * `i18nName` para a configuración do sintetizador: `displayName` e `displayNameWithAccelerator` deberían usarse a cambio. (#6846, #5185)
  * `config.validateConfig`. (#6846, #667)
  * `config.save`: `config.conf.save` debería usarse a cambio. (#6846, #667)
...
* Agora hai unha unidade de proba do framework para o NVDA. (#7026)
  * As probas unitarias e a infraestructura atópanse no directorio tests/unit. Consulta o docstring no arquivo tests\unit\init.py para máis detalles.
  * Podes executar probas usando "scons tests". Consulta a seción "Executar probas" de readme.md para máis detalles.
  * Se estás a enviar un pull request para NVDA, primeiro debes executar as probas e asegurarte de que pasan.
...
* o constructor do nvwave.WavePlayer agora ten a palabra chave wantDucking como argumento que especifica se o audio de fondo debería se atenuar mentres se reproduce audio. (#3830)
  * Cando esto está activado (que é o valor predeterminado), é esencial que se chame a WavePlayer.idle cando sexa apropriado.
* Mellorada a Entrada/saída para pantallas braille: (#5609)
  * Os controladores de pantalla braille seguros poden declararse usando o atributo BrailleDisplayDriver.isThreadSafe. Un controlador debe ser thread-safe para beneficiarse das seguintes características.
  * Os datos escrébense de fondo en controladores de pantalla braille a proba de fíos, o que mellora o rendemento.
  * hwIo.Serial extende pyserial para chamar a un callable cando se reciben datos a cambio de que os controladores teñan que facer un poll.
  * hwIo.Hid proporciona soporte para pantallas braille que se comunican a través de USB HID.
  * hwPortUtils e hwIo pueden proporcionar opcionalmente un rexistro de depuración detallado, incluindo os dispositivos atopados e todos os datos enviados e recibidos.
* Hai varias propiedades novas accesibles dos xestos da pantalla táctil: (#5652)
  * Os obxectos MultitouchTracker conteñen agora unha propiedade childTrackers que contén os MultiTouchTrackers que compoñen o tracker. Por exemplo, un doble toque de 2 dedos ten seguidores fillos para dous toques de 2 dedos. Os proprios toques con dous dedos teñen seguidores fillos para dous toques.
  * Os obxectos MultiTouchTracker agora tamén conteñen unha propiedade RawSingleTouchTracker se o rastreador foi o resultado dun so dedo facendo un tap, flick ou hover. A propiedade SingleTouchTracker permite aceder ao ID subxacente asignado ao dedo polo sistema operativo e saber se o dedo segue ou non en contacto no momento actual.
  * TouchInputGestures agora tenn propiedades x e y, eliminando a necesidade de aceder ao rastreador para casos triviales.
  * Os TouchInputGesturs agora conteñen unha propiedade preheldTracker, que é un obxecto MultitouchTracker que representa os outros dedos sostidos mentres se realizaba esta acción.
* Pódense dar dous novos xestos de pantalla táctil: (#5652)
  * Premer e manter en plural (por exemplo, premer dúas veces e manter)
  * Un identificador xeralizado co reconto de dedos eliminado para as retencións (por exemplo, retención+retención para 1dedo_retención+retención).
...
* Apoio para edición ou texto enriquecido en Google Chrome e navegadores baseados en Chrome como Google Docs co apoio braille habilitado. (#2634)
  * Esto require Chrome versión 47 ou posterior.
...
* En Windows 8 e posterior, NVDA agora arranca moito máis rápido cando se configurou para iniciarse despois de autentificarse en Windows. (#308)
  * Se activaches esta opción cunha versión anterior de NVDA, terás que desactivala e activala de novo para que o cambio faga efecto. Segue este procedemento:
    1. Abre a Caixa de diálogo opcións Xerais.
    1. Desmarca a Caixa Iniciar automáticamente NVDA despois de arrancar sesión en Windows.
    1. Preme o botón Aceptar.
    1. Abre o diálogo Opcións Xerais de novo.
    1. Marca a Caixa Iniciar automáticamente NVDA despois de iniciar sesión en Windows.
    1. Preme o botón Aceptar.
...
* En lugar dun só atributo i18nName, synthDriverHandler.SynthSetting agora ten os atributos  displayNameWithAccelerator e displayName separados para evitar o anunciado do acelerador no grupo de opcións do sintetizador nalgunhas linguas.
  * Por razóns de compatibilidade con versións anteriores, no constructor, displayName é opcional e derivarase de displayNameWithAccelerator se non se proporciona. Sin embargo, se tes a intención de ter un acelerador para unha opción, ambos deben proporcionarse.
  * O atributo i18nName está obsoleto e pode que se elimine en unha futura versión.
...
* Implementáronse ordes de voz para insertar unha ruptura entre palabras e para cambiar o ton, volume e velocidade. Mira BreakCommand, PitchCommand, VolumeCommand e RateCommand no módulo speech. (#4674)
  * También hai speech.PhonemeCommand para insertar unha pronuncia específica, pero as implementacións actuais só admiten un número moi limitado de fonemas.
...
* As cabeceiras de columna de táboa no Microsoft word anúncianse automáticamente para táboas onde se especificara unha cabeceira de fila polo autor a través das propiedades de táboa do Microsoft word. (#4510)
  * Sen embargo, para as táboas nas que se fusionaron filas, esto non funcionará automáticamente. Neste caso, podes configurar as cabeceiras de columna manualmente no NVDA con NVDA+shift+c.
...
* Agora é posible reiniciar o NVDA ou reiniciar NVDA cos complementos deshabilitados dende o diálogo saír do NVDA. (#4057)
  * O NVDA tamén pode arrancarse cos complementos desactivados usando a opción de liña de ordes --disable-addons.
...
* Para executables que abranguen moitas aplicacións diferentes (ex.: javaw.exe), agora o código pode proporcionarse para que cargue app modules específicos para cada aplicación en lugar de cargar o mesmo app module para todas as aplicacións incluídas. (#4360)
  * Consulta a documentación de código de appModuleHandler.AppModule para obter máis detalles.
  * Implementouse a compatibilidade con javaw.exe.
...
* Soporte para o Calendario en Microsoft Outlook 2007 e superior (#2943) incluíndo:
  * Anuncio da hora actual ao desprazarse coas frechas.
  * Indicación de se a hora selecionada está dentro dalgunha cita.
  * anuncio da cita selecionada ao premer tabulador.
  * Filtrado intelixente da data para que só se anuncie a data se a nova hora ou cita selecionada é nun día distinto ao anterior.
* Mellorado o soporte para a bandexa de entrada e outras listas de menxases  en Outlook 2010 e superior (#3834) incluíndo:
  * A posibilidade de silenciar as cabeceiras de columna (de, asunto, etc.) desactivando a opción anunciar Cabeceiras de fila e columna da táboa nas opcións de Formato de documento.
  * Posibilidade de usar ordes de navegación pola táboa (control + alt + frechas) para desprazarse polas distintas columnas.
...
* Mellorado o soporte para a lectura automática de cabeceiras de fila e columna no Microsoft Excel (#3568) incluíndo:
  * Soporte de rangos de nomes definidos en Excel para identificar as celdas de cabeceira (compatible co lector de pantalla Jaws).
  * As ordes estabrecer cabeceira de columna (NVDA+shift+c) e estabrecer cabeceiras de fila (NVDA+shift+r) agora almacenan a configuración na folla de traballo para que estea dispoñible a seguinte vez que se abra a folla, e estará dispoñible para outros lectores de pantalla que admitan o esquema de rango de nomes definido.
  * Estas ordes tamén poden usarse agora varias veces por folla para estabrecer diferentes cabeceiras para distintas rexións.
...
* Microsoft Excel: información en voz e en braille  para moitos máis atallos de teclado para movementos de selección (#4211) incluíndo:
  * Movemento vertical da páxina (rePáx e avPáx);
  * Movemento horizontal da páxina (alt+rePáx e alt+avpáx);
  * Ampliar selección (as teclas anteriores con Shift engadida; e
  * Selecionar rexión actual (control+shift+8.
...
* Microsoft Powerpoint: cando se moven as formas dunha diapositiva cas teclas de flecha, agora anúnciase a ubicación actual da forma (#4214) incluíndo:
  * Anúnciase a distancia entre a forma e cada unha das marxes da diapositiva.
  * Se a forma cubre ou é cuberta por outra forma, anúnciase a distancia solapada e da forma solapada.
  * Para anunciar esta información en calquera momento sen mover unha figura, preme a orde anunciar localización (NVDA+suprimir).
  * Ao selecionar unha figura, se está cuberta por outra figura, o NVDA anunciará que está oscurecida.
* A orden anunciar localización (NVDA+suprimir) é máis específica ó contexto nalgunhas situacións. (#4219):
  * Nos campos de edición estándar e no modo exploración, anúnciase a posición do cursor en porcentaxe a través do contido e das súas coordinadas de pantalla.
  * Nas figuras das presentacións de PowerPoint, anúnciase a posición da figura en relación coa diapositiva e outras figuras.
  * Se premes esta orde dúas veces, producirase o comportamento anterior de anunciar a información de localización de todo o control.
* Nova lingua: Catalán.
...
* Agora é posible cambiar a tecla de atallo utilizada para iniciar NVDA en traducións onde o atallo normal causa problemas. (#2209)
  ...
  * Ten en conta que o texto da opción Crear acceso directo no escritorio da Caixa de diálogo Instalar NVDA, así como a tecla de acceso directo da Guía do usuario, tamén deben actualizarse.
...
* Mellorado o soporte  para  rexiones ARIA live en Firefox e outras aplicacións Gecko de Mozilla:
  ...
  * O texto alternativo (coma o atributo alt o aria-label) inclúese se non hai outro texto útil. (#3329)
  * As actualizacións de rexións vivas xa non se silencian se se producen ao mesmo tempo que se move o foco. (#3777)
...
* Varias correccións ó soporte para aplicacións Java accesibles:
  * O control enfocado inicialmente nun marco ou nun diálogo xa non deixa de ser anunciado cando o marco ou o diálogo pasa a primeiro plano. (#3753)
  * A información de posición inútil xa non se anuncia para os botóns de opción (por exemplo, 1 de 1). (#3754)
  * Mellor información dos controis JComboBox (xa non se anuncia do html, anúnciase mellor dos estados expandido e contraído). (#3755)
  * Ao anunciar o texto dos diálogos, agora inclúese parte do texto que antes faltaba. (#3757)
  * Os cambios no nome, no valor ou na descripción do control enfocado notifícanse agora con maior precisión. (#3770)
...
* Na consola de Python, agora podes premer  a tecla tab para completar o identificador actual. (#433)
  * Se hai varias posibilidades, podes premer tabulador unha segunda vez para escoller dunha listaxe.
...
* A revisión cha foi reemplazada polos modos de revisión de obxectos, documentos e pantalla. (#2996)
  * A revisión de obxectos revisa o texto só dentro do navegador de obxectos, a revisión de documentos revisa todo o texto dun documento en modo exploración (se o hai) e a revisión de pantalla revisa o texto da pantalla para a aplicación actual.
  * As ordes que antes se movían a/dende a revisión chá agora alternan entre estos novos modos de revisión.
  * O navegador de obxectos sigue automáticamente ao cursor de revisión, de xeito que siga sendo o obxeto máis profundo na posición do cursor de revisión cando se está nos modos de revisión de documentos ou de pantalla.
  * Despois de cambiar ao modo de revisión de pantalla, o NVDA permanecerá neste modo ate que cambies explícitamente de novo ao modo de revisión de documentos ou obxectos.
  * Cando esteas no modo de revisión de documentos ou de obxectos, o NVDA pode cambiar automáticamente entre estos dous modos dependendo de se te estás a mover por un documento en modo exploración ou non.
...
* A inclusión do módulo bisect en compilacións binarias está en desuso e poderá eliminarse nunha versión futura. (#3368)
  * Os complementos que dependen de bisect (incluido o módulo urllib2) deben actualizarse para incluir este módulo.
...
* Os controladores de liña Braille agora poden soportar a selección manual de portos. (#426)
  * Esto é moi útil para as pantallas braille que admitan a conexión a través de un porto serie herdado.
  * Para elo úsase o método getPossiblePorts da crase BrailleDisplayDriver.
* Agora sopórtase a entrada braille  dende teclados braille. (#808)
  * A entrada braille englóbase na crase brailleInput.BrailleInputGesture ou nunha subcrase da mesma.
  * As subcrases de braille.BrailleDisplayGesture (como se implementan nos controladores de pantalla braille) tamén poden herdar de brailleInput.BrailleInputGesture. Esto permite que as ordes de pantalla e a entrada braille sexan manexados pola mesma crase de Xesto.
...
* NVDA agora pode soportar entrada de caracteres asiáticos utilizando IME e métodos de servicio de entrada de texto en todas as aplicacións, incluindo:
  * Anunciado e navegación polas listaxes de candidatos;
  * Anunciado e navegación polas cadeas de composición; e
  * Anunciado de cadeas de lectura.
...
* Soporte experimental para pantallas Tactiles no Windows 8, incluíndo:
  * Lectura de texto directamente baixo o dedo mentres o moves
  * Moitos xestos para realizar navegación por obxectos, revisión de textos e outras ordes de NVDA.
...
* No Adobe Reader, agora poden anunciarse os números de páxina. (#2534)
  * En Reader XI, as etiquetas de páxina notifícanse cando están presentes, reflectindo os cambios na numeración de páxinas en diferentes secións, etc. En versións anteriores, esto non é posible e só se anuncian os números de páxina secuenciales.
...
* Agora sopórtanse as mensaxes contextuais de Gettext. Esto permite que sexan definidas múltiples traduccións para unha soa mensaxe en Inglés dependendo do contexto. (#1524)
  * Para elo úsase a función pgettext(context, message).
  * Esto é compatible tanto co proprio NVDA como cos complementos.
  * xgettext e msgfmt de GNU gettext deben usarse para crear calquera ficheiro PO e MO. As ferramentas de Python non soportan contextos de mensaxes.
  * Para xgettext, pasa o argumento de liña de ordes --keyword=pgettext:1c,2 para habilitar a inclusión de contextos de mensaxe.
  * Consulta http://www.gnu.org/software/gettext/manual/html_node/Contexts.html#Contexts para más información.
...
* Agora anúnciase moita máis información en documentos de Microsoft Word, incluindo:
  * Información en liña, como os números das notas a pe de páxina e das notas finais, os niveis dos títulos, a existencia de comentarios, os niveis de anidamento das t´táboas, as ligazóns e a cor do texto;
  * Anunciar cando se introducen secións de documento coma os historiales de comentarios, notas ao pe e notas finais, e historiales de cabeceiras e pes de páxina.
...
* Os obxectos TextInfo agora teñen un método activate() para activar a posición representada polo TextInfo.
  * Úsase en braille para activar a posición mediante os sensores de enrutamento do cursor nunha pantalla braille. Sen embargo, pode haber outros chamantes no futuro.
...
* Movéronse ou cambiáronse os nomes de varios controis e constantes de saída. (#228)
  * as constantes speech.REASON_* trasladáronse a controlTypes.
  * En controlTypes, speechRoleLabels e speechStateLabels pasaron a chamarse roleLabels e stateLabels, respectivamente.
...
* NVDA agora pode instruir ós sintetizadores de voz para cambiar as linguas para seccións en particular de voz.
  * Para soportar esto, os controladores deben manexar speech.LangChangeCommand en secuencias pasadas a SynthDriver.speak().
  * Os obxectos SynthDriver tamén deben proporcionar o argumento language aos obxectos VoiceInfo (ou anular o atributo language para recuperar a lingua actual). Pola contra, usarase a lingua da interfaz de usuario do NVDA.
...
* Os controladores de síntesis agora pásanse como unha secuencia de texto e ordes de voz a se falar, en lugar de só texto e un índice.
  * Esto permite índices incrustados, cambios de parámetros, etc.
  * Os controladores deben implementar SynthDriver.speak() a cambio de SynthDriver.speakText() e SynthDriver.speakCharacter().
  * Os métodos antigos usaranse se non se implementa SynthDriver.speak(), pero están obsoletos e eliminaranse nunha futura versión.
* eliminouse gui.execute(). Debería utilizarse wx.CallAfter() no seu lugar.
* eliminouse gui.scriptUI .
  * Para os diálogos de mensaxes, usa wx.CallAfter(gui.messageBox, ...).
  * Para todos os demáis diálogos, débense usar diálogos wx reais a cambio.
  * Una nova función gui.runScriptModalDialog() simplifica o uso de diálogos modais dende scripts.
...
* Agora pódense anunciar as cores para algúns controis. O anunciado automático pódese configurar no diálogo de preferencias de formateado de documentos. Tamén se poden anunciar baixo demanda utilizando a orde de anunciado de formato de texto (NVDA+f).
  * Inicialmente, esto é compatible cos controis de texto editables IAccessible2 estándar (como nas aplicacións Mozilla), os controis RichEdit (como en Wordpad) e os controis de texto IBM Lotus Symphony.
...
* SCons agora úsase para preparar o árbore fonte e crear compilacións binarias, arquivos portables, instaladores, etc. Consulta readme.txt na raiz da distribución de fontes para máis detalles.
* Os nomes das teclas usados polo NVDA (incluindo os mapas de teclas) fixéronse máis amigables e lóxicos; por exemplo, frechaArriba a cambio de extendidaArriba e numpadPageArriba a cambio de anterior. Consulta a listax no módulo vkCodes.
* Toda a entrada dende o usuario agora represéntase por una instancia  inputCore.InputGesture. (#601)
  * Cada fonte de entrada subcrasea a crase base InputGesture.
  * As pulsacións de teclas no teclado do sistema están engrobadas na crase keyboardHandler.KeyboardInputGesture.
  * As pulsacións de botóns, rodas e outros controis nunha pantalla braille engróbanse en subcrases da crase braille.BrailleDisplayGesture. Estas subcrases proporciónanas cada controlador de pantalla braille.
* Os xestos de entrada vincúlanse a ScriptableObjects mediante o método ScriptableObject.bindGesture() nunha instancia ou nun __gestures.dict  na crase que asigna identificadores de xestos a nomes de script. Consulta baseObject.ScriptableObject para máis detalles.
* Os appModules xa non teñen ficheiros de asignación de teclas. Todas as vinculacións de xestos de entrada deben realizarse no proprio appModule.
* Todos os scripts toman agora unha instancia de InputGesture a cambio dunha pulsación de tecla.
  * Os KeyboardInputGestures poden enviarse ao sistema operativo mediante o método send() do xesto.
* Para enviar unha pulsación de tecla arbitraria, agora débese crear un KeyboardInputGesture usando KeyboardInputGesture.fromName() e logo usar o seu método send().
* As locales agora poden proporcionar un ficheiro de mapa de xestos de entrada para engadir novas ligazóns ou anular ligazons existentes para scripts en calquera parte do NVDA. (#810)
  * Os mapas xestuais de localización deben colocarse en locale\LANG\gestures.ini, onde LANG é o código de lingua.
  * Mira inputCore.GlobalGestureMap para máis detalles sobre o formato do ficheiro.
* Os novos comportamentos LiveText e Terminal NVDAObject facilitan a notificación automática de novo texto. Consulta esas clases en NVDAObjects.behaviors para máis detalles. (#936)
  * A crase de sobreimpresión NVDAObjects.window.DisplayModelLiveText pódese usar para obxectos que deben recuperar texto escrebido na pantalla.
  * Consulta os módulos de aplicación mirc e putty para ver exemplos de uso.
* Xa non existe un appModule _default. A cambio, os appModules deben subclasificar appModuleHandler.AppModule (a crase AppModule base).
* Soporte para plugins globais que poden enlazar scripts globalmente, manexar eventos NVDAObject e escoller crases de superposición NVDAObject. (#281) Consulta globalPluginHandler.GlobalPlugin para máis detalles.
* Nos obxectos SynthDriver, os atributos available* dos axustes de cadena (por exemplo, availableVoices e availableVariants) son agora OrderedDicts con clave ID en lugar de listaxes.
* synthDriverHandler.VoiceInfo agora toma un argumento opcional de lingua que especifica a lingua da voz.
* Os obxectos SynthDriver agora proporcionan un atributo de lingua que especifica a lingua da voz actual.
  * A implementación base usa a lingua especificada nos obxectos VoiceInfo en availableVoices. Esto é adecuado para a maioría dos sintetizadores que admiten una lingua por voz.
* Melloráronse os controladores da pantalla Braille para permitir que os botóns, as rodas e outros controis se vinculen aos scripts do NVDA:
  * Os controladores poden proporcionar un mapa de xestos de entrada global para engadir ligazóns para scripts en calquera parte do NVDA.
  * Tamén poden proporcionar os seus proprios scripts para realizar funcións específicas de visualización.
  * Consulta braille.BrailleDisplayDriver para obter máis detalles e os controladores de pantalla braille existentes para ver exemplos.
* A propiedade 'selfVoicing' das crases AppModule foi renomeada a 'sleepMode'.
* Os eventos de appModule: event_appLoseFocus e event_appGainFocus agora foron renomeados a event_appModule_loseFocus end event_appModule_gainFocus respectivamente, para conservar a mesma sintacse de nomes entre appModules e treeInterceptors etc.
* Todos os controladores de pantalla braille deben usar agora braille.BrailleDisplayDriver a cambio de braille.BrailleDisplayDriverWithCursor.
  * O cursor xestiónase agora fóra do controlador.
  * Os controladores existentes só teñen que cambiar a súa declaración de crase en consecuencia e cambiar o nome do seu método _display a display.
...
* NVDA agora pode recuperar a maioría do texto escrito na pantalla. (#40, #643)
  * Esto permite ler os controis que non expoñen a información de xeito máis directo/ fiable.
  * Entre os controis acesibles mediante esta función inclúense: algúns elementos de menú que amosan iconas (por exemplo, o menú Abrir con en ficheiros en Windows XP) (#151), campos de texto editables en aplicacións Windows Live (#200), a listaxe de erros en Outlook Express (#582), o control de texto editable en TextPad (#605), listaxes en Eudora, moitos controis en Australian E-tax e a barra de fórmulas en Microsoft Excel.
...
* As cabeceiras de fila e columna agora poden anunciarse. Esto é configurable dende o diálogo de preferencias de formato de documento.
  * Actualmente, esto admítese en documentos de aplicacións Mozilla como Firefox (versión 3.6.11 e posteriores) e Thunderbird (versión 3.1.5 e posteriores). (#361)
* Introducidas ordes para a revisión chan: (#58)
  * NVDA+tecládo numérico7 cambia a revisión chá, colocando o cursor de revisión na posición do obxecto actual, permitíndoche revisar a pantalla (ou un documento se está dentro dun) cas ordes de revisión de texto.
  * NVDA+teclado numérico1 move o cursor de revisión ao obxecto representado polo texto na posición do cursor de revisión, permitíndoche navegar por obxectos dende ese punto.
...
* NVDA ten agora un sintetizador incorporado chammado eSpeak, desenrolado por Jonathan Duddington. é moi áxil e lixeiro, e ten soporte para moitas linguas diferentes. Os sintetizadores Sapi todavía poden ser utilizados, pero eSpeak será utilizado de maneira predeterminada. eSpeak non depende de ningún software especial para seren instalado, así que pode ser utilizado con NVDA en calquier ordenador, nun lápiz de memoria USB, ou calquer outro. Para máis información sobre eSpeak, ou para atopar outras versións, vai a https://espeak.sourceforge.net/.
  * eSpeak non depende da instalación de ningún software especial, polo que pode usarse co NVDA en calquera computador, nunha memoria USB ou en calquera lugar.
  * Para máis información sobre eSpeak, ou para atopar outras versións, visita http://espeak.sourceforge.net/.
...
* Engadidos argumentos de liña de ordes a NVDA:
  * -m, --minimal: non reproduce sons de inicio/saída e non amosa a interfaz ao comezo se está configurado para elo.
  * -q, --quit: abandona calquera outra instancia de NVDA que xa se estea executando e logo sae
  * -s, --stderr-file fileName: especifica onde debe colocar NVDA os erros e excepcións non detectados
  * -d, --debug-file fileName: especifica onde debe colocar NVDA as mensaxes de depuración
  * -c, --config-file: especifica un ficheiro de configuración alternativo
  * -h, -help: amosa una mensaxe de axuda cos argumentos da liña de ordes
