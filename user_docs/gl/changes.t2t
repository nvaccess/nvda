...
% Inserta novos elementos de listaxe aquí según a táboa de alias de appModule debería manterse ao fondo desta listaxe
...
- ``gui.quit`` foi posto como obsoleto para borralo en 2023.1. (#13498)
  -
% Inserta novos elementos de listaxe aquí coma o alias appModule a táboa debería permanecer na parte inferior desta listaxe
...
- Un ScriptableObject rompido (coma un GlobalPlugin que perda unha chamada á súa crase base ' método __init__ ) xa non rompe o manexo dos scripts do NVDA. (#5446)
...
- Agora hai unha unidade de proba do framework para o NVDA. (#7026)
 - A unidade de proba e a infraestructura atópanse no directorio tests/unit. Consulta a cadea de documentación no ficheiro tests\unit\__init__.py para detalles.
...
- En Windows 8 e posterior, NVDA agora arranca moito máis rápido cando se configurou para iniciarse despois de autentificarse en Windows. (#308)
 - Se habilitaches esto utilizando unha versión anterior  do NVDA, necesitarás deshabilitalo e habilitalo de novo no diálogo  Opcións Xerais para que o cambio teña efecto. Segue este procedemento:
  + Abre o diálogo Opcións Xerais.
  + Desmarca a caixa de verificación Iniciar Automáticamente NVDA Despois de Autentificarse en Windows.
  + Preme o botón Aceptar.
  + Abre o diálogo Opcións Xerais de novo.
  + Marca a caixa de verificación Iniciar Automáticamente NVDA Despois de Autentificarse en Windows.
  + Preme o botón Aceptar.
...
- Agora é posible utilizar o modo navegación para páxinas en Internet Explorer 10 cando se estea no modo estándar; ex.: www.gmail.com login page. (#3151)
...
- As subclasses do synthDriver sapi5  agora poden sobreescribirse _getVoiceTokens e extender __init__ para soportaren fichas de voces personalizadas como con sapi.spObjectTokenCategory para obter fichas dun rexistro personalizado.
