...
= 2018.3.2 =
Esta es una versión menor para evitar un cuelgue en Google Chrome al navegar por tuits en www.twitter.com. (#8777)
...
- Ahora hay una unidad de prueba del framework para NVDA. (#7026)
 - La unidad de prueba y la infraestructura se encuentran en el directorio tests/unit. Consulta la cadena de documentación en el fichero tests\unit\__init__.py para detalles.
...
- En Windows 8 y posterior, NVDA ahora arranca mucho más rápido cuando se configuró para iniciarse después de autentificarse en Windows. (#308)
 - Si habilitaste esto utilizando una versión anterior  de NVDA, necesitarás deshabilitarlo y habilitarlo de nuevo en el diálogo  Opciones Generales para que el cambio tenga efecto. Sigue este procedimiento:
  + Abre el diálogo Opciones Generales.
  + Desmarca la casilla de verificación Iniciar Automáticamente NVDA Después de Autentificarse en Windows.
  + Pulsa el botón Aceptar.
  + Abre el diálogo Opciones Generales de nuevo.
  + Marca la casilla de verificación Iniciar Automáticamente NVDA Después de Autentificarse en Windows.
  + Pulsa el botón Aceptar.
...
- Ahora es posible utilizar el modo exploración para páginas en Internet Explorer 10 cuando se esté en modo estándar; ej.: www.gmail.com login page. (#3151)
...
- Las subclasses del synthDriver sapi5  ahora pueden sobreescribirse _getVoiceTokens y extender __init__ para soportar fichas de voces personalizadas tales como con sapi.spObjectTokenCategory para obtener fichas de un registro personalizado.
