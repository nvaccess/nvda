...
O NonVisual Desktop Access (NVDA) é um leitor de ecrã livre e open source para o sistema operativo Microsoft Windows. Este software fornece às pessoas cegas o acesso a computadores que corram o Windows sem custos adicionais quando comparados aos das pessoas com visão. 
O NVDA permite ao utilizador saber o que está a aparecer no ecrã através da consulta do sistema operativo e usa um sintetizador de voz para transmitir a informação.
...
Copyright:
Copyright (C) 2006-2008 Contribuidores do NVDA <http://www.nvda-project.org/>
