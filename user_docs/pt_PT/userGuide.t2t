...
+ A janela de instalação do NVDA aparece com o acordo de licença.
Pressione "Seta abaixo" para ler o acordo de licença, se desejar.
+ Pressione "tab" para passar à caixa de verificação "Aceito" e pressione a "barra de espaços" para a marcar.
+ Pressione "tab" para se mover através das opções, depois pressione "Enter" na opção desejada.
+
...
+ Na primeira janela do instalador, certifique-se de que a caixa de verificação para concordar com a licença está marcada;
+ "Tab" até ao botão "Instalar o  NVDA neste computador" e active-o;
+ De seguida aparecem as opções para utilizar o NVDA durante o início de sessão no Windows e para criar um atalho no ambiente de trabalho;
...
+ Aparece uma janela "Controlo de Conta do Utilizador" (UAC) do Windows a perguntar "Deseja permitir que esta aplicação faça alterações no seu PC?";
+ Pressione "alt+y" para concordar com a solicitação UAC;
+ Uma barra de progresso é preenchida à medida que o NVDA se instala;
...
+ Aparece uma janela informando que a instalação do NVDA foi bem sucedida;
...
+ Pressione "tab" para passar para "Utilizar "CapsLock" como tecla modificadora do NVDA";
...
+ Utilize "tab" e "barra de espaços" para ajustar as outras opções nesta janela.
Estas configuram se o NVDA deve iniciar automaticamente.
+ Pressione "Enter" para fechar a janela com o NVDA já em execução.
+
...
+ Abrir o diálogo "Definir Comandos" a partir do modo de navegação;
+ Encontrar "mover para o próximo tab" item na secção "Modo de navegação";
+ Associar "y" como comando;
+ Encontrar "mover para o tab anterior" item na secção "Modo de navegação";
+ + Associar "shift+y" como comando.
+
...
+ Mova o cursor para o texto que contém a nota.
+ Aceda às opções para a selecção como descrito acima.
+ Escolha "Editar Nota".
+
...
%kc:setting
==== Abrir o diálogo de selecção de sintetizador ====
...
%kc:setting
==== Abrir o diálogo de selecção de dispositivo Braille ====
...
%kc:setting
==== Abrir configurações da apresentação de objectos ====
...
%kc:setting
==== Abrir configurações do modo de navegação ====
...
%kc:setting
==== Abrir configurações da formatação de documentos ====
...
Seguem-se as associações de teclas para estes dispositivos braille com o NVDA.
Por favor, consulte a documentação do seu dispositivo braille para obter a descrição de onde estas teclas podem ser encontradas.
+++ Comandos para todos os modelos +++
%kc:beginInclude
|| Nome | Tecla de atalho |
...
+++ Comandos para Brailliant BI 32, BI 40 e B 80 +++ 
%kc:beginInclude
|| Nome | Tecla de atalho |
...
+++ Comandos para Brailliant BI 14 +++
%kc:beginInclude
|| Nome | Tecla de atalho |
...
+ Certifique-se que tem instalada a [última versão do driver https://www.papenmeier-rehatechnik.de/en/service/downloadcenter/software/articles/software-braille-devices.html].
+ Abra o Gestor de dispositivos.
+ Pesquise na lista por "Controladores USB" ou "Dispositivos USB".
+ Seleccione "Papenmeier Braillex USB Device".
+ Abra as propriedades e vá para a aba Avançadas.
