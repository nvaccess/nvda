...
- Un ScriptableObject defect (cum ar fi un GlobalPlugin căruia îi lipsește un apel către metoda __init__ a clasei sale de bază) nu mai afectează manipularea scripturilor NVDA. (#5446)
...
= 2018.3.2 =
Aceasta este o versiune minoră care repară o eroare din Google Chrome la navigarea printre postări (tweet-uri) pe www.twitter.com. (#8777)
