...
### Run Accessibility registration repair tool... {#RunCOMRegistrationFixingTool}
...
The Accessibility registration repair tool attempts to fix these issues by repairing accessibility entries in the registry.
