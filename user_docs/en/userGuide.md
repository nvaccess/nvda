...
When checked, a dialog will appear when you attempt to exit NVDA, asking whether you want to exit, restart, restart with add-ons disabled and debug logging enabled, restart with debug logging enabled, or install pending updates (if any).
