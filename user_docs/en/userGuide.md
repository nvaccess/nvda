...
* The inability to interact with applications running with administrative privileges including Command Prompt and PowerShell running in admin mode and Windows 11 Voice Access, unless of course NVDA itself has been run also with these privileges (not recommended).
