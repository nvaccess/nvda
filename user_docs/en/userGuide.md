...
| Name |Key |Description|
|---|---|---|
| Get an AI-generated image description of the navigator object. | `NVDA+g` | Get a description of the navigator object provided by a recognition performed on the local device. |
