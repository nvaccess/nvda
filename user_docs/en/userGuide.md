...
* Automatic: This option causes NVDA to prefer Diff Match Patch (native) in most situations, but fall back to Difflib in problematic applications, such as older versions of the Windows Console and Mintty.
