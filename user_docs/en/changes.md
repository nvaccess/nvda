...
* A new "Reading order when navigating by line or Say All" option in Browse Mode settings allows choosing whether control information (role, state, etc.) is announced before or after content when navigating with the caret (arrow keys) or Say All. (#11103, #7232)
