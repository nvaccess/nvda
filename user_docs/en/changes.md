...
* Add the `locationHelper.RectLTWH.union` and `locationHelper.RectLTRB.union` methods, which are used to create a rectangle that contains all the other rectangles. (#20705, @hwf1324)
