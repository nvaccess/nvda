...
* A new "Control announcement order when reading" option in Browse Mode settings allows choosing whether control information (role, state, etc.) is announced before or after content when reading with the caret (e.g. by line, paragraph, or sentence) or Say All. (#7232)
