...
* When an application stops responding, NVDA no longer freezes or floods its log with errors; it stays responsive and drops UI Automation and MSAA events from the unresponsive application until it recovers. (#16749, @heath-toby)
