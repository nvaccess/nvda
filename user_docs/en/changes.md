...
* In Microsoft Word with UIA enabled, pressing `NVDA+F10` twice to copy text selected from the review cursor no longer truncates large selections. (#20304, @cary-rowen)
