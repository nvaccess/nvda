...
* When spelling, unicode normalization no longer incorrectly reports subsequent characters as normalized after reporting a normalized character. (#17286, @LeonarddeR)
