...
By default, when lines are skipped in a large text flood, NVDA emits a beep proportional to the length of the skipped material. This can be disabled in the advanced settings panel.
