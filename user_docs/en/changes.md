...
* Added support for reading mathematical content using the newly built-in MathCAT engine. (#18323, #19227, #19230, #19231, #19232, @RyanMcCleary, @codeofdusk)
  * The speech style, Braille code, and other options for this feature may be configured in the new "mathematics" settings panel.
