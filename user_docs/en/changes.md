...
* A new "Say all reads by" speech setting lets you choose whether say all reads by sentence or line; say all now reads by sentence by default again where supported. (#13420, #9179, #13971, @LeonarddeR)
