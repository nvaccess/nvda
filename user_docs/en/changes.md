...
*  The maximum value for the "Maximum number of characters on one line" setting in the Browse Mode settings panel has been increased from 250 to 1000, so browse mode splits long paragraphs less often when screen layout is enabled. (#20478, @Rasaec5)
