...
* In live text regions, such as terminals, NVDA no longer freezes when substantial amounts of text are dumped to the screen. (#20177, #20649, @ethindp, @codeofdusk)
 default, when lines are skipped in a large text flood, NVDA emits a beep proportional to the length of the skipped material. This can be disabled in the advanced settings panel.
