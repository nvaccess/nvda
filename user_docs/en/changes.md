...
* NVDA can report the language of the text being read when automatic language switching is enabled. An unassigned gesture has been added to report the language of the character under caret (#17664, @nvdaes)
