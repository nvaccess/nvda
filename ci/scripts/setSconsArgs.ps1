...
$sconsControllerClientOutTargets = "client"
...
Write-Output "sconsControllerClientOutTargets=$sconsControllerClientOutTargets" | Out-File -FilePath $env:GITHUB_ENV -Encoding utf8 -Append
...
Write-Host "scons controller client output targets: $sconsControllerClientOutTargets"
