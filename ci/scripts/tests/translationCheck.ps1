cmd.exe /c "scons checkPot $sconsArgs --all-cores" >> $env:GITHUB_STEP_SUMMARY
if($LastExitCode -ne 0) {
	$message = "FAIL: Translation comments check. Translation comments missing or unexpectedly included."
