...
from .types import Coordinates, MagnifierFollowTrackingType
...
class FocusManager:
	...
	def __init__(self):
		...
		self._lastFocusedObject: MagnifierFollowTrackingType | None = None
	...
	def getCurrentFocusCoordinates(self) -> Coordinates:
		...
		isFollowMouse = getFollowState(MagnifierFollowTrackingType.MOUSE)
		isFollowSystemFocus = getFollowState(MagnifierFollowTrackingType.SYSTEM_FOCUS)
		isFollowReviewCursor = getFollowState(MagnifierFollowTrackingType.REVIEW)
		isFollowNavigatorObject = getFollowState(MagnifierFollowTrackingType.NAVIGATOR_OBJECT)
		...
		if (isClickPressed or mouseChanged) and isFollowMouse:
			self._lastFocusedObject = MagnifierFollowTrackingType.MOUSE
		...
		if navigatorChanged and systemFocusChanged and not reviewChanged and isFollowNavigatorObject:
			self._lastFocusedObject = MagnifierFollowTrackingType.NAVIGATOR_OBJECT
		...
		if systemFocusChanged and isFollowSystemFocus:
			self._lastFocusedObject = MagnifierFollowTrackingType.SYSTEM_FOCUS
		...
		if reviewChanged and isFollowReviewCursor and reviewPosition is not None:
			self._lastFocusedObject = MagnifierFollowTrackingType.REVIEW
		...
		_sources = (
			(MagnifierFollowTrackingType.MOUSE, isFollowMouse, mousePosition),
			(MagnifierFollowTrackingType.SYSTEM_FOCUS, isFollowSystemFocus, systemFocusPosition),
			(MagnifierFollowTrackingType.REVIEW, isFollowReviewCursor, reviewEffectivePosition),
			(MagnifierFollowTrackingType.NAVIGATOR_OBJECT, isFollowNavigatorObject, navigatorPosition),
		)
	...
	def getLastFocusType(self) -> MagnifierFollowTrackingType | None:
		"""
