...
IEnumOLEVERB._methods_ = [
	...
	COMMETHOD([], HRESULT, "Skip", (["in"], c_ulong, "celt")),  # noqa: F405
	COMMETHOD([], HRESULT, "Reset"),
	COMMETHOD([], HRESULT, "Clone", (["out"], POINTER(POINTER(IEnumOLEVERB)), "ppenum")),  # noqa: F405
]
...
IEnumUnknown._methods_ = [
	...
	COMMETHOD([], HRESULT, "Skip", (["in"], c_ulong, "celt")),  # noqa: F405
	COMMETHOD([], HRESULT, "Reset"),
	COMMETHOD([], HRESULT, "Clone", (["out"], POINTER(POINTER(IEnumUnknown)), "ppenum")),  # noqa: F405
]
...
IOleContainer._methods_ = [
	...
	COMMETHOD([], HRESULT, "LockContainer", (["in"], c_int, "fLock")),  # noqa: F405
]
...
IOleObject._methods_ = [
	COMMETHOD([], HRESULT, "SetClientSite", (["in"], POINTER(IOleClientSite), "pClientSite")),  # noqa: F405
	COMMETHOD([], HRESULT, "GetClientSite", (["out"], POINTER(POINTER(IOleClientSite)), "ppClientSite")),  # noqa: F405
	COMMETHOD(
		[], HRESULT, "SetHostNames", (["in"], WSTRING, "szContainerApp"), (["in"], WSTRING, "szContainerObj")
	),
	COMMETHOD([], HRESULT, "Close", (["in"], c_ulong, "dwSaveOption")),  # noqa: F405
	COMMETHOD(
		[],
		HRESULT,
		"SetMoniker",
	...
	COMMETHOD([], HRESULT, "EnumVerbs", (["out"], POINTER(POINTER(IEnumOLEVERB)), "ppEnumOleVerb")),  # noqa: F405
	COMMETHOD([], HRESULT, "Update"),
	COMMETHOD([], HRESULT, "IsUpToDate"),
	COMMETHOD([], HRESULT, "GetUserClassID", (["out"], POINTER(GUID), "pClsid")),  # noqa: F405
	COMMETHOD(
		[],
		HRESULT,
		"GetUserType",
	...
	COMMETHOD([], HRESULT, "Unadvise", (["in"], c_ulong, "dwConnection")),  # noqa: F405
	COMMETHOD([], HRESULT, "EnumAdvise", (["out"], POINTER(POINTER(IEnumSTATDATA)), "ppenumAdvise")),  # noqa: F405
	COMMETHOD(
		[],
		HRESULT,
		"GetMiscStatus",
	...
	COMMETHOD([], HRESULT, "SetColorScheme", (["in"], POINTER(tagLOGPALETTE), "pLogpal")),  # noqa: F405
]
...
IOleClientSite._methods_ = [
	...
	COMMETHOD([], HRESULT, "GetContainer", (["out"], POINTER(POINTER(IOleContainer)), "ppContainer")),  # noqa: F405
	COMMETHOD([], HRESULT, "ShowObject"),
	COMMETHOD([], HRESULT, "OnShowWindow", (["in"], c_int, "fShow")),  # noqa: F405
...
IDataObject._methods_ = [
	...
	COMMETHOD([], HRESULT, "QueryGetData", (["in"], POINTER(tagFORMATETC), "pformatetc")),  # noqa: F405
	COMMETHOD(
		[],
		HRESULT,
	...
	COMMETHOD([], HRESULT, "DUnadvise", (["in"], c_ulong, "dwConnection")),  # noqa: F405
	COMMETHOD([], HRESULT, "EnumDAdvise", (["out"], POINTER(POINTER(IEnumSTATDATA)), "ppenumAdvise")),  # noqa: F405
]
...
IAdviseSink._methods_ = [
	...
	COMMETHOD([], HRESULT, "RemoteOnRename", (["in"], POINTER(IMoniker), "pmk")),  # noqa: F405
...
assert sizeof(__MIDL___MIDL_itf_oleTypes_0005_0001_0001) == 16, sizeof(
	__MIDL___MIDL_itf_oleTypes_0005_0001_0001
)  # noqa: F405
assert alignment(__MIDL___MIDL_itf_oleTypes_0005_0001_0001) == 4, alignment(
	__MIDL___MIDL_itf_oleTypes_0005_0001_0001
)  # noqa: F405
...
IEnumSTATDATA._methods_ = [
	...
	COMMETHOD([], HRESULT, "Skip", (["in"], c_ulong, "celt")),  # noqa: F405
	COMMETHOD([], HRESULT, "Reset"),
	COMMETHOD([], HRESULT, "Clone", (["out"], POINTER(POINTER(IEnumSTATDATA)), "ppenum")),  # noqa: F405
]
tagSIZEL._fields_ = [
	("cx", c_int),  # noqa: F405
	("cy", c_int),  # noqa: F405
...
IEnumFORMATETC._methods_ = [
	...
	COMMETHOD([], HRESULT, "Skip", (["in"], c_ulong, "celt")),  # noqa: F405
	COMMETHOD([], HRESULT, "Reset"),
	COMMETHOD([], HRESULT, "Clone", (["out"], POINTER(POINTER(IEnumFORMATETC)), "ppenum")),  # noqa: F405
]
