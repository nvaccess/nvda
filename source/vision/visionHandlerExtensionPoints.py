...
class EventExtensionPoints:
	...
	#: Handlers are called with one argument.
	#: @param rect: The screen rectangle of the current math navigation position, or C{None} if there is no current position.
	#: @type rect: Optional[L{locationHelper.RectLTRB}]
