...
#Copyright (C) 2006-2016 NV Access Limited, Aleksey Sadovoy, Christopher Toth, Joseph Lee, Peter Vágner, Zahari Yurukov, Babbage B.v.
...
"""
	...
	try:
		...
		# execute pending update, if any and the user agrees
