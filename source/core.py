...
"""
	...
	# #8661 (Py3 review required): just pull versionInfo.name directly.
	# Py2: messageWindow = MessageWindow(unicode(versionInfo.name))
	# Py3: messageWindow = MessageWindow(versionInfo.name) or call str if appropriate.
