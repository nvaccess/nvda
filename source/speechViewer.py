...
class SpeechViewerFrame(
	...
	def _createControls(self, sizer, parent):
		self.textCtrl = wx.TextCtrl(parent, style=wx.TE_RICH2 | wx.TE_READONLY | wx.TE_MULTILINE)
		...
		sizer.Add(self.shouldShowOnStartupCheckBox, border=5, flag=wx.EXPAND | wx.ALL)
...
def _setActive(isNowActive: bool, speechViewerFrame: Optional[SpeechViewerFrame] = None) -> None:
