...
def processNegativeStates(role, states, reason, negativeStates=None):
	...
	if role in (ROLE_LISTITEM, ROLE_TREEVIEWITEM, ROLE_TABLEROW, ROLE_CHECKBOX) and STATE_SELECTABLE in states and (reason != REASON_CHANGE or STATE_FOCUSED in states):
