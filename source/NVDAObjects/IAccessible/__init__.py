...
"""
	...
	def findBestClass(cls,clsList,kwargs):
		...
		# Some special cases.
		if (windowClassName == "MozillaWindowClass" and not isinstance(IAccessibleObject, IAccessibleHandler.IAccessible2) and role == oleacc.ROLE_SYSTEM_TEXT) or windowClassName in ("MacromediaFlashPlayerActiveX", "ApolloRuntimeContentWindow", "ShockwaveFlash", "ShockwaveFlashPlugin", "ShockwaveFlashLibrary"):
