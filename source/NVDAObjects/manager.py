...
("MozillaWindowClass",ROLE_SYSTEM_TEXT):MSAA.NVDAObject_mozillaText,
("MozillaContentWindowClass",ROLE_SYSTEM_TEXT):MSAA.NVDAObject_mozillaText,
("MozillaWindowClass",ROLE_SYSTEM_LISTITEM):MSAA.NVDAObject_mozillaListItem,
("MozillaContentWindowClass",ROLE_SYSTEM_LISTITEM):MSAA.NVDAObject_mozillaListItem,
("MozillaWindowClass","h1"):MSAA.NVDAObject_mozillaHeading,
("MozillaWindowClass","h2"):MSAA.NVDAObject_mozillaHeading,
("MozillaWindowClass","h3"):MSAA.NVDAObject_mozillaHeading,
("MozillaWindowClass","h4"):MSAA.NVDAObject_mozillaHeading,
("MozillaWindowClass","h5"):MSAA.NVDAObject_mozillaHeading,
("MozillaWindowClass","h6"):MSAA.NVDAObject_mozillaHeading,
