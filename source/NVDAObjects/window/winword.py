	...
	def activate(self):
		...
		if newRng.InlineShapes.Count >= 1:
			if newRng.InlineShapes[1].Type==wdInlineShapeChart:
				return eventHandler.queueEvent('gainFocus',_msOfficeChartConstants.OfficeChart(windowHandle=self.obj.windowHandle, officeApplicationObject=self.obj.WinwordDocumentObject.Application, officeShapeObject=newRng.InlineShapes[1]))
