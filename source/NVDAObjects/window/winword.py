...
class WordDocumentCommentQuickNavItem(WordDocumentCollectionQuickNavItem):
	...
	def label(self):
		...
		# Translators: The text shown for a comment in the NVDA Elements List dialog in Microsoft Word.
...
class WordDocumentRevisionQuickNavItem(WordDocumentCollectionQuickNavItem):
	...
	def label(self):
		...
		# Translators: The text shown for an editor revision (tracked change)  in the NVDA Elements List dialog in Microsoft Word.
...
class WordDocumentSpellingErrorQuickNavItem(WordDocumentCollectionQuickNavItem):
	...
	def label(self):
		...
		# Translators: The text shown for a spelling error in the NVDA Elements List dialog in Microsoft Word.
