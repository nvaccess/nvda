	...
	def _getChartElementText(self, ElementID ,arg1,arg2 , reportExtraInfo=False ):
		if ElementID == xlSeries:
			if arg2 == -1:
				...
				if isinstance( self.officeChartObject.SeriesCollection(arg1).XValues[arg2 - 1] , float): 
					chartSeriesXValue = int(self.officeChartObject.SeriesCollection(arg1).XValues[arg2 - 1] )
				else:
