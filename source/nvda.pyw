...
parser.add_argument('-l','--log-level',dest='logLevel',type=int,default=0,choices=[10, 20, 30, 40, 50, 100],help="The lowest level of message logged (debug 10, info 20, warning 30, error 40, critical 50, off 100), default is warning")
...
parser.add_argument('--no-logging',action="store_true",dest='noLogging',default=False,help="Disable logging completely for this run. This setting will override any other log level (--loglevel, -l) argument given.")
