...
parser.add_option('--start-after-install',action="store_true",dest='startAfterInstall',default=True,help="If installing NVDA, starts the new copy after installation")
