...
parser.add_argument('-f','--log-file',dest='logFileName',type=unicode,help="The file where log messages should be written to")
...
parser.add_argument('-c','--config-path',dest='configPath',default=None,type=unicode,help="The path where all settings for NVDA are stored")
