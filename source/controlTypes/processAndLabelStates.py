...
def _processPositiveStates(
	role: Role, states: Set[State], reason: OutputReason, positiveStates: Optional[Set[State]] = None
) -> Set[State]:
...
def _processNegativeStates(
	role: Role, states: Set[State], reason: OutputReason, negativeStates: Optional[Set[State]] = None
) -> Set[State]:
