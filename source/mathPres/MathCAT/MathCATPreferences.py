...
class UserInterface(MathCATgui.MathCATPreferencesDialog):
	...
	def languagesSet() -> frozenset[str]:
		...
		This set includes standard language codes, as well as regional variants such as
		'en-GB', 'zh-HANT', and others.

		:return: A set frozenset of supported language codes (e.g., 'en', 'fr', 'zh-HANS').
		"""
		languages = frozenset([
			"aa", "ab", "af", "ak",
			"an", "ar", "as", "av",
