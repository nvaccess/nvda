...
class MathPlayerInteraction(mathPres.MathInteractionNVDAObject):
	...
	def reportFocus(self):
		...
		speech.speak(_processMpSpeech(self.provider._mpSpeech.GetSpokenText(), self.provider._language))
	...
	def script_navigate(self, gesture):
		...
		try:
			text = self.provider._mpNavigation.DoNavigateKeyPress(
				gesture.vkCode, "shift" in modNames, "control" in modNames, "alt" in modNames, False
			)
		except COMError:
			return
