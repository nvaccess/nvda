...
a+'">\x3c/script>');return!0}return!1},goog.writeScripts_=function(){function a(e){if(!(e in d.written)){if(!(e in d.visited)&&(d.visited[e]=!0,e in d.requires))for(var g in d.requires[e])if(!goog.isProvided_(g))if(g in d.nameToPath)a(d.nameToPath[g]);else throw Error("Undefined nameToPath for "+g);e in c||(c[e]=!0,b.push(e))}}var b=[],c={},d=goog.dependencies_;console.log(process.cwd());for(var e in goog.included_)d.written[e]||a(e);for(e=0;e<b.length;e++)if(b[e])goog.importScript_(goog.basePath+
...
sre.SemanticTree.prototype.xml=function(a){var b=(new sre.SystemExternal.xmldom.DOMParser).parseFromString("<stree></stree>","text/xml");a=this.root.xml(b,a);b.childNodes[0].appendChild(a);return b};
...
"ancestor::fraction|ancestor::punctuated|ancestor::fenced|ancestor::root|ancestor::sqrt|ancestor::relseq|ancestor::multirel|self::tensor[@embellished]"].concat(c);sre.MathspeakRules.defineRuleAlias_.apply(null,d)}};sre.CombinedStore=function(){};goog.addSingletonGetter(sre.CombinedStore);sre.CombinedStore.mathStore=sre.MathmlStore.getInstance();sre.CombinedStore.mathStore.initialize=function(){sre.MathmlStoreRules.getInstance();sre.SemanticTreeRules.getInstance();sre.MathspeakRules.getInstance();sre.ClearspeakRules.getInstance();sre.CombinedStore.getInstance().updateEngine()};
...
sre.AuditoryDescription.toNvdaString=function(a,b){var c=""===b?"":b||" ";sre.AuditoryDescription.preprocessDescriptionList(a);return sre.BaseUtil.removeEmpty(a.map(function(a){return a.personality&&a.personality.PAUSE?'<break time = "'+a.personality.PAUSE+'ms"/>':a.descriptionString()})).join(c)};sre.AuditoryDescription.toSimpleString=function(a,b){var c=""===b?"":b||" ";sre.AuditoryDescription.preprocessDescriptionList(a);return sre.BaseUtil.removeEmpty(a.map(function(a){return a.descriptionString()})).join(c)};
...
sre.EnrichMathml.Attribute={ADDED:sre.EnrichMathml.ATTRIBUTE_PREFIX_+"added",CHILDREN:sre.EnrichMathml.ATTRIBUTE_PREFIX_+"children",COLLAPSED:sre.EnrichMathml.ATTRIBUTE_PREFIX_+"collapsed",CONTENT:sre.EnrichMathml.ATTRIBUTE_PREFIX_+"content",EMBELLISHED:sre.EnrichMathml.ATTRIBUTE_PREFIX_+"embellished",FENCEPOINTER:sre.EnrichMathml.ATTRIBUTE_PREFIX_+"fencepointer",FONT:sre.EnrichMathml.ATTRIBUTE_PREFIX_+"font",ID:sre.EnrichMathml.ATTRIBUTE_PREFIX_+"id",OPERATOR:sre.EnrichMathml.ATTRIBUTE_PREFIX_+"operator",
PARENT:sre.EnrichMathml.ATTRIBUTE_PREFIX_+"parent",ROLE:sre.EnrichMathml.ATTRIBUTE_PREFIX_+"role",SPEECH:sre.EnrichMathml.ATTRIBUTE_PREFIX_+"speech",TYPE:sre.EnrichMathml.ATTRIBUTE_PREFIX_+"type"};sre.EnrichMathml.enrich=function(a,b){sre.Engine.getInstance().speech&&sre.EnrichMathml.computeSpeech(b);var c=a.cloneNode(!0);sre.EnrichMathml.walkTree(b.root);sre.Debugger.getInstance().generateOutput(function(){sre.EnrichMathml.formattedOutput(c,a,b,!0);return[]});return a};
...
b.parent&&a.setAttribute(sre.EnrichMathml.Attribute.PARENT,b.parent.id);b.embellished&&a.setAttribute(sre.EnrichMathml.Attribute.EMBELLISHED,b.embellished);b.fencePointer&&a.setAttribute(sre.EnrichMathml.Attribute.FENCEPOINTER,b.fencePointer);sre.Engine.getInstance().speech&&sre.EnrichMathml.addSpeech(a,b)};
...
sre.EnrichMathml.removeAttributePrefix=function(a){return a.toString().replace(new RegExp(sre.EnrichMathml.ATTRIBUTE_PREFIX_,"g"),"")};sre.EnrichMathml.printNodeList__=function(a,b){console.log(a);sre.DomUtil.toArray(b).forEach(function(a){console.log(a.toString())});console.log("<<<<<<<<<<<<<<<<<")};sre.EnrichMathml.computeSpeech=function(a){var b=sre.SpeechRuleEngine.getInstance();b.clearCache();a=sre.DomUtil.parseInput(a.toString(),sre.EnrichMathml.Error);b.evaluateNode(a)};
sre.EnrichMathml.recomputeSpeech=function(a,b){var c=sre.SemanticTree.fromNode(b),c=sre.DomUtil.parseInput(c.toString(),sre.EnrichMathml.Error);return sre.SpeechRuleEngine.getInstance().evaluateNode(c)};sre.EnrichMathml.addSpeech=function(a,b){var c=sre.SpeechRuleEngine.getInstance().getCache(b.id.toString());c||(c=sre.EnrichMathml.recomputeSpeech(a,b));c=sre.AuditoryDescription.toNvdaString(c);a.setAttribute(sre.EnrichMathml.Attribute.SPEECH,c)};sre.CaseDoubleScript=function(a){sre.AbstractEnrichCase.call(this,a);this.mml=a.mathmlTree};goog.inherits(sre.CaseDoubleScript,sre.AbstractEnrichCase);sre.CaseDoubleScript.test=function(a){if(!a.mathmlTree)return!1;var b=sre.SemanticUtil.tagName(a.mathmlTree);return"MSUBSUP"===b&&a.type===sre.SemanticAttr.Type.SUPERSCRIPT||"MUNDEROVER"===b&&a.type===sre.SemanticAttr.Type.OVERSCORE};
...
sre.WalkerUtil.getBySemanticId=function(a,b){return a.querySelector?a.querySelector("["+sre.EnrichMathml.Attribute.ID+'="'+b+'"]'):sre.XpathUtil.evalXPath(".//*[@"+sre.EnrichMathml.Attribute.ID+'="'+b+'"]',a)[0]};sre.SpeechGeneratorInterface=function(){};sre.SpeechGeneratorInterface.prototype.getSpeech=function(a){};sre.SpeechGeneratorInterface.prototype.start=function(){};sre.SpeechGeneratorInterface.prototype.end=function(){};sre.AbstractSpeechGenerator=function(){};sre.AbstractSpeechGenerator.prototype.start=function(){};sre.AbstractSpeechGenerator.prototype.end=function(){};sre.DirectSpeechGenerator=function(){sre.AbstractSpeechGenerator.call(this)};goog.inherits(sre.DirectSpeechGenerator,sre.AbstractSpeechGenerator);sre.DirectSpeechGenerator.prototype.getSpeech=function(a){return sre.WalkerUtil.getAttribute(a,sre.EnrichMathml.Attribute.SPEECH)};sre.Focus=function(a){this.nodes_=a.nodes?a.nodes:[];this.primary_=a.primary?a.primary:null};sre.Focus.prototype.getNodes=function(){return this.nodes_};sre.Focus.prototype.getPrimary=function(){return this.primary_};sre.EventUtil={};sre.EventUtil.KeyCode={RETURN:13,ENTER:13,ESC:27,SPACE:32,LEFT:37,UP:38,RIGHT:39,DOWN:40,TAB:9,A:65,B:66,C:67,D:68,E:69,F:70,G:71,H:72,I:73,J:74,K:75,L:76,M:77,N:78,O:79,P:80,Q:81,R:82,S:83,T:84,U:85,V:86,W:87,X:88,Y:89,Z:90};
...
sre.SyntaxWalker.prototype.left=function(){var a=this.levels.indexOf(this.primaryId())-1;return(a=this.levels.get(a))?this.focusFromId_(a):null};sre.SyntaxWalker.prototype.right=function(){var a=this.levels.indexOf(this.primaryId())+1;return(a=this.levels.get(a))?this.focusFromId_(a):null};sre.DummyWalker=function(a,b){sre.AbstractWalker.call(this,a,b)};goog.inherits(sre.DummyWalker,sre.AbstractWalker);sre.DummyWalker.prototype.up=function(){};sre.DummyWalker.prototype.down=function(){};sre.DummyWalker.prototype.left=function(){};sre.DummyWalker.prototype.right=function(){};sre.RebuildStree=function(a){this.mathml=a;this.mmlRoot=sre.WalkerUtil.getSemanticRoot(a);this.streeRoot=this.assembleTree(this.mmlRoot);this.stree=sre.SemanticTree.fromNode(this.streeRoot,this.mathml);(new sre.SystemExternal.xmldom.DOMParser).parseFromString("<stree></stree>","text/xml");return this.stree};
sre.RebuildStree.prototype.assembleTree=function(a){var b=sre.RebuildStree.makeNode(a),c=sre.WalkerUtil.splitAttribute(sre.WalkerUtil.getAttribute(a,sre.EnrichMathml.Attribute.CHILDREN)),d=sre.WalkerUtil.splitAttribute(sre.WalkerUtil.getAttribute(a,sre.EnrichMathml.Attribute.CONTENT));if(0===d.length&&0===c.length)return b.textContent=a.textContent,b;if(0<d.length){var e=sre.WalkerUtil.getBySemanticId(a,d[0]);e&&(e=sre.WalkerUtil.splitAttribute(sre.WalkerUtil.getAttribute(e,sre.EnrichMathml.Attribute.OPERATOR)),
1<e.length&&(b.textContent=e[1]))}e=function(c){c=sre.WalkerUtil.getBySemanticId(a,c);c=this.assembleTree(c);c.parent=b;return c};b.contentNodes=d.map(goog.bind(e,this));b.childNodes=c.map(goog.bind(e,this));return(c=sre.WalkerUtil.getAttribute(a,sre.EnrichMathml.Attribute.COLLAPSED))?sre.RebuildStree.postProcess(b,c):b};
sre.RebuildStree.makeNode=function(a){var b=sre.WalkerUtil.getAttribute(a,sre.EnrichMathml.Attribute.TYPE),c=sre.WalkerUtil.getAttribute(a,sre.EnrichMathml.Attribute.ROLE),d=sre.WalkerUtil.getAttribute(a,sre.EnrichMathml.Attribute.FONT),e=sre.WalkerUtil.getAttribute(a,sre.EnrichMathml.Attribute.ID),f=sre.WalkerUtil.getAttribute(a,sre.EnrichMathml.Attribute.EMBELLISHED);a=sre.WalkerUtil.getAttribute(a,sre.EnrichMathml.Attribute.FENCEPOINTER);e=new sre.SemanticTree.Node(parseInt(e,10));e.type=b;e.role=
c;e.font=d?d:sre.SemanticAttr.Font.UNKNOWN;a&&(e.fencePointer=a);f&&(e.embellished=f);return e};
sre.RebuildStree.postProcess=function(a,b){var c=sre.RebuildStree.parseCollapsed_(b);if(a.type===sre.SemanticAttr.Role.SUBSUP){var d=new sre.SemanticTree.Node(c[1][0]);d.type=sre.SemanticAttr.Type.SUBSCRIPT;d.role=sre.SemanticAttr.Role.SUBSUP;a.type=sre.SemanticAttr.Type.SUPERSCRIPT;d.embellished=a.embellished;d.fencePointer=a.fencePointer;sre.RebuildStree.collapsedChildren_(a,[d],c);return a}a.type===sre.SemanticAttr.Role.UNDEROVER&&(d=new sre.SemanticTree.Node(c[1][0]),d.type=sre.SemanticAttr.Type.UNDERSCORE,
d.role=sre.SemanticAttr.Role.UNDEROVER,a.type=sre.SemanticAttr.Type.OVERSCORE,d.embellished=a.embellished,d.fencePointer=a.fencePointer,sre.RebuildStree.collapsedChildren_(a,[d],c));return a};sre.RebuildStree.collapsedChildren_=function(a,b,c){b.unshift(a);b=b.concat(a.childNodes);var d={};a=0;for(var e;e=b[a];a++)d[e.id]=e;var f=function(a){var b=d[a[0]];b.childNodes=[];for(var c=1,e=a.length;c<e;c++)"number"===typeof a[c]?b.childNodes.push(d[a[c]]):b.childNodes.push(f(a[c]));return b};f(c)};
sre.RebuildStree.parseCollapsed_=function(a){a=a.replace(/\(/g,"[");a=a.replace(/\)/g,"]");a=a.replace(/ /g,",");return JSON.parse(a)};sre.RebuildStree.experiment__=function(a){var b=sre.DomUtil.parseInput("<math>"+a+"</math>");console.log(b.toString());var c=new sre.SemanticTree(b);a=c.toString();b=sre.EnrichMathml.enrich(b,c);b=(new sre.RebuildStree(b)).toString();return a===b};sre.System=function(){this.version="0.8";this.speechGenerator=this.walker=null};goog.addSingletonGetter(sre.System);sre.System.Error=function(a){Error.call(this);this.message=a||"";this.name="System Error"};goog.inherits(sre.System.Error,Error);
sre.System.prototype.setupEngine=function(a){var b=sre.Engine.getInstance();b.mode=a.mode||b.mode;sre.System.prototype.configBlocks_(a);b.style=a.style||b.style;b.domain=a.domain||b.domain;b.semantics=!!a.semantics;void 0!==a.cache&&(b.withCache=!!a.cache);b.speech=!!a.speech;a.json&&(sre.SystemExternal.jsonPath=a.json);sre.SpeechRuleEngine.getInstance().parameterize(sre.MathmlStore.getInstance());sre.SpeechRuleEngine.getInstance().dynamicCstr=sre.MathStore.createDynamicConstraint(b.domain,b.style)};
sre.System.prototype.configBlocks_=function(a){if(sre.Engine.getInstance().mode===sre.Engine.Mode.HTTP)for(var b=document.rootNode.querySelectorAll('script[type="text/x-sre-config"]'),c=0,d=b.length;c<d;c++)try{var e=b[c].innerHTML,f=JSON.parse(e),g;for(g in f)a[g]=f[g]}catch(h){sre.Debugger.getInstance().output("Illegal configuration ",e)}};
...
sre.System.prototype.processFile_=function(a,b,c){b=sre.System.getInstance().inputFile_(b);a=a(b);if(c)try{sre.SystemExternal.fs.writeFileSync(c,a)}catch(d){throw new sre.System.Error("Can not write to file: "+c);}else console.log(a)};
sre.System.prototype.walk=function(a){this.speechGenerator=new sre.DirectSpeechGenerator;sre.System.getInstance().parseExpression_(a,!1);sre.Engine.getInstance().speech=!0;a=sre.System.getInstance().toEnriched(a);a=sre.DomUtil.parseInput(a,sre.System.Error);this.walker=new sre.SyntaxWalker(a,this.speechGenerator);return this.walker.speech()};sre.System.prototype.move=function(a){return!1===this.walker.move(a)?null:this.walker.speech()};sre.Api={};sre.Api.toSpeech=function(a){return sre.System.getInstance().toSpeech(a)};module.exports.processExpression=sre.Api.toSpeech;module.exports.toSpeech=sre.Api.toSpeech;module.exports.toSemantic=sre.System.getInstance().toSemantic;module.exports.toJson=sre.System.getInstance().toJson;module.exports.toDescription=sre.System.getInstance().toDescription;module.exports.toEnriched=sre.System.getInstance().toEnriched;module.exports.walk=sre.System.getInstance().walk;module.exports.move=sre.System.getInstance().move;
