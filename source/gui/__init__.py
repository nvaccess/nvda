...
class SysTrayIcon(wx.TaskBarIcon):
	...
	def __init__(self, frame):
		...
		self.menu=wx.Menu()
		menu_NVDA = wx.Menu()
		item = menu_NVDA.Append(wx.ID_ANY, _("&Revert to saved configuration"),_("Reset all settings to saved state"))
		self.Bind(wx.EVT_MENU, frame.onRevertToSavedConfigurationCommand, item)
		item = menu_NVDA.Append(wx.ID_SAVE, _("&Save configuration"), _("Write the current configuration to nvda.ini"))
		...
		self.menu.AppendMenu(wx.ID_ANY,_("&NVDA"),menu_NVDA)
