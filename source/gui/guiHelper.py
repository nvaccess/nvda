...
def associateElements(firstElement: wx.Control, secondElement: wx.Control) -> wx.BoxSizer:
	...
	# staticText and (ListCtrl, ListBox or TreeCtrl)
		...
		secondElement, (wx.ListCtrl, wx.ListBox, wx.TreeCtrl)
	):
...
class BoxSizerHelper:
	...
	def addLabeledControl(
		self, labelText: str, wxCtrlClass: Type[_LabeledControlT], **kwargs
	) -> _LabeledControlT:
	...
	def addDialogDismissButtons(self, buttons: "_ButtonsT", separated: bool = False) -> "_ButtonsT":
