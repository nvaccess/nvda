...
class AddonCompatibilityDialog(wx.Dialog):
	"""A dialog that allows add-ons to be blacklisted or whitelisted,
	and lists the add-ons that are unsupported by NVDA."""
	_instance = None
	def __new__(cls, *args, **kwargs):
		if AddonsDialog._instance is None:
			return super(AddonsDialog, cls).__new__(cls, *args, **kwargs)
