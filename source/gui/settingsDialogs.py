...
class MathSettingsPanel(SettingsPanel):
	...
	title = pgettext("math", "Mathematics")
	helpId = "MathSettings"
	...
	def makeSettings(self, settingsSizer: wx.BoxSizer) -> None:
		...
		speechSoundText = pgettext("math", "Make a sound when starting/ending mathematical speech")
		...
		speechForChemicalText = pgettext("math", "Speech for chemical formulae:")
		...
		navSpeechText = pgettext("math", "When navigating to an equation:")
		...
		navCopyAsText = pgettext("math", "Copy mathematical content as:")
