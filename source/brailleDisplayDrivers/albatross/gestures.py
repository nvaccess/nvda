...
_gestureMap = inputCore.GlobalGestureMap(
	{
		"globalCommands.GlobalCommands": {
			...
			"navigatorObject_toFocus": (
				"br(albatross):eCursor1",
				"br(albatross):eCursor2",
			),
			"braille_toFocus": (
				"br(albatross):cursor1",
				"br(albatross):cursor2",
			),
			...
			"activateBrailleSettingsDialog": (
				"br(albatross):f1+home1",
				"br(albatross):f9+home2",
			),
			"reviewCursorToStatusLine": (
				"br(albatross):f1+end1",
				"br(albatross):f9+end2",
			),
			"braille_cycleCursorShape": (
				"br(albatross):f1+eCursor1",
				"br(albatross):f9+eCursor2",
			),
			"braille_toggleShowCursor": (
				"br(albatross):f1+cursor1",
				"br(albatross):f9+cursor2",
			),
			...
			"review_previousLine": (
				"br(albatross):lWheelUp",
				"br(albatross):rWheelUp",
			),
			"review_nextLine": (
				"br(albatross):lWheelDown",
				"br(albatross):rWheelDown",
			),
