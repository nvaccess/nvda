...
keyMap={
(frozenset(["Insert"]),"Q"):script_quit,
(None,"Up"):script_navigator_line_current,
(None,"Home"):script_navigator_line_previous,
(None,"Prior"):script_navigator_line_next,
(None,"Down"):script_navigator_character_current,
(None,"End"):script_navigator_character_previous,
(None,"Next"):script_navigator_character_next,
(frozenset(["Insert"]),"Clear"):script_navigator_object_current,
(frozenset(["Insert"]),"Up"):script_navigator_object_parent,
(frozenset(["Insert"]),"Down"):script_navigator_object_firstChild,
(frozenset(["Insert"]),"Left"):script_navigator_object_previous,
(frozenset(["Insert"]),"Right"):script_navigator_object_next,
(frozenset(["Insert","Shift"]),"Left"):script_navigator_object_left,
(frozenset(["Insert","Shift"]),"Right"):script_navigator_object_right,
(frozenset(["Insert","Shift"]),"Up"):script_navigator_object_up,
(frozenset(["Insert","Shift"]),"Down"):script_navigator_object_down,
(frozenset(["Insert"]),"ExtendedReturn"):script_navigator_object_doDefaultAction,
(frozenset(["Insert"]),"Add"):script_navigator_object_recursive,
(frozenset(["Insert","Shift"]),"Add"):script_navigator_object_where,
(None,"ExtendedUp"):script_upArrow,
(None,"ExtendedDown"):script_downArrow,
(None,"ExtendedLeft"):script_leftArrow,
(None,"ExtendedRight"):script_rightArrow,
(frozenset(["Control"]),"ExtendedLeft"):script_controlLeftArrow,
(frozenset(["Control"]),"ExtendedRight"):script_controlRightArrow,
(frozenset(["Shift"]),"ExtendedRight"):script_shiftRightArrow,
(frozenset(["Shift"]),"ExtendedLeft"):script_shiftLeftArrow,
(frozenset(["Shift"]),"ExtendedHome"):script_shiftHome,
(frozenset(["Shift"]),"ExtendedEnd"):script_shiftEnd,
(frozenset(["Shift"]),"ExtendedUp"):script_shiftUpArrow,
(frozenset(["Shift"]),"ExtendedDown"):script_shiftDownArrow,
(frozenset(["Control","Shift"]),"ExtendedLeft"):script_controlShiftLeftArrow,
(frozenset(["Control","Shift"]),"ExtendedRight"):script_controlShiftRightArrow,
(None,"ExtendedHome"):script_home,
(None,"ExtendedEnd"):script_end,
(None,"ExtendedDelete"):script_delete,
(None,"Back"):script_backspace,
(frozenset(["Insert"]), "N"): script_showGui,
}
