...
def isChildOfRow(obj):
	...
	while obj.parent and obj.parent.presentationType != obj.presType_content:
		if isinstance(obj.parent, UIA) and obj.parent.UIAElement.CachedAutomationID == "TmViewRow":
			return True
		obj = obj.parent
	return False
...
class AppModule(appModuleHandler.AppModule):
	def chooseNVDAObjectOverlayClasses(self, obj, clsList):
		if isinstance(obj, UIA) and obj.UIAElement.CachedAutomationID == "TmRowIcon":
