...
def main():
	...
	parser.add_argument("-r", "--restrict-token", help="use a restricted token", action="store_true")
	parser.add_argument(
		"-ru",
	...
	parser.add_argument("command_args", nargs=argparse.REMAINDER, help="Arguments for Command to execute")
	...
	p = secureProcess.SecurePopen(
		...
		restrictToken=args.restrict_token,
