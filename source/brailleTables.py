...
_tablesDirs = collections.ChainMap({TableSource.BUILTIN: TABLES_DIR})
...
def listTables() -> list[BrailleTable]:
	...
	"""
	return sorted(
		_tables.values(), key=lambda table: (table.source != TableSource.BUILTIN, strxfrm(table.displayName))
	)
