...
__all__ = [
    ...
    'StyleId_Heading7', 'UIA_PaneControlTypeId',
    'UIA_SpreadsheetPatternId', 'NavigateDirection_PreviousSibling',
    'IUIAutomationElement', 'HeadingLevel4',
    'IUIAutomationLegacyIAccessiblePattern',
    'IUIAutomationGridItemPattern', 'UIA_Drag_DragStartEventId',
    'IUIAutomationDropTargetPattern', 'StyleId_Subtitle',
    'UIA_IsContentElementPropertyId', 'UIA_PositionInSetPropertyId',
    'DockPosition_Top', 'ToggleState',
    'UIA_AnimationStyleAttributeId', 'StructureChangeType',
    ...
    'UIA_SelectionPattern2Id', 'UIA_NavigationLandmarkTypeId',
    'IUIAutomationPropertyCondition', 'UIA_IsActiveAttributeId',
    'UIA_IndentationLeadingAttributeId', 'StyleId_Normal',
    'UIA_LabeledByPropertyId', 'UIA_LayoutInvalidatedEventId',
    'UIA_DragDropEffectsPropertyId',
    'UIA_RangeValueLargeChangePropertyId',
    'UIA_GridItemContainingGridPropertyId', 'UIA_FillTypePropertyId',
    'NotificationProcessing_CurrentThenMostRecent',
    'UIA_TextPatternId', 'ProviderOptions_ClientSideProvider',
    'StyleId_Emphasis', 'ZoomUnit_LargeDecrement',
    'IUIAutomationElement2', 'UIA_WindowPatternId',
    'SynchronizedInputType', 'UIA_TabsAttributeId',
    'UIA_TreeControlTypeId', 'IUIAutomationTogglePattern',
    'UIA_StyleNameAttributeId', 'AutomationElementMode_None',
    'IUIAutomationTextRangeArray', 'UIA_DescribedByPropertyId',
    'HeadingLevel7', 'StyleId_Custom',
    ...
    'AnnotationType_Highlighted', 'UIA_CenterPointPropertyId',
    'TextEditChangeType_AutoComplete', 'UIA_ToolBarControlTypeId',
    'UIA_SpinnerControlTypeId', 'AnnotationType_Footnote',
    'DockPosition_Left', 'UIA_MenuOpenedEventId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'IUIAutomationSelectionItemPattern',
    'UIA_ProgressBarControlTypeId',
    'AnnotationType_AdvancedProofingIssue',
    'UIA_IsSuperscriptAttributeId', 'UIA_AcceleratorKeyPropertyId',
    'UIA_LocalizedControlTypePropertyId', 'UIA_OrientationPropertyId',
    'IUIAutomationPropertyChangedEventHandler',
    'UIA_StrikethroughStyleAttributeId',
    'StructureChangeType_ChildrenBulkAdded', 'TextUnit_Page',
    'UIA_IsInvokePatternAvailablePropertyId',
    'UIA_AnnotationPatternId', 'StyleId_Heading1',
    'ScrollAmount_NoAmount',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'UIA_IsStylesPatternAvailablePropertyId',
    'UIA_HorizontalTextAlignmentAttributeId', 'TreeScope_Element',
    'WindowInteractionState', 'UIA_IsKeyboardFocusablePropertyId',
    'UIA_Selection_InvalidatedEventId', 'UIA_NotificationEventId',
    'UIA_RangeValuePatternId', 'AnnotationType_MoveChange',
    'UIA_ToolTipOpenedEventId', 'UIA_TitleBarControlTypeId',
    'UIA_AnnotationTypesPropertyId', 'DockPosition', 'CUIAutomation',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'UIA_SystemAlertEventId', 'UIA_TextEdit_TextChangedEventId',
    'UIA_TablePatternId', 'UIA_SemanticZoomControlTypeId',
    ...
    'AnnotationType_ExternalChange', 'UIA_DragIsGrabbedPropertyId',
    'StyleId_Heading4', 'UIA_TogglePatternId',
    'UIA_SynchronizedInputPatternId', 'OrientationType_None',
    'NavigateDirection', 'IUIAutomationInvokePattern',
    'UIA_RangeValueMaximumPropertyId',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'UIA_IsControlElementPropertyId', 'UIA_LiveRegionChangedEventId',
    'TextEditChangeType_None', 'IUIAutomationTextEditPattern',
    'StyleId_Heading3', 'IUIAutomationCacheRequest',
    'IUIAutomationWindowPattern', 'UIA_AnnotationDateTimePropertyId',
    'UIA_AnnotationTargetPropertyId',
    'IUIAutomationChangesEventHandler', 'ScrollAmount_SmallDecrement',
    'UIA_ListControlTypeId', 'UIA_CalendarControlTypeId',
    'UIA_ObjectModelPatternId', 'ProviderOptions_OverrideProvider',
    'ScrollAmount_LargeDecrement', 'IUIAutomationTransformPattern2',
    'AnnotationType_TrackChanges', 'Off', 'AnnotationType_Unknown',
    'UIA_LiveSettingPropertyId', 'UIA_AnnotationAuthorPropertyId',
    'UIA_WindowCanMaximizePropertyId', 'UIA_TableItemPatternId',
    'UIA_SpreadsheetItemPatternId', 'StyleId_Heading2',
    'UIA_AutomationIdPropertyId', 'IUIAutomationObjectModelPattern',
    'UIA_TransformPattern2Id', 'UIA_BoundingRectanglePropertyId',
    'AnnotationType_CircularReferenceError',
    'UIA_StructureChangedEventId',
    'SynchronizedInputType_RightMouseDown', 'TreeScope_Subtree',
    'IUIAutomationDockPattern', 'UIA_IsDialogPropertyId',
    'ExtendedProperty', 'ExpandCollapseState_Collapsed',
    'UIA_UnderlineColorAttributeId',
    'UIA_RangeValueMinimumPropertyId',
    'UIA_StylesFillPatternColorPropertyId',
    'PropertyConditionFlags_MatchSubstring',
    'NotificationProcessing_ImportantMostRecent',
    'AnnotationType_InsertionChange', 'UIA_SizeOfSetPropertyId',
    'UIA_StyleIdAttributeId', 'CUIAutomation8',
    'IUIAutomationTreeWalker',
    'WindowInteractionState_BlockedByModalWindow',
    'CoalesceEventsOptions', 'ZoomUnit', 'UIA_StatusBarControlTypeId',
    'UIA_StylesStyleNamePropertyId', 'UIA_DragDropEffectPropertyId',
    ...
    'IUIAutomationBoolCondition', 'UIA_ProcessIdPropertyId',
    'UIA_SelectionActiveEndAttributeId',
    'UIA_IsRequiredForFormPropertyId',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'UIA_MarginBottomAttributeId', 'UIA_MarginTrailingAttributeId',
    'UIA_TransformCanRotatePropertyId', 'SynchronizedInputType_KeyUp',
    'IUIAutomationEventHandlerGroup', 'UIA_InputReachedTargetEventId',
    'HeadingLevel6', 'WindowVisualState_Minimized',
    'UIA_ChangesEventId', 'UIA_IsItalicAttributeId', 'HeadingLevel8',
    'UIA_SearchLandmarkTypeId', 'UIA_HasKeyboardFocusPropertyId',
    'IUIAutomationElement7', 'UIA_IndentationFirstLineAttributeId',
    'IUIAutomationElement9', 'ZoomUnit_SmallIncrement', 'TreeScope',
    'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_IsTogglePatternAvailablePropertyId', 'WindowVisualState',
    'Polite', 'ScrollAmount_LargeIncrement',
    'UIA_ToolTipClosedEventId',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'ExpandCollapseState_LeafNode', 'PropertyConditionFlags',
    'StyleId_Quote', 'UIA_RotationPropertyId',
    'AnnotationType_Author', 'NotificationKind_ActionAborted',
    'UIA_CultureAttributeId', 'UIA_SelectionSelectionPropertyId',
    'IUIAutomationScrollPattern', 'UIA_AppBarControlTypeId',
    ...
    'IUIAutomationScrollItemPattern', 'RowOrColumnMajor_RowMajor',
    ...
    'UIA_AutomationPropertyChangedEventId', 'UIA_ValuePatternId',
    'UIA_IsTextPattern2AvailablePropertyId',
    'UIA_SelectionItem_ElementSelectedEventId',
    'UIA_IsWindowPatternAvailablePropertyId',
    'UIA_IsReadOnlyAttributeId', 'ToggleState_Off',
    'AnnotationType_Comment', 'UIA_TableRowOrColumnMajorPropertyId',
    ...
    'UIA_AriaPropertiesPropertyId', 'UIA_RadioButtonControlTypeId',
    'StyleId_Heading9', 'UIA_VirtualizedItemPatternId',
    'UIA_MenuBarControlTypeId', 'RowOrColumnMajor_ColumnMajor',
    'ExpandCollapseState_PartiallyExpanded', 'UIA_TextPattern2Id',
    'WindowInteractionState_ReadyForUserInteraction',
    'IUIAutomationAndCondition', 'IUIAutomationTextChildPattern',
    'UIA_LegacyIAccessibleNamePropertyId', 'UIA_MenuClosedEventId',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'UIA_StylesPatternId', 'IUIAutomationTextPattern2',
    'UIA_FormLandmarkTypeId', 'ProviderOptions_ProviderOwnsSetFocus',
    'UIA_GridItemPatternId', 'UIA_UnderlineStyleAttributeId',
    'UIA_OverlineStyleAttributeId',
    'UIA_IsGridPatternAvailablePropertyId', 'StyleId_Heading5',
    'TextUnit_Character', 'UIA_LineSpacingAttributeId',
    'AnnotationType_Header', 'CoalesceEventsOptions_Disabled',
    ...
    'UIA_Drag_DragCancelEventId', 'UIA_DragGrabbedItemsPropertyId',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'WindowInteractionState_NotResponding',
    'SynchronizedInputType_RightMouseUp', 'UIA_MultipleViewPatternId',
    'TreeScope_Ancestors', 'UIA_ListItemControlTypeId',
    'NotificationKind', 'UIA_IsPasswordPropertyId',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'UIA_Transform2CanZoomPropertyId',
    'TextPatternRangeEndpoint_Start', 'TextUnit_Word',
    'IUIAutomationProxyFactory', 'UiaChangeInfo',
    'UIA_FillColorPropertyId',
    'UIA_IsValuePatternAvailablePropertyId', 'OrientationType',
    'IUIAutomationTextRange3', 'UIA_LocalizedLandmarkTypePropertyId',
    'IAccessible', 'TreeScope_Children',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'IUIAutomationElement5', 'WindowVisualState_Normal',
    'UIA_DockPatternId', 'AnnotationType_EditingLockedChange',
    'UIA_VisualEffectsPropertyId', 'UIA_TransformCanResizePropertyId',
    'UIA_MenuModeStartEventId', 'CoalesceEventsOptions_Enabled',
    'AnnotationType_ConflictingChange',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'UIA_ClickablePointPropertyId',
    'UIA_Transform2ZoomLevelPropertyId', 'TextUnit', 'IUIAutomation',
    'UIA_FrameworkIdPropertyId',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_IsPeripheralPropertyId', 'IUIAutomation3', 'ProviderOptions',
    'IUIAutomationElement6', 'StyleId_BulletedList',
    'UIA_AnnotationObjectsAttributeId',
    'ProviderOptions_UseClientCoordinates',
    'UIA_ControllerForPropertyId', 'DockPosition_Bottom',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'IUIAutomationProxyFactoryEntry',
    'UIA_TableColumnHeadersPropertyId',
    'StructureChangeType_ChildAdded', 'UIA_ComboBoxControlTypeId',
    'UIA_GridColumnCountPropertyId', 'TreeScope_Descendants',
    'IUIAutomationElement8', 'UIA_WindowControlTypeId',
    'IUIAutomationCondition', 'UIA_MenuControlTypeId',
    'UIA_MultipleViewCurrentViewPropertyId',
    'UIA_AnnotationTypesAttributeId', 'UIA_DragPatternId',
    'UIA_MenuItemControlTypeId', 'UIA_CaretPositionAttributeId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'IUIAutomationTableItemPattern', 'UIA_FlowsToPropertyId',
    'IUIAutomationElement4', 'UIA_MarginTopAttributeId',
    'SupportedTextSelection_None',
    'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_StrikethroughColorAttributeId', 'UIA_LevelPropertyId',
    'PropertyConditionFlags_IgnoreCase',
    'UIA_HeaderItemControlTypeId',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'ProviderOptions_UseComThreading', 'IRawElementProviderSimple',
    'OrientationType_Vertical', 'AnnotationType_DataValidationError',
    'UIA_GridPatternId', 'UIA_SizePropertyId',
    'UIA_EditControlTypeId', 'IUIAutomationExpandCollapsePattern',
    'UIA_IsScrollPatternAvailablePropertyId',
    'UIA_IsDockPatternAvailablePropertyId',
    'UIA_ValueValuePropertyId', 'UIA_IsEnabledPropertyId',
    'UIA_LegacyIAccessiblePatternId', 'LiveSetting',
    ...
    'UIA_FontSizeAttributeId', 'UIA_TextControlTypeId',
    'UIA_IsSubscriptAttributeId', 'UIA_CustomNavigationPatternId',
    'UIA_DropTargetDropTargetEffectsPropertyId', 'StyleId_Heading6',
    'UIA_ImageControlTypeId', 'UIA_TabControlTypeId',
    'IUIAutomationElement3',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_CulturePropertyId', 'IUIAutomationTextRange',
    'IUIAutomationAnnotationPattern', 'UIA_AriaRolePropertyId',
    'NotificationProcessing_MostRecent', 'IUIAutomation2',
    'IUIAutomationGridPattern', 'NotificationKind_ItemAdded',
    'DockPosition_None', 'UIA_ScrollItemPatternId',
    'UIA_MenuModeEndEventId', 'TextEditChangeType_AutoCorrect',
    'UIA_ThumbControlTypeId', 'IUIAutomationVirtualizedItemPattern',
    'IUIAutomation5', 'TreeTraversalOptions',
    'ProviderOptions_NonClientAreaProvider',
    'UIA_TextFlowDirectionsAttributeId',
    'NavigateDirection_LastChild', 'WindowInteractionState_Closing',
    'UIA_GroupControlTypeId',
    'StructureChangeType_ChildrenInvalidated',
    'IUIAutomationFocusChangedEventHandler',
    'IUIAutomationItemContainerPattern', 'UIA_BulletStyleAttributeId',
    'UIA_CapStyleAttributeId', 'UIA_ForegroundColorAttributeId',
    'IUIAutomationRangeValuePattern',
    'TreeTraversalOptions_PostOrder', 'UIA_DropTarget_DroppedEventId',
    ...
    'UIA_StylesFillPatternStylePropertyId', 'AutomationElementMode',
    'IUIAutomationSelectionPattern2', 'ToggleState_On',
    'UIA_HyperlinkControlTypeId',
    'ProviderOptions_ServerSideProvider', 'UIA_ScrollPatternId',
    'UIA_RuntimeIdPropertyId', 'ExpandCollapseState_Expanded',
    'TextPatternRangeEndpoint', 'UIA_ToggleToggleStatePropertyId',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'NavigateDirection_FirstChild', 'UIA_OverlineColorAttributeId',
    'UIA_OutlineThicknessPropertyId', 'StyleId_Heading8',
    'IUIAutomationSpreadsheetPattern', 'IUIAutomationValuePattern',
    'TextEditChangeType_Composition', 'AutomationElementMode_Full',
    'UIA_AnnotationObjectsPropertyId', 'UIA_OutlineStylesAttributeId',
    'ZoomUnit_SmallDecrement', 'IUIAutomationEventHandler',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_Text_TextChangedEventId',
    'UIA_DropTargetDropTargetEffectPropertyId',
    'IUIAutomationTransformPattern',
    'IUIAutomationCustomNavigationPattern',
    'UIA_CustomLandmarkTypeId', 'TextUnit_Line',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_FlowsFromPropertyId', 'UIA_SeparatorControlTypeId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'WindowInteractionState_Running', 'DockPosition_Fill',
    'UIA_TableControlTypeId', 'UIA_RangeValueIsReadOnlyPropertyId',
    'IUIAutomationTextPattern', 'ConnectionRecoveryBehaviorOptions',
    'ZoomUnit_LargeIncrement', 'UIA_CheckBoxControlTypeId',
    'UIA_SummaryChangeId', 'UIA_WindowIsModalPropertyId',
    'TreeScope_None', 'NotificationKind_Other',
    'SupportedTextSelection_Single',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_CaretBidiModeAttributeId', 'IUIAutomationOrCondition',
    'TextPatternRangeEndpoint_End',
    'UIA_Transform2ZoomMaximumPropertyId',
    'SynchronizedInputType_KeyDown', 'UIA_TransformPatternId',
    'UIA_DropTarget_DragLeaveEventId',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'UIA_IndentationTrailingAttributeId',
    'IUIAutomationStructureChangedEventHandler',
    'ScrollAmount_SmallIncrement', 'UIA_MainLandmarkTypeId',
    'UIA_BackgroundColorAttributeId', 'WindowVisualState_Maximized',
    'ScrollAmount', 'UIA_GridItemRowSpanPropertyId',
    'SynchronizedInputType_LeftMouseUp', 'IUIAutomationTextRange2',
    'AnnotationType_DeletionChange', 'UIA_HeadingLevelPropertyId',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'UIA_SplitButtonControlTypeId', 'AnnotationType_SpellingError',
    'UIA_RangeValueValuePropertyId', 'TreeScope_Parent',
    'UIA_AutomationFocusChangedEventId', 'HeadingLevel5',
    'UIA_ItemTypePropertyId', 'TextUnit_Format',
    'UIA_ButtonControlTypeId', 'UIA_SelectionPatternId',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'AnnotationType_FormatChange', 'IUIAutomationDragPattern',
    'HeadingLevel9', 'TextEditChangeType',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'UIA_ItemContainerPatternId', 'SupportedTextSelection',
    'AnnotationType_FormulaError', 'UIA_OutlineColorPropertyId',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'UIA_StylesShapePropertyId', 'UIA_ValueIsReadOnlyPropertyId',
    'UIA_ClassNamePropertyId', 'UIA_ControlTypePropertyId',
    'UIA_AfterParagraphSpacingAttributeId',
    'PropertyConditionFlags_None', 'UIA_DockDockPositionPropertyId',
    'UIA_HeaderControlTypeId',
    'StructureChangeType_ChildrenReordered',
    'UIA_LandmarkTypePropertyId', 'RowOrColumnMajor_Indeterminate',
    'IUIAutomationElementArray',
    'IUIAutomationTextEditTextChangedEventHandler',
    'UIA_DataItemControlTypeId', 'NotificationKind_ItemRemoved',
    'UIA_TransformCanMovePropertyId', 'UIA_DataGridControlTypeId',
    'UIA_Drag_DragCompleteEventId', 'UIA_FontWeightAttributeId',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'UIA_IsHiddenAttributeId', 'UIA_GridItemColumnPropertyId',
    'AnnotationType_Sensitive', 'UIA_WindowCanMinimizePropertyId',
    'HeadingLevel_None', 'UIA_SliderControlTypeId',
    'UIA_FontNameAttributeId', 'UIA_AccessKeyPropertyId',
    'IUIAutomationStylesPattern', 'StyleId_Title',
    'StyleId_NumberedList', 'TreeTraversalOptions_Default',
    'TextUnit_Document', 'UIA_DropTargetPatternId',
    ...
    'UIA_ScrollBarControlTypeId', 'AnnotationType_Endnote',
    'UIA_Invoke_InvokedEventId',
    'UIA_LegacyIAccessibleHelpPropertyId', 'UIA_InvokePatternId',
    'SupportedTextSelection_Multiple', 'UIA_GridRowCountPropertyId',
    'UIA_TreeItemControlTypeId',
    'IUIAutomationSpreadsheetItemPattern',
    'StructureChangeType_ChildRemoved',
    'UIA_IsTextPatternAvailablePropertyId',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'UIA_ToolTipControlTypeId', 'UIA_GridItemRowPropertyId',
    'AnnotationType_Mathematics', 'UIA_CustomControlTypeId',
    'IUIAutomationProxyFactoryMapping', 'UIA_TextChildPatternId',
    'IUIAutomation4', 'UIA_IsDataValidForFormPropertyId',
    'OrientationType_Horizontal', 'AnnotationType_GrammarError',
    'UIA_DropTarget_DragEnterEventId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'UIA_InputReachedOtherElementEventId',
    'IUIAutomationMultipleViewPattern', 'HeadingLevel3',
    'RowOrColumnMajor', 'HeadingLevel2',
    'IUIAutomationSelectionPattern', 'UIA_ItemStatusPropertyId'
]

_check_version('1.2.0', 1693435323.237984)
