...
__all__ = [
    'UIA_HeaderItemControlTypeId', 'SupportedTextSelection_Single',
    'UIA_IsEnabledPropertyId', 'HeadingLevel8',
    'AnnotationType_ExternalChange', 'UIA_ItemContainerPatternId',
    'UIA_MultipleViewCurrentViewPropertyId', 'Polite',
    'ScrollAmount_LargeDecrement', 'UIA_IsOffscreenPropertyId',
    'ScrollAmount_LargeIncrement', 'UIA_OutlineStylesAttributeId',
    'UIA_CustomNavigationPatternId', 'UIA_ListControlTypeId',
    'UIA_LegacyIAccessibleValuePropertyId',
    'UIA_TabItemControlTypeId', 'UIA_TextPattern2Id',
    'AnnotationType_Mathematics', 'UIA_HasKeyboardFocusPropertyId',
    'UIA_InputReachedTargetEventId', 'TextPatternRangeEndpoint_Start',
    'StructureChangeType_ChildAdded', 'SynchronizedInputType',
    'UIA_Drag_DragCancelEventId', 'TreeScope_Parent',
    'UIA_ObjectModelPatternId',
    'UIA_IsStylesPatternAvailablePropertyId',
    'UIA_IsTextPattern2AvailablePropertyId',
    'UIA_FontNameAttributeId', 'IUIAutomationElement3',
    'UIA_RuntimeIdPropertyId',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'UIA_IsRequiredForFormPropertyId',
    'UIA_BackgroundColorAttributeId', 'AnnotationType_Author',
    'UIA_ValueValuePropertyId', 'ZoomUnit_LargeDecrement',
    'IUIAutomationSynchronizedInputPattern',
    'UIA_Window_WindowOpenedEventId', 'UIA_GroupControlTypeId',
    'UIA_ToolTipOpenedEventId', 'UIA_TableItemPatternId',
    'DockPosition_Fill', 'UIA_ScrollHorizontallyScrollablePropertyId',
    'CUIAutomation', 'UIA_TreeControlTypeId',
    'UIA_WindowControlTypeId', 'UIA_EditControlTypeId',
    'IUIAutomationVirtualizedItemPattern',
    'UIA_SynchronizedInputPatternId',
    'SynchronizedInputType_RightMouseDown',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_TransformPatternId', 'UIA_IsTextPatternAvailablePropertyId',
    'UIA_AsyncContentLoadedEventId', 'UIA_VirtualizedItemPatternId',
    'RowOrColumnMajor', 'CoalesceEventsOptions',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'AutomationElementMode', 'WindowVisualState_Minimized',
    'UIA_DropTargetPatternId', 'NavigateDirection_Parent',
    'UIA_WindowIsTopmostPropertyId', 'StyleId_Emphasis',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'UIA_ImageControlTypeId', 'UIA_GridItemColumnPropertyId',
    'UIA_IsScrollPatternAvailablePropertyId',
    'TextPatternRangeEndpoint', 'UIA_MarginTrailingAttributeId',
    'UIA_CenterPointPropertyId', 'UIA_Text_TextChangedEventId',
    'UIA_RotationPropertyId', 'AnnotationType_Header',
    'UIA_AnnotationAuthorPropertyId', 'StyleId_BulletedList',
    'IUIAutomationTextRange3', 'HeadingLevel3',
    'IUIAutomationSpreadsheetPattern', 'IUIAutomationElement',
    'UIA_StyleIdAttributeId', 'UIA_IndentationFirstLineAttributeId',
    'UIA_PositionInSetPropertyId',
    'UIA_InputReachedOtherElementEventId',
    'UIA_IsKeyboardFocusablePropertyId',
    'UIA_FullDescriptionPropertyId', 'IUIAutomationElement4',
    'IUIAutomationSpreadsheetItemPattern', 'UIA_IsItalicAttributeId',
    'IUIAutomationBoolCondition', 'UIA_TransformCanResizePropertyId',
    'UIA_CaretBidiModeAttributeId', 'UIA_ValueIsReadOnlyPropertyId',
    'UIA_Drag_DragStartEventId',
    'IUIAutomationNotificationEventHandler', 'StructureChangeType',
    'IUIAutomationChangesEventHandler', 'DockPosition_Left',
    'NotificationProcessing_ImportantAll', 'UIA_WindowPatternId',
    'IUIAutomationPropertyChangedEventHandler',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'UIA_ProcessIdPropertyId', 'UIA_OutlineColorPropertyId',
    'UIA_TextControlTypeId', 'UIA_ToolTipControlTypeId',
    'AnnotationType_DataValidationError',
    'UIA_AriaPropertiesPropertyId', 'UIA_DescribedByPropertyId',
    'IUIAutomationExpandCollapsePattern',
    'UIA_LegacyIAccessibleNamePropertyId', 'UIA_SystemAlertEventId',
    'SupportedTextSelection', 'UIA_Text_TextSelectionChangedEventId',
    'UIA_LocalizedControlTypePropertyId', 'UIA_ClassNamePropertyId',
    'UIA_IsPasswordPropertyId', 'HeadingLevel6',
    'AnnotationType_ConflictingChange', 'UIA_MenuControlTypeId',
    'SynchronizedInputType_KeyUp', 'UIA_MenuClosedEventId',
    'IUIAutomationTextPattern2', 'UIA_TitleBarControlTypeId',
    'IUIAutomationScrollPattern', 'HeadingLevel1',
    'HeadingLevel_None', 'UIA_DragDropEffectsPropertyId',
    ...
    'UIA_TableRowHeadersPropertyId', 'WindowVisualState',
    'UIA_LayoutInvalidatedEventId',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'StructureChangeType_ChildrenBulkAdded',
    'UIA_FontWeightAttributeId', 'UIA_StylesStyleNamePropertyId',
    'AnnotationType_Comment', 'IUIAutomationElement7',
    'UIA_AnnotationDateTimePropertyId',
    'TextEditChangeType_Composition', 'UIA_ComboBoxControlTypeId',
    'AnnotationType_MoveChange', 'UIA_TransformCanRotatePropertyId',
    'UIA_RangeValueMinimumPropertyId',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_StylesFillPatternColorPropertyId',
    'UIA_TableRowOrColumnMajorPropertyId', 'IUIAutomationCondition',
    'AnnotationType_GrammarError', 'StyleId_Heading6',
    'IUIAutomationTogglePattern', 'IUIAutomationNotCondition',
    'TreeTraversalOptions_Default', 'UIA_AriaRolePropertyId',
    ...
    'UIA_IsSubscriptAttributeId', 'UIA_GridItemRowPropertyId',
    'PropertyConditionFlags', 'AnnotationType_Endnote',
    'CUIAutomation8', 'UIA_ScrollItemPatternId', 'UIA_GridPatternId',
    'OrientationType_Horizontal', 'UIA_FrameworkIdPropertyId',
    'UIA_StatusBarControlTypeId', 'UIA_CultureAttributeId',
    'UIA_DropTarget_DroppedEventId', 'IUIAutomationOrCondition',
    'UIA_DragGrabbedItemsPropertyId', 'IUIAutomationTablePattern',
    'UIA_TablePatternId', 'IUIAutomation5',
    'IUIAutomationMultipleViewPattern', 'UIA_StructureChangedEventId',
    'WindowInteractionState_NotResponding',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'UIA_IsDockPatternAvailablePropertyId',
    'UIA_SayAsInterpretAsAttributeId', 'UIA_SeparatorControlTypeId',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'ExpandCollapseState', 'UIA_IsReadOnlyAttributeId',
    'TreeTraversalOptions_PostOrder',
    'IUIAutomationPropertyCondition',
    'UIA_WindowWindowVisualStatePropertyId', 'UIA_FlowsToPropertyId',
    'ZoomUnit_LargeIncrement', 'UiaChangeInfo',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'AnnotationType_UnsyncedChange',
    'IUIAutomationStructureChangedEventHandler', 'DockPosition',
    'ScrollAmount_NoAmount', 'IUIAutomationCustomNavigationPattern',
    'UIA_RangeValueValuePropertyId', 'IUIAutomationGridPattern',
    'HeadingLevel2', 'NotificationProcessing',
    'IUIAutomationAnnotationPattern', 'NavigateDirection',
    'IUIAutomation4', 'UIA_WindowCanMaximizePropertyId',
    'ProviderOptions', 'TreeTraversalOptions_LastToFirstOrder',
    'UIA_ProviderDescriptionPropertyId', 'TextUnit_Page',
    'ProviderOptions_UseClientCoordinates',
    'TextPatternRangeEndpoint_End', 'UIA_WindowCanMinimizePropertyId',
    'UIA_GridItemContainingGridPropertyId', 'StyleId_Heading4',
    'IUIAutomationObjectModelPattern', 'OrientationType_Vertical',
    'IUIAutomationTextRange',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'IUIAutomationProxyFactoryEntry', 'DockPosition_Right',
    'StyleId_Heading9', 'IRawElementProviderSimple',
    'UIA_AnimationStyleAttributeId', 'UIA_IsDialogPropertyId',
    'TextUnit_Character', 'UIA_StylesFillColorPropertyId',
    'UIA_ChangesEventId', 'TextUnit_Paragraph',
    'UIA_TextChildPatternId', 'UIA_CheckBoxControlTypeId',
    'AnnotationType_Highlighted',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'UIA_IsWindowPatternAvailablePropertyId', 'UIA_NamePropertyId',
    'UIA_LineSpacingAttributeId',
    'UIA_IsTablePatternAvailablePropertyId', 'Assertive',
    'UIA_CapStyleAttributeId', 'IUIAutomation6',
    'UIA_MenuItemControlTypeId',
    'UIA_ActiveTextPositionChangedEventId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'SynchronizedInputType_KeyDown', 'IUIAutomationDockPattern',
    'UIA_MenuOpenedEventId', 'UIA_SayAsInterpretAsMetadataId',
    'ExpandCollapseState_Expanded', 'UIA_InvokePatternId',
    'IUIAutomationAndCondition',
    'UIA_AutomationPropertyChangedEventId', 'StyleId_Heading1',
    'UIA_LegacyIAccessibleRolePropertyId',
    'UIA_ForegroundColorAttributeId',
    'UIA_SelectionActiveEndAttributeId', 'UIA_MultipleViewPatternId',
    'NotificationKind_Other', 'RowOrColumnMajor_RowMajor',
    ...
    'UIA_IsSuperscriptAttributeId', 'SupportedTextSelection_Multiple',
    ...
    'UIA_MainLandmarkTypeId', 'UIA_MenuBarControlTypeId',
    'UIA_ItemStatusPropertyId', 'IUIAutomationElement2',
    'WindowVisualState_Maximized',
    'PropertyConditionFlags_MatchSubstring',
    'UIA_SearchLandmarkTypeId',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'IUIAutomationInvokePattern', 'StructureChangeType_ChildRemoved',
    'UIA_GridItemColumnSpanPropertyId',
    'UIA_Window_WindowClosedEventId',
    'UIA_TableColumnHeadersPropertyId', 'IUIAutomationElement8',
    'UIA_LabeledByPropertyId', 'AnnotationType_FormatChange',
    'UIA_ItemTypePropertyId', 'AnnotationType_SpellingError',
    'PropertyConditionFlags_None', 'TextEditChangeType',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'UIA_RangeValueIsReadOnlyPropertyId',
    'UIA_OptimizeForVisualContentPropertyId',
    'UIA_SelectionCanSelectMultiplePropertyId', 'UIA_SummaryChangeId',
    'IUIAutomationProxyFactoryMapping', 'UIA_SpinnerControlTypeId',
    'UIA_DragPatternId', 'UIA_CulturePropertyId',
    'UIA_SizePropertyId', 'UIA_SpreadsheetItemPatternId',
    'UIA_FillColorPropertyId', 'UIA_DropTarget_DragEnterEventId',
    'UIA_LegacyIAccessiblePatternId', 'UIA_GridColumnCountPropertyId',
    'IUIAutomationRangeValuePattern',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_AnnotationObjectsPropertyId', 'UIA_LevelPropertyId',
    'UIA_StyleNameAttributeId', 'IUIAutomationTextRange2',
    'UIA_SelectionSelectionPropertyId', 'UIA_MarginTopAttributeId',
    'UIA_IsDataValidForFormPropertyId',
    'NotificationKind_ItemRemoved', 'UIA_TogglePatternId',
    'WindowInteractionState_Closing',
    'StructureChangeType_ChildrenReordered', 'UIA_SelectionPatternId',
    'UIA_NavigationLandmarkTypeId', 'UIA_ToolBarControlTypeId',
    'IUIAutomationSelectionItemPattern',
    'ScrollAmount_SmallIncrement', 'UIA_AppBarControlTypeId',
    'UIA_AccessKeyPropertyId', 'UIA_TabsAttributeId',
    'UIA_GridRowCountPropertyId', 'UIA_AnnotationTypesPropertyId',
    'NotificationProcessing_ImportantMostRecent',
    'ExpandCollapseState_Collapsed', 'ExpandCollapseState_LeafNode',
    'StyleId_Heading2', 'NavigateDirection_PreviousSibling',
    'IUIAutomationTransformPattern', 'UIA_AnnotationPatternId',
    'UIA_NativeWindowHandlePropertyId',
    'UIA_ProgressBarControlTypeId', 'IUIAutomationElementArray',
    'UIA_DropTarget_DragLeaveEventId', 'TreeScope_Descendants',
    'SynchronizedInputType_LeftMouseUp', 'UIA_NotificationEventId',
    'IUIAutomation3', 'NotificationKind_ItemAdded',
    'UIA_DropTargetDropTargetEffectsPropertyId', 'NotificationKind',
    'NotificationKind_ActionAborted', 'HeadingLevel9',
    'UIA_BeforeParagraphSpacingAttributeId',
    'UIA_MarginLeadingAttributeId', 'UIA_CaretPositionAttributeId',
    'SynchronizedInputType_LeftMouseDown', 'UIA_FillTypePropertyId',
    'StyleId_Normal', 'UIA_SpreadsheetPatternId',
    'UIA_SplitButtonControlTypeId',
    'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_AcceleratorKeyPropertyId', 'UIA_RangeValueMaximumPropertyId',
    'UIA_TreeItemControlTypeId', 'UIA_DocumentControlTypeId',
    'ZoomUnit_SmallDecrement', 'UIA_CustomLandmarkTypeId',
    'IUIAutomationCacheRequest', 'NotificationKind_ActionCompleted',
    'NotificationProcessing_CurrentThenMostRecent',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'TextEditChangeType_AutoCorrect', 'UIA_StylesStyleIdPropertyId',
    'ToggleState_On', 'UIA_TransformPattern2Id',
    'ProviderOptions_OverrideProvider',
    'UIA_TextEdit_TextChangedEventId',
    'PropertyConditionFlags_IgnoreCase', 'UIA_StylesPatternId',
    'AnnotationType_Sensitive', 'AnnotationType_DeletionChange',
    'UIA_GridItemPatternId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_StylesFillPatternStylePropertyId', 'UIA_SliderControlTypeId',
    'UIA_OverlineStyleAttributeId', 'StyleId_Heading3',
    'TreeTraversalOptions', 'TextEditChangeType_CompositionFinalized',
    'RowOrColumnMajor_Indeterminate', 'TreeScope_Subtree',
    'UIA_ExpandCollapsePatternId', 'IUIAutomationTreeWalker',
    'UIA_HelpTextPropertyId', 'UIA_ControllerForPropertyId',
    'AutomationElementMode_Full',
    'WindowInteractionState_ReadyForUserInteraction',
    'UIA_FontSizeAttributeId', 'UIA_LinkAttributeId',
    'UIA_Selection_InvalidatedEventId',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'IUIAutomationEventHandler', 'UIA_DragDropEffectPropertyId',
    ...
    'IUIAutomationElement5', 'IUIAutomationGridItemPattern',
    'UIA_IsDragPatternAvailablePropertyId',
    'UIA_MarginBottomAttributeId', 'IUIAutomationTableItemPattern',
    'ZoomUnit_SmallIncrement',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'UIA_FlowsFromPropertyId', 'IUIAutomation2', 'StyleId_Title',
    'AnnotationType_AdvancedProofingIssue', 'ToggleState',
    'WindowInteractionState', 'AnnotationType_Unknown',
    'UIA_UnderlineStyleAttributeId', 'UIA_PaneControlTypeId',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId', 'TreeScope',
    'UIA_TextPatternId', 'UIA_SemanticZoomControlTypeId',
    'UIA_ControlTypePropertyId', 'UIA_IndentationTrailingAttributeId',
    'IUIAutomationProxyFactory', 'ProviderOptions_UseComThreading',
    'IUIAutomation', 'UIA_SelectionPattern2Id',
    'UIA_StrikethroughStyleAttributeId',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_IsValuePatternAvailablePropertyId',
    'UIA_CalendarControlTypeId', 'IUIAutomationEventHandlerGroup',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'UIA_DragIsGrabbedPropertyId', 'UIA_Drag_DragCompleteEventId',
    'UIA_IsInvokePatternAvailablePropertyId',
    'UIA_Transform2ZoomLevelPropertyId', 'IUIAutomationValuePattern',
    'ScrollAmount', 'UIA_ClickablePointPropertyId',
    'AutomationElementMode_None', 'UIA_AutomationIdPropertyId',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'IUIAutomationStylesPattern', 'UIA_OverlineColorAttributeId',
    'UIA_RangeValuePatternId', 'UIA_LocalizedLandmarkTypePropertyId',
    'ZoomUnit', 'UIA_ToolTipClosedEventId', 'UIA_DockPatternId',
    'StyleId_Heading8', 'UIA_IsGridItemPatternAvailablePropertyId',
    'IUIAutomationLegacyIAccessiblePattern', 'StyleId_NumberedList',
    'UIA_AfterParagraphSpacingAttributeId',
    'ToggleState_Indeterminate', 'UIA_CustomControlTypeId',
    'TextEditChangeType_None', 'UIA_ToggleToggleStatePropertyId',
    'UIA_AnnotationTypesAttributeId', 'UIA_DataGridControlTypeId',
    'UIA_AnnotationObjectsAttributeId',
    'UIA_TextFlowDirectionsAttributeId',
    'NavigateDirection_LastChild', 'IUIAutomationDragPattern',
    'ZoomUnit_NoAmount', 'UIA_DataItemControlTypeId',
    'UIA_ScrollVerticalScrollPercentPropertyId', 'ExtendedProperty',
    'UIA_LegacyIAccessibleSelectionPropertyId', 'UIA_ScrollPatternId',
    'TreeScope_None', 'StyleId_Quote',
    ...
    'TreeScope_Element', 'SynchronizedInputType_RightMouseUp',
    'AnnotationType_Footnote', 'UIA_WindowIsModalPropertyId',
    'UIA_FormLandmarkTypeId', 'UIA_LiveSettingPropertyId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_GridItemRowSpanPropertyId', 'UIA_ScrollBarControlTypeId',
    'UIA_BoundingRectanglePropertyId', 'UIA_HeaderControlTypeId',
    'NavigateDirection_FirstChild',
    'UIA_IsTransformPattern2AvailablePropertyId', 'IAccessible',
    ...
    'UIA_RadioButtonControlTypeId', 'UIA_TableControlTypeId',
    'StyleId_Heading5', 'ScrollAmount_SmallDecrement',
    'UIA_ThumbControlTypeId', 'ProviderOptions_NonClientAreaProvider',
    'AnnotationType_FormulaError',
    'IUIAutomationTextEditTextChangedEventHandler',
    'StructureChangeType_ChildrenBulkRemoved', 'TreeScope_Ancestors',
    'UIA_OrientationPropertyId', 'AnnotationType_Footer',
    'IUIAutomationSelectionPattern',
    'ProviderOptions_RefuseNonClientSupport', 'Off',
    'StyleId_Subtitle', 'StructureChangeType_ChildrenInvalidated',
    'UIA_MenuModeEndEventId', 'IUIAutomationTextRangeArray',
    'CoalesceEventsOptions_Disabled', 'HeadingLevel4',
    'IUIAutomationWindowPattern', 'AnnotationType_InsertionChange',
    'UIA_StylesExtendedPropertiesPropertyId',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'IUIAutomationDropTargetPattern',
    'UIA_TransformCanMovePropertyId',
    'IUIAutomationTransformPattern2', 'IUIAutomationTextPattern',
    'ProviderOptions_HasNativeIAccessible',
    'UIA_SelectionItem_ElementSelectedEventId',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'OrientationType_None', 'UIA_LegacyIAccessibleStatePropertyId',
    'IUIAutomationElement6', 'UIA_ScrollVerticalViewSizePropertyId',
    'WindowVisualState_Normal', 'UIA_TextEditPatternId',
    'LiveSetting', 'NotificationProcessing_MostRecent',
    'OrientationType', 'IUIAutomationScrollItemPattern',
    ...
    'UIA_InputDiscardedEventId', 'ToggleState_Off',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_SizeOfSetPropertyId', 'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_IsHiddenAttributeId', 'HeadingLevel5',
    'SupportedTextSelection_None', 'TextUnit_Word',
    'UIA_ListItemControlTypeId',
    'UIA_IsGridPatternAvailablePropertyId',
    'UIA_Selection2ItemCountPropertyId', 'TextUnit_Line',
    'StyleId_Heading7', 'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_WindowWindowInteractionStatePropertyId',
    'ProviderOptions_ProviderOwnsSetFocus', 'DockPosition_Bottom',
    'UIA_IsPeripheralPropertyId', 'UIA_MenuModeStartEventId',
    'DockPosition_None', 'IUIAutomationTextEditPattern',
    'UIA_Invoke_InvokedEventId', 'StyleId_Custom',
    'WindowInteractionState_Running', 'TextUnit_Format',
    'DockPosition_Top', 'IUIAutomationElement9',
    'UIA_Transform2CanZoomPropertyId', 'HeadingLevel7',
    'UIA_AnnotationTargetPropertyId', 'UIA_HeadingLevelPropertyId',
