...
class SpeechSpy:
	...
	def speak(self, speechSeqence: SpeechSequence):
...
def old_speakWithoutPauses(  # noqa: C901
	speechSequence: SpeechSequence, detectBreaks: bool = True
) -> bool:
	"""
	...
	def test_stopsSpeakingCase(self):
		...
		def createInputSequences():
			...
			return [
				...
				[callbackCommand, lang_en, "learn, understand and use ", lang_default],
				[
					callbackCommand,
					"visited",
					"link",
