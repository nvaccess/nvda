...
class Test_isWindowAboveWindowMatchesCond_dynamic(_Test_isWindowAboveWindowMatchesCond):
	...
	def _test_windowWithMove(
		...
		if aboveRaises is None:
			self.assertEqual(
				isBelow, _isWindowBelowWindowMatchesCond(aboveWindow, self._windowMatches(belowWindow))
			)
		else:
		...
		if belowRaises is None:
			self.assertEqual(
				isBelow, _isWindowBelowWindowMatchesCond(belowWindow, self._windowMatches(aboveWindow))
			)
		else:
	...
	def test_visited_windowMoves_aboveTargets(self):
		...
		self._test_windowWithMove(
			move=_MoveWindow(HWNDToMove=3, insertBelowHWND=6, triggerHWND=4),
			aboveWindow=5,
			belowWindow=2,
		)
	...
	def test_visited_windowMoves_betweenTargets(self):
		...
		"""
		self._test_windowWithMove(
			move=_MoveWindow(HWNDToMove=3, insertBelowHWND=5, triggerHWND=4), aboveWindow=6, belowWindow=2
		)
	...
	def test_visited_windowMoves_belowTargets(self):
		...
		"""
		self._test_windowWithMove(
			move=_MoveWindow(HWNDToMove=3, insertBelowHWND=1, triggerHWND=4),
			aboveWindow=5,
			belowWindow=2,
		)
	...
	def test_active_windowMoves_betweenTargets(self):
		...
		"""
		self._test_windowWithMove(
			move=_MoveWindow(HWNDToMove=3, insertBelowHWND=8, triggerHWND=3),
			aboveWindow=10,
			belowWindow=6,
	...
	def test_active_windowMoves_beforeTargets(self):
		...
		"""
		self._test_windowWithMove(
			move=_MoveWindow(HWNDToMove=3, insertBelowHWND=5, triggerHWND=3),
			aboveWindow=10,
			belowWindow=6,
		)
	...
	def test_active_windowMoves_belowTargets(self):
		...
		"""
		self._test_windowWithMove(
			_MoveWindow(HWNDToMove=3, insertBelowHWND=1, triggerHWND=3), aboveWindow=10, belowWindow=6
		)
	...
	def test_unvisited_windowMoves_aboveTargets(self):
		...
		"""
		self._test_windowWithMove(
			move=_MoveWindow(HWNDToMove=5, insertBelowHWND=8, triggerHWND=3), aboveWindow=6, belowWindow=2
		)
	...
	def test_unvisited_windowMoves_betweenTargets(self):
		...
		"""
		self._test_windowWithMove(
			move=_MoveWindow(HWNDToMove=4, insertBelowHWND=6, triggerHWND=3), aboveWindow=8, belowWindow=2
		)
	...
	def test_unvisited_windowMoves_belowTargets(self):
		...
		"""
		self._test_windowWithMove(
			move=_MoveWindow(HWNDToMove=4, insertBelowHWND=1, triggerHWND=3), aboveWindow=8, belowWindow=2
		)
	...
	def test_belowWindow_windowMoves_aboveAboveWindow(self):
		...
		belowWindow = 2
		self._test_windowWithMove(
			move=_MoveWindow(HWNDToMove=belowWindow, insertBelowHWND=8, triggerHWND=3),
			aboveWindow=6,
	...
	def test_belowWindow_windowMoves_towardsAboveWindow(self):
		...
		belowWindow = 2
		self._test_windowWithMove(
			move=_MoveWindow(HWNDToMove=belowWindow, insertBelowHWND=6, triggerHWND=3),
			aboveWindow=8,
			belowWindow=belowWindow,
	...
	def test_belowWindow_windowMoves_furtherBelow(self):
		...
		belowWindow = 2
		self._test_windowWithMove(
			move=_MoveWindow(HWNDToMove=belowWindow, insertBelowHWND=1, triggerHWND=3),
			aboveWindow=8,
			belowWindow=belowWindow,
		)
	...
	def test_aboveWindow_windowMoves_furtherAbove(self):
		...
		aboveWindow = 6
		self._test_windowWithMove(
			move=_MoveWindow(HWNDToMove=aboveWindow, insertBelowHWND=8, triggerHWND=3),
	...
	def test_aboveWindow_windowMoves_towardsBelowWindow(self):
		...
		aboveWindow = 8
		self._test_windowWithMove(
			move=_MoveWindow(HWNDToMove=aboveWindow, insertBelowHWND=6, triggerHWND=3),
			aboveWindow=aboveWindow,
			belowWindow=2,
		)
	...
	def test_aboveWindow_windowMoves_belowBelowWindow(self):
		...
		aboveWindow = 8
		self._test_windowWithMove(
			move=_MoveWindow(HWNDToMove=aboveWindow, insertBelowHWND=1, triggerHWND=3),
			aboveWindow=aboveWindow,
			belowWindow=2,
			belowRaises=_UnexpectedWindowCountError,  # handled as if window is above
		)
