...
class TestEdgeCases(unittest.TestCase):
	...
	def test_wideToStrOffsets(self):
		converter = WideStringOffsetConverter(text="abc")
		self.assertEqual(converter.strLength, 3)
		self.assertEqual(converter.wideToStrOffsets(-1, 0, raiseOnError=False), (0, 0))
		self.assertEqual(converter.wideToStrOffsets(0, 4, raiseOnError=False), (0, 3))
	...
	def test_strToWideOffsets(self):
		converter = WideStringOffsetConverter(text="abc")
		self.assertEqual(converter.wideStringLength, 3)
		self.assertEqual(converter.strToWideOffsets(-1, 0, raiseOnError=False), (0, 0))
		self.assertEqual(converter.strToWideOffsets(0, 4, raiseOnError=False), (0, 3))
