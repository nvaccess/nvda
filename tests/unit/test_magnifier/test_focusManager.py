...
from _magnifier.utils.types import Coordinates, MagnifierFollowTrackingType
import unittest
...
def _makeFollowStateSideEffect(
	...
	states = {
		...
		MagnifierFollowTrackingType.REVIEW: followReview,
...
class FocusTestParam:
	...
	expectedFocus: MagnifierFollowTrackingType | None
	description: str = ""
	lastFocusedObject: MagnifierFollowTrackingType | None = None
...
class TestFocusManager(unittest.TestCase):
	...
	def testGetCurrentFocusCoordinates(self):
		...
		subTestParams = [
			FocusTestParam(
				...
				expectedFocus=MagnifierFollowTrackingType.MOUSE,
			...
			FocusTestParam(
				...
				expectedFocus=MagnifierFollowTrackingType.SYSTEM_FOCUS,
			...
			FocusTestParam(
				...
				expectedFocus=MagnifierFollowTrackingType.NAVIGATOR_OBJECT,
			...
			FocusTestParam(
				...
				expectedCoords=Coordinates(30, 30),
				expectedFocus=MagnifierFollowTrackingType.REVIEW,
			...
			FocusTestParam(
				...
				lastFocusedObject=MagnifierFollowTrackingType.MOUSE,
			),
			FocusTestParam(
				navigatorObjectPos=Coordinates(0, 0),
				systemFocusPos=Coordinates(0, 0),
				...
				lastFocusedObject=MagnifierFollowTrackingType.NAVIGATOR_OBJECT,
			),
			FocusTestParam(
				navigatorObjectPos=Coordinates(0, 0),
				systemFocusPos=Coordinates(0, 0),
				...
				lastFocusedObject=MagnifierFollowTrackingType.REVIEW,
			),
			FocusTestParam(
	...
	def testGetLastFocusType(self):
		...
		for focusType in MagnifierFollowTrackingType:
...
class TestFollowSettings(unittest.TestCase):
	...
	def testFollowMouseDisabled(self):
		...
		self.assertEqual(self.focusManager.getLastFocusType(), MagnifierFollowTrackingType.SYSTEM_FOCUS)
	...
	def testFollowSystemFocusDisabled(self):
		...
		self.assertEqual(self.focusManager.getLastFocusType(), MagnifierFollowTrackingType.REVIEW)
	...
	def testFollowReviewDisabled(self):
		...
		self.assertEqual(self.focusManager.getLastFocusType(), MagnifierFollowTrackingType.NAVIGATOR_OBJECT)
	...
	def testFollowMouseDragIgnoresSettings(self):
		...
		self.assertEqual(coords, Coordinates(10, 10))
		self.assertEqual(self.focusManager.getLastFocusType(), MagnifierFollowTrackingType.MOUSE)
	...
	def testDisableFollowMouseKeepsViewFrozen(self):
		...
		self.focusManager._lastFocusedObject = MagnifierFollowTrackingType.MOUSE
	...
	def testDisableFollowSystemFocusKeepsViewFrozen(self):
		...
		self.focusManager._lastFocusedObject = MagnifierFollowTrackingType.SYSTEM_FOCUS
