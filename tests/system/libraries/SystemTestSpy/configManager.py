...
def setupProfile(
	...
	_installSystemTestSpyToScratchPad(repoRoot, _pJoin(stagingDir, "nvdaProfile", "scratchpad"))
...
def teardownProfile(stagingDir: str):
	...
	opSys.remove_directory(_pJoin(stagingDir, "nvdaProfile"), recursive=True)
