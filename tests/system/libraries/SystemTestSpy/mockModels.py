...
class MockVisionEncoderDecoderGenerator:
	...
	def _createDecoderInputs(self) -> list:
		...
		inputs.extend([
			...
			helper.make_tensor_value_info(
				"use_cache_branch", TensorProto.BOOL, ["batch"]
			)
		])
	...
	def _getVocabulary(self) -> Dict[str, int]:
		...
		return {
			...
			"yellow": 47, "black": 48, "white": 49, "brown": 50,
			"orange": 51, "purple": 52, "pink": 53, "!": 54,
			"small": 55, "tall": 56, "short": 57, "old": 58,
			"young": 59, "beautiful": 61, "ugly": 62, "good": 63,
			"bad": 64, "sitting": 65, "standing": 66, "walking": 67,
			"running": 68, "screen": 69, "drinking": 70, "playing": 71,
			"working": 72, "is": 73, "open": 74, "was": 75, "were": 76,
			"has": 77, "Best": 78, "helping": 79, "will": 80,
			"would": 81, "could": 82, "should": 83, "very": 84,
			"quite": 85, "really": 86, "too": 87, "also": 88,
			"source": 89, "only": 90, "even": 91, "still": 92,
			"already": 93, "windows": 96
		}
