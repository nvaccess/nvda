...
In the environment section, after a couple lines of comment about what these variables do, you will find a set of variable names starting with the word "feature" and a value of "configured".
